...
fn list_children(
    path: &VfsPath,
    cp_store: &haneul_core::checkpoints::CheckpointStore,
    committee_store: &haneul_core::epoch::committee_store::CommitteeStore,
    auth_store: &haneul_core::authority::AuthorityStore,
...
fn render_consensus_commit_summary(
    ...
    let summary = haneul_core::consensus_commit_summary::build_consensus_commit_summary(cs, index)
        .map_err(internal)?
