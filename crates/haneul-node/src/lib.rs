...
// unified node. See https://github.com/GeunhwaJeong/haneul/issues/2068 for more info.
...
//TODO remove the separate FullNode type and merge with the HaneulNode type above
pub struct FullNode {
