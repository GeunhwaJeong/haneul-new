...
pub async fn start_tx_checkpoint_commit_task<S>(
    ...
    tx_indexing_receiver: haneullabs_metrics::metered_channel::Receiver<CheckpointDataToCommit>,
    ...
    S: IndexerStore + Clone + Sync + Send + 'static,
{
    ...
    let mut stream = haneullabs_metrics::metered_channel::ReceiverStream::new(tx_indexing_receiver)
