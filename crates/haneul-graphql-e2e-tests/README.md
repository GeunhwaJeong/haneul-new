...
1. See the instructions in the Haneul Indexer [README](../haneul-indexer/README.md)
...
$ psql "postgres://postgres:postgrespw@localhost:5432/postgres" \
    -c "CREATE DATABASE haneul_indexer_v2;" -c "ALTER SYSTEM SET max_connections = 500;"
```
