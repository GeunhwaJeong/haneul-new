...
//# run 0x3::haneul_system::request_add_stake --args object(0x5) object(6,0) @validator_0 --sender C
...
//# run-graphql --cursors bcs(bcs(@{obj_3_1}),1) bcs(bcs(@{obj_7_0}),1)
...
//# run-graphql --cursors bcs(bcs(@{obj_3_1}),3) bcs(bcs(@{obj_7_0}),3)
