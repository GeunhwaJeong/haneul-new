...
//# run-graphql --cursors bcs(bcs(@{obj_5_0}),1) bcs(bcs(@{obj_5_0}),2)
fragment DynamicFieldSelect on DynamicField {
  name {
    bcs
    type {
...
//# run-graphql --cursors bcs(bcs(@{obj_5_0}),2) bcs(bcs(@{obj_5_0}),3)
fragment DynamicFieldSelect on DynamicField {
  name {
    bcs
    type {
...
//# run-graphql --cursors bcs(bcs(@{obj_5_0}),2) bcs(bcs(@{obj_5_0}),4)
fragment DynamicFieldSelect on DynamicField {
  name {
    bcs
    type {
