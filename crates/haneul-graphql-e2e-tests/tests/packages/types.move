...
//# init --protocol-version 45 --addresses P0=0x0 --simulator

//# run-graphql
# Happy path -- valid type, get everything

{
    type(type: "0x2::priority_queue::PriorityQueue<0x2::coin::Coin<0x2::haneul::HANEUL>>") {
        repr
        signature
        layout
    }
...
{
    token: type(type: "0x2::token::Token<0x2::haneul::HANEUL>") {
        abilities
    }

    coin: type(type: "0x2::coin::Coin<0x2::haneul::HANEUL>") {
        abilities
    }

    balance: type(type: "0x2::balance::Balance<0x2::haneul::HANEUL>") {
        abilities
    }

    coin_vector: type(type: "vector<0x2::coin::Coin<0x2::haneul::HANEUL>>") {
        abilities
    }
