...
//! Those stores are loosely modeled after the GQL schema in `crates/haneul-indexer-alt-graphql/schema.graphql`.
...
/// `haneul_execution::executor::Executor::execute_transaction_to_effects` has to be provided.
...
/// allowed by `crates/haneul-indexer-alt-graphql/schema.graphql::multiGetObjects`.
