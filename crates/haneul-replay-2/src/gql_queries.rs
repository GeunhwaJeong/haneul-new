...
//! GQL Queries
//! Interface to the rpc for the gql schema defined in `crates\haneul-indexer-alt-graphql/schema.graphql`.
...
mod schema {
    cynic::use_schema!("../haneul-indexer-alt-graphql/schema.graphql");
...
pub mod epoch_query {
    ...
    #[cynic(schema_path = "../haneul-indexer-alt-graphql/schema.graphql")]
    pub struct Query {
...
pub mod txn_query {
    ...
    #[derive(cynic::QueryFragment)]
    #[cynic(
        schema_path = "../haneul-indexer-alt-graphql/schema.graphql",
    ...
    pub async fn query(
    ...
    ) -> Result<(TransactionData, haneul_types::effects::TransactionEffects, u64), anyhow::Error> {
        ...
        let effects: haneul_types::effects::TransactionEffects = bcs::from_bytes(
            &CryptoBase64::decode(
                &effect_frag
                    .effects_bcs
                    .ok_or_else(|| {
...
pub mod object_query {
    ...
    pub struct HaneulAddress(pub String);
    ...
    impl From<crate::replay_interface::ObjectKey> for ObjectKey {
        fn from(key: crate::replay_interface::ObjectKey) -> Self {
            ObjectKey {
                address: HaneulAddress(key.object_id.to_string()),
