...
impl PackageRebuilder {
    ...
    fn compile_package_with_id(&self) -> Result<Vec<CompiledModule>> {
        // Register HaneulPackageHooks to recognize Haneul-specific manifest fields (matching haneul move build)
    ...
    /// This follows the same logic as build_upgraded_type_origin_table in haneul-types
