...
//! Haneul blockchain data (transactions, checkpooints, epochs, objects). The stores are loosely
//! modeled after the GQL schema in `crates/haneul-indexer-alt-graphql/schema.graphql`.
//!
//! ## Core Traits
//!
