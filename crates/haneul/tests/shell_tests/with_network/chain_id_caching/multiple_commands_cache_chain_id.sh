...
haneul client --client.config $CONFIG objects > output.txt 2>&1
...
haneul client --client.config $CONFIG gas > output.txt 2>&1
echo "Command executed"
...
haneul client --client.config $CONFIG balance > output.txt 2>&1
echo "Command executed"
