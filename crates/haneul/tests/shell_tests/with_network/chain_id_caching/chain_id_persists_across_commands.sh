...
haneul client --client.config $CONFIG chain-identifier > chain_id_1.txt 2>&1
...
haneul client --client.config $CONFIG chain-identifier > chain_id_2.txt 2>&1
echo "Command executed"
...
haneul client --client.config $CONFIG objects > objects_output.txt 2>&1
echo "Command executed"
