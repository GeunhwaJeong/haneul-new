...
use haneul_core::gateway_state::{GatewayAPI, GatewayState};
use haneul_types::messages::{CallArg, ExecutionStatus, ObjectInfoRequest, ObjectInfoRequestKind};
...
async fn shared_object_sync() {
    ...
    // Ideally we expect Err(HaneulError::SharedObjectLockingFailure(_)).
