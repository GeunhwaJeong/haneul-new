...
This is a guide for users who wish to sign a transaction using an offline device without relying on haneul keystore. Here are the steps to:
...
```shell
haneul client serialize-transfer-haneul --to 0x581a119a6576d3b502b5dc47c5de497b774e68ca --haneul-coin-object-id 0x0599b794da39169f7c75d34eba06ae105fedc61b --gas-budget 1000
...
This can be done elsewhere in your signing device or implemented in languages of your choice. Haneul accepts signature for both ECDSA Secp256k1 and pure Ed25519. 
...
Here we use the keytool command to sign as an example, using the Ed25519 key corresponding to the provided address stored in `haneul.keystore`. This commands outputs the signature, the public key and the flag encoded in Base64. This command is backed by [fastcrypto](https://crates.io/crates/fastcrypto).

```shell
haneul keytool sign --address 0x581a119a6576d3b502b5dc47c5de497b774e68ca --data VHJhbnNhY3Rpb25EYXRhOjoAA1gaEZpldtO1ArXcR8XeSXt3TmjKAFgaEZpldtO1ArXcR8XeSXt3TmjKBZm3lNo5Fp98ddNOugauEF/txhsCAAAAAAAAACC0knjIoZEdbQBQuqg3feG/GA0L2v9gLDfH2uX8iGf5SwEAAAAAAAAA6AMAAAAAAAA=
2022-10-18T03:30:39.510775Z  INFO haneul::keytool: Data to sign : VHJhbnNhY3Rpb25EYXRhOjoAA1gaEZpldtO1ArXcR8XeSXt3TmjKAFgaEZpldtO1ArXcR8XeSXt3TmjKBZm3lNo5Fp98ddNOugauEF/txhsCAAAAAAAAACC0knjIoZEdbQBQuqg3feG/GA0L2v9gLDfH2uX8iGf5SwEAAAAAAAAA6AMAAAAAAAA=
2022-10-18T03:30:39.510838Z  INFO haneul::keytool: Address : 0x581a119a6576d3b502b5dc47c5de497b774e68ca
2022-10-18T03:30:39.511304Z  INFO haneul::keytool: Flag Base64: AA==
2022-10-18T03:30:39.511318Z  INFO haneul::keytool: Public Key Base64: rJzjxQ+FCK9m8YDU8Dq1Yx931HkIArhcw33kUPL9P8c=
2022-10-18T03:30:39.511326Z  INFO haneul::keytool: Signature : epIttAjg4OBOzVBQQuMflR9sJwh12XiBFwDV9gmiBxomKJ0YyjcbhLONdvA1xs2NXy8xdagwHR/uRVdI6z+LAg==
```
