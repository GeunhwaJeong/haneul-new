...
const FILE_PATH: &str = "haneul-open-rpc/spec/openrpc.json";
const OBJECT_SAMPLE_FILE_PATH: &str = "haneul-open-rpc/samples/objects.json";
const TRANSACTION_SAMPLE_FILE_PATH: &str = "haneul-open-rpc/samples/transactions.json";
