...
{%- for instance in haneul_event_instances %}

{%- set S = "'" ~ instance.suffix ~ "'" -%}
{%- set T = instance.name -%}

// ----------------------------------------------------------------------------------
// Native Haneul event implementation for object type `{{instance.suffix}}`
...
{%- for instance in haneul_types_instances %}

{%- set S = "'" ~ instance.suffix ~ "'" -%}
{%- set T = instance.name -%}

// ----------------------------------------------------------------------------------
// Native Haneul types implementation for object type `{{instance.suffix}}`
...
// ----------------------------------------------------------------------------------
// Native Haneul prover implementation for object type `{{instance.suffix}}`
