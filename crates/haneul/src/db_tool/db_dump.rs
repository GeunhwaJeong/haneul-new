...
pub type AuthorityStoreReadOnly = HaneulDataStoreReadonly<AuthoritySignInfo>;
pub type GatewayStoreReadOnly = HaneulDataStoreReadonly<EmptySignInfo>;
...
pub struct HaneulDataStoreReadonly<S> {
