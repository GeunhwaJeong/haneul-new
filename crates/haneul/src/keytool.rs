...
pub enum KeyToolCommand {
    /// Generate a new keypair with keypair scheme flag {ed25519 | secp256k1}. Output file to current dir (to generate keypair to haneul.keystore, use `haneul client new-address`)
    Generate {
