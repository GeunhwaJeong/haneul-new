...
pub enum KeyToolCommand {
    ...
    /// with optional derivation path, default to m/44'/8282'/0'/0'/0' for ed25519 or m/54'/8282'/0'/0/0 for secp256k1.
            ...
            KeyToolCommand::LoadKeypair { file } => {
                match read_keypair_from_file(&file) {
                    Ok(keypair) => {
                        ...
                        if let HaneulKeyPair::Ed25519HaneulKeyPair(kp) = keypair {
