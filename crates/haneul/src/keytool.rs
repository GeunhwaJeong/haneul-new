...
pub enum KeyToolCommand {
    ...
    /// Add a new key to haneul.keystore based on the input mnemonic phrase, the key scheme flag {ed25519 | secp256k1 | secp256r1}
    ...
    /// Returns a valid MultiSig and its sender address. The result can be used as signature field for `haneul client execute-signed-tx`.
