...
use haneul_types::crypto::{
    random_key_pair_by_type, AuthorityKeyPair, EncodeDecodeBase64, HaneulKeyPair,
};
...
pub enum KeyToolCommand {
    /// Generate a new keypair with optional keypair scheme flag, default using ed25519. Output file to current dir (to generate keypair to haneul.keystore, use `haneul client new-address`)
    Generate {
