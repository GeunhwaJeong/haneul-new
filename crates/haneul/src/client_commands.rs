...
use haneul_json_rpc_types::{
    Coin, DynamicFieldPage, HaneulCoinMetadata, HaneulData, HaneulExecutionStatus, HaneulObjectData,
    HaneulObjectDataOptions, HaneulObjectResponse, HaneulObjectResponseQuery, HaneulParsedData, HaneulRawData,
...
pub enum HaneulClientCommands {
    ...
    Call {
        ...
        /// can be used to execute transaction with `haneul client execute-combined-signed-tx --signed-tx-bytes
        /// <SIGNED_TX_BYTES>`.
        #[clap(long, required = false)]
    ...
    pub async fn execute(
        ...
        let ret = Ok(match self {
            ...
            HaneulClientCommands::VerifyBytecodeMeter {
                ...
                let mut verifier =
                    haneul_execution::verifier(&protocol_config, true, &bytecode_verifier_metrics);
...
impl From<&GasCoin> for GasCoinOutput {
    fn from(gas_coin: &GasCoin) -> Self {
        Self {
            ...
            haneul_balance: format_balance(gas_coin.value() as u128, 9, 3),
        }
    }
}
