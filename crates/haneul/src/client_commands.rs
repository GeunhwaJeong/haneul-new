...
pub async fn load_root_pkg_for_publish_upgrade(
    ...
    Ok(RootPackage::<HaneulFlavor>::load(path, env, build_config.mode_set()).await?)
}
...
async fn load_root_pkg_for_test_publish(
    ...
    Ok(RootPackage::<HaneulFlavor>::load_ephemeral(
        package_path,
        build_env,
        chain_id,
        pubfile_path,
