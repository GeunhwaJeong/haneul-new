...
This document lays out the step-by-step process for orchestrating a Haneul Genesis Ceremony.
...
- An Ed25519 key can be created using `haneul keytool generate`
...
$ haneul genesis-ceremony add-validator \
...
```
$ haneul genesis-ceremony add-gas-object \
    --address <HaneulAddress> \
    --object-id <ObjectId> \
    --valud <# of haneul coins>
$ git add .
...
```
$ haneul genesis-ceremony verify-and-sign \
    --key-file <path to key file>
$ git add .
...
```
$ haneul genesis-ceremony finalize
```
