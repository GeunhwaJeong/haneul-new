...
To set up and build the [Haneul CLI client](https://docs.haneul.io/contribute/cli-client) needed for Move development, follow the instructions to [install Haneul](https://docs.haneul.io/build/install).
