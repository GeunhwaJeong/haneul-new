...
4. Link the move interface with the native function in [all_natives](https://github.com/GeunhwaJeong/haneul/blob/main/external-crates/move/crates/move-stdlib-natives/src/lib.rs#L146)
