...
<pre><code><b>fun</b> <a href="genesis.md#0x2_genesis_create">create</a>(
    initial_haneul_custody_account_address: <b>address</b>,
    ...
    validator_haneul_addresses: <a href="">vector</a>&lt;<b>address</b>&gt;,
    ...
    <b>let</b> haneul_supply = <a href="haneul.md#0x2_haneul_new">haneul::new</a>(ctx);
    <b>let</b> subsidy_fund = <a href="balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> haneul_supply, <a href="genesis.md#0x2_genesis_INIT_STAKE_SUBSIDY_FUND_BALANCE_TEST_ONLY">INIT_STAKE_SUBSIDY_FUND_BALANCE_TEST_ONLY</a>);
    ...
    <b>assert</b>!(
        <a href="_length">vector::length</a>(&validator_haneul_addresses) == count
    ...
    <b>let</b> i = 0;
    <b>while</b> (i &lt; count) {
        <b>let</b> haneul_address = *<a href="_borrow">vector::borrow</a>(&validator_haneul_addresses, i);
        ...
        <b>let</b> <a href="validator.md#0x2_validator">validator</a> = <a href="validator.md#0x2_validator_new">validator::new</a>(
            ...
            <a href="_some">option::some</a>(<a href="balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> haneul_supply, initial_validator_stake_geunhwa)),
            gas_price,
            commission_rate,
            ctx
        );
    ...
    // Transfer the remaining <a href="balance.md#0x2_balance">balance</a> of <a href="haneul.md#0x2_haneul">haneul</a>'s supply <b>to</b> the initial account
    <a href="haneul.md#0x2_haneul_transfer">haneul::transfer</a>(<a href="coin.md#0x2_coin_from_balance">coin::from_balance</a>(haneul_supply, ctx), initial_haneul_custody_account_address);
}
</code></pre>
