...
<pre><code><b>fun</b> <a href="genesis.md#0x3_genesis_create">create</a>(
    ...
    <b>assert</b>!(<a href="../../../.././build/Haneul/docs/tx_context.md#0x2_tx_context_epoch">tx_context::epoch</a>(ctx) == 0, <a href="genesis.md#0x3_genesis_ENotCalledAtGenesis">ENotCalledAtGenesis</a>);
    ...
    <b>let</b> subsidy_fund = <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_split">balance::split</a>(
        &<b>mut</b> haneul_supply,
        stake_subsidy_fund_geunhwa,
    );
    <b>let</b> <a href="storage_fund.md#0x3_storage_fund">storage_fund</a> = <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_zero">balance::zero</a>();
    ...
    <b>let</b> system_parameters = <a href="haneul_system_state_inner.md#0x3_haneul_system_state_inner_create_system_parameters">haneul_system_state_inner::create_system_parameters</a>(
    ...
    <a href="haneul_system.md#0x3_haneul_system_create">haneul_system::create</a>(
...
<pre><code><b>fun</b> <a href="genesis.md#0x3_genesis_allocate_tokens">allocate_tokens</a>(haneul_supply: <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../../../.././build/Haneul/docs/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, allocations: <a href="">vector</a>&lt;<a href="genesis.md#0x3_genesis_TokenAllocation">genesis::TokenAllocation</a>&gt;, validators: &<b>mut</b> <a href="">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, ctx: &<b>mut</b> <a href="../../../.././build/Haneul/docs/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x3_genesis_allocate_tokens">allocate_tokens</a>(
    ...
    <b>while</b> (!<a href="_is_empty">vector::is_empty</a>(&allocations)) {
        ...
        <b>let</b> allocation_balance = <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> haneul_supply, amount_geunhwa);
        ...
        <b>if</b> (<a href="_is_some">option::is_some</a>(&staked_with_validator)) {
            ...
            <a href="../../../.././build/Haneul/docs/haneul.md#0x2_haneul_transfer">haneul::transfer</a>(
                <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_from_balance">coin::from_balance</a>(allocation_balance, ctx),
                recipient_address,
            );
        };
    };
    ...
    <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_destroy_zero">balance::destroy_zero</a>(haneul_supply);
}
</code></pre>
