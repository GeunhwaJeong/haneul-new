...
<pre><code><b>fun</b> <a href="genesis.md#0x2_genesis_create">create</a>(
    ...
    <b>let</b> storage_fund = <a href="balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> haneul_supply, <a href="genesis.md#0x2_genesis_INIT_STORAGE_FUND">INIT_STORAGE_FUND</a>);
    ...
    <b>while</b> (i &lt; count) {
        ...
        <a href="_push_back">vector::push_back</a>(&<b>mut</b> validators, <a href="validator.md#0x2_validator_new">validator::new</a>(
            ...
            consensus_address,
            worker_address,
            <a href="balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> haneul_supply, <a href="stake.md#0x2_stake">stake</a>),
    ...
    // distribution of Haneul instead of sending it <b>to</b> <b>address</b> 0x0
    <a href="haneul.md#0x2_haneul_transfer">haneul::transfer</a>(<a href="coin.md#0x2_coin_from_balance">coin::from_balance</a>(haneul_supply, ctx), @0x0);
}
</code></pre>
