...
Represents an arbitrary URL. Clients rendering values of this type should fetch the resource at <code><a href="url.md#0x2_url">url</a></code> and render it using a to-be-defined Haneul standard.
...
resource hash. Clients rendering values of this type should fetch the resource at <code><a href="url.md#0x2_url">url</a></code>, and then compare it against <code>resource_hash</code> using a to-be-defined Haneul standard, and (if the two match) render the value using the <code><a href="url.md#0x2_url_Url">Url</a></code> standard.
