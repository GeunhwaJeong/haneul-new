...
-  [Function `update_stake_subsidy_amount`](#0x2_haneul_system_update_stake_subsidy_amount)
...
<a name="0x2_haneul_system_STAKE_SUBSIDY_DECREASE_RATE"></a>



<pre><code><b>const</b> <a href="haneul_system.md#0x2_haneul_system_STAKE_SUBSIDY_DECREASE_RATE">STAKE_SUBSIDY_DECREASE_RATE</a>: u128 = 1000;
</code></pre>



<a name="0x2_haneul_system_STAKE_SUBSIDY_PERIOD_LENGTH"></a>



<pre><code><b>const</b> <a href="haneul_system.md#0x2_haneul_system_STAKE_SUBSIDY_PERIOD_LENGTH">STAKE_SUBSIDY_PERIOD_LENGTH</a>: u64 = 30;
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="haneul_system.md#0x2_haneul_system_advance_epoch">advance_epoch</a>(
    ...
    <b>let</b> stake_subsidy = <a href="balance.md#0x2_balance_increase_supply">balance::increase_supply</a>(&<b>mut</b> self.haneul_supply, self.next_epoch_stake_subsidy);
    ...
    <a href="haneul_system.md#0x2_haneul_system_update_stake_subsidy_amount">update_stake_subsidy_amount</a>(self, new_epoch);
...
<pre><code><b>ensures</b> <a href="balance.md#0x2_balance_supply_value">balance::supply_value</a>(self.haneul_supply)
    == <b>old</b>(<a href="balance.md#0x2_balance_supply_value">balance::supply_value</a>(self.haneul_supply));
</code></pre>
...
<a name="0x2_haneul_system_update_stake_subsidy_amount"></a>

## Function `update_stake_subsidy_amount`



<pre><code><b>fun</b> <a href="haneul_system.md#0x2_haneul_system_update_stake_subsidy_amount">update_stake_subsidy_amount</a>(self: &<b>mut</b> <a href="haneul_system.md#0x2_haneul_system_HaneulSystemState">haneul_system::HaneulSystemState</a>, new_epoch: u64)
</code></pre>
...
<pre><code><b>fun</b> <a href="haneul_system.md#0x2_haneul_system_update_stake_subsidy_amount">update_stake_subsidy_amount</a>(self: &<b>mut</b> <a href="haneul_system.md#0x2_haneul_system_HaneulSystemState">HaneulSystemState</a>, new_epoch: u64) {
    // Decrease the subsidy amount only when the current period ends.
    <b>if</b> (new_epoch % <a href="haneul_system.md#0x2_haneul_system_STAKE_SUBSIDY_PERIOD_LENGTH">STAKE_SUBSIDY_PERIOD_LENGTH</a> == 0) {
        <b>let</b> decrease_amount = (self.next_epoch_stake_subsidy <b>as</b> u128)
            * <a href="haneul_system.md#0x2_haneul_system_STAKE_SUBSIDY_DECREASE_RATE">STAKE_SUBSIDY_DECREASE_RATE</a> / <a href="haneul_system.md#0x2_haneul_system_BASIS_POINT_DENOMINATOR">BASIS_POINT_DENOMINATOR</a>;
