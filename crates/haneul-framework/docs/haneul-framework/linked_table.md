...
<pre><code><b>public</b> <b>fun</b> <a href="linked_table.md#0x2_linked_table_push_front">push_front</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(
    ...
    <b>let</b> old_head = <a href="table.md#0x2_table">table</a>.head.swap_or_fill(k);
    <b>if</b> (<a href="table.md#0x2_table">table</a>.tail.is_none()) <a href="table.md#0x2_table">table</a>.tail.fill(k);
    ...
    <b>let</b> next = <b>if</b> (old_head.is_some()) {
        ...
        field::borrow_mut&lt;K, <a href="linked_table.md#0x2_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="table.md#0x2_table">table</a>.id, old_head_k).prev = <a href="../move-stdlib/option.md#0x1_option_some">option::some</a>(k);
...
<pre><code><b>public</b> <b>fun</b> <a href="linked_table.md#0x2_linked_table_push_back">push_back</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(
    ...
    <b>if</b> (<a href="table.md#0x2_table">table</a>.head.is_none()) <a href="table.md#0x2_table">table</a>.head.fill(k);
    <b>let</b> old_tail = <a href="table.md#0x2_table">table</a>.tail.swap_or_fill(k);
    <b>let</b> prev = <b>if</b> (old_tail.is_some()) {
        <b>let</b> old_tail_k = old_tail.destroy_some();
        field::borrow_mut&lt;K, <a href="linked_table.md#0x2_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="table.md#0x2_table">table</a>.id, old_tail_k).next = <a href="../move-stdlib/option.md#0x1_option_some">option::some</a>(k);
...
<pre><code><b>public</b> <b>fun</b> <a href="linked_table.md#0x2_linked_table_remove">remove</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="table.md#0x2_table">table</a>: &<b>mut</b> <a href="linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;, k: K): V {
    ...
    <a href="table.md#0x2_table">table</a>.size = <a href="table.md#0x2_table">table</a>.size - 1;
    <b>if</b> (prev.is_some()) {
        field::borrow_mut&lt;K, <a href="linked_table.md#0x2_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="table.md#0x2_table">table</a>.id, *prev.<a href="borrow.md#0x2_borrow">borrow</a>()).next = next
    };
    <b>if</b> (next.is_some()) {
        field::borrow_mut&lt;K, <a href="linked_table.md#0x2_linked_table_Node">Node</a>&lt;K, V&gt;&gt;(&<b>mut</b> <a href="table.md#0x2_table">table</a>.id, *next.<a href="borrow.md#0x2_borrow">borrow</a>()).prev = prev
    };
    <b>if</b> (<a href="table.md#0x2_table">table</a>.head.<a href="borrow.md#0x2_borrow">borrow</a>() == &k) <a href="table.md#0x2_table">table</a>.head = next;
    <b>if</b> (<a href="table.md#0x2_table">table</a>.tail.<a href="borrow.md#0x2_borrow">borrow</a>() == &k) <a href="table.md#0x2_table">table</a>.tail = prev;
    value
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="linked_table.md#0x2_linked_table_pop_front">pop_front</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="table.md#0x2_table">table</a>: &<b>mut</b> <a href="linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): (K, V) {
    <b>assert</b>!(<a href="table.md#0x2_table">table</a>.head.is_some(), <a href="linked_table.md#0x2_linked_table_ETableIsEmpty">ETableIsEmpty</a>);
    <b>let</b> head = *<a href="table.md#0x2_table">table</a>.head.<a href="borrow.md#0x2_borrow">borrow</a>();
    (head, <a href="table.md#0x2_table">table</a>.<a href="linked_table.md#0x2_linked_table_remove">remove</a>(head))
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="linked_table.md#0x2_linked_table_pop_back">pop_back</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="table.md#0x2_table">table</a>: &<b>mut</b> <a href="linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): (K, V) {
    <b>assert</b>!(<a href="table.md#0x2_table">table</a>.tail.is_some(), <a href="linked_table.md#0x2_linked_table_ETableIsEmpty">ETableIsEmpty</a>);
    <b>let</b> tail = *<a href="table.md#0x2_table">table</a>.tail.<a href="borrow.md#0x2_borrow">borrow</a>();
    (tail, <a href="table.md#0x2_table">table</a>.<a href="linked_table.md#0x2_linked_table_remove">remove</a>(tail))
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="linked_table.md#0x2_linked_table_length">length</a>&lt;K: <b>copy</b> + drop + store, V: store&gt;(<a href="table.md#0x2_table">table</a>: &<a href="linked_table.md#0x2_linked_table_LinkedTable">LinkedTable</a>&lt;K, V&gt;): <a href="../move-stdlib/u64.md#0x1_u64">u64</a> {
