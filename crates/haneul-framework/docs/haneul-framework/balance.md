...
<pre><code><b>const</b> <a href="balance.md#0x2_balance_ENotHANEUL">ENotHANEUL</a>: <a href="../move-stdlib/u64.md#0x1_u64">u64</a> = 4;
</code></pre>
...
<pre><code><b>fun</b> <a href="balance.md#0x2_balance_create_staking_rewards">create_staking_rewards</a>&lt;T&gt;(value: <a href="../move-stdlib/u64.md#0x1_u64">u64</a>, ctx: &TxContext): <a href="balance.md#0x2_balance_Balance">Balance</a>&lt;T&gt; {
    ...
    <b>assert</b>!(std::type_name::get&lt;T&gt;().into_string().into_bytes() == <a href="balance.md#0x2_balance_HANEUL_TYPE_NAME">HANEUL_TYPE_NAME</a>, <a href="balance.md#0x2_balance_ENotHANEUL">ENotHANEUL</a>);
    <a href="balance.md#0x2_balance_Balance">Balance</a> { value }
}
</code></pre>
