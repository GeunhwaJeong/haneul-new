...
<pre><code><b>const</b> <a href="../haneul-framework/hex.md#0x2_hex_EInvalidHexLength">EInvalidHexLength</a>: u64 = 0;
</code></pre>
...
<pre><code><b>const</b> <a href="../haneul-framework/hex.md#0x2_hex_ENotValidHexCharacter">ENotValidHexCharacter</a>: u64 = 1;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../haneul-framework/hex.md#0x2_hex_encode">encode</a>(bytes: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../haneul-framework/hex.md#0x2_hex_encode">encode</a>(bytes: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt; {
    ...
    <b>let</b> hex_vector = <a href="../haneul-framework/hex.md#0x2_hex_HEX">HEX</a>;
    <b>while</b> (i &lt; l) {
...
<pre><code><b>public</b> <b>fun</b> <a href="../haneul-framework/hex.md#0x2_hex_decode">decode</a>(<a href="../haneul-framework/hex.md#0x2_hex">hex</a>: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../haneul-framework/hex.md#0x2_hex_decode">decode</a>(<a href="../haneul-framework/hex.md#0x2_hex">hex</a>: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt; {
    <b>let</b> (<b>mut</b> i, <b>mut</b> r, l) = (0, <a href="../move-stdlib/vector.md#0x1_vector">vector</a>[], <a href="../move-stdlib/vector.md#0x1_vector_length">vector::length</a>(&<a href="../haneul-framework/hex.md#0x2_hex">hex</a>));
    <b>assert</b>!(l % 2 == 0, <a href="../haneul-framework/hex.md#0x2_hex_EInvalidHexLength">EInvalidHexLength</a>);
    <b>while</b> (i &lt; l) {
        <b>let</b> decimal = (<a href="../haneul-framework/hex.md#0x2_hex_decode_byte">decode_byte</a>(*<a href="../move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(&<a href="../haneul-framework/hex.md#0x2_hex">hex</a>, i)) * 16) +
                      <a href="../haneul-framework/hex.md#0x2_hex_decode_byte">decode_byte</a>(*<a href="../move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(&<a href="../haneul-framework/hex.md#0x2_hex">hex</a>, i + 1));
...
<pre><code><b>fun</b> <a href="../haneul-framework/hex.md#0x2_hex_decode_byte">decode_byte</a>(<a href="../haneul-framework/hex.md#0x2_hex">hex</a>: u8): u8
</code></pre>
...
<pre><code><b>fun</b> <a href="../haneul-framework/hex.md#0x2_hex_decode_byte">decode_byte</a>(<a href="../haneul-framework/hex.md#0x2_hex">hex</a>: u8): u8 {
    <b>if</b> (/* 0 .. 9 */ 48 &lt;= <a href="../haneul-framework/hex.md#0x2_hex">hex</a> && <a href="../haneul-framework/hex.md#0x2_hex">hex</a> &lt; 58) {
        <a href="../haneul-framework/hex.md#0x2_hex">hex</a> - 48
    } <b>else</b> <b>if</b> (/* A .. F */ 65 &lt;= <a href="../haneul-framework/hex.md#0x2_hex">hex</a> && <a href="../haneul-framework/hex.md#0x2_hex">hex</a> &lt; 71) {
        10 + <a href="../haneul-framework/hex.md#0x2_hex">hex</a> - 65
    } <b>else</b> <b>if</b> (/* a .. f */ 97 &lt;= <a href="../haneul-framework/hex.md#0x2_hex">hex</a> && <a href="../haneul-framework/hex.md#0x2_hex">hex</a> &lt; 103) {
        10 + <a href="../haneul-framework/hex.md#0x2_hex">hex</a> - 97
    } <b>else</b> {
        <b>abort</b> <a href="../haneul-framework/hex.md#0x2_hex_ENotValidHexCharacter">ENotValidHexCharacter</a>
    }
}
</code></pre>
