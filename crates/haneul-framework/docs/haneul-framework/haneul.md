...
<pre><code><b>const</b> <a href="haneul.md#0x2_haneul_ENotSystemAddress">ENotSystemAddress</a>: <a href="../move-stdlib/u64.md#0x1_u64">u64</a> = 1;
</code></pre>
...
<pre><code><b>const</b> <a href="haneul.md#0x2_haneul_EAlreadyMinted">EAlreadyMinted</a>: <a href="../move-stdlib/u64.md#0x1_u64">u64</a> = 0;
</code></pre>
...
<pre><code><b>const</b> <a href="haneul.md#0x2_haneul_GEUNHWA_PER_HANEUL">GEUNHWA_PER_HANEUL</a>: <a href="../move-stdlib/u64.md#0x1_u64">u64</a> = 1000000000;
</code></pre>
...
<pre><code><b>const</b> <a href="haneul.md#0x2_haneul_TOTAL_SUPPLY_GEUNHWA">TOTAL_SUPPLY_GEUNHWA</a>: <a href="../move-stdlib/u64.md#0x1_u64">u64</a> = 10000000000000000000;
</code></pre>
...
<pre><code><b>const</b> <a href="haneul.md#0x2_haneul_TOTAL_SUPPLY_HANEUL">TOTAL_SUPPLY_HANEUL</a>: <a href="../move-stdlib/u64.md#0x1_u64">u64</a> = 10000000000;
</code></pre>
...
<pre><code><b>fun</b> <a href="haneul.md#0x2_haneul_new">new</a>(ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="haneul.md#0x2_haneul_new">new</a>(ctx: &<b>mut</b> TxContext): Balance&lt;<a href="haneul.md#0x2_haneul_HANEUL">HANEUL</a>&gt; {
    <b>assert</b>!(ctx.sender() == @0x0, <a href="haneul.md#0x2_haneul_ENotSystemAddress">ENotSystemAddress</a>);
    <b>assert</b>!(ctx.epoch() == 0, <a href="haneul.md#0x2_haneul_EAlreadyMinted">EAlreadyMinted</a>);
    ...
    <b>let</b> total_haneul = supply.increase_supply(<a href="haneul.md#0x2_haneul_TOTAL_SUPPLY_GEUNHWA">TOTAL_SUPPLY_GEUNHWA</a>);
