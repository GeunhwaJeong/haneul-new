...
<pre><code><b>const</b> <a href="haneul.md#0x2_haneul_ENotSystemAddress">ENotSystemAddress</a>: u64 = 1;
</code></pre>
...
<pre><code><b>const</b> <a href="haneul.md#0x2_haneul_EAlreadyMinted">EAlreadyMinted</a>: u64 = 0;
</code></pre>
...
<pre><code><b>fun</b> <a href="haneul.md#0x2_haneul_new">new</a>(ctx: &<b>mut</b> TxContext): Balance&lt;<a href="haneul.md#0x2_haneul_HANEUL">HANEUL</a>&gt; {
    <b>assert</b>!(<a href="tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx) == @0x0, <a href="haneul.md#0x2_haneul_ENotSystemAddress">ENotSystemAddress</a>);
    <b>assert</b>!(<a href="tx_context.md#0x2_tx_context_epoch">tx_context::epoch</a>(ctx) == 0, <a href="haneul.md#0x2_haneul_EAlreadyMinted">EAlreadyMinted</a>);
    ...
    <b>let</b> total_haneul = <a href="balance.md#0x2_balance_increase_supply">balance::increase_supply</a>(&<b>mut</b> supply, <a href="haneul.md#0x2_haneul_TOTAL_SUPPLY_GEUNHWA">TOTAL_SUPPLY_GEUNHWA</a>);
