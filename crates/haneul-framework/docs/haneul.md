...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="haneul.md#0x2_haneul_new">new</a>(ctx: &<b>mut</b> TxContext): Supply&lt;<a href="haneul.md#0x2_haneul_HANEUL">HANEUL</a>&gt; {
    <a href="coin.md#0x2_coin_treasury_into_supply">coin::treasury_into_supply</a>(
        <a href="coin.md#0x2_coin_create_currency">coin::create_currency</a>(<a href="haneul.md#0x2_haneul_HANEUL">HANEUL</a> {}, 9, ctx)
    )
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="transfer.md#0x2_transfer">transfer</a>(c: <a href="coin.md#0x2_coin_Coin">coin::Coin</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, recipient: <b>address</b>)
</code></pre>
