...
It should only be called by <code><a href="haneul_system.md#0x2_haneul_system_advance_epoch">haneul_system::advance_epoch</a></code> to create staking rewards,
and nowhere else.
...
It should only be called by <code><a href="haneul_system.md#0x2_haneul_system_advance_epoch">haneul_system::advance_epoch</a></code> to destroy storage rebates,
and nowhere else.
