...
<pre><code><b>fun</b> <a href="prover.md#0x2_prover_uid_has_field">uid_has_field</a>&lt;K: <b>copy</b> + drop + store&gt;(uid: haneul::object::UID, name: K): bool {
...
<pre><code><b>fun</b> <a href="prover.md#0x2_prover_uid_num_fields">uid_num_fields</a>&lt;K: <b>copy</b> + drop + store&gt;(uid: haneul::object::UID): u64 {
   <b>let</b> addr = <a href="object.md#0x2_object_uid_to_address">object::uid_to_address</a>(uid);
