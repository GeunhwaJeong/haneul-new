...
-  [Function `withdraw_principal`](#0x2_staking_pool_withdraw_principal)
-  [Function `distribute_rewards`](#0x2_staking_pool_distribute_rewards)
-  [Function `process_pending_delegations`](#0x2_staking_pool_process_pending_delegations)
-  [Function `batch_rewards_withdraws`](#0x2_staking_pool_batch_rewards_withdraws)
...
-  [Function `destroy_empty_staked_haneul`](#0x2_staking_pool_destroy_empty_staked_haneul)
...
<dt>
<code>principal_haneul_amount: u64</code>
</dt>
<dd>
...
<a name="0x2_staking_pool_EINSUFFICIENT_HANEUL_TOKEN_BALANCE"></a>



<pre><code><b>const</b> <a href="staking_pool.md#0x2_staking_pool_EINSUFFICIENT_HANEUL_TOKEN_BALANCE">EINSUFFICIENT_HANEUL_TOKEN_BALANCE</a>: u64 = 3;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_request_add_delegation">request_add_delegation</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, <a href="stake.md#0x2_stake">stake</a>: <a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, haneul_token_lock: <a href="_Option">option::Option</a>&lt;<a href="epoch_time_lock.md#0x2_epoch_time_lock_EpochTimeLock">epoch_time_lock::EpochTimeLock</a>&gt;, delegator: <b>address</b>, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_mint_delegation_tokens_to_delegator">mint_delegation_tokens_to_delegator</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, delegator: <b>address</b>, haneul_amount: u64, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
Withdraw <code>withdraw_pool_token_amount</code> worth of delegated stake from a staking pool. A proportional amount of principal
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_request_withdraw_stake">request_withdraw_stake</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, delegation: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, staked_haneul: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, withdraw_pool_token_amount: u64, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_request_withdraw_stake">request_withdraw_stake</a>(
    ...
    <b>let</b> (withdrawn_pool_tokens, principal_withdraw, time_lock) =
        <a href="staking_pool.md#0x2_staking_pool_withdraw_principal">withdraw_principal</a>(pool, delegation, staked_haneul, withdraw_pool_token_amount);
...
<a name="0x2_staking_pool_withdraw_principal"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_principal">withdraw_principal</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, delegation: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, staked_haneul: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, withdraw_pool_token_amount: u64): (<a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="staking_pool.md#0x2_staking_pool_DelegationToken">staking_pool::DelegationToken</a>&gt;, <a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, <a href="_Option">option::Option</a>&lt;<a href="epoch_time_lock.md#0x2_epoch_time_lock_EpochTimeLock">epoch_time_lock::EpochTimeLock</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_principal">withdraw_principal</a>(
    pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>,
    delegation: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_Delegation">Delegation</a>,
    staked_haneul: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">StakedHaneul</a>,
    withdraw_pool_token_amount: u64,
    ...
    // Calculate the amounts of HANEUL <b>to</b> be withdrawn from the principal component.
    // We already checked that pool_token_balance is greater than zero.
    <b>let</b> haneul_withdraw_from_principal =
        (delegation.principal_haneul_amount <b>as</b> u128) * (withdraw_pool_token_amount <b>as</b> u128) / (pool_token_balance <b>as</b> u128);

    <b>let</b> (principal_withdraw, time_lock) = <a href="staking_pool.md#0x2_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(delegation, staked_haneul, (haneul_withdraw_from_principal <b>as</b> u64));
...
<a name="0x2_staking_pool_distribute_rewards"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_distribute_rewards">distribute_rewards</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, rewards: <a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_distribute_rewards">distribute_rewards</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>, rewards: Balance&lt;HANEUL&gt;, ctx: &<b>mut</b> TxContext): u64 {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_process_pending_delegations">process_pending_delegations</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_process_pending_delegations">process_pending_delegations</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>, ctx: &<b>mut</b> TxContext) : u64 {
    <b>let</b> before_haneul_balance = pool.haneul_balance;
...
<a name="0x2_staking_pool_batch_rewards_withdraws"></a>

## Function `batch_rewards_withdraws`

Called by validator_set at epoch boundaries for delegation switches.


<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_batch_rewards_withdraws">batch_rewards_withdraws</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, entries: <a href="">vector</a>&lt;<a href="staking_pool.md#0x2_staking_pool_PendingWithdrawEntry">staking_pool::PendingWithdrawEntry</a>&gt;): (<a href="">vector</a>&lt;<b>address</b>&gt;, <a href="">vector</a>&lt;<a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;&gt;, u64)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_batch_rewards_withdraws">batch_rewards_withdraws</a>(
    pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>,
    entries: <a href="">vector</a>&lt;<a href="staking_pool.md#0x2_staking_pool_PendingWithdrawEntry">PendingWithdrawEntry</a>&gt;,
) : (<a href="">vector</a>&lt;<b>address</b>&gt;, <a href="">vector</a>&lt;Balance&lt;HANEUL&gt;&gt;, u64) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_rewards_and_burn_pool_tokens">withdraw_rewards_and_burn_pool_tokens</a>(
    pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>,
    ...
    <b>let</b> total_haneul_withdraw_amount = <a href="staking_pool.md#0x2_staking_pool_get_haneul_amount">get_haneul_amount</a>(pool, pool_token_amount);
    <b>assert</b>!(total_haneul_withdraw_amount &gt;= principal_withdraw_amount, 0);
    <b>let</b> reward_withdraw_amount = total_haneul_withdraw_amount - principal_withdraw_amount;
...
<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_from_inactive_pool">withdraw_from_inactive_pool</a>(inactive_pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_InactiveStakingPool">staking_pool::InactiveStakingPool</a>, staked_haneul: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, delegation: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, withdraw_pool_token_amount: u64, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_destroy_empty_delegation">destroy_empty_delegation</a>(delegation: <a href="staking_pool.md#0x2_staking_pool_Delegation">Delegation</a>) {
    ...
    <b>assert</b>!(principal_haneul_amount == 0, <a href="staking_pool.md#0x2_staking_pool_EDESTROY_NON_ZERO_BALANCE">EDESTROY_NON_ZERO_BALANCE</a>);
...
<a name="0x2_staking_pool_destroy_empty_staked_haneul"></a>

## Function `destroy_empty_staked_haneul`

Destroy an empty delegation that no longer contains any HANEUL or pool tokens.


<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_destroy_empty_staked_haneul">destroy_empty_staked_haneul</a>(staked_haneul: <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_destroy_empty_staked_haneul">destroy_empty_staked_haneul</a>(staked_haneul: <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">StakedHaneul</a>) {
    ...
    <b>assert</b>!(<a href="_is_none">option::is_none</a>(&haneul_token_lock), <a href="staking_pool.md#0x2_staking_pool_ETOKEN_TIME_LOCK_IS_SOME">ETOKEN_TIME_LOCK_IS_SOME</a>);
...
Withdraw <code>withdraw_amount</code> of HANEUL tokens from the delegation and give it back to the delegator
in the original state of the tokens.


<pre><code><b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(delegation: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, staked_haneul: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, withdraw_amount: u64): (<a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, <a href="_Option">option::Option</a>&lt;<a href="epoch_time_lock.md#0x2_epoch_time_lock_EpochTimeLock">epoch_time_lock::EpochTimeLock</a>&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(
    ...
    <b>assert</b>!(<a href="balance.md#0x2_balance_value">balance::value</a>(&staked_haneul.principal) &gt;= withdraw_amount, <a href="staking_pool.md#0x2_staking_pool_EINSUFFICIENT_HANEUL_TOKEN_BALANCE">EINSUFFICIENT_HANEUL_TOKEN_BALANCE</a>);
    delegation.principal_haneul_amount = delegation.principal_haneul_amount - withdraw_amount;
    <b>let</b> principal_withdraw = <a href="balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> staked_haneul.principal, withdraw_amount);
    <b>if</b> (<a href="_is_some">option::is_some</a>(&staked_haneul.haneul_token_lock)) {
        <b>let</b> time_lock =
            <b>if</b> (<a href="balance.md#0x2_balance_value">balance::value</a>(&staked_haneul.principal) == 0) {<a href="_extract">option::extract</a>(&<b>mut</b> staked_haneul.haneul_token_lock)}
            <b>else</b> *<a href="_borrow">option::borrow</a>(&staked_haneul.haneul_token_lock);
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x2_staking_pool_get_haneul_amount">get_haneul_amount</a>(pool: &<a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, token_amount: u64): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x2_staking_pool_get_haneul_amount">get_haneul_amount</a>(pool: &<a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>, token_amount: u64): u64 {
    ...
    <b>let</b> res = (pool.haneul_balance <b>as</b> u128)
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x2_staking_pool_get_token_amount">get_token_amount</a>(pool: &<a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, haneul_amount: u64): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x2_staking_pool_get_token_amount">get_token_amount</a>(pool: &<a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>, haneul_amount: u64): u64 {
    <b>if</b> (pool.haneul_balance == 0) {
        <b>return</b> haneul_amount
    };
    <b>let</b> token_supply = <a href="balance.md#0x2_balance_supply_value">balance::supply_value</a>(&pool.delegation_token_supply);
    <b>let</b> res = (token_supply <b>as</b> u128)
            * (haneul_amount <b>as</b> u128)
            / (pool.haneul_balance <b>as</b> u128);
    (res <b>as</b> u64)
}
</code></pre>
