...
<dt>
<code>pending_delegations: <a href="table_vec.md#0x2_table_vec_TableVec">table_vec::TableVec</a>&lt;<a href="staking_pool.md#0x2_staking_pool_PendingDelegationEntry">staking_pool::PendingDelegationEntry</a>&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_new">new</a>(validator_address: <b>address</b>, starting_epoch: u64, ctx: &<b>mut</b> TxContext) : <a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a> {
    <a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a> {
        ...
        pending_delegations: <a href="table_vec.md#0x2_table_vec_empty">table_vec::empty</a>(ctx),
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_request_add_delegation">request_add_delegation</a>(
    ...
    <a href="table_vec.md#0x2_table_vec_push_back">table_vec::push_back</a>(
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_request_withdraw_delegation">request_withdraw_delegation</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, delegation: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, staked_haneul: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, principal_withdraw_amount: u64, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_request_withdraw_delegation">request_withdraw_delegation</a>(
    ...
    <b>let</b> (withdrawn_pool_tokens, principal_withdraw, time_lock) =
        <a href="staking_pool.md#0x2_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(pool, delegation, staked_haneul, principal_withdraw_amount);
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, delegation: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, staked_haneul: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, principal_withdraw_amount: u64): (<a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="staking_pool.md#0x2_staking_pool_DelegationToken">staking_pool::DelegationToken</a>&gt;, <a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, <a href="_Option">option::Option</a>&lt;<a href="epoch_time_lock.md#0x2_epoch_time_lock_EpochTimeLock">epoch_time_lock::EpochTimeLock</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(
    ...
    <b>assert</b>!(delegation.principal_haneul_amount &gt;= principal_withdraw_amount, <a href="staking_pool.md#0x2_staking_pool_EINSUFFICIENT_HANEUL_TOKEN_BALANCE">EINSUFFICIENT_HANEUL_TOKEN_BALANCE</a>);
    ...
    <b>let</b> withdraw_pool_token_amount =
        (pool_token_balance <b>as</b> u128) * (principal_withdraw_amount <b>as</b> u128) / (delegation.principal_haneul_amount <b>as</b> u128);

    <b>let</b> (principal_withdraw, time_lock) = <a href="staking_pool.md#0x2_staking_pool_withdraw_from_principal_impl">withdraw_from_principal_impl</a>(delegation, staked_haneul, principal_withdraw_amount);
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_process_pending_delegation_withdraws">process_pending_delegation_withdraws</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>, ctx: &<b>mut</b> TxContext) : u64 {
    ...
    <b>while</b> (!<a href="table_vec.md#0x2_table_vec_is_empty">table_vec::is_empty</a>(&pool.pending_withdraws)) {
        <b>let</b> <a href="staking_pool.md#0x2_staking_pool_PendingWithdrawEntry">PendingWithdrawEntry</a> { delegator, principal_withdraw_amount, withdrawn_pool_tokens } = <a href="table_vec.md#0x2_table_vec_pop_back">table_vec::pop_back</a>(&<b>mut</b> pool.pending_withdraws);
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_process_pending_delegations">process_pending_delegations</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>, ctx: &<b>mut</b> TxContext) {
    <b>while</b> (!<a href="table_vec.md#0x2_table_vec_is_empty">table_vec::is_empty</a>(&pool.pending_delegations)) {
        <b>let</b> <a href="staking_pool.md#0x2_staking_pool_PendingDelegationEntry">PendingDelegationEntry</a> { delegator, haneul_amount, staked_haneul_id } =
            <a href="table_vec.md#0x2_table_vec_pop_back">table_vec::pop_back</a>(&<b>mut</b> pool.pending_delegations);
...
<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_from_inactive_pool">withdraw_from_inactive_pool</a>(
    ...
    <b>let</b> (withdrawn_pool_tokens, principal_withdraw, time_lock) =
        <a href="staking_pool.md#0x2_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(pool, delegation, staked_haneul, withdraw_pool_token_amount);
...
Withdraw <code>withdraw_haneul_amount</code> of HANEUL tokens from the principal stored in the staked_haneul together with its time lock
if applicable, and also decrement the <code>principal_haneul_amount</code> field of the delegation object.


<pre><code><b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_from_principal_impl">withdraw_from_principal_impl</a>(delegation: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, staked_haneul: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, withdraw_haneul_amount: u64): (<a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, <a href="_Option">option::Option</a>&lt;<a href="epoch_time_lock.md#0x2_epoch_time_lock_EpochTimeLock">epoch_time_lock::EpochTimeLock</a>&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_from_principal_impl">withdraw_from_principal_impl</a>(
    ...
    <b>assert</b>!(<a href="balance.md#0x2_balance_value">balance::value</a>(&staked_haneul.principal) &gt;= withdraw_haneul_amount, <a href="staking_pool.md#0x2_staking_pool_EINSUFFICIENT_HANEUL_TOKEN_BALANCE">EINSUFFICIENT_HANEUL_TOKEN_BALANCE</a>);
    // Decrement the principal <a href="haneul.md#0x2_haneul">haneul</a> value stored in delegation <a href="object.md#0x2_object">object</a>.
    delegation.principal_haneul_amount = delegation.principal_haneul_amount - withdraw_haneul_amount;
    // Withdraw the HANEUL <a href="balance.md#0x2_balance">balance</a> from the staked <a href="haneul.md#0x2_haneul">haneul</a> <a href="object.md#0x2_object">object</a>. Return it and its time lock.
    <b>let</b> principal_withdraw = <a href="balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> staked_haneul.principal, withdraw_haneul_amount);
