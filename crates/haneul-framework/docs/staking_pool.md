...
-  [Function `withdraw_all_to_haneul_tokens`](#0x2_staking_pool_withdraw_all_to_haneul_tokens)
-  [Function `withdraw_to_haneul_tokens`](#0x2_staking_pool_withdraw_to_haneul_tokens)
...
<dt>
<code>epoch_starting_haneul_balance: u64</code>
</dt>
<dd>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_advance_epoch">advance_epoch</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, rewards: <a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_advance_epoch">advance_epoch</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>, rewards: Balance&lt;HANEUL&gt;, ctx: &<b>mut</b> TxContext) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_stake">withdraw_stake</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, delegation: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, staked_haneul: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, withdraw_pool_token_amount: u64, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_stake">withdraw_stake</a>(
    ...
    <b>let</b> (principal_withdraw, reward_withdraw, time_lock) =
        <a href="staking_pool.md#0x2_staking_pool_withdraw_to_haneul_tokens">withdraw_to_haneul_tokens</a>(pool, delegation, staked_haneul, withdraw_pool_token_amount);
    <b>let</b> haneul_withdraw_amount = <a href="balance.md#0x2_balance_value">balance::value</a>(&principal_withdraw) + <a href="balance.md#0x2_balance_value">balance::value</a>(&reward_withdraw);
    <b>let</b> delegator = <a href="tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx);
...
<a name="0x2_staking_pool_withdraw_all_to_haneul_tokens"></a>

## Function `withdraw_all_to_haneul_tokens`
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_all_to_haneul_tokens">withdraw_all_to_haneul_tokens</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, delegation: <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, staked_haneul: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>): (<a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, <a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, <a href="_Option">option::Option</a>&lt;<a href="epoch_time_lock.md#0x2_epoch_time_lock_EpochTimeLock">epoch_time_lock::EpochTimeLock</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_all_to_haneul_tokens">withdraw_all_to_haneul_tokens</a>(
    pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>,
    ...
    <b>let</b> (principal_withdraw, reward_withdraw, time_lock) =
        <a href="staking_pool.md#0x2_staking_pool_withdraw_to_haneul_tokens">withdraw_to_haneul_tokens</a>(pool, &<b>mut</b> delegation, staked_haneul, withdraw_amount);
...
<a name="0x2_staking_pool_withdraw_to_haneul_tokens"></a>

## Function `withdraw_to_haneul_tokens`



<pre><code><b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_to_haneul_tokens">withdraw_to_haneul_tokens</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, delegation: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, staked_haneul: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, withdraw_pool_token_amount: u64): (<a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, <a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, <a href="_Option">option::Option</a>&lt;<a href="epoch_time_lock.md#0x2_epoch_time_lock_EpochTimeLock">epoch_time_lock::EpochTimeLock</a>&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_to_haneul_tokens">withdraw_to_haneul_tokens</a>(
    pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>,
    delegation: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_Delegation">Delegation</a>,
    staked_haneul: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">StakedHaneul</a>,
    withdraw_pool_token_amount: u64,
    ...
    <b>let</b> haneul_withdraw_amount = <a href="staking_pool.md#0x2_staking_pool_get_haneul_amount">get_haneul_amount</a>(pool, withdraw_pool_token_amount);

    // decrement <a href="haneul.md#0x2_haneul">haneul</a> <a href="balance.md#0x2_balance">balance</a> in the pool
    pool.haneul_balance = pool.haneul_balance - haneul_withdraw_amount;

    // Calculate the amounts of HANEUL <b>to</b> be withdrawn from the principal component and the rewards component.
    ...
    <b>let</b> haneul_withdraw_from_rewards = haneul_withdraw_amount - (haneul_withdraw_from_principal <b>as</b> u64);
    ...
    <b>assert</b>!(<a href="balance.md#0x2_balance_value">balance::value</a>(&pool.rewards_pool) &gt;= haneul_withdraw_from_rewards, <a href="staking_pool.md#0x2_staking_pool_EINSUFFICIENT_REWARDS_POOL_BALANCE">EINSUFFICIENT_REWARDS_POOL_BALANCE</a>);
    <b>let</b> reward_withdraw = <a href="balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> pool.rewards_pool, haneul_withdraw_from_rewards);
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_from_inactive_pool">withdraw_from_inactive_pool</a>(inactive_pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_InactiveStakingPool">staking_pool::InactiveStakingPool</a>, staked_haneul: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, delegation: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, withdraw_amount: u64, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_from_inactive_pool">withdraw_from_inactive_pool</a>(
    ...
    <a href="staking_pool.md#0x2_staking_pool_withdraw_stake">withdraw_stake</a>(&<b>mut</b> inactive_pool.pool, delegation, staked_haneul, withdraw_amount, ctx);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_destroy_empty_staked_haneul">destroy_empty_staked_haneul</a>(staked_haneul: <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_haneul_balance">haneul_balance</a>(pool: &<a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>) : u64 { pool.epoch_starting_haneul_balance }
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x2_staking_pool_get_haneul_amount">get_haneul_amount</a>(pool: &<a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>, token_amount: u64): u64 {
    ...
    <b>let</b> res = (pool.haneul_balance <b>as</b> u128) * (token_amount <b>as</b> u128) / (token_supply_amount <b>as</b> u128);
    (res <b>as</b> u64)
}
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x2_staking_pool_get_token_amount">get_token_amount</a>(pool: &<a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>, haneul_amount: u64): u64 {
    ...
    <b>let</b> res = (token_supply_amount <b>as</b> u128) * (haneul_amount <b>as</b> u128) / (pool.haneul_balance <b>as</b> u128);
    (res <b>as</b> u64)
}
</code></pre>
