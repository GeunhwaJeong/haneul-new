...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_request_add_delegation">request_add_delegation</a>(
    ...
    <a href="linked_table.md#0x2_linked_table_push_back">linked_table::push_back</a>(
        ...
        <a href="object.md#0x2_object_id">object::id</a>(&staked_haneul),
        <a href="staking_pool.md#0x2_staking_pool_PendingDelegationEntry">PendingDelegationEntry</a> { delegator, haneul_amount }
    );
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_request_withdraw_delegation">request_withdraw_delegation</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, delegation: <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, staked_haneul: <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_request_withdraw_delegation">request_withdraw_delegation</a>(
    ...
    <b>let</b> (withdrawn_pool_tokens, principal_withdraw, time_lock) =
        <a href="staking_pool.md#0x2_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(pool, delegation, staked_haneul);
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_cancel_delegation_request">cancel_delegation_request</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, staked_haneul: <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_cancel_delegation_request">cancel_delegation_request</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>, staked_haneul: <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">StakedHaneul</a>, ctx: &<b>mut</b> TxContext) {
    <b>let</b> delegator = <a href="tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx);
    <b>let</b> staked_haneul_id = <a href="object.md#0x2_object_id">object::id</a>(&staked_haneul);
    <b>assert</b>!(<a href="linked_table.md#0x2_linked_table_contains">linked_table::contains</a>(&<b>mut</b> pool.pending_delegations, staked_haneul_id), <a href="staking_pool.md#0x2_staking_pool_EPENDING_DELEGATION_DOES_NOT_EXIST">EPENDING_DELEGATION_DOES_NOT_EXIST</a>);

    <a href="linked_table.md#0x2_linked_table_remove">linked_table::remove</a>(&<b>mut</b> pool.pending_delegations, staked_haneul_id);
    ...
    // sanity check that the <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">StakedHaneul</a> is indeed from this pool. Should never fail.
    <b>assert</b>!(
        validator_address == pool.validator_address &&
        pool_starting_epoch == pool.starting_epoch,
    ...
    <b>if</b> (<a href="_is_some">option::is_some</a>(&haneul_token_lock)) {
        <a href="locked_coin.md#0x2_locked_coin_new_from_balance">locked_coin::new_from_balance</a>(principal, <a href="_destroy_some">option::destroy_some</a>(haneul_token_lock), delegator, ctx);
    } <b>else</b> {
...
amount is 21. Then if <code>principal_withdraw_amount</code> is 7, 5 pool tokens and 7 HANEUL tokens will
be withdrawn.
Returns values are withdrawn pool tokens, withdrawn principal portion of HANEUL, and its
time lock if applicable.


<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">staking_pool::StakingPool</a>, delegation: <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, staked_haneul: <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>): (<a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="staking_pool.md#0x2_staking_pool_DelegationToken">staking_pool::DelegationToken</a>&gt;, <a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, <a href="_Option">option::Option</a>&lt;<a href="epoch_time_lock.md#0x2_epoch_time_lock_EpochTimeLock">epoch_time_lock::EpochTimeLock</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(
    ...
    <b>assert</b>!(delegation.principal_haneul_amount == <a href="balance.md#0x2_balance_value">balance::value</a>(&staked_haneul.principal), <a href="staking_pool.md#0x2_staking_pool_EINSUFFICIENT_HANEUL_TOKEN_BALANCE">EINSUFFICIENT_HANEUL_TOKEN_BALANCE</a>);
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x2_staking_pool_destroy_delegation_and_return_pool_tokens">destroy_delegation_and_return_pool_tokens</a>(delegation: <a href="staking_pool.md#0x2_staking_pool_Delegation">Delegation</a>): Balance&lt;<a href="staking_pool.md#0x2_staking_pool_DelegationToken">DelegationToken</a>&gt; {
    <b>let</b> <a href="staking_pool.md#0x2_staking_pool_Delegation">Delegation</a> { id, staked_haneul_id: _, pool_tokens, principal_haneul_amount: _ } = delegation;
    <a href="object.md#0x2_object_delete">object::delete</a>(id);
    pool_tokens
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_process_pending_delegations">process_pending_delegations</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakingPool">StakingPool</a>, ctx: &<b>mut</b> TxContext) {
    <b>while</b> (!<a href="linked_table.md#0x2_linked_table_is_empty">linked_table::is_empty</a>(&pool.pending_delegations)) {
        <b>let</b> (staked_haneul_id, <a href="staking_pool.md#0x2_staking_pool_PendingDelegationEntry">PendingDelegationEntry</a> { delegator, haneul_amount }) =
...
Given the <code>haneul_amount</code>, mint the corresponding amount of pool tokens at the current exchange
...
<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_withdraw_from_inactive_pool">withdraw_from_inactive_pool</a>(inactive_pool: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_InactiveStakingPool">staking_pool::InactiveStakingPool</a>, staked_haneul: <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, delegation: <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_delegation_request_epoch">delegation_request_epoch</a>(staked_haneul: &<a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x2_staking_pool_delegation_request_epoch">delegation_request_epoch</a>(staked_haneul: &<a href="staking_pool.md#0x2_staking_pool_StakedHaneul">StakedHaneul</a>): u64 {
