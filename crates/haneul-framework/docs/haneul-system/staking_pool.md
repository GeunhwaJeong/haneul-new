...
<dt>
<code>rewards_pool: <a href="dependencies/haneul-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/haneul-framework/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>exchange_rates: <a href="dependencies/haneul-framework/table.md#0x2_table_Table">table::Table</a>&lt;u64, <a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">staking_pool::PoolTokenExchangeRate</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>principal: <a href="dependencies/haneul-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/haneul-framework/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_new">new</a>(ctx: &<b>mut</b> <a href="dependencies/haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="staking_pool.md#0x3_staking_pool_StakingPool">staking_pool::StakingPool</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_new">new</a>(ctx: &<b>mut</b> TxContext) : <a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a> {
    <b>let</b> exchange_rates = <a href="dependencies/haneul-framework/table.md#0x2_table_new">table::new</a>(ctx);
    <a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a> {
        ...
        haneul_balance: 0,
        rewards_pool: <a href="dependencies/haneul-framework/balance.md#0x2_balance_zero">balance::zero</a>(),
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_request_add_stake">request_add_stake</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakingPool">staking_pool::StakingPool</a>, stake: <a href="dependencies/haneul-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/haneul-framework/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, stake_activation_epoch: u64, ctx: &<b>mut</b> <a href="dependencies/haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_request_add_stake">request_add_stake</a>(
    ...
    <b>let</b> haneul_amount = <a href="dependencies/haneul-framework/balance.md#0x2_balance_value">balance::value</a>(&stake);
    ...
    <b>let</b> staked_haneul = <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">StakedHaneul</a> {
        id: <a href="dependencies/haneul-framework/object.md#0x2_object_new">object::new</a>(ctx),
        pool_id: <a href="dependencies/haneul-framework/object.md#0x2_object_id">object::id</a>(pool),
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_request_withdraw_stake">request_withdraw_stake</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakingPool">staking_pool::StakingPool</a>, staked_haneul: <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, ctx: &<a href="dependencies/haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="dependencies/haneul-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/haneul-framework/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_request_withdraw_stake">request_withdraw_stake</a>(
    ...
    <b>let</b> principal_withdraw_amount = <a href="dependencies/haneul-framework/balance.md#0x2_balance_value">balance::value</a>(&principal_withdraw);

    <b>let</b> rewards_withdraw = <a href="staking_pool.md#0x3_staking_pool_withdraw_rewards">withdraw_rewards</a>(
        pool, principal_withdraw_amount, pool_token_withdraw_amount, <a href="dependencies/haneul-framework/tx_context.md#0x2_tx_context_epoch">tx_context::epoch</a>(ctx)
    );
    <b>let</b> total_haneul_withdraw_amount = principal_withdraw_amount + <a href="dependencies/haneul-framework/balance.md#0x2_balance_value">balance::value</a>(&rewards_withdraw);
    ...
    <a href="dependencies/haneul-framework/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> principal_withdraw, rewards_withdraw);
    principal_withdraw
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(pool: &<a href="staking_pool.md#0x3_staking_pool_StakingPool">staking_pool::StakingPool</a>, staked_haneul: <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>): (u64, <a href="dependencies/haneul-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/haneul-framework/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(
    ...
    <b>assert</b>!(staked_haneul.pool_id == <a href="dependencies/haneul-framework/object.md#0x2_object_id">object::id</a>(pool), <a href="staking_pool.md#0x3_staking_pool_EWrongPool">EWrongPool</a>);
    ...
    <b>let</b> pool_token_withdraw_amount = <a href="staking_pool.md#0x3_staking_pool_get_token_amount">get_token_amount</a>(&exchange_rate_at_staking_epoch, <a href="dependencies/haneul-framework/balance.md#0x2_balance_value">balance::value</a>(&principal_withdraw));
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_unwrap_staked_haneul">unwrap_staked_haneul</a>(staked_haneul: <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>): <a href="dependencies/haneul-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/haneul-framework/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_deposit_rewards">deposit_rewards</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakingPool">staking_pool::StakingPool</a>, rewards: <a href="dependencies/haneul-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/haneul-framework/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_deposit_rewards">deposit_rewards</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>, rewards: Balance&lt;HANEUL&gt;) {
    pool.haneul_balance = pool.haneul_balance + <a href="dependencies/haneul-framework/balance.md#0x2_balance_value">balance::value</a>(&rewards);
    <a href="dependencies/haneul-framework/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> pool.rewards_pool, rewards);
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_process_pending_stakes_and_withdraws">process_pending_stakes_and_withdraws</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>, ctx: &TxContext) {
    <b>let</b> new_epoch = <a href="dependencies/haneul-framework/tx_context.md#0x2_tx_context_epoch">tx_context::epoch</a>(ctx) + 1;
    ...
    <a href="dependencies/haneul-framework/table.md#0x2_table_add">table::add</a>(
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_withdraw_rewards">withdraw_rewards</a>(
    ...
    // the rewards pool <a href="dependencies/haneul-framework/balance.md#0x2_balance">balance</a> may be less than reward_withdraw_amount.
    // TODO: FIGURE OUT EXACTLY WHY THIS CAN HAPPEN.
    reward_withdraw_amount = <a href="dependencies/haneul-framework/math.md#0x2_math_min">math::min</a>(reward_withdraw_amount, <a href="dependencies/haneul-framework/balance.md#0x2_balance_value">balance::value</a>(&pool.rewards_pool));
    <a href="dependencies/haneul-framework/balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> pool.rewards_pool, reward_withdraw_amount)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_activate_staking_pool">activate_staking_pool</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>, activation_epoch: u64) {
    // Add the initial exchange rate <b>to</b> the <a href="dependencies/haneul-framework/table.md#0x2_table">table</a>.
    <a href="dependencies/haneul-framework/table.md#0x2_table_add">table::add</a>(
        &<b>mut</b> pool.exchange_rates,
        activation_epoch,
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_pool_id">pool_id</a>(staked_haneul: &<a href="staking_pool.md#0x3_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>): <a href="dependencies/haneul-framework/object.md#0x2_object_ID">object::ID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_staked_haneul_amount">staked_haneul_amount</a>(staked_haneul: &<a href="staking_pool.md#0x3_staking_pool_StakedHaneul">StakedHaneul</a>): u64 { <a href="dependencies/haneul-framework/balance.md#0x2_balance_value">balance::value</a>(&staked_haneul.principal) }
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_split">split</a>(self: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, split_amount: u64, ctx: &<b>mut</b> <a href="dependencies/haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_split">split</a>(self: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">StakedHaneul</a>, split_amount: u64, ctx: &<b>mut</b> TxContext): <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">StakedHaneul</a> {
    <b>let</b> original_amount = <a href="dependencies/haneul-framework/balance.md#0x2_balance_value">balance::value</a>(&self.principal);
    ...
    <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">StakedHaneul</a> {
        ...
        principal: <a href="dependencies/haneul-framework/balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> self.principal, split_amount),
    }
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_split_staked_haneul">split_staked_haneul</a>(stake: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, split_amount: u64, ctx: &<b>mut</b> <a href="dependencies/haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_split_staked_haneul">split_staked_haneul</a>(stake: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">StakedHaneul</a>, split_amount: u64, ctx: &<b>mut</b> TxContext) {
    <a href="dependencies/haneul-framework/transfer.md#0x2_transfer_transfer">transfer::transfer</a>(<a href="staking_pool.md#0x3_staking_pool_split">split</a>(stake, split_amount, ctx), <a href="dependencies/haneul-framework/tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx));
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_join_staked_haneul">join_staked_haneul</a>(self: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">StakedHaneul</a>, other: <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">StakedHaneul</a>) {
    ...
    <a href="dependencies/haneul-framework/object.md#0x2_object_delete">object::delete</a>(id);
    <a href="dependencies/haneul-framework/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> self.principal, principal);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_pool_token_exchange_rate_at_epoch">pool_token_exchange_rate_at_epoch</a>(pool: &<a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>, epoch: u64): <a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">PoolTokenExchangeRate</a> {
    ...
    <b>let</b> epoch = <a href="dependencies/haneul-framework/math.md#0x2_math_min">math::min</a>(clamped_epoch, epoch);
    ...
    // Find the latest epoch that's earlier than the given epoch <b>with</b> an entry in the <a href="dependencies/haneul-framework/table.md#0x2_table">table</a>
    <b>while</b> (epoch &gt;= activation_epoch) {
        <b>if</b> (<a href="dependencies/haneul-framework/table.md#0x2_table_contains">table::contains</a>(&pool.exchange_rates, epoch)) {
            <b>return</b> *<a href="dependencies/haneul-framework/table.md#0x2_table_borrow">table::borrow</a>(&pool.exchange_rates, epoch)
        };
        epoch = epoch - 1;
    };
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_exchange_rates">exchange_rates</a>(pool: &<a href="staking_pool.md#0x3_staking_pool_StakingPool">staking_pool::StakingPool</a>): &<a href="dependencies/haneul-framework/table.md#0x2_table_Table">table::Table</a>&lt;u64, <a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">staking_pool::PoolTokenExchangeRate</a>&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_is_preactive_at_epoch">is_preactive_at_epoch</a>(pool: &<a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>, epoch: u64): bool{
    ...
    <a href="staking_pool.md#0x3_staking_pool_is_preactive">is_preactive</a>(pool) || (*<a href="dependencies/move-stdlib/option.md#0x1_option_borrow">option::borrow</a>(&pool.activation_epoch) &gt; epoch)
}
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_check_balance_invariants">check_balance_invariants</a>(pool: &<a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>, epoch: u64) {
    <b>let</b> exchange_rate = <a href="staking_pool.md#0x3_staking_pool_pool_token_exchange_rate_at_epoch">pool_token_exchange_rate_at_epoch</a>(pool, epoch);
    // check that the pool token <a href="dependencies/haneul-framework/balance.md#0x2_balance">balance</a> and <a href="dependencies/haneul-framework/haneul.md#0x2_haneul">haneul</a> <a href="dependencies/haneul-framework/balance.md#0x2_balance">balance</a> ratio matches the exchange rate stored.
