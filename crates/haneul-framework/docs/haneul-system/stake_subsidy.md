...
<pre><code><b>public</b>(package) <b>fun</b> <a href="stake_subsidy.md#0x3_stake_subsidy_advance_epoch">advance_epoch</a>(self: &<b>mut</b> <a href="stake_subsidy.md#0x3_stake_subsidy_StakeSubsidy">StakeSubsidy</a>): Balance&lt;HANEUL&gt; {
    ...
    // <a href="../haneul-framework/balance.md#0x2_balance">balance</a>
    <b>let</b> to_withdraw = self.current_distribution_amount.<b>min</b>(self.<a href="../haneul-framework/balance.md#0x2_balance">balance</a>.value());
...
<pre><code><b>public</b> <b>fun</b> <a href="stake_subsidy.md#0x3_stake_subsidy_current_epoch_subsidy_amount">current_epoch_subsidy_amount</a>(self: &<a href="stake_subsidy.md#0x3_stake_subsidy_StakeSubsidy">StakeSubsidy</a>): <a href="../move-stdlib/u64.md#0x1_u64">u64</a> {
    self.current_distribution_amount.<b>min</b>(self.<a href="../haneul-framework/balance.md#0x2_balance">balance</a>.value())
}
</code></pre>
