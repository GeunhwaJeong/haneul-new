...
<b>use</b> <a href="../haneul-framework/priority_queue.md#0x2_priority_queue">0x2::priority_queue</a>;
...
<b>use</b> <a href="../haneul-framework/table_vec.md#0x2_table_vec">0x2::table_vec</a>;
...
<dt>
<code>pending_active_validators: <a href="../haneul-framework/table_vec.md#0x2_table_vec_TableVec">table_vec::TableVec</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>pending_removals: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;</code>
</dt>
<dd>
...
<dt>
<code>staking_pool_mappings: <a href="../haneul-framework/table.md#0x2_table_Table">table::Table</a>&lt;<a href="../haneul-framework/object.md#0x2_object_ID">object::ID</a>, <b>address</b>&gt;</code>
</dt>
<dd>
 Mappings from staking pool's ID to the haneul address of a validator.
</dd>
<dt>
<code>inactive_validators: <a href="../haneul-framework/table.md#0x2_table_Table">table::Table</a>&lt;<a href="../haneul-framework/object.md#0x2_object_ID">object::ID</a>, <a href="validator_wrapper.md#0x3_validator_wrapper_ValidatorWrapper">validator_wrapper::ValidatorWrapper</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>validator_candidates: <a href="../haneul-framework/table.md#0x2_table_Table">table::Table</a>&lt;<b>address</b>, <a href="validator_wrapper.md#0x3_validator_wrapper_ValidatorWrapper">validator_wrapper::ValidatorWrapper</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>at_risk_validators: <a href="../haneul-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;<b>address</b>, u64&gt;</code>
</dt>
<dd>
...
<dt>
<code>staking_pool_id: <a href="../haneul-framework/object.md#0x2_object_ID">object::ID</a></code>
</dt>
<dd>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_new">new</a>(init_active_validators: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, ctx: &<b>mut</b> <a href="../haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_new">new</a>(init_active_validators: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;, ctx: &<b>mut</b> TxContext): <a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a> {
    ...
    <b>let</b> staking_pool_mappings = <a href="../haneul-framework/table.md#0x2_table_new">table::new</a>(ctx);
    ...
    <b>while</b> (i &lt; num_validators) {
        ...
        <a href="../haneul-framework/table.md#0x2_table_add">table::add</a>(&<b>mut</b> staking_pool_mappings, staking_pool_id(<a href="validator.md#0x3_validator">validator</a>), haneul_address(<a href="validator.md#0x3_validator">validator</a>));
        i = i + 1;
    };
    <b>let</b> validators = <a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a> {
        total_stake,
        active_validators: init_active_validators,
        pending_active_validators: <a href="../haneul-framework/table_vec.md#0x2_table_vec_empty">table_vec::empty</a>(ctx),
        pending_removals: <a href="../move-stdlib/vector.md#0x1_vector_empty">vector::empty</a>(),
        staking_pool_mappings,
        inactive_validators: <a href="../haneul-framework/table.md#0x2_table_new">table::new</a>(ctx),
        validator_candidates: <a href="../haneul-framework/table.md#0x2_table_new">table::new</a>(ctx),
        at_risk_validators: <a href="../haneul-framework/vec_map.md#0x2_vec_map_empty">vec_map::empty</a>(),
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_add_validator_candidate">request_add_validator_candidate</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, <a href="validator.md#0x3_validator">validator</a>: <a href="validator.md#0x3_validator_Validator">validator::Validator</a>, ctx: &<b>mut</b> <a href="../haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_add_validator_candidate">request_add_validator_candidate</a>(
    ...
    <b>assert</b>!(
        !<a href="../haneul-framework/table.md#0x2_table_contains">table::contains</a>(&self.validator_candidates, validator_address),
    ...
    <a href="../haneul-framework/table.md#0x2_table_add">table::add</a>(&<b>mut</b> self.staking_pool_mappings, staking_pool_id(&<a href="validator.md#0x3_validator">validator</a>), validator_address);
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_remove_validator_candidate">request_remove_validator_candidate</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, ctx: &<b>mut</b> <a href="../haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_remove_validator_candidate">request_remove_validator_candidate</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>, ctx: &<b>mut</b> TxContext) {
    <b>let</b> validator_address = <a href="../haneul-framework/tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx);
     <b>assert</b>!(
        <a href="../haneul-framework/table.md#0x2_table_contains">table::contains</a>(&self.validator_candidates, validator_address),
        <a href="validator_set.md#0x3_validator_set_ENotValidatorCandidate">ENotValidatorCandidate</a>
    );
    <b>let</b> wrapper = <a href="../haneul-framework/table.md#0x2_table_remove">table::remove</a>(&<b>mut</b> self.validator_candidates, validator_address);
    ...
    <a href="../haneul-framework/table.md#0x2_table_remove">table::remove</a>(&<b>mut</b> self.staking_pool_mappings, staking_pool_id);

    // Deactivate the staking pool.
    <a href="validator.md#0x3_validator_deactivate">validator::deactivate</a>(&<b>mut</b> <a href="validator.md#0x3_validator">validator</a>, <a href="../haneul-framework/tx_context.md#0x2_tx_context_epoch">tx_context::epoch</a>(ctx));
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_add_validator">request_add_validator</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, min_joining_stake_amount: u64, ctx: &<a href="../haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_add_validator">request_add_validator</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>, min_joining_stake_amount: u64, ctx: &TxContext) {
    ...
    <a href="../haneul-framework/table_vec.md#0x2_table_vec_push_back">table_vec::push_back</a>(&<b>mut</b> self.pending_active_validators, <a href="validator.md#0x3_validator">validator</a>);
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_add_stake">request_add_stake</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, validator_address: <b>address</b>, stake: <a href="../haneul-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../haneul-framework/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, ctx: &<b>mut</b> <a href="../haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_add_stake">request_add_stake</a>(
    ...
    <a href="validator.md#0x3_validator_request_add_stake">validator::request_add_stake</a>(<a href="validator.md#0x3_validator">validator</a>, stake, <a href="../haneul-framework/tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx), ctx)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_withdraw_stake">request_withdraw_stake</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, staked_haneul: <a href="staking_pool.md#0x3_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, ctx: &<a href="../haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="../haneul-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../haneul-framework/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_withdraw_stake">request_withdraw_stake</a>(
    ...
    <b>let</b> <a href="validator.md#0x3_validator">validator</a> =
        <b>if</b> (<a href="../haneul-framework/table.md#0x2_table_contains">table::contains</a>(&self.staking_pool_mappings, staking_pool_id)) { // This is an active <a href="validator.md#0x3_validator">validator</a>.
            <b>let</b> validator_address = *<a href="../haneul-framework/table.md#0x2_table_borrow">table::borrow</a>(&self.staking_pool_mappings, pool_id(&staked_haneul));
            ...
            <b>assert</b>!(<a href="../haneul-framework/table.md#0x2_table_contains">table::contains</a>(&self.inactive_validators, staking_pool_id), <a href="validator_set.md#0x3_validator_set_ENoPoolFound">ENoPoolFound</a>);
            <b>let</b> wrapper = <a href="../haneul-framework/table.md#0x2_table_borrow_mut">table::borrow_mut</a>(&<b>mut</b> self.inactive_validators, staking_pool_id);
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_set_commission_rate">request_set_commission_rate</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, new_commission_rate: u64, ctx: &<a href="../haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_advance_epoch">advance_epoch</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, computation_reward: &<b>mut</b> <a href="../haneul-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../haneul-framework/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, storage_fund_reward: &<b>mut</b> <a href="../haneul-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../haneul-framework/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;, validator_report_records: &<b>mut</b> <a href="../haneul-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;<b>address</b>, <a href="../haneul-framework/vec_set.md#0x2_vec_set_VecSet">vec_set::VecSet</a>&lt;<b>address</b>&gt;&gt;, reward_slashing_rate: u64, low_stake_threshold: u64, very_low_stake_threshold: u64, low_stake_grace_period: u64, ctx: &<b>mut</b> <a href="../haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_advance_epoch">advance_epoch</a>(
    ...
    <b>let</b> (unadjusted_staking_reward_amounts, unadjusted_storage_fund_reward_amounts) = <a href="validator_set.md#0x3_validator_set_compute_unadjusted_reward_distribution">compute_unadjusted_reward_distribution</a>(
        ...
        total_voting_power,
        <a href="../haneul-framework/balance.md#0x2_balance_value">balance::value</a>(computation_reward),
        <a href="../haneul-framework/balance.md#0x2_balance_value">balance::value</a>(storage_fund_reward),
    );
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_update_and_process_low_stake_departures">update_and_process_low_stake_departures</a>(
    ...
    <b>let</b> i = <a href="../move-stdlib/vector.md#0x1_vector_length">vector::length</a>(&self.active_validators);
    <b>while</b> (i &gt; 0) {
        i = i - 1;
        ...
        <b>if</b> (stake &gt;= low_stake_threshold) {
            ...
            <b>if</b> (<a href="../haneul-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(&self.at_risk_validators, &validator_address)) {
                <a href="../haneul-framework/vec_map.md#0x2_vec_map_remove">vec_map::remove</a>(&<b>mut</b> self.at_risk_validators, &validator_address);
            }
            ...
            <b>let</b> new_low_stake_period =
                <b>if</b> (<a href="../haneul-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(&self.at_risk_validators, &validator_address)) {
                    <b>let</b> num_epochs = <a href="../haneul-framework/vec_map.md#0x2_vec_map_get_mut">vec_map::get_mut</a>(&<b>mut</b> self.at_risk_validators, &validator_address);
                    *num_epochs = *num_epochs + 1;
                    *num_epochs
                } <b>else</b> {
                    <a href="../haneul-framework/vec_map.md#0x2_vec_map_insert">vec_map::insert</a>(&<b>mut</b> self.at_risk_validators, validator_address, 1);
                    1
                };
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_derive_reference_gas_price">derive_reference_gas_price</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>): u64 {
    ...
    <b>let</b> entries = <a href="../move-stdlib/vector.md#0x1_vector_empty">vector::empty</a>();
    <b>let</b> i = 0;
    <b>while</b> (i &lt; num_validators) {
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_staking_pool_mappings">staking_pool_mappings</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>): &<a href="../haneul-framework/table.md#0x2_table_Table">table::Table</a>&lt;<a href="../haneul-framework/object.md#0x2_object_ID">object::ID</a>, <b>address</b>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_pool_exchange_rates">pool_exchange_rates</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, pool_id: &<a href="../haneul-framework/object.md#0x2_object_ID">object::ID</a>): &<a href="../haneul-framework/table.md#0x2_table_Table">table::Table</a>&lt;u64, <a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">staking_pool::PoolTokenExchangeRate</a>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_pool_exchange_rates">pool_exchange_rates</a>(
    ...
    <b>let</b> <a href="validator.md#0x3_validator">validator</a> =
        ...
        <b>if</b> (<a href="../haneul-framework/table.md#0x2_table_contains">table::contains</a>(&self.staking_pool_mappings, *pool_id)) {
            <b>let</b> validator_address = *<a href="../haneul-framework/table.md#0x2_table_borrow">table::borrow</a>(&self.staking_pool_mappings, *pool_id);
            ...
            <b>let</b> wrapper = <a href="../haneul-framework/table.md#0x2_table_borrow_mut">table::borrow_mut</a>(&<b>mut</b> self.inactive_validators, *pool_id);
            <a href="validator_wrapper.md#0x3_validator_wrapper_load_validator_maybe_upgrade">validator_wrapper::load_validator_maybe_upgrade</a>(wrapper)
        };
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_next_epoch_validator_count">next_epoch_validator_count</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>): u64 {
    <a href="../move-stdlib/vector.md#0x1_vector_length">vector::length</a>(&self.active_validators) - <a href="../move-stdlib/vector.md#0x1_vector_length">vector::length</a>(&self.pending_removals) + <a href="../haneul-framework/table_vec.md#0x2_table_vec_length">table_vec::length</a>(&self.pending_active_validators)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_is_duplicate_validator">is_duplicate_validator</a>(validators: &<a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;, new_validator: &Validator): bool {
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_count_duplicates_tablevec">count_duplicates_tablevec</a>(validators: &<a href="../haneul-framework/table_vec.md#0x2_table_vec_TableVec">table_vec::TableVec</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, <a href="validator.md#0x3_validator">validator</a>: &<a href="validator.md#0x3_validator_Validator">validator::Validator</a>): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_count_duplicates_tablevec">count_duplicates_tablevec</a>(validators: &TableVec&lt;Validator&gt;, <a href="validator.md#0x3_validator">validator</a>: &Validator): u64 {
    <b>let</b> len = <a href="../haneul-framework/table_vec.md#0x2_table_vec_length">table_vec::length</a>(validators);
    <b>let</b> i = 0;
    <b>let</b> result = 0;
    <b>while</b> (i &lt; len) {
        <b>let</b> v = <a href="../haneul-framework/table_vec.md#0x2_table_vec_borrow">table_vec::borrow</a>(validators, i);
        <b>if</b> (<a href="validator.md#0x3_validator_is_duplicate">validator::is_duplicate</a>(v, <a href="validator.md#0x3_validator">validator</a>)) {
            result = result + 1;
        };
        i = i + 1;
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_get_candidate_or_active_validator_mut">get_candidate_or_active_validator_mut</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>, validator_address: <b>address</b>): &<b>mut</b> Validator {
    <b>if</b> (<a href="../haneul-framework/table.md#0x2_table_contains">table::contains</a>(&self.validator_candidates, validator_address)) {
        <b>let</b> wrapper = <a href="../haneul-framework/table.md#0x2_table_borrow_mut">table::borrow_mut</a>(&<b>mut</b> self.validator_candidates, validator_address);
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_find_validator_from_table_vec">find_validator_from_table_vec</a>(validators: &<a href="../haneul-framework/table_vec.md#0x2_table_vec_TableVec">table_vec::TableVec</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, validator_address: <b>address</b>): <a href="../move-stdlib/option.md#0x1_option_Option">option::Option</a>&lt;u64&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_find_validator_from_table_vec">find_validator_from_table_vec</a>(validators: &TableVec&lt;Validator&gt;, validator_address: <b>address</b>): Option&lt;u64&gt; {
    <b>let</b> length = <a href="../haneul-framework/table_vec.md#0x2_table_vec_length">table_vec::length</a>(validators);
    <b>let</b> i = 0;
    <b>while</b> (i &lt; length) {
        <b>let</b> v = <a href="../haneul-framework/table_vec.md#0x2_table_vec_borrow">table_vec::borrow</a>(validators, i);
        <b>if</b> (<a href="validator.md#0x3_validator_haneul_address">validator::haneul_address</a>(v) == validator_address) {
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_get_active_or_pending_or_candidate_validator_mut">get_active_or_pending_or_candidate_validator_mut</a>(
    ...
    <b>if</b> (<a href="../move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&validator_index_opt)) {
        <b>let</b> validator_index = <a href="../move-stdlib/option.md#0x1_option_extract">option::extract</a>(&<b>mut</b> validator_index_opt);
        <b>return</b> <a href="../haneul-framework/table_vec.md#0x2_table_vec_borrow_mut">table_vec::borrow_mut</a>(&<b>mut</b> self.pending_active_validators, validator_index)
    };
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_get_validator_mut_with_ctx">get_validator_mut_with_ctx</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, ctx: &<a href="../haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): &<b>mut</b> <a href="validator.md#0x3_validator_Validator">validator::Validator</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_get_active_or_pending_or_candidate_validator_ref">get_active_or_pending_or_candidate_validator_ref</a>(
    ...
    <b>if</b> (<a href="../move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&validator_index_opt) || which_validator == <a href="validator_set.md#0x3_validator_set_ACTIVE_OR_PENDING_VALIDATOR">ACTIVE_OR_PENDING_VALIDATOR</a>) {
        <b>let</b> validator_index = <a href="../move-stdlib/option.md#0x1_option_extract">option::extract</a>(&<b>mut</b> validator_index_opt);
        <b>return</b> <a href="../haneul-framework/table_vec.md#0x2_table_vec_borrow">table_vec::borrow</a>(&self.pending_active_validators, validator_index)
    };
    <b>let</b> wrapper = <a href="../haneul-framework/table.md#0x2_table_borrow_mut">table::borrow_mut</a>(&<b>mut</b> self.validator_candidates, validator_address);
    <a href="validator_wrapper.md#0x3_validator_wrapper_load_validator_maybe_upgrade">validator_wrapper::load_validator_maybe_upgrade</a>(wrapper)
}
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_get_pending_validator_ref">get_pending_validator_ref</a>(
    ...
    <b>let</b> validator_index = <a href="../move-stdlib/option.md#0x1_option_extract">option::extract</a>(&<b>mut</b> validator_index_opt);
    <a href="../haneul-framework/table_vec.md#0x2_table_vec_borrow">table_vec::borrow</a>(&self.pending_active_validators, validator_index)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_verify_cap">verify_cap</a>(
    ...
    <b>assert</b>!(<a href="validator.md#0x3_validator_operation_cap_id">validator::operation_cap_id</a>(<a href="validator.md#0x3_validator">validator</a>) == &<a href="../haneul-framework/object.md#0x2_object_id">object::id</a>(cap), <a href="validator_set.md#0x3_validator_set_EInvalidCap">EInvalidCap</a>);
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_process_validator_departure">process_validator_departure</a>(
    ...
    <a href="../haneul-framework/table.md#0x2_table_remove">table::remove</a>(&<b>mut</b> self.staking_pool_mappings, validator_pool_id);
    <b>if</b> (<a href="../haneul-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(&self.at_risk_validators, &validator_address)) {
        <a href="../haneul-framework/vec_map.md#0x2_vec_map_remove">vec_map::remove</a>(&<b>mut</b> self.at_risk_validators, &validator_address);
    };
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_clean_report_records_leaving_validator">clean_report_records_leaving_validator</a>(
    ...
    <b>if</b> (<a href="../haneul-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(validator_report_records, &leaving_validator_addr)) {
        <a href="../haneul-framework/vec_map.md#0x2_vec_map_remove">vec_map::remove</a>(validator_report_records, &leaving_validator_addr);
    };

    // Remove the reports submitted by this <a href="validator.md#0x3_validator">validator</a>
    <b>let</b> reported_validators = <a href="../haneul-framework/vec_map.md#0x2_vec_map_keys">vec_map::keys</a>(validator_report_records);
    ...
    <b>while</b> (i &lt; length) {
        ...
        <b>let</b> reporters = <a href="../haneul-framework/vec_map.md#0x2_vec_map_get_mut">vec_map::get_mut</a>(validator_report_records, reported_validator_addr);
        <b>if</b> (<a href="../haneul-framework/vec_set.md#0x2_vec_set_contains">vec_set::contains</a>(reporters, &leaving_validator_addr)) {
            <a href="../haneul-framework/vec_set.md#0x2_vec_set_remove">vec_set::remove</a>(reporters, &leaving_validator_addr);
            <b>if</b> (<a href="../haneul-framework/vec_set.md#0x2_vec_set_is_empty">vec_set::is_empty</a>(reporters)) {
                <a href="../haneul-framework/vec_map.md#0x2_vec_map_remove">vec_map::remove</a>(validator_report_records, reported_validator_addr);
            };
        };
        i = i + 1;
    }
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_process_pending_validators">process_pending_validators</a>(
    ...
    <b>while</b> (!<a href="../haneul-framework/table_vec.md#0x2_table_vec_is_empty">table_vec::is_empty</a>(&self.pending_active_validators)) {
        <b>let</b> <a href="validator.md#0x3_validator">validator</a> = <a href="../haneul-framework/table_vec.md#0x2_table_vec_pop_back">table_vec::pop_back</a>(&<b>mut</b> self.pending_active_validators);
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_process_pending_stakes_and_withdraws">process_pending_stakes_and_withdraws</a>(validators: &<b>mut</b> <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, ctx: &<a href="../haneul-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_calculate_total_stakes">calculate_total_stakes</a>(validators: &<a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_compute_reward_adjustments">compute_reward_adjustments</a>(
    slashed_validator_indices: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;,
    reward_slashing_rate: u64,
    ...
    <b>let</b> individual_staking_reward_adjustments = <a href="../haneul-framework/vec_map.md#0x2_vec_map_empty">vec_map::empty</a>();
    <b>let</b> total_storage_fund_reward_adjustment = 0;
    <b>let</b> individual_storage_fund_reward_adjustments = <a href="../haneul-framework/vec_map.md#0x2_vec_map_empty">vec_map::empty</a>();
    ...
    <b>while</b> (!<a href="../move-stdlib/vector.md#0x1_vector_is_empty">vector::is_empty</a>(&slashed_validator_indices)) {
        ...
        <a href="../haneul-framework/vec_map.md#0x2_vec_map_insert">vec_map::insert</a>(&<b>mut</b> individual_staking_reward_adjustments, validator_index, (staking_reward_adjustment_u128 <b>as</b> u64));
        ...
        <b>let</b> storage_fund_reward_adjustment_u128 =
            ...
            / <a href="validator_set.md#0x3_validator_set_BASIS_POINT_DENOMINATOR">BASIS_POINT_DENOMINATOR</a>;
        <a href="../haneul-framework/vec_map.md#0x2_vec_map_insert">vec_map::insert</a>(&<b>mut</b> individual_storage_fund_reward_adjustments, validator_index, (storage_fund_reward_adjustment_u128 <b>as</b> u64));
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_compute_slashed_validators">compute_slashed_validators</a>(
    ...
    <b>let</b> slashed_validators = <a href="../move-stdlib/vector.md#0x1_vector">vector</a>[];
    <b>while</b> (!<a href="../haneul-framework/vec_map.md#0x2_vec_map_is_empty">vec_map::is_empty</a>(&validator_report_records)) {
        <b>let</b> (validator_address, reporters) = <a href="../haneul-framework/vec_map.md#0x2_vec_map_pop">vec_map::pop</a>(&<b>mut</b> validator_report_records);
        <b>assert</b>!(
        ...
        <b>let</b> reporter_votes = <a href="validator_set.md#0x3_validator_set_sum_voting_power_by_addresses">sum_voting_power_by_addresses</a>(&self.active_validators, &<a href="../haneul-framework/vec_set.md#0x2_vec_set_into_keys">vec_set::into_keys</a>(reporters));
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_compute_unadjusted_reward_distribution">compute_unadjusted_reward_distribution</a>(
    ...
    <b>let</b> staking_reward_amounts = <a href="../move-stdlib/vector.md#0x1_vector_empty">vector::empty</a>();
    <b>let</b> storage_fund_reward_amounts = <a href="../move-stdlib/vector.md#0x1_vector_empty">vector::empty</a>();
    <b>let</b> length = <a href="../move-stdlib/vector.md#0x1_vector_length">vector::length</a>(validators);
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_compute_adjusted_reward_distribution">compute_adjusted_reward_distribution</a>(
    ...
    <b>let</b> adjusted_staking_reward_amounts = <a href="../move-stdlib/vector.md#0x1_vector_empty">vector::empty</a>();
    <b>let</b> adjusted_storage_fund_reward_amounts = <a href="../move-stdlib/vector.md#0x1_vector_empty">vector::empty</a>();

    <b>let</b> length = <a href="../move-stdlib/vector.md#0x1_vector_length">vector::length</a>(validators);
    <b>let</b> num_unslashed_validators = length - <a href="../haneul-framework/vec_map.md#0x2_vec_map_size">vec_map::size</a>(&individual_staking_reward_adjustments);
    ...
    <b>while</b> (i &lt; length) {
        ...
        <b>let</b> adjusted_staking_reward_amount =
            ...
            <b>if</b> (<a href="../haneul-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(&individual_staking_reward_adjustments, &i)) {
                <b>let</b> adjustment = *<a href="../haneul-framework/vec_map.md#0x2_vec_map_get">vec_map::get</a>(&individual_staking_reward_adjustments, &i);
        ...
        <b>let</b> adjusted_storage_fund_reward_amount =
            // If the <a href="validator.md#0x3_validator">validator</a> is one of the slashed ones, then subtract the adjustment.
            <b>if</b> (<a href="../haneul-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(&individual_storage_fund_reward_adjustments, &i)) {
                <b>let</b> adjustment = *<a href="../haneul-framework/vec_map.md#0x2_vec_map_get">vec_map::get</a>(&individual_storage_fund_reward_adjustments, &i);
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_distribute_reward">distribute_reward</a>(
    ...
    <b>while</b> (i &lt; length) {
        ...
        <b>let</b> staker_reward = <a href="../haneul-framework/balance.md#0x2_balance_split">balance::split</a>(staking_rewards, staking_reward_amount);
        ...
        <b>let</b> validator_reward = <a href="../haneul-framework/balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> staker_reward, (validator_commission_amount <b>as</b> u64));

        // Add storage fund rewards <b>to</b> the <a href="validator.md#0x3_validator">validator</a>'s reward.
        <a href="../haneul-framework/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> validator_reward, <a href="../haneul-framework/balance.md#0x2_balance_split">balance::split</a>(storage_fund_reward, *<a href="../move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(adjusted_storage_fund_reward_amounts, i)));
        ...
        <b>if</b> (<a href="../haneul-framework/balance.md#0x2_balance_value">balance::value</a>(&validator_reward) &gt; 0) {
            <b>let</b> validator_address = <a href="validator.md#0x3_validator_haneul_address">validator::haneul_address</a>(<a href="validator.md#0x3_validator">validator</a>);
            ...
            <a href="../haneul-framework/transfer.md#0x2_transfer_public_transfer">transfer::public_transfer</a>(rewards_stake, validator_address);
        } <b>else</b> {
            <a href="../haneul-framework/balance.md#0x2_balance_destroy_zero">balance::destroy_zero</a>(validator_reward);
        };
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_emit_validator_epoch_events">emit_validator_epoch_events</a>(
    ...
    <b>while</b> (i &lt; num_validators) {
        ...
        <b>let</b> tallying_rule_reporters =
            <b>if</b> (<a href="../haneul-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(report_records, &validator_address)) {
                <a href="../haneul-framework/vec_set.md#0x2_vec_set_into_keys">vec_set::into_keys</a>(*<a href="../haneul-framework/vec_map.md#0x2_vec_map_get">vec_map::get</a>(report_records, &validator_address))
            } <b>else</b> {
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_is_validator_candidate">is_validator_candidate</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>, addr: <b>address</b>): bool {
    <a href="../haneul-framework/table.md#0x2_table_contains">table::contains</a>(&self.validator_candidates, addr)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_is_inactive_validator">is_inactive_validator</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, staking_pool_id: <a href="../haneul-framework/object.md#0x2_object_ID">object::ID</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_is_inactive_validator">is_inactive_validator</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>, staking_pool_id: ID): bool {
    <a href="../haneul-framework/table.md#0x2_table_contains">table::contains</a>(&self.inactive_validators, staking_pool_id)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_active_validator_addresses">active_validator_addresses</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt; {
    <b>let</b> vs = &self.active_validators;
    <b>let</b> res = <a href="../move-stdlib/vector.md#0x1_vector">vector</a>[];
    <b>let</b> i = 0;
    <b>let</b> length = <a href="../move-stdlib/vector.md#0x1_vector_length">vector::length</a>(vs);
    <b>while</b> (i &lt; length) {
        <b>let</b> validator_address = <a href="validator.md#0x3_validator_haneul_address">validator::haneul_address</a>(<a href="../move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(vs, i));
