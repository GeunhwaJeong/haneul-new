...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_request_switch_delegation">request_switch_delegation</a>(
    ...
    <b>let</b> (current_validator_pool_token, principal_stake, time_lock) =
        <a href="staking_pool.md#0x2_staking_pool_withdraw_principal">staking_pool::withdraw_principal</a>(<a href="validator.md#0x2_validator_get_staking_pool_mut_ref">validator::get_staking_pool_mut_ref</a>(current_validator), delegation, staked_haneul, switch_pool_token_amount);
