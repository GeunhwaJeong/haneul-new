...
Called by <code>HaneulSystem</code>, add a new validator to <code>pending_validators</code>, which will be
...
Called by <code>HaneulSystem</code>, to remove a validator.
...
Called by <code>HaneulSystem</code>, to add more stake to a validator.
...
Called by <code>HaneulSystem</code>, to withdraw stake from a validator.
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_request_add_delegation">request_add_delegation</a>(
    ...
    <b>let</b> <a href="validator.md#0x2_validator">validator</a> = <a href="validator_set.md#0x2_validator_set_get_validator_mut">get_validator_mut</a>(&<b>mut</b> self.active_validators, validator_address);
    <a href="validator.md#0x2_validator_request_add_delegation">validator::request_add_delegation</a>(<a href="validator.md#0x2_validator">validator</a>, delegated_stake, locking_period, ctx);
    self.next_epoch_validators = <a href="validator_set.md#0x2_validator_set_derive_next_epoch_validators">derive_next_epoch_validators</a>(self);
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_request_switch_delegation">request_switch_delegation</a>(self: &<b>mut</b> <a href="validator_set.md#0x2_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, delegation: <a href="staking_pool.md#0x2_staking_pool_Delegation">staking_pool::Delegation</a>, staked_haneul: &<b>mut</b> <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, new_validator_address: <b>address</b>, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_request_switch_delegation">request_switch_delegation</a>(
    ...
    // withdraw <a href="stake.md#0x2_stake">stake</a> and compounded rewards from the current <a href="validator.md#0x2_validator">validator</a>'s pool
    ...
    <b>let</b> (principal_stake, rewards_stake, time_lock) =
        <a href="staking_pool.md#0x2_staking_pool_withdraw_all_to_haneul_tokens">staking_pool::withdraw_all_to_haneul_tokens</a>(<a href="validator.md#0x2_validator_get_staking_pool_mut_ref">validator::get_staking_pool_mut_ref</a>(current_validator), delegation, staked_haneul);
    <b>let</b> withdraw_haneul_amount = <a href="balance.md#0x2_balance_value">balance::value</a>(&principal_stake) + <a href="balance.md#0x2_balance_value">balance::value</a>(&rewards_stake);
    <a href="validator.md#0x2_validator_decrease_next_epoch_delegation">validator::decrease_next_epoch_delegation</a>(current_validator, withdraw_haneul_amount);
