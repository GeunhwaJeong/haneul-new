...
-  [Function `is_active_validator_by_haneul_address`](#0x2_validator_set_is_active_validator_by_haneul_address)
...
-  [Function `get_active_or_pending_validator_ref`](#0x2_validator_set_get_active_or_pending_validator_ref)
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_new">new</a>(init_active_validators: <a href="">vector</a>&lt;Validator&gt;, ctx: &<b>mut</b> TxContext): <a href="validator_set.md#0x2_validator_set_ValidatorSet">ValidatorSet</a> {
    ...
    <b>while</b> (i &lt; num_validators) {
        ...
        <a href="table.md#0x2_table_add">table::add</a>(&<b>mut</b> staking_pool_mappings, staking_pool_id(<a href="validator.md#0x2_validator">validator</a>), haneul_address(<a href="validator.md#0x2_validator">validator</a>));
        i = i + 1;
    };
...
Called by <code><a href="haneul_system.md#0x2_haneul_system">haneul_system</a></code> to add a new validator candidate.
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_request_add_validator_candidate">request_add_validator_candidate</a>(self: &<b>mut</b> <a href="validator_set.md#0x2_validator_set_ValidatorSet">ValidatorSet</a>, <a href="validator.md#0x2_validator">validator</a>: Validator) {
    ...
    <b>let</b> validator_address = haneul_address(&<a href="validator.md#0x2_validator">validator</a>);
    <b>assert</b>!(
    ...
    <a href="table.md#0x2_table_add">table::add</a>(&<b>mut</b> self.validator_candidates, haneul_address(&<a href="validator.md#0x2_validator">validator</a>), <a href="validator.md#0x2_validator">validator</a>);
}
</code></pre>
...
Called by <code><a href="haneul_system.md#0x2_haneul_system">haneul_system</a></code> to remove a validator candidate, and move them to <code>inactive_validators</code>.
...
Called by <code><a href="haneul_system.md#0x2_haneul_system">haneul_system</a></code> to add a new validator to <code>pending_active_validators</code>, which will be
...
Called by <code><a href="haneul_system.md#0x2_haneul_system">haneul_system</a></code>, to remove a validator.
...
Called by <code><a href="haneul_system.md#0x2_haneul_system">haneul_system</a></code>, to withdraw some share of a stake from the validator. The share to withdraw
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_request_withdraw_stake">request_withdraw_stake</a>(self: &<b>mut</b> <a href="validator_set.md#0x2_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, staked_haneul: <a href="staking_pool.md#0x2_staking_pool_StakedHaneul">staking_pool::StakedHaneul</a>, ctx: &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_request_withdraw_stake">request_withdraw_stake</a>(
    ...
    <b>if</b> (<a href="table.md#0x2_table_contains">table::contains</a>(&self.staking_pool_mappings, staking_pool_id)) {
        <b>let</b> validator_address = *<a href="table.md#0x2_table_borrow">table::borrow</a>(&self.staking_pool_mappings, pool_id(&staked_haneul));
        <b>let</b> <a href="validator.md#0x2_validator">validator</a> = <a href="validator_set.md#0x2_validator_set_get_preactive_or_active_validator_mut">get_preactive_or_active_validator_mut</a>(self, validator_address);
        <a href="validator.md#0x2_validator_request_withdraw_stake">validator::request_withdraw_stake</a>(<a href="validator.md#0x2_validator">validator</a>, staked_haneul, ctx);
...
Called by <code><a href="haneul_system.md#0x2_haneul_system">haneul_system</a></code> to derive reference gas price for the new epoch.
...
<a name="0x2_validator_set_is_active_validator_by_haneul_address"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_is_active_validator_by_haneul_address">is_active_validator_by_haneul_address</a>(self: &<a href="validator_set.md#0x2_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, validator_address: <b>address</b>): bool
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_is_active_validator_by_haneul_address">is_active_validator_by_haneul_address</a>(
...
<pre><code><b>fun</b> <a href="validator_set.md#0x2_validator_set_find_validator">find_validator</a>(validators: &<a href="">vector</a>&lt;Validator&gt;, validator_address: <b>address</b>): Option&lt;u64&gt; {
    ...
    <b>while</b> (i &lt; length) {
        ...
        <b>if</b> (<a href="validator.md#0x2_validator_haneul_address">validator::haneul_address</a>(v) == validator_address) {
...
<pre><code><b>fun</b> <a href="validator_set.md#0x2_validator_set_get_active_or_pending_validator_mut">get_active_or_pending_validator_mut</a>(
    self: &<b>mut</b> <a href="validator_set.md#0x2_validator_set_ValidatorSet">ValidatorSet</a>,
    validator_address: <b>address</b>,
): &<b>mut</b> Validator {
    <b>let</b> validator_index_opt = <a href="validator_set.md#0x2_validator_set_find_validator">find_validator</a>(&self.active_validators, validator_address);
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_get_validator_mut_with_verified_cap">get_validator_mut_with_verified_cap</a>(
    ...
    <a href="validator_set.md#0x2_validator_set_get_active_or_pending_validator_mut">get_active_or_pending_validator_mut</a>(self, *<a href="validator_cap.md#0x2_validator_cap_verified_operation_cap_address">validator_cap::verified_operation_cap_address</a>(verified_cap))
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_get_validator_mut_with_ctx">get_validator_mut_with_ctx</a>(
    ...
    <b>let</b> validator_address = <a href="tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx);
    <a href="validator_set.md#0x2_validator_set_get_active_or_pending_validator_mut">get_active_or_pending_validator_mut</a>(self, validator_address)
}
</code></pre>
...
<a name="0x2_validator_set_get_active_or_pending_validator_ref"></a>

## Function `get_active_or_pending_validator_ref`



<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_get_active_or_pending_validator_ref">get_active_or_pending_validator_ref</a>(self: &<a href="validator_set.md#0x2_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, validator_address: <b>address</b>): &<a href="validator.md#0x2_validator_Validator">validator::Validator</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_get_active_or_pending_validator_ref">get_active_or_pending_validator_ref</a>(
    self: &<a href="validator_set.md#0x2_validator_set_ValidatorSet">ValidatorSet</a>,
    validator_address: <b>address</b>,
): &Validator {
    <b>let</b> validator_index_opt = <a href="validator_set.md#0x2_validator_set_find_validator">find_validator</a>(&self.active_validators, validator_address);
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x2_validator_set_verify_cap">verify_cap</a>(
    ...
    <b>let</b> <a href="validator.md#0x2_validator">validator</a> =
        <b>if</b> (active_validator_only)
            <a href="validator_set.md#0x2_validator_set_get_active_validator_ref">get_active_validator_ref</a>(self, cap_address)
        <b>else</b>
            <a href="validator_set.md#0x2_validator_set_get_active_or_pending_validator_ref">get_active_or_pending_validator_ref</a>(self, cap_address);
...
<pre><code><b>fun</b> <a href="validator_set.md#0x2_validator_set_process_pending_removals">process_pending_removals</a>(
    ...
    <b>while</b> (!<a href="_is_empty">vector::is_empty</a>(&self.pending_removals)) {
        ...
        <a href="validator_set.md#0x2_validator_set_clean_report_records_leaving_validator">clean_report_records_leaving_validator</a>(
            validator_report_records, <a href="validator.md#0x2_validator_haneul_address">validator::haneul_address</a>(&<a href="validator.md#0x2_validator">validator</a>));
        ...
        <a href="event.md#0x2_event_emit">event::emit</a>(
            <a href="validator_set.md#0x2_validator_set_ValidatorLeaveEvent">ValidatorLeaveEvent</a> {
                epoch: new_epoch,
                validator_address: <a href="validator.md#0x2_validator_haneul_address">validator::haneul_address</a>(&<a href="validator.md#0x2_validator">validator</a>),
...
<pre><code><b>fun</b> <a href="validator_set.md#0x2_validator_set_compute_slashed_validators_and_total_stake">compute_slashed_validators_and_total_stake</a>(
    ...
    <b>while</b> (!<a href="vec_map.md#0x2_vec_map_is_empty">vec_map::is_empty</a>(&validator_report_records)) {
        ...
        <b>assert</b>!(
            <a href="validator_set.md#0x2_validator_set_is_active_validator_by_haneul_address">is_active_validator_by_haneul_address</a>(self, validator_address),
...
<pre><code><b>fun</b> <a href="validator_set.md#0x2_validator_set_distribute_reward">distribute_reward</a>(
    ...
    <b>while</b> (i &lt; length) {
        ...
        <b>if</b> (<a href="balance.md#0x2_balance_value">balance::value</a>(&validator_reward) &gt; 0) {
            <b>let</b> validator_address = <a href="validator.md#0x2_validator_haneul_address">validator::haneul_address</a>(<a href="validator.md#0x2_validator">validator</a>);
            <a href="validator.md#0x2_validator_request_add_stake">validator::request_add_stake</a>(<a href="validator.md#0x2_validator">validator</a>, validator_reward, <a href="_none">option::none</a>(), validator_address, ctx);
        } <b>else</b> {
...
<pre><code><b>fun</b> <a href="validator_set.md#0x2_validator_set_emit_validator_epoch_events">emit_validator_epoch_events</a>(
    ...
    <b>while</b> (i &lt; num_validators) {
        <b>let</b> v = <a href="_borrow">vector::borrow</a>(vs, i);
        <b>let</b> validator_address = <a href="validator.md#0x2_validator_haneul_address">validator::haneul_address</a>(v);
