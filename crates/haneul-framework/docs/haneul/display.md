...
<pre><code><b>public</b> <b>fun</b> newT(pub: &<a href="../haneul/package.md#haneul_package_Publisher">haneul::package::Publisher</a>, ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>): <a href="../haneul/display.md#haneul_display_Display">haneul::display::Display</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> new_with_fieldsT(pub: &<a href="../haneul/package.md#haneul_package_Publisher">haneul::package::Publisher</a>, <a href="../haneul/display.md#haneul_display_fields">fields</a>: vector&lt;<a href="../std/string.md#std_string_String">std::string::String</a>&gt;, values: vector&lt;<a href="../std/string.md#std_string_String">std::string::String</a>&gt;, ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>): <a href="../haneul/display.md#haneul_display_Display">haneul::display::Display</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../haneul/display.md#haneul_display_new_with_fields">new_with_fields</a>&lt;T: key&gt;(
    ...
    <b>while</b> (i &lt; len) {
        <a href="../haneul/display.md#haneul_display">display</a>.<a href="../haneul/display.md#haneul_display_add_internal">add_internal</a>(<a href="../haneul/display.md#haneul_display_fields">fields</a>[i], values[i]);
        i = i + 1;
    };
...
<pre><code><b>public</b> <b>entry</b> <b>fun</b> create_and_keepT(pub: &<a href="../haneul/package.md#haneul_package_Publisher">haneul::package::Publisher</a>, ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>entry</b> <b>fun</b> update_versionT(<a href="../haneul/display.md#haneul_display">display</a>: &<b>mut</b> <a href="../haneul/display.md#haneul_display_Display">haneul::display::Display</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>entry</b> <b>fun</b> addT(self: &<b>mut</b> <a href="../haneul/display.md#haneul_display_Display">haneul::display::Display</a>&lt;T&gt;, name: <a href="../std/string.md#std_string_String">std::string::String</a>, value: <a href="../std/string.md#std_string_String">std::string::String</a>)
</code></pre>
...
<pre><code><b>public</b> <b>entry</b> <b>fun</b> add_multipleT(self: &<b>mut</b> <a href="../haneul/display.md#haneul_display_Display">haneul::display::Display</a>&lt;T&gt;, <a href="../haneul/display.md#haneul_display_fields">fields</a>: vector&lt;<a href="../std/string.md#std_string_String">std::string::String</a>&gt;, values: vector&lt;<a href="../std/string.md#std_string_String">std::string::String</a>&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>entry</b> <b>fun</b> <a href="../haneul/display.md#haneul_display_add_multiple">add_multiple</a>&lt;T: key&gt;(
    ...
    <b>let</b> <b>mut</b> i = 0;
    <b>while</b> (i &lt; len) {
        self.<a href="../haneul/display.md#haneul_display_add_internal">add_internal</a>(<a href="../haneul/display.md#haneul_display_fields">fields</a>[i], values[i]);
        i = i + 1;
    };
}
</code></pre>
...
<pre><code><b>public</b> <b>entry</b> <b>fun</b> editT(self: &<b>mut</b> <a href="../haneul/display.md#haneul_display_Display">haneul::display::Display</a>&lt;T&gt;, name: <a href="../std/string.md#std_string_String">std::string::String</a>, value: <a href="../std/string.md#std_string_String">std::string::String</a>)
</code></pre>
...
<pre><code><b>public</b> <b>entry</b> <b>fun</b> removeT(self: &<b>mut</b> <a href="../haneul/display.md#haneul_display_Display">haneul::display::Display</a>&lt;T&gt;, name: <a href="../std/string.md#std_string_String">std::string::String</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> is_authorizedT(pub: &<a href="../haneul/package.md#haneul_package_Publisher">haneul::package::Publisher</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> versionT(d: &<a href="../haneul/display.md#haneul_display_Display">haneul::display::Display</a>&lt;T&gt;): u16
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> fieldsT(d: &<a href="../haneul/display.md#haneul_display_Display">haneul::display::Display</a>&lt;T&gt;): &<a href="../haneul/vec_map.md#haneul_vec_map_VecMap">haneul::vec_map::VecMap</a>&lt;<a href="../std/string.md#std_string_String">std::string::String</a>, <a href="../std/string.md#std_string_String">std::string::String</a>&gt;
</code></pre>
...
<pre><code><b>fun</b> create_internalT(ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>): <a href="../haneul/display.md#haneul_display_Display">haneul::display::Display</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>fun</b> add_internalT(<a href="../haneul/display.md#haneul_display">display</a>: &<b>mut</b> <a href="../haneul/display.md#haneul_display_Display">haneul::display::Display</a>&lt;T&gt;, name: <a href="../std/string.md#std_string_String">std::string::String</a>, value: <a href="../std/string.md#std_string_String">std::string::String</a>)
</code></pre>
