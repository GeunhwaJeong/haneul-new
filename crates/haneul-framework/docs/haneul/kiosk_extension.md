...
<pre><code><b>public</b> <b>fun</b> disableExt(self: &<b>mut</b> <a href="../haneul/kiosk.md#haneul_kiosk_Kiosk">haneul::kiosk::Kiosk</a>, cap: &<a href="../haneul/kiosk.md#haneul_kiosk_KioskOwnerCap">haneul::kiosk::KioskOwnerCap</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> enableExt(self: &<b>mut</b> <a href="../haneul/kiosk.md#haneul_kiosk_Kiosk">haneul::kiosk::Kiosk</a>, cap: &<a href="../haneul/kiosk.md#haneul_kiosk_KioskOwnerCap">haneul::kiosk::KioskOwnerCap</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> removeExt(self: &<b>mut</b> <a href="../haneul/kiosk.md#haneul_kiosk_Kiosk">haneul::kiosk::Kiosk</a>, cap: &<a href="../haneul/kiosk.md#haneul_kiosk_KioskOwnerCap">haneul::kiosk::KioskOwnerCap</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> storageExt(_ext: Ext, self: &<a href="../haneul/kiosk.md#haneul_kiosk_Kiosk">haneul::kiosk::Kiosk</a>): &<a href="../haneul/bag.md#haneul_bag_Bag">haneul::bag::Bag</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> storage_mutExt(_ext: Ext, self: &<b>mut</b> <a href="../haneul/kiosk.md#haneul_kiosk_Kiosk">haneul::kiosk::Kiosk</a>): &<b>mut</b> <a href="../haneul/bag.md#haneul_bag_Bag">haneul::bag::Bag</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> placeExt, T(_ext: Ext, self: &<b>mut</b> <a href="../haneul/kiosk.md#haneul_kiosk_Kiosk">haneul::kiosk::Kiosk</a>, item: T, _policy: &<a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferPolicy">haneul::transfer_policy::TransferPolicy</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> lockExt, T(_ext: Ext, self: &<b>mut</b> <a href="../haneul/kiosk.md#haneul_kiosk_Kiosk">haneul::kiosk::Kiosk</a>, item: T, _policy: &<a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferPolicy">haneul::transfer_policy::TransferPolicy</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> is_installedExt(self: &<a href="../haneul/kiosk.md#haneul_kiosk_Kiosk">haneul::kiosk::Kiosk</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> is_enabledExt(self: &<a href="../haneul/kiosk.md#haneul_kiosk_Kiosk">haneul::kiosk::Kiosk</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> can_placeExt(self: &<a href="../haneul/kiosk.md#haneul_kiosk_Kiosk">haneul::kiosk::Kiosk</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> can_lockExt(self: &<a href="../haneul/kiosk.md#haneul_kiosk_Kiosk">haneul::kiosk::Kiosk</a>): bool
</code></pre>
...
<pre><code><b>fun</b> extensionExt(self: &<a href="../haneul/kiosk.md#haneul_kiosk_Kiosk">haneul::kiosk::Kiosk</a>): &<a href="../haneul/kiosk_extension.md#haneul_kiosk_extension_Extension">haneul::kiosk_extension::Extension</a>
</code></pre>
...
<pre><code><b>fun</b> extension_mutExt(self: &<b>mut</b> <a href="../haneul/kiosk.md#haneul_kiosk_Kiosk">haneul::kiosk::Kiosk</a>): &<b>mut</b> <a href="../haneul/kiosk_extension.md#haneul_kiosk_extension_Extension">haneul::kiosk_extension::Extension</a>
</code></pre>
