...
<pre><code><b>public</b> <b>fun</b> newT(pub: &<a href="../haneul/package.md#haneul_package_Publisher">haneul::package::Publisher</a>, ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>): (<a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferPolicy">haneul::transfer_policy::TransferPolicy</a>&lt;T&gt;, <a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferPolicyCap">haneul::transfer_policy::TransferPolicyCap</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>entry</b> <b>fun</b> defaultT(pub: &<a href="../haneul/package.md#haneul_package_Publisher">haneul::package::Publisher</a>, ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../haneul/transfer_policy.md#haneul_transfer_policy_confirm_request">confirm_request</a>&lt;T&gt;(
    ...
    <b>assert</b>!(total == self.<a href="../haneul/transfer_policy.md#haneul_transfer_policy_rules">rules</a>.size(), <a href="../haneul/transfer_policy.md#haneul_transfer_policy_EPolicyNotSatisfied">EPolicyNotSatisfied</a>);
    <b>while</b> (total &gt; 0) {
...
<pre><code><b>public</b> <b>fun</b> add_ruleT, Rule, Config(_: Rule, policy: &<b>mut</b> <a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferPolicy">haneul::transfer_policy::TransferPolicy</a>&lt;T&gt;, cap: &<a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferPolicyCap">haneul::transfer_policy::TransferPolicyCap</a>&lt;T&gt;, cfg: Config)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../haneul/transfer_policy.md#haneul_transfer_policy_add_rule">add_rule</a>&lt;T, Rule: drop, Config: store + drop&gt;(
    ...
    policy.<a href="../haneul/transfer_policy.md#haneul_transfer_policy_rules">rules</a>.insert(type_name::get&lt;Rule&gt;())
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> get_ruleT, Rule, Config(_: Rule, policy: &<a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferPolicy">haneul::transfer_policy::TransferPolicy</a>&lt;T&gt;): &Config
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> add_receiptT, Rule(_: Rule, request: &<b>mut</b> <a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferRequest">haneul::transfer_policy::TransferRequest</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> has_ruleT, Rule(policy: &<a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferPolicy">haneul::transfer_policy::TransferPolicy</a>&lt;T&gt;): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> remove_ruleT, Rule, Config(policy: &<b>mut</b> <a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferPolicy">haneul::transfer_policy::TransferPolicy</a>&lt;T&gt;, cap: &<a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferPolicyCap">haneul::transfer_policy::TransferPolicyCap</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../haneul/transfer_policy.md#haneul_transfer_policy_remove_rule">remove_rule</a>&lt;T, Rule: drop, Config: store + drop&gt;(
    ...
    policy.<a href="../haneul/transfer_policy.md#haneul_transfer_policy_rules">rules</a>.remove(&type_name::get&lt;Rule&gt;());
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> uidT(self: &<a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferPolicy">haneul::transfer_policy::TransferPolicy</a>&lt;T&gt;): &<a href="../haneul/object.md#haneul_object_UID">haneul::object::UID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> rulesT(self: &<a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferPolicy">haneul::transfer_policy::TransferPolicy</a>&lt;T&gt;): &<a href="../haneul/vec_set.md#haneul_vec_set_VecSet">haneul::vec_set::VecSet</a>&lt;<a href="../std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> itemT(self: &<a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferRequest">haneul::transfer_policy::TransferRequest</a>&lt;T&gt;): <a href="../haneul/object.md#haneul_object_ID">haneul::object::ID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> paidT(self: &<a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferRequest">haneul::transfer_policy::TransferRequest</a>&lt;T&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> fromT(self: &<a href="../haneul/transfer_policy.md#haneul_transfer_policy_TransferRequest">haneul::transfer_policy::TransferRequest</a>&lt;T&gt;): <a href="../haneul/object.md#haneul_object_ID">haneul::object::ID</a>
</code></pre>
