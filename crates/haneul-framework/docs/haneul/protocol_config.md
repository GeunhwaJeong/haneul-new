---
title: Module `haneul::protocol_config`
---
...
-  [Function `is_feature_enabled`](#haneul_protocol_config_is_feature_enabled)
...
<a name="haneul_protocol_config_is_feature_enabled"></a>

## Function `is_feature_enabled`

Checks if a specific protocol feature flag is enabled.

Restricted to internal use within the haneul-framework package only.
If we need to use it in haneul-system, we can add friend declarations.
...
<pre><code><b>public</b>(<a href="../haneul/package.md#haneul_package">package</a>) <b>fun</b> <a href="../haneul/protocol_config.md#haneul_protocol_config_is_feature_enabled">is_feature_enabled</a>(feature_flag_name: vector&lt;u8&gt;): bool
</code></pre>
...
<pre><code><b>public</b>(<a href="../haneul/package.md#haneul_package">package</a>) <b>native</b> <b>fun</b> <a href="../haneul/protocol_config.md#haneul_protocol_config_is_feature_enabled">is_feature_enabled</a>(feature_flag_name: vector&lt;u8&gt;): bool;
</code></pre>
