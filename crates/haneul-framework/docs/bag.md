...
A bag is a heterogenous map-like collection. The collection is similar to <code>haneul::table</code> in that
it's keys and values are not stored within the <code><a href="bag.md#0x2_bag_Bag">Bag</a></code> value, but instead are stored using Haneul's
