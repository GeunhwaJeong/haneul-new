...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#0xdee9_clob_place_market_order">place_market_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>if</b> (is_bid) {
        ...
        <b>assert</b>!(quantity &lt;= <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_value">coin::value</a>(&base_coin), <a href="clob.md#0xdee9_clob_EInvalidBaseCoin">EInvalidBaseCoin</a>);
