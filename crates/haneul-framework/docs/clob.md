...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#0xdee9_clob_deposit_base">deposit_base</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <a href="custodian.md#0xdee9_custodian_increase_user_available_balance">custodian::increase_user_available_balance</a>(&<b>mut</b> pool.base_custodian, <a href="../../../.././build/Haneul/docs/object.md#0x2_object_id">object::id</a>(account_cap), <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_into_balance">coin::into_balance</a>(<a href="../../../.././build/Haneul/docs/coin.md#0x2_coin">coin</a>))
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob.md#0xdee9_clob_deposit_quote">deposit_quote</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <a href="custodian.md#0xdee9_custodian_increase_user_available_balance">custodian::increase_user_available_balance</a>(&<b>mut</b> pool.quote_custodian, <a href="../../../.././build/Haneul/docs/object.md#0x2_object_id">object::id</a>(account_cap), <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_into_balance">coin::into_balance</a>(<a href="../../../.././build/Haneul/docs/coin.md#0x2_coin">coin</a>))
}
</code></pre>
    ...
    <b>while</b> (!is_empty&lt;<a href="clob.md#0xdee9_clob_TickLevel">TickLevel</a>&gt;(all_open_orders) && tick_price &lt;= price_limit) {
        ...
        <b>while</b> (!<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_is_empty">linked_table::is_empty</a>(&tick_level.open_orders)) {
            ...
            <b>if</b> (maker_order.expire_timestamp &lt;= current_timestamp) {
                ...
                <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> pool.base_asset_trading_fees, taker_commission_balance);
...
<pre><code><b>fun</b> <a href="clob.md#0xdee9_clob_inject_limit_order">inject_limit_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <a href="../../../.././build/Haneul/docs/event.md#0x2_event_emit">event::emit</a>(<a href="clob.md#0xdee9_clob_OrderPlaced">OrderPlaced</a>&lt;BaseAsset, QuoteAsset&gt; {
        pool_id: *<a href="../../../.././build/Haneul/docs/object.md#0x2_object_uid_as_inner">object::uid_as_inner</a>(&pool.id),
        order_id,
        is_bid,
        owner: user,
