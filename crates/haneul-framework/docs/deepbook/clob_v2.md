...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_match_bid_with_quote_quantity">match_bid_with_quote_quantity</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>let</b> base_balance_filled = <a href="../haneul-framework/balance.md#0x2_balance_zero">balance::zero</a>&lt;BaseAsset&gt;();
    ...
    <b>while</b> (!is_empty&lt;<a href="clob_v2.md#0xdee9_clob_v2_TickLevel">TickLevel</a>&gt;(all_open_orders) && tick_price &lt;= price_limit) {
        ...
        <b>let</b> order_id = *<a href="../move-stdlib/option.md#0x1_option_borrow">option::borrow</a>(<a href="../haneul-framework/linked_table.md#0x2_linked_table_front">linked_table::front</a>(&tick_level.open_orders));
        ...
        <b>while</b> (!<a href="../haneul-framework/linked_table.md#0x2_linked_table_is_empty">linked_table::is_empty</a>(&tick_level.open_orders)) {
            ...
            <b>if</b> (maker_order.<a href="clob_v2.md#0xdee9_clob_v2_expire_timestamp">expire_timestamp</a> &lt;= current_timestamp || account_owner(account_cap) == maker_order.owner) {
                ...
                <b>let</b> quote_balance_filled = <a href="../haneul-framework/balance.md#0x2_balance_split">balance::split</a>(
    ...
    <b>while</b> (!is_empty&lt;<a href="clob_v2.md#0xdee9_clob_v2_TickLevel">TickLevel</a>&gt;(all_open_orders) && tick_price &lt;= price_limit) {
        ...
        <b>while</b> (!<a href="../haneul-framework/linked_table.md#0x2_linked_table_is_empty">linked_table::is_empty</a>(&tick_level.open_orders)) {
            ...
            <b>if</b> (maker_order.<a href="clob_v2.md#0xdee9_clob_v2_expire_timestamp">expire_timestamp</a> &lt;= current_timestamp || account_owner(account_cap) == maker_order.owner) {
                ...
                <b>let</b> taker_commission_balance = <a href="../haneul-framework/balance.md#0x2_balance_split">balance::split</a>(
                    &<b>mut</b> quote_balance_left,
                    taker_commission,
                );
                <a href="custodian.md#0xdee9_custodian_increase_user_available_balance">custodian::increase_user_available_balance</a>&lt;QuoteAsset&gt;(
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_match_ask">match_ask</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    // Base <a href="../haneul-framework/balance.md#0x2_balance">balance</a> received by taker, taking into account of taker commission.
    <b>let</b> quote_balance_filled = <a href="../haneul-framework/balance.md#0x2_balance_zero">balance::zero</a>&lt;QuoteAsset&gt;();
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_list_open_orders">list_open_orders</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>let</b> order_id = <a href="../haneul-framework/linked_table.md#0x2_linked_table_front">linked_table::front</a>(usr_open_order_ids);
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_get_level2_book_status">get_level2_book_status</a>(
    ...
    <b>let</b> depth = 0;
    <b>let</b> order_id = <a href="../haneul-framework/linked_table.md#0x2_linked_table_front">linked_table::front</a>(tick_open_orders);
    <b>let</b> order: &<a href="clob_v2.md#0xdee9_clob_v2_Order">Order</a>;
    <b>while</b> (!<a href="../move-stdlib/option.md#0x1_option_is_none">option::is_none</a>(order_id)) {
