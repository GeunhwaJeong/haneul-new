...
<b>use</b> <a href="../../../.././build/Haneul/docs/clock.md#0x2_clock">0x2::clock</a>;
...
<dt>
<code>client_id: u64</code>
</dt>
<dd>
 ID of client that placed the order
</dd>
<dt>
...
<dd>
 ID of client that canceled the order
</dd>
<dt>
<code>is_bid: bool</code>
</dt>
...
<dt>
<code>taker_client_id: u64</code>
</dt>
<dd>
 ID of client that filled the order
</dd>
<dt>
<code>maker_client_id: u64</code>
</dt>
<dd>
 ID of client that placed the order
</dd>
...
<dt>
<code>self_matching_prevention: u64</code>
</dt>
<dd>
...
<dt>
<code>open_orders: <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_LinkedTable">linked_table::LinkedTable</a>&lt;u64, <a href="clob_v2.md#0xdee9_clob_v2_Order">clob_v2::Order</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>usr_open_orders: <a href="../../../.././build/Haneul/docs/table.md#0x2_table_Table">table::Table</a>&lt;<b>address</b>, <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_LinkedTable">linked_table::LinkedTable</a>&lt;u64, u64&gt;&gt;</code>
</dt>
<dd>
...
<dt>
<code>creation_fee: <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../../../.././build/Haneul/docs/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>base_asset_trading_fees: <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;BaseAsset&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>quote_asset_trading_fees: <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;QuoteAsset&gt;</code>
</dt>
<dd>
...
<pre><code><b>const</b> <a href="clob_v2.md#0xdee9_clob_v2_REFERENCE_MAKER_REBATE_RATE">REFERENCE_MAKER_REBATE_RATE</a>: u64 = 2500000;
</code></pre>
...
<pre><code><b>const</b> <a href="clob_v2.md#0xdee9_clob_v2_REFERENCE_TAKER_FEE_RATE">REFERENCE_TAKER_FEE_RATE</a>: u64 = 5000000;
</code></pre>
...
<pre><code><b>const</b> <a href="clob_v2.md#0xdee9_clob_v2_PREVENT_SELF_MATCHING_DEFAULT">PREVENT_SELF_MATCHING_DEFAULT</a>: u64 = 0;
</code></pre>
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_destroy_empty_level">destroy_empty_level</a>(level: <a href="clob_v2.md#0xdee9_clob_v2_TickLevel">TickLevel</a>) {
    ...
    <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_destroy_empty">linked_table::destroy_empty</a>(orders);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_create_account">create_account</a>(ctx: &<b>mut</b> <a href="../../../.././build/Haneul/docs/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="custodian_v2.md#0xdee9_custodian_v2_AccountCap">custodian_v2::AccountCap</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_create_account">create_account</a>(ctx: &<b>mut</b> TxContext): AccountCap {
    mint_account_cap(sender(ctx), ctx)
}
</code></pre>
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_create_pool_">create_pool_</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>let</b> pool_uid = <a href="../../../.././build/Haneul/docs/object.md#0x2_object_new">object::new</a>(ctx);
    <b>let</b> pool_id = *<a href="../../../.././build/Haneul/docs/object.md#0x2_object_uid_as_inner">object::uid_as_inner</a>(&pool_uid);
    <a href="../../../.././build/Haneul/docs/transfer.md#0x2_transfer_share_object">transfer::share_object</a>(
        <a href="clob_v2.md#0xdee9_clob_v2_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt; {
            ...
            usr_open_orders: <a href="../../../.././build/Haneul/docs/table.md#0x2_table_new">table::new</a>(ctx),
            taker_fee_rate,
            maker_rebate_rate,
            tick_size,
            lot_size,
            ...
            creation_fee,
            base_asset_trading_fees: <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_zero">balance::zero</a>(),
            quote_asset_trading_fees: <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_zero">balance::zero</a>(),
        }
    );
    <a href="../../../.././build/Haneul/docs/event.md#0x2_event_emit">event::emit</a>(<a href="clob_v2.md#0xdee9_clob_v2_PoolCreated">PoolCreated</a> {
        pool_id,
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_create_pool">create_pool</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>assert</b>!(<a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_value">coin::value</a>(&creation_fee) == <a href="clob_v2.md#0xdee9_clob_v2_FEE_AMOUNT_FOR_CREATE_POOL">FEE_AMOUNT_FOR_CREATE_POOL</a>, <a href="clob_v2.md#0xdee9_clob_v2_EInvalidFee">EInvalidFee</a>);
    <a href="clob_v2.md#0xdee9_clob_v2_create_pool_">create_pool_</a>&lt;BaseAsset, QuoteAsset&gt;(
        ...
        tick_size,
        lot_size,
        <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_into_balance">coin::into_balance</a>(creation_fee),
        ctx
    )
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_deposit_base">deposit_base</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin">coin</a>: Coin&lt;BaseAsset&gt;,
    account_cap: &AccountCap
) {
    <b>assert</b>!(<a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_value">coin::value</a>(&<a href="../../../.././build/Haneul/docs/coin.md#0x2_coin">coin</a>) != 0, <a href="clob_v2.md#0xdee9_clob_v2_EInsufficientBaseCoin">EInsufficientBaseCoin</a>);
    <a href="custodian.md#0xdee9_custodian_increase_user_available_balance">custodian::increase_user_available_balance</a>(
        ...
        <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_into_balance">coin::into_balance</a>(<a href="../../../.././build/Haneul/docs/coin.md#0x2_coin">coin</a>)
    )
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_deposit_quote">deposit_quote</a>&lt;BaseAsset, QuoteAsset&gt;(pool: &<b>mut</b> <a href="clob_v2.md#0xdee9_clob_v2_Pool">clob_v2::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin">coin</a>: <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;QuoteAsset&gt;, account_cap: &<a href="custodian_v2.md#0xdee9_custodian_v2_AccountCap">custodian_v2::AccountCap</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_deposit_quote">deposit_quote</a>&lt;BaseAsset, QuoteAsset&gt;(
    pool: &<b>mut</b> <a href="clob_v2.md#0xdee9_clob_v2_Pool">Pool</a>&lt;BaseAsset, QuoteAsset&gt;,
    <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin">coin</a>: Coin&lt;QuoteAsset&gt;,
    account_cap: &AccountCap
) {
    <b>assert</b>!(<a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_value">coin::value</a>(&<a href="../../../.././build/Haneul/docs/coin.md#0x2_coin">coin</a>) != 0, <a href="clob_v2.md#0xdee9_clob_v2_EInsufficientQuoteCoin">EInsufficientQuoteCoin</a>);
    <a href="custodian.md#0xdee9_custodian_increase_user_available_balance">custodian::increase_user_available_balance</a>(
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_withdraw_base">withdraw_base</a>&lt;BaseAsset, QuoteAsset&gt;(pool: &<b>mut</b> <a href="clob_v2.md#0xdee9_clob_v2_Pool">clob_v2::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, quantity: u64, account_cap: &<a href="custodian_v2.md#0xdee9_custodian_v2_AccountCap">custodian_v2::AccountCap</a>, ctx: &<b>mut</b> <a href="../../../.././build/Haneul/docs/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;BaseAsset&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_withdraw_base">withdraw_base</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <a href="custodian.md#0xdee9_custodian_withdraw_asset">custodian::withdraw_asset</a>(&<b>mut</b> pool.base_custodian, quantity, account_owner(account_cap), ctx)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_withdraw_quote">withdraw_quote</a>&lt;BaseAsset, QuoteAsset&gt;(pool: &<b>mut</b> <a href="clob_v2.md#0xdee9_clob_v2_Pool">clob_v2::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, quantity: u64, account_cap: &<a href="custodian_v2.md#0xdee9_custodian_v2_AccountCap">custodian_v2::AccountCap</a>, ctx: &<b>mut</b> <a href="../../../.././build/Haneul/docs/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;QuoteAsset&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_withdraw_quote">withdraw_quote</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>assert</b>!(quantity &gt; 0, <a href="clob_v2.md#0xdee9_clob_v2_EInvalidQuantity">EInvalidQuantity</a>);
    <a href="custodian.md#0xdee9_custodian_withdraw_asset">custodian::withdraw_asset</a>(&<b>mut</b> pool.quote_custodian, quantity, account_owner(account_cap), ctx)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_swap_exact_base_for_quote">swap_exact_base_for_quote</a>&lt;BaseAsset, QuoteAsset&gt;(pool: &<b>mut</b> <a href="clob_v2.md#0xdee9_clob_v2_Pool">clob_v2::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, client_id: u64, account_cap: &<a href="custodian_v2.md#0xdee9_custodian_v2_AccountCap">custodian_v2::AccountCap</a>, quantity: u64, base_coin: <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;BaseAsset&gt;, quote_coin: <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;QuoteAsset&gt;, <a href="../../../.././build/Haneul/docs/clock.md#0x2_clock">clock</a>: &<a href="../../../.././build/Haneul/docs/clock.md#0x2_clock_Clock">clock::Clock</a>, ctx: &<b>mut</b> <a href="../../../.././build/Haneul/docs/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): (<a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;BaseAsset&gt;, <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;QuoteAsset&gt;, u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_swap_exact_base_for_quote">swap_exact_base_for_quote</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <a href="../../../.././build/Haneul/docs/clock.md#0x2_clock">clock</a>: &Clock,
    ctx: &<b>mut</b> TxContext,
): (Coin&lt;BaseAsset&gt;, Coin&lt;QuoteAsset&gt;, u64) {
    <b>assert</b>!(quantity &gt; 0, <a href="clob_v2.md#0xdee9_clob_v2_EInvalidQuantity">EInvalidQuantity</a>);
    <b>assert</b>!(<a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_value">coin::value</a>(&base_coin) &gt;= quantity, <a href="clob_v2.md#0xdee9_clob_v2_EInsufficientBaseCoin">EInsufficientBaseCoin</a>);
    <b>let</b> original_val = <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_value">coin::value</a>(&quote_coin);
    <b>let</b> (ret_base_coin, ret_quote_coin) = <a href="clob_v2.md#0xdee9_clob_v2_place_market_order">place_market_order</a>(
        ...
        base_coin,
        quote_coin,
        <a href="../../../.././build/Haneul/docs/clock.md#0x2_clock">clock</a>,
        ctx
    );
    <b>let</b> ret_val = <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_value">coin::value</a>(&ret_quote_coin);
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_swap_exact_quote_for_base">swap_exact_quote_for_base</a>&lt;BaseAsset, QuoteAsset&gt;(pool: &<b>mut</b> <a href="clob_v2.md#0xdee9_clob_v2_Pool">clob_v2::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, client_id: u64, account_cap: &<a href="custodian_v2.md#0xdee9_custodian_v2_AccountCap">custodian_v2::AccountCap</a>, quantity: u64, <a href="../../../.././build/Haneul/docs/clock.md#0x2_clock">clock</a>: &<a href="../../../.././build/Haneul/docs/clock.md#0x2_clock_Clock">clock::Clock</a>, quote_coin: <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;QuoteAsset&gt;, ctx: &<b>mut</b> <a href="../../../.././build/Haneul/docs/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): (<a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;BaseAsset&gt;, <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;QuoteAsset&gt;, u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_swap_exact_quote_for_base">swap_exact_quote_for_base</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>assert</b>!(quantity &gt; 0, <a href="clob_v2.md#0xdee9_clob_v2_EInvalidQuantity">EInvalidQuantity</a>);
    <b>assert</b>!(<a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_value">coin::value</a>(&quote_coin) &gt;= quantity, <a href="clob_v2.md#0xdee9_clob_v2_EInsufficientQuoteCoin">EInsufficientQuoteCoin</a>);
    <b>let</b> (base_asset_balance, quote_asset_balance) = <a href="clob_v2.md#0xdee9_clob_v2_match_bid_with_quote_quantity">match_bid_with_quote_quantity</a>(
        ...
        <a href="../../../.././build/Haneul/docs/clock.md#0x2_clock_timestamp_ms">clock::timestamp_ms</a>(<a href="../../../.././build/Haneul/docs/clock.md#0x2_clock">clock</a>),
        <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_into_balance">coin::into_balance</a>(quote_coin)
    );
    <b>let</b> val = <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_value">balance::value</a>(&base_asset_balance);
    (<a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_from_balance">coin::from_balance</a>(base_asset_balance, ctx), <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_from_balance">coin::from_balance</a>(quote_asset_balance, ctx), val)
}
</code></pre>
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_match_bid_with_quote_quantity">match_bid_with_quote_quantity</a>&lt;BaseAsset, QuoteAsset&gt;(pool: &<b>mut</b> <a href="clob_v2.md#0xdee9_clob_v2_Pool">clob_v2::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, account_cap: &<a href="custodian_v2.md#0xdee9_custodian_v2_AccountCap">custodian_v2::AccountCap</a>, client_id: u64, quantity: u64, price_limit: u64, current_timestamp: u64, quote_balance: <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;QuoteAsset&gt;): (<a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;BaseAsset&gt;, <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;QuoteAsset&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_match_bid_with_quote_quantity">match_bid_with_quote_quantity</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    // Base <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance">balance</a> received by taker, taking into account of taker commission.
    // Need <b>to</b> individually keep track of the remaining base quantity <b>to</b> be filled <b>to</b> avoid infinite <b>loop</b>.
    <b>let</b> pool_id = *<a href="../../../.././build/Haneul/docs/object.md#0x2_object_uid_as_inner">object::uid_as_inner</a>(&pool.id);
    <b>let</b> taker_quote_quantity_remaining = quantity;
    <b>let</b> base_balance_filled = <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_zero">balance::zero</a>&lt;BaseAsset&gt;();
    ...
    <b>while</b> (!is_empty&lt;<a href="clob_v2.md#0xdee9_clob_v2_TickLevel">TickLevel</a>&gt;(all_open_orders) && tick_price &lt;= price_limit) {
        ...
        <b>let</b> order_id = *<a href="_borrow">option::borrow</a>(<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_front">linked_table::front</a>(&tick_level.open_orders));

        <b>while</b> (!<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_is_empty">linked_table::is_empty</a>(&tick_level.open_orders)) {
            <b>let</b> maker_order = <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_borrow">linked_table::borrow</a>(&tick_level.open_orders, order_id);
            ...
            <b>if</b> (maker_order.expire_timestamp &lt;= current_timestamp) {
                ...
                <b>let</b> quote_balance_filled = <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_split">balance::split</a>(
                ...
                <a href="custodian.md#0xdee9_custodian_increase_user_available_balance">custodian::increase_user_available_balance</a>&lt;QuoteAsset&gt;(
                    &<b>mut</b> pool.quote_custodian,
                    maker_order.owner,
                    <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_split">balance::split</a>(
                ...
                <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> pool.quote_asset_trading_fees, quote_balance_filled);
                <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> base_balance_filled, locked_base_balance);

                <a href="clob_v2.md#0xdee9_clob_v2_emit_order_filled">emit_order_filled</a>&lt;BaseAsset, QuoteAsset&gt;(
                    *<a href="../../../.././build/Haneul/docs/object.md#0x2_object_uid_as_inner">object::uid_as_inner</a>(&pool.id),
                    client_id,
                    account_owner(account_cap),
                    maker_order,
                    filled_base_quantity,
            ...
            <b>if</b> (skip_order || maker_base_quantity == 0) {
                ...
                <b>let</b> maybe_order_id = <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_next">linked_table::next</a>(&tick_level.open_orders, order_id);
                <b>if</b> (!<a href="_is_none">option::is_none</a>(maybe_order_id)) {
                    order_id = *<a href="_borrow">option::borrow</a>(maybe_order_id);
                };
                <b>let</b> usr_open_order_ids = <a href="../../../.././build/Haneul/docs/table.md#0x2_table_borrow_mut">table::borrow_mut</a>(&<b>mut</b> pool.usr_open_orders, maker_order.owner);
                <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_remove">linked_table::remove</a>(usr_open_order_ids, old_order_id);
                <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_remove">linked_table::remove</a>(&<b>mut</b> tick_level.open_orders, old_order_id);
            } <b>else</b> {
                // Update the maker order.
                <b>let</b> maker_order_mut = <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_borrow_mut">linked_table::borrow_mut</a>(
        ...
        <b>if</b> (<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_is_empty">linked_table::is_empty</a>(&tick_level.open_orders)) {
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_match_bid">match_bid</a>&lt;BaseAsset, QuoteAsset&gt;(pool: &<b>mut</b> <a href="clob_v2.md#0xdee9_clob_v2_Pool">clob_v2::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, account_cap: &<a href="custodian_v2.md#0xdee9_custodian_v2_AccountCap">custodian_v2::AccountCap</a>, client_id: u64, quantity: u64, price_limit: u64, current_timestamp: u64, quote_balance: <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;QuoteAsset&gt;): (<a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;BaseAsset&gt;, <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;QuoteAsset&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_match_bid">match_bid</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>let</b> pool_id = *<a href="../../../.././build/Haneul/docs/object.md#0x2_object_uid_as_inner">object::uid_as_inner</a>(&pool.id);
    // Base <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance">balance</a> received by taker.
    // Need <b>to</b> individually keep track of the remaining base quantity <b>to</b> be filled <b>to</b> avoid infinite <b>loop</b>.
    ...
    <b>while</b> (!is_empty&lt;<a href="clob_v2.md#0xdee9_clob_v2_TickLevel">TickLevel</a>&gt;(all_open_orders) && tick_price &lt;= price_limit) {
        ...
        <b>while</b> (!<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_is_empty">linked_table::is_empty</a>(&tick_level.open_orders)) {
            ...
            <b>if</b> (maker_order.expire_timestamp &lt;= current_timestamp) {
                ...
                <b>let</b> taker_commission_balance = <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_split">balance::split</a>(
                    &<b>mut</b> quote_balance_left,
                    taker_commission,
                );
                <a href="custodian.md#0xdee9_custodian_increase_user_available_balance">custodian::increase_user_available_balance</a>&lt;QuoteAsset&gt;(
                ...
                <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> pool.quote_asset_trading_fees, taker_commission_balance);
                <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> base_balance_filled, locked_base_balance);
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_match_ask">match_ask</a>&lt;BaseAsset, QuoteAsset&gt;(pool: &<b>mut</b> <a href="clob_v2.md#0xdee9_clob_v2_Pool">clob_v2::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, account_cap: &<a href="custodian_v2.md#0xdee9_custodian_v2_AccountCap">custodian_v2::AccountCap</a>, client_id: u64, price_limit: u64, current_timestamp: u64, base_balance: <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;BaseAsset&gt;): (<a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;BaseAsset&gt;, <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;QuoteAsset&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_match_ask">match_ask</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    // Base <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance">balance</a> received by taker, taking into account of taker commission.
    <b>let</b> quote_balance_filled = <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_zero">balance::zero</a>&lt;QuoteAsset&gt;();
    ...
    <b>while</b> (!is_empty&lt;<a href="clob_v2.md#0xdee9_clob_v2_TickLevel">TickLevel</a>&gt;(all_open_orders) && tick_price &gt;= price_limit) {
        ...
        <b>while</b> (!<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_is_empty">linked_table::is_empty</a>(&tick_level.open_orders)) {
            ...
            <b>if</b> (maker_order.expire_timestamp &lt;= current_timestamp) {
                ...
                <b>let</b> taker_base_quantity_remaining = <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_value">balance::value</a>(&base_balance_left);
                <b>let</b> filled_base_quantity =
                    <b>if</b> (taker_base_quantity_remaining &gt;= maker_base_quantity) { maker_base_quantity }
                    <b>else</b> { taker_base_quantity_remaining };
                ...
                <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> pool.quote_asset_trading_fees, taker_commission_balance);
                <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> quote_balance_filled, locked_quote_balance);
            ...
            <b>if</b> (<a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_value">balance::value</a>(&base_balance_left) == 0) {
                <b>break</b>
            };
        };
        <b>if</b> (<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_is_empty">linked_table::is_empty</a>(&tick_level.open_orders)) {
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_place_market_order">place_market_order</a>&lt;BaseAsset, QuoteAsset&gt;(pool: &<b>mut</b> <a href="clob_v2.md#0xdee9_clob_v2_Pool">clob_v2::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, account_cap: &<a href="custodian_v2.md#0xdee9_custodian_v2_AccountCap">custodian_v2::AccountCap</a>, client_id: u64, quantity: u64, is_bid: bool, base_coin: <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;BaseAsset&gt;, quote_coin: <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;QuoteAsset&gt;, <a href="../../../.././build/Haneul/docs/clock.md#0x2_clock">clock</a>: &<a href="../../../.././build/Haneul/docs/clock.md#0x2_clock_Clock">clock::Clock</a>, ctx: &<b>mut</b> <a href="../../../.././build/Haneul/docs/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): (<a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;BaseAsset&gt;, <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;QuoteAsset&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_place_market_order">place_market_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>if</b> (is_bid) {
        ...
        join(
            &<b>mut</b> base_coin,
            <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_from_balance">coin::from_balance</a>(base_balance_filled, ctx),
        );
        quote_coin = <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_from_balance">coin::from_balance</a>(quote_balance_left, ctx);
    } <b>else</b> {
        <b>assert</b>!(quantity &lt;= <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_value">coin::value</a>(&base_coin), <a href="clob_v2.md#0xdee9_clob_v2_EInsufficientBaseCoin">EInsufficientBaseCoin</a>);
        <b>let</b> (base_balance_left, quote_balance_filled) = <a href="clob_v2.md#0xdee9_clob_v2_match_ask">match_ask</a>(
            ...
            <a href="../../../.././build/Haneul/docs/clock.md#0x2_clock_timestamp_ms">clock::timestamp_ms</a>(<a href="../../../.././build/Haneul/docs/clock.md#0x2_clock">clock</a>),
            <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_into_balance">coin::into_balance</a>(base_coin),
        );
        base_coin = <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_from_balance">coin::from_balance</a>(base_balance_left, ctx);
        join(
            &<b>mut</b> quote_coin,
            <a href="../../../.././build/Haneul/docs/coin.md#0x2_coin_from_balance">coin::from_balance</a>(quote_balance_filled, ctx),
        );
    };
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_inject_limit_order">inject_limit_order</a>&lt;BaseAsset, QuoteAsset&gt;(pool: &<b>mut</b> <a href="clob_v2.md#0xdee9_clob_v2_Pool">clob_v2::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, client_id: u64, price: u64, original_quantity: u64, quantity: u64, is_bid: bool, self_matching_prevention: u64, expire_timestamp: u64, account_cap: &<a href="custodian_v2.md#0xdee9_custodian_v2_AccountCap">custodian_v2::AccountCap</a>, ctx: &<b>mut</b> <a href="../../../.././build/Haneul/docs/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_inject_limit_order">inject_limit_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>if</b> (is_bid) {
        ...
        <a href="custodian.md#0xdee9_custodian_lock_balance">custodian::lock_balance</a>&lt;QuoteAsset&gt;(&<b>mut</b> pool.quote_custodian, owner, quote_quantity);
        order_id = pool.next_bid_order_id;
        pool.next_bid_order_id = pool.next_bid_order_id + 1;
        open_orders = &<b>mut</b> pool.bids;
    } <b>else</b> {
        <a href="custodian.md#0xdee9_custodian_lock_balance">custodian::lock_balance</a>&lt;BaseAsset&gt;(&<b>mut</b> pool.base_custodian, owner, quantity);
    ...
    <b>if</b> (!tick_exists) {
        tick_index = insert_leaf(
            ...
            <a href="clob_v2.md#0xdee9_clob_v2_TickLevel">TickLevel</a> {
                price,
                open_orders: <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_new">linked_table::new</a>(ctx),
            });
    };

    <b>let</b> tick_level = borrow_mut_leaf_by_index(open_orders, tick_index);
    <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_push_back">linked_table::push_back</a>(&<b>mut</b> tick_level.open_orders, order_id, order);
    <a href="../../../.././build/Haneul/docs/event.md#0x2_event_emit">event::emit</a>(<a href="clob_v2.md#0xdee9_clob_v2_OrderPlaced">OrderPlaced</a>&lt;BaseAsset, QuoteAsset&gt; {
        pool_id: *<a href="../../../.././build/Haneul/docs/object.md#0x2_object_uid_as_inner">object::uid_as_inner</a>(&pool.id),
        order_id,
        client_id,
        is_bid,
        owner,
    ...
    <b>if</b> (!contains(&pool.usr_open_orders, owner)) {
        add(&<b>mut</b> pool.usr_open_orders, owner, <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_new">linked_table::new</a>(ctx));
    };
    <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_push_back">linked_table::push_back</a>(borrow_mut(&<b>mut</b> pool.usr_open_orders, owner), order_id, price);
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_place_limit_order">place_limit_order</a>&lt;BaseAsset, QuoteAsset&gt;(pool: &<b>mut</b> <a href="clob_v2.md#0xdee9_clob_v2_Pool">clob_v2::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, client_id: u64, price: u64, quantity: u64, self_matching_prevention: u64, is_bid: bool, expire_timestamp: u64, restriction: u8, <a href="../../../.././build/Haneul/docs/clock.md#0x2_clock">clock</a>: &<a href="../../../.././build/Haneul/docs/clock.md#0x2_clock_Clock">clock::Clock</a>, account_cap: &<a href="custodian_v2.md#0xdee9_custodian_v2_AccountCap">custodian_v2::AccountCap</a>, ctx: &<b>mut</b> <a href="../../../.././build/Haneul/docs/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): (u64, u64, bool, u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_place_limit_order">place_limit_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>assert</b>!(quantity % pool.lot_size == 0, <a href="clob_v2.md#0xdee9_clob_v2_EInvalidQuantity">EInvalidQuantity</a>);
    <b>assert</b>!(expire_timestamp &gt; <a href="../../../.././build/Haneul/docs/clock.md#0x2_clock_timestamp_ms">clock::timestamp_ms</a>(<a href="../../../.././build/Haneul/docs/clock.md#0x2_clock">clock</a>), <a href="clob_v2.md#0xdee9_clob_v2_EInvalidExpireTimestamp">EInvalidExpireTimestamp</a>);
    ...
    <b>if</b> (is_bid) {
        ...
        base_quantity_filled = <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_value">balance::value</a>(&base_balance_filled);
        quote_quantity_filled = quote_quantity_original - <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_value">balance::value</a>(&quote_balance_left);
        ...
        base_quantity_filled = quantity - <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_value">balance::value</a>(&base_balance_left);
        quote_quantity_filled = <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_value">balance::value</a>(&quote_balance_filled);
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_emit_order_canceled">emit_order_canceled</a>&lt;BaseAsset, QuoteAsset&gt;(pool_id: <a href="../../../.././build/Haneul/docs/object.md#0x2_object_ID">object::ID</a>, order: &<a href="clob_v2.md#0xdee9_clob_v2_Order">clob_v2::Order</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_emit_order_canceled">emit_order_canceled</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <a href="../../../.././build/Haneul/docs/event.md#0x2_event_emit">event::emit</a>(<a href="clob_v2.md#0xdee9_clob_v2_OrderCanceled">OrderCanceled</a>&lt;BaseAsset, QuoteAsset&gt; {
        pool_id,
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_emit_order_filled">emit_order_filled</a>&lt;BaseAsset, QuoteAsset&gt;(pool_id: <a href="../../../.././build/Haneul/docs/object.md#0x2_object_ID">object::ID</a>, taker_client_id: u64, taker_address: <b>address</b>, order: &<a href="clob_v2.md#0xdee9_clob_v2_Order">clob_v2::Order</a>, base_asset_quantity_filled: u64, taker_commission: u64, maker_rebates: u64)
</code></pre>
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_emit_order_filled">emit_order_filled</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <a href="../../../.././build/Haneul/docs/event.md#0x2_event_emit">event::emit</a>(<a href="clob_v2.md#0xdee9_clob_v2_OrderFilled">OrderFilled</a>&lt;BaseAsset, QuoteAsset&gt; {
        pool_id,
        order_id: order.order_id,
        taker_client_id,
        taker_address,
        maker_client_id: order.client_id,
        is_bid: order.is_bid,
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_cancel_order">cancel_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>assert</b>!(<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_contains">linked_table::contains</a>(usr_open_orders, order_id), <a href="clob_v2.md#0xdee9_clob_v2_EInvalidOrderId">EInvalidOrderId</a>);
    <b>let</b> tick_price = *<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_borrow">linked_table::borrow</a>(usr_open_orders, order_id);
    ...
    <a href="clob_v2.md#0xdee9_clob_v2_emit_order_canceled">emit_order_canceled</a>&lt;BaseAsset, QuoteAsset&gt;(*<a href="../../../.././build/Haneul/docs/object.md#0x2_object_uid_as_inner">object::uid_as_inner</a>(&pool.id), &order);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_remove_order">remove_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_remove">linked_table::remove</a>(usr_open_orders, order_id);
    <b>let</b> tick_level = borrow_leaf_by_index(open_orders, tick_index);
    <b>assert</b>!(<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_contains">linked_table::contains</a>(&tick_level.open_orders, order_id), <a href="clob_v2.md#0xdee9_clob_v2_EInvalidOrderId">EInvalidOrderId</a>);
    <b>let</b> mut_tick_level = borrow_mut_leaf_by_index(open_orders, tick_index);
    <b>let</b> order = <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_remove">linked_table::remove</a>(&<b>mut</b> mut_tick_level.open_orders, order_id);
    <b>assert</b>!(order.owner == owner, <a href="clob_v2.md#0xdee9_clob_v2_EUnauthorizedCancel">EUnauthorizedCancel</a>);
    <b>if</b> (<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_is_empty">linked_table::is_empty</a>(&mut_tick_level.open_orders)) {
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_cancel_all_orders">cancel_all_orders</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>let</b> owner = account_owner(account_cap);
    <b>assert</b>!(contains(&pool.usr_open_orders, owner), <a href="clob_v2.md#0xdee9_clob_v2_EInvalidUser">EInvalidUser</a>);
    <b>let</b> usr_open_order_ids = <a href="../../../.././build/Haneul/docs/table.md#0x2_table_borrow_mut">table::borrow_mut</a>(&<b>mut</b> pool.usr_open_orders, owner);
    <b>while</b> (!<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_is_empty">linked_table::is_empty</a>(usr_open_order_ids)) {
        <b>let</b> order_id = *<a href="_borrow">option::borrow</a>(<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_back">linked_table::back</a>(usr_open_order_ids));
        <b>let</b> order_price = *<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_borrow">linked_table::borrow</a>(usr_open_order_ids, order_id);
        <b>let</b> is_bid = <a href="clob_v2.md#0xdee9_clob_v2_order_is_bid">order_is_bid</a>(order_id);
        <b>let</b> open_orders =
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_batch_cancel_order">batch_cancel_order</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>while</b> (i_order &lt; n_order) {
        ...
        <b>assert</b>!(<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_contains">linked_table::contains</a>(usr_open_orders, order_id), <a href="clob_v2.md#0xdee9_clob_v2_EInvalidOrderId">EInvalidOrderId</a>);
        <b>let</b> new_tick_price = *<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_borrow">linked_table::borrow</a>(usr_open_orders, order_id);
        <b>let</b> is_bid = <a href="clob_v2.md#0xdee9_clob_v2_order_is_bid">order_is_bid</a>(order_id);
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_list_open_orders">list_open_orders</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>let</b> owner = account_owner(account_cap);
    <b>let</b> usr_open_order_ids = <a href="../../../.././build/Haneul/docs/table.md#0x2_table_borrow">table::borrow</a>(&pool.usr_open_orders, owner);
    <b>let</b> open_orders = <a href="_empty">vector::empty</a>&lt;<a href="clob_v2.md#0xdee9_clob_v2_Order">Order</a>&gt;();
    <b>let</b> order_id = <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_front">linked_table::front</a>(usr_open_order_ids);
    <b>while</b> (!<a href="_is_none">option::is_none</a>(order_id)) {
        <b>let</b> order_price = *<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_borrow">linked_table::borrow</a>(usr_open_order_ids, *<a href="_borrow">option::borrow</a>(order_id));
        <b>let</b> tick_level =
        ...
        <b>let</b> order = <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_borrow">linked_table::borrow</a>(&tick_level.open_orders, *<a href="_borrow">option::borrow</a>(order_id));
        ...
        order_id = <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_next">linked_table::next</a>(usr_open_order_ids, *<a href="_borrow">option::borrow</a>(order_id));
    };
    open_orders
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_get_market_price">get_market_price</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>let</b> bid_price;
    <b>let</b> ask_price;
    <b>if</b> (!<a href="critbit.md#0xdee9_critbit_is_empty">critbit::is_empty</a>(&pool.bids)) {
        <b>let</b> (result, _) = <a href="critbit.md#0xdee9_critbit_max_leaf">critbit::max_leaf</a>(&pool.bids);
        bid_price = <a href="_some">option::some</a>&lt;u64&gt;(result);
    } <b>else</b> {
        bid_price = <a href="_none">option::none</a>&lt;u64&gt;();
    };
    <b>if</b> (!<a href="critbit.md#0xdee9_critbit_is_empty">critbit::is_empty</a>(&pool.asks)) {
        <b>let</b> (result, _) = <a href="critbit.md#0xdee9_critbit_min_leaf">critbit::min_leaf</a>(&pool.asks);
        ask_price = <a href="_some">option::some</a>&lt;u64&gt;(result);
    } <b>else</b> {
        ask_price = <a href="_none">option::none</a>&lt;u64&gt;();
    };
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_get_level2_book_status_bid_side">get_level2_book_status_bid_side</a>&lt;BaseAsset, QuoteAsset&gt;(pool: &<a href="clob_v2.md#0xdee9_clob_v2_Pool">clob_v2::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, price_low: u64, price_high: u64, <a href="../../../.././build/Haneul/docs/clock.md#0x2_clock">clock</a>: &<a href="../../../.././build/Haneul/docs/clock.md#0x2_clock_Clock">clock::Clock</a>): (<a href="">vector</a>&lt;u64&gt;, <a href="">vector</a>&lt;u64&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_get_level2_book_status_ask_side">get_level2_book_status_ask_side</a>&lt;BaseAsset, QuoteAsset&gt;(pool: &<a href="clob_v2.md#0xdee9_clob_v2_Pool">clob_v2::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, price_low: u64, price_high: u64, <a href="../../../.././build/Haneul/docs/clock.md#0x2_clock">clock</a>: &<a href="../../../.././build/Haneul/docs/clock.md#0x2_clock_Clock">clock::Clock</a>): (<a href="">vector</a>&lt;u64&gt;, <a href="">vector</a>&lt;u64&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_get_level2_book_status">get_level2_book_status</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>let</b> depth = 0;
    <b>let</b> order_id = <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_front">linked_table::front</a>(tick_open_orders);
    <b>let</b> order: &<a href="clob_v2.md#0xdee9_clob_v2_Order">Order</a>;
    <b>while</b> (!<a href="_is_none">option::is_none</a>(order_id)) {
        order = <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_borrow">linked_table::borrow</a>(tick_open_orders, *<a href="_borrow">option::borrow</a>(order_id));
        <b>if</b> (order.expire_timestamp &gt; time_stamp) depth = depth + order.quantity;
        order_id = <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_next">linked_table::next</a>(tick_open_orders, *<a href="_borrow">option::borrow</a>(order_id));
    };
    depth
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="clob_v2.md#0xdee9_clob_v2_get_order_status">get_order_status</a>&lt;BaseAsset, QuoteAsset&gt;(
    ...
    <b>let</b> owner = account_owner(account_cap);
    <b>assert</b>!(<a href="../../../.././build/Haneul/docs/table.md#0x2_table_contains">table::contains</a>(&pool.usr_open_orders, owner), <a href="clob_v2.md#0xdee9_clob_v2_EInvalidUser">EInvalidUser</a>);
    <b>let</b> usr_open_order_ids = <a href="../../../.././build/Haneul/docs/table.md#0x2_table_borrow">table::borrow</a>(&pool.usr_open_orders, owner);
    <b>assert</b>!(<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_contains">linked_table::contains</a>(usr_open_order_ids, order_id), <a href="clob_v2.md#0xdee9_clob_v2_EInvalidOrderId">EInvalidOrderId</a>);
    <b>let</b> order_price = *<a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_borrow">linked_table::borrow</a>(usr_open_order_ids, order_id);
    <b>let</b> open_orders =
    ...
    <b>let</b> tick_open_orders = &tick_level.open_orders;
    <b>let</b> order = <a href="../../../.././build/Haneul/docs/linked_table.md#0x2_linked_table_borrow">linked_table::borrow</a>(tick_open_orders, order_id);
    order
}
</code></pre>
