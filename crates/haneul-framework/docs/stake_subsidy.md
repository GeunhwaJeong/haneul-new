...
<pre><code><b>use</b> <a href="../../../.././build/Haneul/docs/bag.md#0x2_bag">0x2::bag</a>;
...
<dl>
<dt>
<code><a href="../../../.././build/Haneul/docs/balance.md#0x2_balance">balance</a>: <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../../../.././build/Haneul/docs/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake_subsidy.md#0x3_stake_subsidy_create">create</a>(
    <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance">balance</a>: Balance&lt;HANEUL&gt;,
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake_subsidy.md#0x3_stake_subsidy_advance_epoch">advance_epoch</a>(self: &<b>mut</b> <a href="stake_subsidy.md#0x3_stake_subsidy_StakeSubsidy">stake_subsidy::StakeSubsidy</a>): <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="../../../.././build/Haneul/docs/haneul.md#0x2_haneul_HANEUL">haneul::HANEUL</a>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake_subsidy.md#0x3_stake_subsidy_advance_epoch">advance_epoch</a>(self: &<b>mut</b> <a href="stake_subsidy.md#0x3_stake_subsidy_StakeSubsidy">StakeSubsidy</a>): Balance&lt;HANEUL&gt; {
    // Take the minimum of the reward amount and the remaining <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance">balance</a> in
    // order <b>to</b> ensure we don't overdraft the remaining stake subsidy
    // <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance">balance</a>
    <b>let</b> to_withdraw = <a href="../../../.././build/Haneul/docs/math.md#0x2_math_min">math::min</a>(self.current_distribution_amount, <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_value">balance::value</a>(&self.<a href="../../../.././build/Haneul/docs/balance.md#0x2_balance">balance</a>));

    // Drawn down the subsidy for this epoch.
    <b>let</b> <a href="stake_subsidy.md#0x3_stake_subsidy">stake_subsidy</a> = <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> self.<a href="../../../.././build/Haneul/docs/balance.md#0x2_balance">balance</a>, to_withdraw);
...
<pre><code><b>public</b> <b>fun</b> <a href="stake_subsidy.md#0x3_stake_subsidy_current_epoch_subsidy_amount">current_epoch_subsidy_amount</a>(self: &<a href="stake_subsidy.md#0x3_stake_subsidy_StakeSubsidy">StakeSubsidy</a>): u64 {
    <a href="../../../.././build/Haneul/docs/math.md#0x2_math_min">math::min</a>(self.current_distribution_amount, <a href="../../../.././build/Haneul/docs/balance.md#0x2_balance_value">balance::value</a>(&self.<a href="../../../.././build/Haneul/docs/balance.md#0x2_balance">balance</a>))
}
</code></pre>
