...
Similar to <code>haneul::dynamic_field</code>, this module allows for the access of dynamic fields. But
unlike, <code>haneul::dynamic_field</code> the values bound to these dynamic fields _must_ be objects
