...
<dt>
<code>sequence_nums: <a href="../haneul/vec_map.md#haneul_vec_map_VecMap">haneul::vec_map::VecMap</a>&lt;u8, u64&gt;</code>
</dt>
<dd>
</dd>
<dt>
...
<dt>
<code>token_transfer_records: <a href="../haneul/linked_table.md#haneul_linked_table_LinkedTable">haneul::linked_table::LinkedTable</a>&lt;<a href="../bridge/message.md#bridge_message_BridgeMessageKey">bridge::message::BridgeMessageKey</a>, <a href="../bridge/bridge.md#bridge_bridge_BridgeRecord">bridge::bridge::BridgeRecord</a>&gt;</code>
</dt>
<dd>
</dd>
<dt>
...
<a name="bridge_bridge_EInvariantHaneulInitializedTokenTransferShouldNotBeClaimed"></a>



<pre><code><b>const</b> <a href="../bridge/bridge.md#bridge_bridge_EInvariantHaneulInitializedTokenTransferShouldNotBeClaimed">EInvariantHaneulInitializedTokenTransferShouldNotBeClaimed</a>: u64 = 10;
</code></pre>
...
<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_create">create</a>(id: <a href="../haneul/object.md#haneul_object_UID">haneul::object::UID</a>, chain_id: u8, ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_init_bridge_committee">init_bridge_committee</a>(<a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_Bridge">bridge::bridge::Bridge</a>, active_validator_voting_power: <a href="../haneul/vec_map.md#haneul_vec_map_VecMap">haneul::vec_map::VecMap</a>&lt;<b>address</b>, u64&gt;, min_stake_participation_percentage: u64, ctx: &<a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_committee_registration">committee_registration</a>(
    <a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_Bridge">Bridge</a>,
    system_state: &<b>mut</b> HaneulSystemState,
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_register_foreign_token">register_foreign_token</a>&lt;T&gt;(<a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_Bridge">bridge::bridge::Bridge</a>, tc: <a href="../haneul/coin.md#haneul_coin_TreasuryCap">haneul::coin::TreasuryCap</a>&lt;T&gt;, uc: <a href="../haneul/package.md#haneul_package_UpgradeCap">haneul::package::UpgradeCap</a>, metadata: &<a href="../haneul/coin.md#haneul_coin_CoinMetadata">haneul::coin::CoinMetadata</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_register_foreign_token">register_foreign_token</a>&lt;T&gt;(
    ...
    <a href="../bridge/bridge.md#bridge_bridge_load_inner_mut">load_inner_mut</a>(<a href="../bridge/bridge.md#bridge_bridge">bridge</a>).<a href="../bridge/treasury.md#bridge_treasury">treasury</a>.<a href="../bridge/bridge.md#bridge_bridge_register_foreign_token">register_foreign_token</a>&lt;T&gt;(tc, uc, metadata)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_send_token">send_token</a>&lt;T&gt;(<a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_Bridge">bridge::bridge::Bridge</a>, target_chain: u8, target_address: vector&lt;u8&gt;, token: <a href="../haneul/coin.md#haneul_coin_Coin">haneul::coin::Coin</a>&lt;T&gt;, ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>)
</code></pre>
...
<a name="bridge_bridge_send_token_v2"></a>

## Function `send_token_v2`



<pre><code><b>public</b> <b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_send_token_v2">send_token_v2</a>&lt;T&gt;(<a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_Bridge">bridge::bridge::Bridge</a>, target_chain: u8, target_address: vector&lt;u8&gt;, token: <a href="../haneul/coin.md#haneul_coin_Coin">haneul::coin::Coin</a>&lt;T&gt;, clock: &<a href="../haneul/clock.md#haneul_clock_Clock">haneul::clock::Clock</a>, ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_send_token_v2">send_token_v2</a>&lt;T&gt;(
    <a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_Bridge">Bridge</a>,
    target_chain: u8,
    target_address: vector&lt;u8&gt;,
    token: Coin&lt;T&gt;,
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_approve_token_transfer">approve_token_transfer</a>(
    ...
    <b>assert</b>!(
        <a href="../bridge/message.md#bridge_message">message</a>.message_version() &lt;= <a href="../bridge/message.md#bridge_message_token_transfer_message_version">message::token_transfer_message_version</a>(),
        <a href="../bridge/bridge.md#bridge_bridge_EUnexpectedMessageVersion">EUnexpectedMessageVersion</a>,
    );
    <b>let</b> token_payload = <b>if</b> (<a href="../bridge/message.md#bridge_message">message</a>.message_version() == 2) {
        <a href="../bridge/message.md#bridge_message">message</a>.extract_token_bridge_payload_v2().to_token_payload_v1()
    } <b>else</b> {
        <a href="../bridge/message.md#bridge_message">message</a>.extract_token_bridge_payload()
    };
    ...
    // retrieve pending <a href="../bridge/message.md#bridge_message">message</a> <b>if</b> source chain is Haneul, the initial <a href="../bridge/message.md#bridge_message">message</a>
    // must exist on chain
    <b>if</b> (<a href="../bridge/message.md#bridge_message">message</a>.source_chain() == inner.chain_id) {
        ...
        <b>assert</b>!(!record.claimed, <a href="../bridge/bridge.md#bridge_bridge_EInvariantHaneulInitializedTokenTransferShouldNotBeClaimed">EInvariantHaneulInitializedTokenTransferShouldNotBeClaimed</a>);
        ...
        <b>if</b> (record.verified_signatures.is_some()) {
            event::emit(<a href="../bridge/bridge.md#bridge_bridge_TokenTransferAlreadyApproved">TokenTransferAlreadyApproved</a> { message_key });
            <b>return</b>
        };
        // Store approval
    ...
    event::emit(<a href="../bridge/bridge.md#bridge_bridge_TokenTransferApproved">TokenTransferApproved</a> { message_key });
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_claim_token">claim_token</a>&lt;T&gt;(<a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_Bridge">bridge::bridge::Bridge</a>, clock: &<a href="../haneul/clock.md#haneul_clock_Clock">haneul::clock::Clock</a>, source_chain: u8, bridge_seq_num: u64, ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>): <a href="../haneul/coin.md#haneul_coin_Coin">haneul::coin::Coin</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_get_token_transfer_action_status">get_token_transfer_action_status</a>(<a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<a href="../bridge/bridge.md#bridge_bridge_Bridge">Bridge</a>, source_chain: u8, bridge_seq_num: u64): u8 {
...
<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_load_inner">load_inner</a>(<a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<a href="../bridge/bridge.md#bridge_bridge_Bridge">Bridge</a>): &<a href="../bridge/bridge.md#bridge_bridge_BridgeInner">BridgeInner</a> {
...
<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_claim_token_internal">claim_token_internal</a>&lt;T&gt;(<a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_Bridge">bridge::bridge::Bridge</a>, clock: &<a href="../haneul/clock.md#haneul_clock_Clock">haneul::clock::Clock</a>, source_chain: u8, bridge_seq_num: u64, ctx: &<b>mut</b> <a href="../haneul/tx_context.md#haneul_tx_context_TxContext">haneul::tx_context::TxContext</a>): (<a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;<a href="../haneul/coin.md#haneul_coin_Coin">haneul::coin::Coin</a>&lt;T&gt;&gt;, <b>address</b>)
</code></pre>
...
<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_claim_token_internal">claim_token_internal</a>&lt;T&gt;(
    ...
    <b>assert</b>!(&record.<a href="../bridge/message.md#bridge_message">message</a>.message_type() == <a href="../bridge/message_types.md#bridge_message_types_token">message_types::token</a>(), <a href="../bridge/bridge.md#bridge_bridge_EUnexpectedMessageType">EUnexpectedMessageType</a>);
    // Ensure it's signed
    ...
    <b>if</b> (record.<a href="../bridge/message.md#bridge_message">message</a>.message_version() == 2) {
        <b>let</b> token_payload_v2 = record.<a href="../bridge/message.md#bridge_message">message</a>.extract_token_bridge_payload_v2();
        <b>let</b> timestamp = token_payload_v2.timestamp_ms();
        // <b>if</b> more than 48 hours have passed since deposit, bypass the <a href="../bridge/limiter.md#bridge_limiter">limiter</a>
        // (the <a href="../bridge/limiter.md#bridge_limiter">limiter</a> exists to give time to respond to bugs)
        bypass_limiter = clock.timestamp_ms() &gt; timestamp + 48 * 3600000;
        token_payload = token_payload_v2.to_token_payload_v1();
    } <b>else</b> {
        token_payload = record.<a href="../bridge/message.md#bridge_message">message</a>.extract_token_bridge_payload();
    };
    // get owner <b>address</b>
    <b>let</b> owner = address::from_bytes(token_payload.token_target_address());
    // If already claimed, exit early
    <b>if</b> (record.claimed) {
        event::emit(<a href="../bridge/bridge.md#bridge_bridge_TokenTransferAlreadyClaimed">TokenTransferAlreadyClaimed</a> { message_key: key });
...
<a name="bridge_bridge_send_token_internal"></a>

## Function `send_token_internal`



<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_send_token_internal">send_token_internal</a>&lt;T&gt;(inner: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_BridgeInner">bridge::bridge::BridgeInner</a>, target_chain: u8, token: <a href="../haneul/coin.md#haneul_coin_Coin">haneul::coin::Coin</a>&lt;T&gt;, <a href="../bridge/message.md#bridge_message">message</a>: <a href="../bridge/message.md#bridge_message_BridgeMessage">bridge::message::BridgeMessage</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_send_token_internal">send_token_internal</a>&lt;T&gt;(
...
<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_execute_emergency_op">execute_emergency_op</a>(inner: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_BridgeInner">BridgeInner</a>, payload: EmergencyOp) {
    ...
    <b>if</b> (op == <a href="../bridge/message.md#bridge_message_emergency_op_pause">message::emergency_op_pause</a>()) {
        ...
        event::emit(<a href="../bridge/bridge.md#bridge_bridge_EmergencyOpEvent">EmergencyOpEvent</a> { frozen: <b>true</b> });
        ...
        event::emit(<a href="../bridge/bridge.md#bridge_bridge_EmergencyOpEvent">EmergencyOpEvent</a> { frozen: <b>false</b> });
    } <b>else</b> {
...
<a name="bridge_bridge_execute_add_tokens_on_haneul"></a>

## Function `execute_add_tokens_on_haneul`



<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_execute_add_tokens_on_haneul">execute_add_tokens_on_haneul</a>(inner: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_BridgeInner">bridge::bridge::BridgeInner</a>, payload: <a href="../bridge/message.md#bridge_message_AddTokenOnHaneul">bridge::message::AddTokenOnHaneul</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_execute_add_tokens_on_haneul">execute_add_tokens_on_haneul</a>(inner: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_BridgeInner">BridgeInner</a>, payload: AddTokenOnHaneul) {
