...
-  [Struct `AddTokenOnHaneul`](#0xb_message_AddTokenOnHaneul)
...
-  [Function `extract_add_tokens_on_haneul`](#0xb_message_extract_add_tokens_on_haneul)
...
-  [Function `create_add_tokens_on_haneul_message`](#0xb_message_create_add_tokens_on_haneul_message)
...
<b>use</b> <a href="../haneul-framework/bcs.md#0x2_bcs">0x2::bcs</a>;
...
<a name="0xb_message_AddTokenOnHaneul"></a>

## Struct `AddTokenOnHaneul`



<pre><code><b>struct</b> <a href="message.md#0xb_message_AddTokenOnHaneul">AddTokenOnHaneul</a> <b>has</b> drop
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_extract_token_bridge_payload">extract_token_bridge_payload</a>(<a href="message.md#0xb_message">message</a>: &<a href="message.md#0xb_message_BridgeMessage">BridgeMessage</a>): <a href="message.md#0xb_message_TokenTransferPayload">TokenTransferPayload</a> {
    <b>let</b> <b>mut</b> <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a> = <a href="../haneul-framework/bcs.md#0x2_bcs_new">bcs::new</a>(<a href="message.md#0xb_message">message</a>.payload);
    <b>let</b> sender_address = <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.peel_vec_u8();
    <b>let</b> target_chain = <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.peel_u8();
    <b>let</b> target_address = <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.peel_vec_u8();
    <b>let</b> token_type = <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.peel_u8();
    <b>let</b> amount = <a href="message.md#0xb_message_peel_u64_be">peel_u64_be</a>(&<b>mut</b> <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>);

    <a href="chain_ids.md#0xb_chain_ids_assert_valid_chain_id">chain_ids::assert_valid_chain_id</a>(target_chain);
    <b>assert</b>!(<a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.into_remainder_bytes().is_empty(), <a href="message.md#0xb_message_ETrailingBytes">ETrailingBytes</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_extract_blocklist_payload">extract_blocklist_payload</a>(<a href="message.md#0xb_message">message</a>: &<a href="message.md#0xb_message_BridgeMessage">BridgeMessage</a>): <a href="message.md#0xb_message_Blocklist">Blocklist</a> {
    ...
    <b>let</b> <b>mut</b> <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a> = <a href="../haneul-framework/bcs.md#0x2_bcs_new">bcs::new</a>(<a href="message.md#0xb_message">message</a>.payload);
    <b>let</b> blocklist_type = <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.peel_u8();
    <b>let</b> <b>mut</b> address_count = <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.peel_u8();
    ...
    <b>while</b> (address_count &gt; 0) {
        ...
        <b>while</b> (i &lt; <a href="message.md#0xb_message_ECDSA_ADDRESS_LENGTH">ECDSA_ADDRESS_LENGTH</a>) {
            <b>address</b>.push_back(<a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.peel_u8());
            i = i + 1;
        };
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_extract_update_bridge_limit">extract_update_bridge_limit</a>(<a href="message.md#0xb_message">message</a>: &<a href="message.md#0xb_message_BridgeMessage">BridgeMessage</a>): <a href="message.md#0xb_message_UpdateBridgeLimit">UpdateBridgeLimit</a> {
    <b>let</b> <b>mut</b> <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a> = <a href="../haneul-framework/bcs.md#0x2_bcs_new">bcs::new</a>(<a href="message.md#0xb_message">message</a>.payload);
    <b>let</b> sending_chain = <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.peel_u8();
    <b>let</b> limit = <a href="message.md#0xb_message_peel_u64_be">peel_u64_be</a>(&<b>mut</b> <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_extract_update_asset_price">extract_update_asset_price</a>(<a href="message.md#0xb_message">message</a>: &<a href="message.md#0xb_message_BridgeMessage">BridgeMessage</a>): <a href="message.md#0xb_message_UpdateAssetPrice">UpdateAssetPrice</a> {
    <b>let</b> <b>mut</b> <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a> = <a href="../haneul-framework/bcs.md#0x2_bcs_new">bcs::new</a>(<a href="message.md#0xb_message">message</a>.payload);
    <b>let</b> token_id = <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.peel_u8();
    <b>let</b> new_price = <a href="message.md#0xb_message_peel_u64_be">peel_u64_be</a>(&<b>mut</b> <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>);
...
<a name="0xb_message_extract_add_tokens_on_haneul"></a>

## Function `extract_add_tokens_on_haneul`



<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_extract_add_tokens_on_haneul">extract_add_tokens_on_haneul</a>(<a href="message.md#0xb_message">message</a>: &<a href="message.md#0xb_message_BridgeMessage">message::BridgeMessage</a>): <a href="message.md#0xb_message_AddTokenOnHaneul">message::AddTokenOnHaneul</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_extract_add_tokens_on_haneul">extract_add_tokens_on_haneul</a>(<a href="message.md#0xb_message">message</a>: &<a href="message.md#0xb_message_BridgeMessage">BridgeMessage</a>): <a href="message.md#0xb_message_AddTokenOnHaneul">AddTokenOnHaneul</a> {
    <b>let</b> <b>mut</b> <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a> = <a href="../haneul-framework/bcs.md#0x2_bcs_new">bcs::new</a>(<a href="message.md#0xb_message">message</a>.payload);
    <b>let</b> native_token = <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.peel_bool();
    <b>let</b> token_ids = <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.peel_vec_u8();
    <b>let</b> token_type_names_bytes = <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.peel_vec_vec_u8();
    <b>let</b> token_prices = <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.peel_vec_u64();
    ...
    <b>assert</b>!(<a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>.into_remainder_bytes().is_empty(), <a href="message.md#0xb_message_ETrailingBytes">ETrailingBytes</a>);
    <a href="message.md#0xb_message_AddTokenOnHaneul">AddTokenOnHaneul</a> {
        native_token,
        token_ids,
        token_type_names,
        token_prices
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_serialize_message">serialize_message</a>(<a href="message.md#0xb_message">message</a>: <a href="message.md#0xb_message_BridgeMessage">BridgeMessage</a>): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt; {
    ...
    // <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a> serializes <a href="../move-stdlib/u64.md#0x1_u64">u64</a> <b>as</b> 8 bytes
    <a href="message.md#0xb_message">message</a>.append(<a href="message.md#0xb_message_reverse_bytes">reverse_bytes</a>(<a href="../haneul-framework/bcs.md#0x2_bcs_to_bytes">bcs::to_bytes</a>(&seq_num)));
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_create_token_bridge_message">create_token_bridge_message</a>(
    ...
    // <a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a> serialzies <a href="../move-stdlib/u64.md#0x1_u64">u64</a> <b>as</b> 8 bytes
    payload.append(<a href="message.md#0xb_message_reverse_bytes">reverse_bytes</a>(<a href="../haneul-framework/bcs.md#0x2_bcs_to_bytes">bcs::to_bytes</a>(&amount)));
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_create_update_bridge_limit_message">create_update_bridge_limit_message</a>(
    ...
    payload.append(<a href="message.md#0xb_message_reverse_bytes">reverse_bytes</a>(<a href="../haneul-framework/bcs.md#0x2_bcs_to_bytes">bcs::to_bytes</a>(&new_limit)));
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_create_update_asset_price_message">create_update_asset_price_message</a>(
    ...
    payload.append(<a href="message.md#0xb_message_reverse_bytes">reverse_bytes</a>(<a href="../haneul-framework/bcs.md#0x2_bcs_to_bytes">bcs::to_bytes</a>(&new_price)));
    <a href="message.md#0xb_message_BridgeMessage">BridgeMessage</a> {
...
<a name="0xb_message_create_add_tokens_on_haneul_message"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_create_add_tokens_on_haneul_message">create_add_tokens_on_haneul_message</a>(
    source_chain: u8,
    seq_num: <a href="../move-stdlib/u64.md#0x1_u64">u64</a>,
    native_token: bool,
    ...
    <a href="chain_ids.md#0xb_chain_ids_assert_valid_chain_id">chain_ids::assert_valid_chain_id</a>(source_chain);
    <b>let</b> <b>mut</b> payload = <a href="../haneul-framework/bcs.md#0x2_bcs_to_bytes">bcs::to_bytes</a>(&native_token);
    payload.append(<a href="../haneul-framework/bcs.md#0x2_bcs_to_bytes">bcs::to_bytes</a>(&token_ids));
    payload.append(<a href="../haneul-framework/bcs.md#0x2_bcs_to_bytes">bcs::to_bytes</a>(&type_names));
    payload.append(<a href="../haneul-framework/bcs.md#0x2_bcs_to_bytes">bcs::to_bytes</a>(&token_prices));
    <a href="message.md#0xb_message_BridgeMessage">BridgeMessage</a> {
        message_type: <a href="message_types.md#0xb_message_types_add_tokens_on_haneul">message_types::add_tokens_on_haneul</a>(),
        message_version: <a href="message.md#0xb_message_CURRENT_MESSAGE_VERSION">CURRENT_MESSAGE_VERSION</a>,
        seq_num,
        source_chain,
        payload,
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_is_native">is_native</a>(self: &<a href="message.md#0xb_message_AddTokenOnHaneul">message::AddTokenOnHaneul</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_is_native">is_native</a>(self: &<a href="message.md#0xb_message_AddTokenOnHaneul">AddTokenOnHaneul</a>): bool {
    self.native_token
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_token_ids">token_ids</a>(self: &<a href="message.md#0xb_message_AddTokenOnHaneul">message::AddTokenOnHaneul</a>): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_token_ids">token_ids</a>(self: &<a href="message.md#0xb_message_AddTokenOnHaneul">AddTokenOnHaneul</a>): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt; {
    self.token_ids
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_token_type_names">token_type_names</a>(self: &<a href="message.md#0xb_message_AddTokenOnHaneul">message::AddTokenOnHaneul</a>): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="../move-stdlib/ascii.md#0x1_ascii_String">ascii::String</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_token_type_names">token_type_names</a>(self: &<a href="message.md#0xb_message_AddTokenOnHaneul">AddTokenOnHaneul</a>): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;String&gt; {
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_token_prices">token_prices</a>(self: &<a href="message.md#0xb_message_AddTokenOnHaneul">message::AddTokenOnHaneul</a>): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="../move-stdlib/u64.md#0x1_u64">u64</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="message.md#0xb_message_token_prices">token_prices</a>(self: &<a href="message.md#0xb_message_AddTokenOnHaneul">AddTokenOnHaneul</a>): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="../move-stdlib/u64.md#0x1_u64">u64</a>&gt; {
    self.token_prices
}
</code></pre>
...
<pre><code><b>fun</b> <a href="message.md#0xb_message_peel_u64_be">peel_u64_be</a>(<a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>: &<b>mut</b> <a href="../haneul-framework/bcs.md#0x2_bcs_BCS">bcs::BCS</a>): <a href="../move-stdlib/u64.md#0x1_u64">u64</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="message.md#0xb_message_peel_u64_be">peel_u64_be</a>(<a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>: &<b>mut</b> BCS): <a href="../move-stdlib/u64.md#0x1_u64">u64</a> {
    <b>let</b> (<b>mut</b> value, <b>mut</b> i) = (0u64, 64u8);
    <b>while</b> (i &gt; 0) {
        i = i - 8;
        <b>let</b> byte = (<a href="../haneul-framework/bcs.md#0x2_bcs_peel_u8">bcs::peel_u8</a>(<a href="../haneul-framework/bcs.md#0x2_bcs">bcs</a>) <b>as</b> <a href="../move-stdlib/u64.md#0x1_u64">u64</a>);
        value = value + (byte &lt;&lt; i);
    };
    value
}
