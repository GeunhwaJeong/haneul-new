...
-  [Function `haneul_mainnet`](#bridge_chain_ids_haneul_mainnet)
-  [Function `haneul_testnet`](#bridge_chain_ids_haneul_testnet)
-  [Function `haneul_custom`](#bridge_chain_ids_haneul_custom)
...
<a name="bridge_chain_ids_HaneulMainnet"></a>



<pre><code><b>const</b> <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulMainnet">HaneulMainnet</a>: u8 = 0;
</code></pre>



<a name="bridge_chain_ids_HaneulTestnet"></a>



<pre><code><b>const</b> <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulTestnet">HaneulTestnet</a>: u8 = 1;
</code></pre>



<a name="bridge_chain_ids_HaneulCustom"></a>



<pre><code><b>const</b> <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulCustom">HaneulCustom</a>: u8 = 2;
</code></pre>
...
<a name="bridge_chain_ids_haneul_mainnet"></a>

## Function `haneul_mainnet`



<pre><code><b>public</b> <b>fun</b> <a href="../bridge/chain_ids.md#bridge_chain_ids_haneul_mainnet">haneul_mainnet</a>(): u8
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/chain_ids.md#bridge_chain_ids_haneul_mainnet">haneul_mainnet</a>(): u8 { <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulMainnet">HaneulMainnet</a> }
</code></pre>
...
<a name="bridge_chain_ids_haneul_testnet"></a>

## Function `haneul_testnet`



<pre><code><b>public</b> <b>fun</b> <a href="../bridge/chain_ids.md#bridge_chain_ids_haneul_testnet">haneul_testnet</a>(): u8
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/chain_ids.md#bridge_chain_ids_haneul_testnet">haneul_testnet</a>(): u8 { <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulTestnet">HaneulTestnet</a> }
</code></pre>
...
<a name="bridge_chain_ids_haneul_custom"></a>

## Function `haneul_custom`



<pre><code><b>public</b> <b>fun</b> <a href="../bridge/chain_ids.md#bridge_chain_ids_haneul_custom">haneul_custom</a>(): u8
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/chain_ids.md#bridge_chain_ids_haneul_custom">haneul_custom</a>(): u8 { <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulCustom">HaneulCustom</a> }
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/chain_ids.md#bridge_chain_ids_assert_valid_chain_id">assert_valid_chain_id</a>(id: u8) {
    <b>assert</b>!(
        id == <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulMainnet">HaneulMainnet</a> ||
        id == <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulTestnet">HaneulTestnet</a> ||
        id == <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulCustom">HaneulCustom</a> ||
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/chain_ids.md#bridge_chain_ids_valid_routes">valid_routes</a>(): vector&lt;<a href="../bridge/chain_ids.md#bridge_chain_ids_BridgeRoute">BridgeRoute</a>&gt; {
    vector[
        <a href="../bridge/chain_ids.md#bridge_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulMainnet">HaneulMainnet</a>, destination: <a href="../bridge/chain_ids.md#bridge_chain_ids_EthMainnet">EthMainnet</a> },
        <a href="../bridge/chain_ids.md#bridge_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="../bridge/chain_ids.md#bridge_chain_ids_EthMainnet">EthMainnet</a>, destination: <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulMainnet">HaneulMainnet</a> },
        <a href="../bridge/chain_ids.md#bridge_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulTestnet">HaneulTestnet</a>, destination: <a href="../bridge/chain_ids.md#bridge_chain_ids_EthSepolia">EthSepolia</a> },
        <a href="../bridge/chain_ids.md#bridge_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulTestnet">HaneulTestnet</a>, destination: <a href="../bridge/chain_ids.md#bridge_chain_ids_EthCustom">EthCustom</a> },
        <a href="../bridge/chain_ids.md#bridge_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulCustom">HaneulCustom</a>, destination: <a href="../bridge/chain_ids.md#bridge_chain_ids_EthCustom">EthCustom</a> },
        <a href="../bridge/chain_ids.md#bridge_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulCustom">HaneulCustom</a>, destination: <a href="../bridge/chain_ids.md#bridge_chain_ids_EthSepolia">EthSepolia</a> },
        <a href="../bridge/chain_ids.md#bridge_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="../bridge/chain_ids.md#bridge_chain_ids_EthSepolia">EthSepolia</a>, destination: <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulTestnet">HaneulTestnet</a> },
        <a href="../bridge/chain_ids.md#bridge_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="../bridge/chain_ids.md#bridge_chain_ids_EthSepolia">EthSepolia</a>, destination: <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulCustom">HaneulCustom</a> },
        <a href="../bridge/chain_ids.md#bridge_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="../bridge/chain_ids.md#bridge_chain_ids_EthCustom">EthCustom</a>, destination: <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulTestnet">HaneulTestnet</a> },
        <a href="../bridge/chain_ids.md#bridge_chain_ids_BridgeRoute">BridgeRoute</a> { source: <a href="../bridge/chain_ids.md#bridge_chain_ids_EthCustom">EthCustom</a>, destination: <a href="../bridge/chain_ids.md#bridge_chain_ids_HaneulCustom">HaneulCustom</a> }
    ]
}
</code></pre>
