...
<pre><code><b>fun</b> <a href="../../dependencies/haneul-framework/haneul.md#0x2_haneul_new">new</a>(ctx: &<b>mut</b> TxContext): Balance&lt;<a href="../../dependencies/haneul-framework/haneul.md#0x2_haneul_HANEUL">HANEUL</a>&gt; {
    ...
    <b>let</b> (<a href="../../treasury.md#0xb_treasury">treasury</a>, metadata) = <a href="../../dependencies/haneul-framework/coin.md#0x2_coin_create_currency">coin::create_currency</a>(
    ...
    <b>let</b> supply = <a href="../../dependencies/haneul-framework/coin.md#0x2_coin_treasury_into_supply">coin::treasury_into_supply</a>(<a href="../../treasury.md#0xb_treasury">treasury</a>);
