...
module bridge::bridge {
    ...
    use haneul::coin::{Coin, TreasuryCap, CoinMetadata};
    ...
    use bridge::message::{
        ...
        UpdateBridgeLimit, AddTokenOnHaneul, ParsedTokenTransferMessage,
    ...
    const EInvariantHaneulInitializedTokenTransferShouldNotBeClaimed: u64 = 10;
    ...
    public fun approve_token_transfer(
        ...
        // retrieve pending message if source chain is Haneul, the initial message
        // must exist on chain
    ...
    #[test_only]
    public fun test_execute_add_tokens_on_haneul(bridge: &mut Bridge, payload: AddTokenOnHaneul) {
        let inner = load_inner_mut(bridge);
        inner.execute_add_tokens_on_haneul(payload);
    }
