...
module bridge::message {
    ...
    #[test]
    fun test_message_serialization_haneul_to_eth() {
        ...
        let token_bridge_message = create_token_bridge_message(
            chain_ids::haneul_testnet(), // source chain
            10, // seq_num
    ...
    #[test]
    fun test_message_serialization_eth_to_haneul() {
        ...
        let token_bridge_message = create_token_bridge_message(
            ...
            chain_ids::haneul_testnet(), // target_chain
        ...
        let token_payload = TokenPayload {
            ...
            target_chain: chain_ids::haneul_testnet(),
    ...
    fun test_update_bridge_limit_message_serialization() {
        ...
        assert!(bridge_limit.source_chain == chain_ids::haneul_testnet(), 0);
