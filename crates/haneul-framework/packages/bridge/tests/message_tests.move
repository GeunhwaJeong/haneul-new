...
module bridge::message_tests {
    use bridge::{
        ...
        message::{
            ...
            deserialize_message_test_only, extract_add_tokens_on_haneul,
    ...
    use std::ascii;
    use haneul::{address, balance, coin, hex, test_scenario, test_utils::{assert_eq, destroy}};
    use haneul::bcs;
    ...
    fun test_add_tokens_on_haneul_message_serialization() {
        ...
        assert_eq(message, expected_msg);
        assert!(add_tokens_on_haneul_message == deserialize_message_test_only(message), 0);
