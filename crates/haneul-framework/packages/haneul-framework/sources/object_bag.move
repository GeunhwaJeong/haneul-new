...
/// Similar to `haneul::bag`, an `ObjectBag` is a heterogeneous map-like collection. But unlike
/// `haneul::bag`, the values bound to these dynamic fields _must_ be objects themselves. This allows
