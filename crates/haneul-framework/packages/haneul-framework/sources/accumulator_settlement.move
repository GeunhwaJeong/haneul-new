...
module haneul::accumulator_settlement;

use haneul::accumulator::{AccumulatorRoot, accumulator_key, U128, create_u128, destroy_u128};
use haneul::bcs;
use haneul::hash;
...
use fun haneul::accumulator_metadata::remove_accumulator_metadata as AccumulatorRoot.remove_metadata;
use fun haneul::accumulator_metadata::create_accumulator_metadata as AccumulatorRoot.create_metadata;
