...
module haneul::prover {
    ...
    spec fun uid_has_field<K: copy + drop + store>(uid: haneul::object::UID, name: K): bool {
    ...
    spec fun uid_num_fields<K: copy + drop + store>(uid: haneul::object::UID): u64 {
        let addr = object::uid_to_address(uid);
