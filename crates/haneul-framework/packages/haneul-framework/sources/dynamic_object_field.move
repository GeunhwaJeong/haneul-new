...
/// Similar to `haneul::dynamic_field`, this module allows for the access of dynamic fields. But
/// unlike, `haneul::dynamic_field` the values bound to these dynamic fields _must_ be objects
...
module haneul::dynamic_object_field;
