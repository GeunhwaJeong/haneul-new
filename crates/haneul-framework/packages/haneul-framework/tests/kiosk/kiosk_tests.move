...
module haneul::kiosk_tests {
    ...
    #[test]
    #[expected_failure(abort_code = haneul::kiosk::EItemLocked)]
    ...
    #[test]
    #[expected_failure(abort_code = haneul::kiosk::ENotListed)]
    ...
    #[allow(unused_field)]
    public struct WrongAsset has key, store { id: haneul::object::UID }
    ...
    #[test]
    #[expected_failure(abort_code = haneul::kiosk::ENotEnough)]
    ...
    fun test_uid_access() {
        ...
        assert!(haneul::object::uid_to_inner(uid) == haneul::object::id(&kiosk), 0);
