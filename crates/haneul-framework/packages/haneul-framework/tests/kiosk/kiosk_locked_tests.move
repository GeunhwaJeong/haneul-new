...
module haneul::kiosk_locked_test;

use haneul::item_locked_policy as locked_policy;
use haneul::kiosk_test_utils::{Self as test, Asset};
...
fun test_item_always_locked() {
    ...
    let payment = test::get_haneul(1000, ctx);
