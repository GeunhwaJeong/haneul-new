...
use haneul::zklogin_verified_id::{check_zklogin_id, verify_zklogin_id};

#[test]
#[expected_failure(abort_code = haneul::zklogin_verified_id::EFunctionDisabled)]
fun test_check_zklogin_id() {
    ...
    let salt_hash =
        15232766888716517538274372547598053531354666056102343895255590477425668733026u256;
