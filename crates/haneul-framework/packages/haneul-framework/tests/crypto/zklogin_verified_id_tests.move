...
#[test_only]
module haneul::zklogin_verified_id_tests {
    use haneul::zklogin_verified_id::{check_zklogin_id, delete, verify_zklogin_id, VerifiedID};
    use haneul::address;
    use std::string::utf8;
    ...
    #[test]
    #[expected_failure(abort_code = haneul::zklogin_verified_id::EInvalidInput)]
    ...
    #[test]
    #[expected_failure(abort_code = haneul::zklogin_verified_id::EInvalidProof)]
