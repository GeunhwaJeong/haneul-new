...
#[test]
#[expected_failure(abort_code = haneul::rangeproofs::EInvalidProof)]
...
#[test]
#[expected_failure(abort_code = haneul::rangeproofs::EInvalidRange)]
...
#[test]
#[expected_failure(abort_code = haneul::rangeproofs::EInvalidBatchSize)]
...
#[test]
#[expected_failure(abort_code = haneul::rangeproofs::EInvalidDst)]
...
#[test]
#[expected_failure(abort_code = haneul::rangeproofs::ENotSupported)]
...
#[test_only]
fun peel_tuple_u8(bcs: &mut haneul::bcs::BCS, length: u64): vector<u8> {
    vector::tabulate!(length, |_| bcs.peel_u8())
}

#[test]
fun test_proof_format() {
    use haneul::bcs::{Self, BCS};
    use haneul::ristretto255::{g_from_bytes, scalar_from_bytes};
