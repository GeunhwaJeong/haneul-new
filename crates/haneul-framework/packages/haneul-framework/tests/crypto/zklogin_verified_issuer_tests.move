...
#[test_only]
module haneul::zklogin_verified_issuer_tests;

use haneul::test_scenario;
use haneul::zklogin_verified_issuer::{
...
fun test_check_zklogin_issuer() {
    ...
    let address_seed =
        3006596378422062745101035755700472756930796952630484939867684134047976874601u256;
...
#[test]
#[expected_failure(abort_code = haneul::zklogin_verified_issuer::EInvalidProof)]
