...
#[test_only]
module haneul::test_scenario_tests;
...
fun create_system_objects() {
    ...
    let clock = scenario.take_shared<haneul::clock::Clock>();
    test_scenario::return_shared(clock);

    let random = scenario.take_shared<haneul::random::Random>();
    test_scenario::return_shared(random);

    let deny_list = scenario.take_shared<haneul::deny_list::DenyList>();
