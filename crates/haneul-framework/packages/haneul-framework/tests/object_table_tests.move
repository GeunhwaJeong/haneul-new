...
#[test_only]
module haneul::object_table_tests {
    use std::option;
    use haneul::object_table::{Self, add, contains, borrow, borrow_mut, remove, value_id};
    ...
    #[test]
    #[expected_failure(abort_code = haneul::object_table::ETableNotEmpty)]
