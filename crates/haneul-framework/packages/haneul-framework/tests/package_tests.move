...
module haneul::package_tests {
    use haneul::package::{Self, UpgradeCap, UpgradeTicket};
    ...
    fun test_upgrade_policy_reflected_in_ticket() {
        ...
        while (!policies.is_empty()) {
            ...
            let ticket = check_ticket(&mut cap, policy, haneul::hash::blake2b256(&vector[policy]));
    ...
    #[test]
    #[expected_failure(abort_code = haneul::package::ETooPermissive)]
    ...
    #[test]
    #[expected_failure(abort_code = haneul::package::EAlreadyAuthorized)]
    ...
    #[test]
    #[expected_failure(abort_code = haneul::package::EWrongUpgradeCap)]
