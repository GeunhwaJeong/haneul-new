...
module haneul::safe_mode_tests {
    ...
    fun test_safe_mode_gas_accumulation() {
        ...
        };
        {
            ...
            test_utils::assert_eq(haneul_system::validator_stake_amount(&mut system_state, @0x1), 1);
            test_utils::assert_eq(haneul_system::get_storage_fund_total_balance(&mut system_state), 1000);
        ...
        test_utils::assert_eq(haneul_system::validator_stake_amount(&mut system_state, @0x1), 15);
        test_utils::assert_eq(haneul_system::validator_stake_amount(&mut system_state, @0x2), 15);
        test_utils::assert_eq(haneul_system::validator_stake_amount(&mut system_state, @0x3), 15);
        test_utils::assert_eq(haneul_system::validator_stake_amount(&mut system_state, @0x4), 15);

        // Storage fund is 1000 + 48 + 32 - 30 - 30 = 1020. 4 leftover due to integer division.
        test_utils::assert_eq(haneul_system::get_storage_fund_total_balance(&mut system_state), 1024);
