...
module haneul::safe_mode_tests {
    ...
    fun test_safe_mode_gas_accumulation() {
        ...
        };
        {
            ...
            test_utils::assert_eq(haneul_system::get_storage_fund_balance(&mut system_state), 1000);
        ...
        test_utils::assert_eq(haneul_system::get_storage_fund_balance(&mut system_state), 968);
