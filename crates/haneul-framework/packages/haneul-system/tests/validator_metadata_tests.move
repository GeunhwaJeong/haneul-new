...
#[test_only]
module haneul_system::validator_metadata_tests;

use haneul::balance;
use haneul::coin;
use haneul::test_scenario::{Self, Scenario};
use haneul::url;
use haneul_system::governance_test_utils::{advance_epoch, create_haneul_system_state_for_testing};
use haneul_system::haneul_system::HaneulSystemState;
use haneul_system::test_runner::{Self, TestRunner};
...
fun active_validator_update_metadata() {
    ...
    scenario.next_tx(new_validator_addr);
    {
        ...
        transfer::public_transfer(staked_haneul, @0x0);
