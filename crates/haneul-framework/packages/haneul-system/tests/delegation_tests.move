...
module haneul_system::stake_tests {
    ...
    fun test_remove_stake_post_active_flow(should_distribute_rewards: bool) {
        ...
        // 5 = validator rewards
        let reward_amt = if (should_distribute_rewards) 10 * GEUNHWA_PER_HANEUL else 0;
        let validator_reward_amt = if (should_distribute_rewards) 5 * GEUNHWA_PER_HANEUL else 0;
    ...
    fun test_earns_rewards_at_last_epoch() {
        ...
        let reward_amt = 10 * GEUNHWA_PER_HANEUL;
        let validator_reward_amt = 5 * GEUNHWA_PER_HANEUL;
    ...
    fun test_add_preactive_remove_active() {
        ...
        // At this point we got the following distribution of HANEUL:
        ...
        assert_eq(total_haneul_balance(STAKER_ADDR_1, scenario), 110 * GEUNHWA_PER_HANEUL);
        unstake(STAKER_ADDR_3, 0, scenario);
        assert_eq(total_haneul_balance(STAKER_ADDR_3, scenario), 110 * GEUNHWA_PER_HANEUL);
    ...
    fun test_add_preactive_remove_post_active() {
        ...
        advance_epoch_with_reward_amounts(0, 80, scenario); // staker 1 earns 20 GEUNHWA here.
        ...
        unstake(STAKER_ADDR_1, 0, scenario);
        assert_eq(total_haneul_balance(STAKER_ADDR_1, scenario), 100 * GEUNHWA_PER_HANEUL + 20 * GEUNHWA_PER_HANEUL);
    ...
    fun test_stake_during_safe_mode() {
        ...
        assert_eq(total_haneul_balance(STAKER_ADDR_1, scenario), 130 * GEUNHWA_PER_HANEUL);
        test_scenario::end(scenario_val);
    }
