...
module haneul_system::validator_set_tests {
    ...
    fun test_validator_set_flow() {
        ...
        assert!(validator_set::total_stake(&validator_set) == 1500 * GEUNHWA_PER_HANEUL, 0);
        ...
        assert!(validator_set::total_stake(&validator_set) == 900 * GEUNHWA_PER_HANEUL, 0);
    ...
    fun test_add_validator_failure_below_min_stake() {
        ...
        validator_set::request_add_validator(&mut validator_set, 701 * GEUNHWA_PER_HANEUL, test_scenario::ctx(scenario));
    ...
    fun test_add_validator_with_nonzero_min_stake() {
        ...
        validator_set::request_add_validator(&mut validator_set, 700 * GEUNHWA_PER_HANEUL, test_scenario::ctx(scenario));
    ...
    fun test_low_stake_departure() {
        ...
        let ctx1 = test_scenario::ctx(scenario);
        // Create 4 validators.
        let v1 = create_validator(@0x1, 1, 1, true, ctx1); // 100 HANEUL of stake
        let v2 = create_validator(@0x2, 4, 1, true, ctx1); // 400 HANEUL of stake
        let v3 = create_validator(@0x3, 10, 1, true, ctx1); // 1000 HANEUL of stake
        let v4 = create_validator(@0x4, 4, 1, true, ctx1); // 400 HANEUL of stake
    ...
    fun add_and_activate_validator(validator_set: &mut ValidatorSet, validator: Validator, scenario: &mut Scenario) {
        test_scenario::next_tx(scenario, validator::haneul_address(&validator));
        let ctx = test_scenario::ctx(scenario);
