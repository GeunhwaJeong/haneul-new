...
fun validator_owner_flow() {
    ...
    assert_eq!(validator.haneul_address(), @2);
...
fun pending_validator_flow() {
    ...
    runner.owned_tx!<StakedHaneul>(|staked_haneul| {
        let withdrawn_balance = validator
            .request_withdraw_stake(staked_haneul, runner.ctx())
            .destroy_for_testing();
...
#[test, expected_failure(abort_code = haneul_system::validator::EMetadataInvalidNetPubkey)]
...
#[test, expected_failure(abort_code = haneul_system::validator::EMetadataInvalidWorkerPubkey)]
...
#[test, expected_failure(abort_code = haneul_system::validator::EMetadataInvalidNetAddr)]
...
#[test, expected_failure(abort_code = haneul_system::validator::EMetadataInvalidP2pAddr)]
...
#[test, expected_failure(abort_code = haneul_system::validator::EMetadataInvalidPrimaryAddr)]
...
#[test, expected_failure(abort_code = haneul_system::validator::EMetadataInvalidWorkerAddr)]
...
#[
    test,
    expected_failure(
        abort_code = haneul_system::validator::EValidatorMetadataExceedingLengthLimit,
    ),
]
