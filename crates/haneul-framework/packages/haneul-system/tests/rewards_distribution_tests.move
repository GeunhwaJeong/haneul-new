...
module haneul_system::rewards_distribution_tests {
    ...
    fun test_mul_rewards_withdraws_at_same_epoch() {
        ...
        assert_eq(haneul_system::validator_stake_amount(&mut system_state, VALIDATOR_ADDR_1), 140 * 23);
        ...
        assert_eq(haneul_system::validator_stake_amount(&mut system_state, VALIDATOR_ADDR_1), 140);
        test_scenario::return_shared(system_state);
        test_scenario::end(scenario_val);
    }
