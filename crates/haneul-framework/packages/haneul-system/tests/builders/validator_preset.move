...
#[test_only]
module haneul_system::validator_preset;
...
/// Validator Preset 1.
///
/// Generated using the `haneul validator make-validator-info` for this specific
...
public fun preset(index: u64): Preset {
    ...
    Preset {
        name: preset[0],
        account_address: haneul::address::from_bytes(preset[1]),
