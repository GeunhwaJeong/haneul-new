...
module haneul_system::haneul_system {
    ...
    use haneul_system::haneul_system_state_inner::{Self, SystemParameters, HaneulSystemStateInner, HaneulSystemStateInnerV2};
    ...
    public entry fun request_add_stake_mul_coin(
        ...
        let self = load_system_state_mut(wrapper);
        let staked_haneul = self.request_add_stake_mul_coin(stakes, stake_amount, validator_address, ctx);
        transfer::public_transfer(staked_haneul, ctx.sender());
    }
    ...
    public fun request_withdraw_stake_non_entry(
        ...
        let self = load_system_state_mut(wrapper);
        self.request_withdraw_stake(staked_haneul, ctx)
    }
