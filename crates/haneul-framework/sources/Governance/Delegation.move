...
module Haneul::Delegation {
    ...
    use Haneul::EpochTimeLock::EpochTimeLock;
    ...
    struct Delegation has key {
        ...
        active_delegation: Option<Balance<HANEUL>>,
        ...
        /// field is not None, and after undelegation the stake will be returned to a LockedCoin<HANEUL>
