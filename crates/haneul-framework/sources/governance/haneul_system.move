...
module haneul::haneul_system {
    ...
    public entry fun advance_epoch(
        ...
        let stake_subsidy = balance::increase_supply(&mut self.haneul_supply, self.next_epoch_stake_subsidy);
    ...
    fun update_stake_subsidy_amount(self: &mut HaneulSystemState, new_epoch: u64) {
