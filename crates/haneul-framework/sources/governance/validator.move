...
//    }
    ...
    public (friend) fun cancel_delegation_request(
        ...
        let delegate_amount = staking_pool::staked_haneul_amount(&staked_haneul);
        staking_pool::cancel_delegation_request(&mut self.delegation_staking_pool, staked_haneul, ctx);
        self.metadata.next_epoch_delegation = self.metadata.next_epoch_delegation - delegate_amount;
    }
    ...
    public fun total_stake_amount(self: &Validator): u64 {
        spec {
            ...
            assume self.stake_amount + self.delegation_staking_pool.haneul_balance <= MAX_U64;
        };
        self.stake_amount + staking_pool::haneul_balance(&self.delegation_staking_pool)
    }
