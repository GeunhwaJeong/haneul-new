...
module haneul::validator {
    ...
    use haneul::staking_pool::{Self, Delegation, StakedHaneul, StakingPool};
    ...
    fun verify_proof_of_possession(
        ...
        let address_bytes = bcs::to_bytes(&haneul_address);
    ...
    public(friend) fun new(
        ...
        Validator {
            ...
            pending_withdraw: 0,
            gas_price,
            delegation_staking_pool: staking_pool::new(haneul_address, tx_context::epoch(ctx) + 1),
            commission_rate,
        }
    }
    ...
    public(friend) fun request_withdraw_delegation(
        ...
        let withdraw_haneul_amount = staking_pool::request_withdraw_stake(
    ...
    public(friend) fun distribute_rewards(self: &mut Validator, reward: Balance<HANEUL>, ctx: &mut TxContext) {
    ...
    public(friend) fun process_pending_delegations(self: &mut Validator, ctx: &mut TxContext) {
        let _haneul_deposit = staking_pool::process_pending_delegations(&mut self.delegation_staking_pool, ctx);
    ...
    public fun haneul_address(self: &Validator): address {
    ...
    public fun delegate_amount(self: &Validator): u64 {
        staking_pool::haneul_balance(&self.delegation_staking_pool)
    }
