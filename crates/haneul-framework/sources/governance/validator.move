...
module haneul::validator {
    ...
    public(friend) fun request_add_delegation(
        ...
        staking_pool::request_add_delegation(
            &mut self.staking_pool, delegated_stake, locking_period, self.metadata.haneul_address, delegator, delegation_epoch, ctx
        );
    ...
    fun new_from_metadata(
        ...
        staking_pool::request_add_delegation(&mut staking_pool, stake, coin_locked_until_epoch, haneul_address, haneul_address, starting_epoch, ctx);
