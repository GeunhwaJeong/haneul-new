...
module haneul::validator {
    ...
    use haneul::bls12381::bls12381_verify_with_domain;
    ...
    public(friend) fun distribute_rewards_and_new_delegations(self: &mut Validator, reward: Balance<HANEUL>, ctx: &mut TxContext) {
