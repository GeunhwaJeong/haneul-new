...
module haneul::stake_subsidy {
    ...
    struct StakeSubsidy has store {
        ...
        epoch_counter: u64,
        /// Balance of Haneul set asside for Staking subsidies that will be drawn down over time.
    ...
    public(friend) fun advance_epoch(subsidy: &mut StakeSubsidy): Balance<HANEUL> {
