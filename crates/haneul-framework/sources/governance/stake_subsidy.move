...
module haneul::stake_subsidy {
    ...
    public(friend) fun mint_stake_subsidy_proportional_to_total_stake_testnet(
        subsidy: &mut StakeSubsidy, supply: &mut Supply<HANEUL>, stake_subsidy_rate: u64, total_stake: u64
    ) {
    ...
    public(friend) fun advance_epoch(subsidy: &mut StakeSubsidy, supply: &mut Supply<HANEUL>) {
    ...
    public(friend) fun withdraw_all(subsidy: &mut StakeSubsidy): Balance<HANEUL> {
