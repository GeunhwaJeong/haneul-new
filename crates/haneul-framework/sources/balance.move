...
module haneul::balance {
    ...
    /// It should only be called by `haneul_system::advance_epoch` to create staking rewards,
    /// and nowhere else.
    ...
    /// It should only be called by `haneul_system::advance_epoch` to destroy storage rebates,
    /// and nowhere else.
