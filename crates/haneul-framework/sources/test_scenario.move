...
module haneul::test_scenario {
    ...
    /// Utility for mocking a multi-transaction Haneul execution in a single Move procedure.
    ...
    public fun return_to_address<T: key>(account: address, t: T) {
        ...
        haneul::transfer::transfer(t, account)
    }
    ...
    public fun return_immutable<T: key>(t: T) {
        ...
        haneul::transfer::freeze_object(t)
    }
    ...
    public fun return_shared<T: key>(t: T) {
        ...
        haneul::transfer::share_object(t)
    }
