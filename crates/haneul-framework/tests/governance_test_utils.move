...
module haneul::governance_test_utils {
    ...
    public fun advance_epoch_with_reward_amounts(
        ...
        haneul_system::advance_epoch(&mut system_state, new_epoch, storage_charge, computation_charge, 0, 0, 0, 0, ctx);
    ...
    public fun advance_epoch_with_reward_amounts_and_subsidy_rate(
        ...
        haneul_system::advance_epoch(&mut system_state, new_epoch, storage_charge, computation_charge, 0, 0, 0, stake_subsidy_rate, ctx);
        test_scenario::return_shared(system_state);
    }
