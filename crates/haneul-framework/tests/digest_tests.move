...
#[test_only]
module haneul::digest_tests {
    use haneul::digest::{sha3_256_digest_from_bytes, sha3_256_digest_to_bytes};

    const EHASH_LENGTH_MISMATCH: u64 = 0;

    #[test]
    #[expected_failure(abort_code = haneul::digest::EHashLengthMismatch)]
