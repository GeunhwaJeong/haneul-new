...
module haneul::address_tests {
    ...
    #[test]
    #[expected_failure(abort_code = haneul::address::EAddressParseError)]
    ...
    #[expected_failure(abort_code = haneul::address::EU256TooBigToConvertToAddress)]
    #[test]
