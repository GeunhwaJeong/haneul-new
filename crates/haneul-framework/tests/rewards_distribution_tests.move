...
module haneul::rewards_distribution_tests {
    ...
    fun test_delegation_rewards() {
        ...
        assert!(total_haneul_balance(DELEGATOR_ADDR_1, scenario) == 110, 0);
        ...
        assert!(total_haneul_balance(DELEGATOR_ADDR_2, scenario) == 120, 0);

        undelegate(DELEGATOR_ADDR_2, 0, 0, 545, scenario);
        assert!(total_haneul_balance(DELEGATOR_ADDR_2, scenario) == 730, 0);
        test_scenario::end(scenario_val);
    }
    ...
    fun test_validator_commission() {
        ...
        // 1 HANEUL, or 10 % of delegator_1's rewards, goes to validator_1
        // and 9 HANEUL of delegator_2's rewards goes to validator_2
