...
module haneul::rewards_distribution_tests {
    ...
    fun test_delegation_rewards() {
        ...
        undelegate(DELEGATOR_ADDR_2, 0, 0, scenario); // unstake 600 principal HANEUL
        governance_test_utils::advance_epoch(scenario); 
    ...
    fun set_up_haneul_system_state(scenario: &mut Scenario) {
        ...
        create_haneul_system_state_for_testing(validators, 1000, 0);
    }
    ...
    fun set_up_haneul_system_state_with_big_amounts(scenario: &mut Scenario) {
        ...
        create_haneul_system_state_for_testing(validators, 1000000000, 0);
    }
