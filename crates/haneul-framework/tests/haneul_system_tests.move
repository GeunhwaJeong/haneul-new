...
module haneul::haneul_system_tests {
    ...
    fun update_candidate(
        ...
        haneul_system::update_candidate_validator_primary_address(system_state, b"/ip4/127.0.0.1", ctx);
        haneul_system::update_candidate_validator_worker_address(system_state, b"/ip4/127.0.0.1", ctx);
    ...
    fun update_metadata(
        ...
        haneul_system::update_validator_next_epoch_primary_address(system_state, b"/ip4/168.168.168.168", ctx);
        haneul_system::update_validator_next_epoch_worker_address(system_state, b"/ip4/168.168.168.168", ctx);
