...
module haneul::haneul_system_tests {
    ...
    use haneul::governance_test_utils::{advance_epoch, set_up_haneul_system_state};
    ...
    #[test]
    #[expected_failure(abort_code = haneul_system::ENOT_VALIDATOR)]
    ...
    #[test]
    #[expected_failure(abort_code = haneul_system::ECANNOT_REPORT_ONESELF)]
    ...
    #[test]
    #[expected_failure(abort_code = haneul_system::EREPORT_RECORD_NOT_FOUND)]
