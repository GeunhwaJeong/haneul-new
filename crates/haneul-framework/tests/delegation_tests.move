...
module haneul::delegation_tests {
    ...
    fun test_partial_withdraw_delegation() {
        ...
        test_scenario::next_tx(scenario, DELEGATOR_ADDR_1);
        {
            ...
            // delegator should get back a quarter of her stake plus the rewards which is 25 + 3 = 28 HANEUL.
    ...
    fun test_switch_delegation() {
        ...
        test_scenario::next_tx(scenario, DELEGATOR_ADDR_1);
        {
            ...
            haneul_system::request_switch_delegation(
                &mut system_state, delegation, &mut staked_haneul, VALIDATOR_ADDR_2, ctx);
        ...
        test_scenario::next_tx(scenario, DELEGATOR_ADDR_1);
        {
            ...
            assert!(haneul_system::validator_delegate_amount(&system_state, VALIDATOR_ADDR_2) == 57, 107);
            test_scenario::return_shared(system_state);
        };
        test_scenario::end(scenario_val);
    }
