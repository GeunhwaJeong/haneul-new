...
module haneul::delegation_tests {
    use haneul::coin;
    use haneul::epoch_reward_record::EpochRewardRecord;
    ...
    fun test_add_remove_delegation_flow() {
        ...
        {
            let system_state_wrapper = test_scenario::take_shared<HaneulSystemState>(scenario);
            ...
            assert!(haneul_system::validator_delegate_amount(system_state_mut_ref, VALIDATOR_ADDR_1) == 70, 101);
            assert!(haneul_system::validator_delegate_amount(system_state_mut_ref, VALIDATOR_ADDR_2) == 0, 102);
            assert!(haneul_system::validator_delegator_count(system_state_mut_ref, VALIDATOR_ADDR_1) == 2, 103);
            assert!(haneul_system::validator_delegator_count(system_state_mut_ref, VALIDATOR_ADDR_2) == 0, 104);
        ...
        test_scenario::next_tx(scenario, &DELEGATOR_ADDR_1);
        {
            ...
            // Undelegate 60 HANEULs from VALIDATOR_ADDR_1
            haneul_system::request_remove_delegation(
            ...
            assert!(haneul_system::validator_delegate_amount(system_state_mut_ref, VALIDATOR_ADDR_1) == 10, 107);
            assert!(haneul_system::validator_delegator_count(system_state_mut_ref, VALIDATOR_ADDR_1) == 1, 108);
            test_scenario::return_shared(scenario, system_state_wrapper);
        };
    }
    ...
    fun test_switch_delegation_flow() {
        ...
        test_scenario::next_tx(scenario, &DELEGATOR_ADDR_1);
        {
            ...
            // Switch the 10 HANEUL delegation from VALIDATOR_ADDR_2 to VALIDATOR_ADDR_1
    ...
    fun test_double_claim_reward_active() {
        ...
        test_scenario::next_tx(scenario, &DELEGATOR_ADDR_1);
        {
            ...
            haneul_system::claim_delegation_reward(system_state_mut_ref, &mut delegation, epoch_reward_record_ref, ctx);
    ...
    fun test_double_claim_reward_inactive() {
        ...
        test_scenario::next_tx(scenario, &DELEGATOR_ADDR_1);
        {
            ...
            haneul_system::request_remove_delegation(system_state_mut_ref, &mut delegation, ctx);
            haneul_system::claim_delegation_reward(system_state_mut_ref, &mut delegation, epoch_reward_record_ref, ctx);
