...
pub struct ImageBuildArgs {
    /// The name of the git repository within the haneullabs org
    #[arg(short, long)]
    repo_name: String,
    ...
    /// Optional arg to speciy the org to build the image for, default to "haneullabs"
    #[arg(short = 'o', long)]
    org: Option<String>,
    ...
    let req = match action {
        ImageAction::Build(args) => {
            ...
            let body = RequestBuildRequest {
                ...
                org: args.org.clone().unwrap_or("haneullabs".to_string()),
