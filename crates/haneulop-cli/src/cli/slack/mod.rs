...
/// Serialize the obj into ~/.haneulop/{subname} so we can cache it across
/// executions
...
/// Check if the file in ~/.haneulop/{subname} is less than 1 day old
...
impl Channel {
    pub fn url(self) -> String {
        format!("https://haneullabs-labs.slack.com/archives/{}", self.id)
    }
}
