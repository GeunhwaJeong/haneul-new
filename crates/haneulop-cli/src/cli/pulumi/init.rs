...
fn run_poetry_init(project_name: &str, project_dir_str: &str) -> Result<()> {
    ...
    run_cmd(
        vec![
            ...
            "-c",
            &format!(
                r#"poetry init -C {0} --python "^3.11" --name {1} --description "pulumi project for {1}" --author "haneullabs labs <info@haneul-labs.com>" -n"#,
...
fn create_basic_project(
    ...
    // add haneullabs common lib and standard deps
