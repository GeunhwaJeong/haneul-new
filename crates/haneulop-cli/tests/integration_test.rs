...
version = "0.1.0"
description = "dummy"
authors = ["haneullabs labs <info@haneul-labs.com>"]
readme = "README.md"
packages = [{ include = "dummy_package" }]

[tool.poetry.dependencies]
python = "^3.11"
haneul-pulumi-common = {path = "../../common"}
pulumi = "^3.75.0"
...
"#,
    ...
    haneuloplib::cli::pulumi::adjust_pyproject(&tempdir_path).context("running adjust_pyproject")?;
