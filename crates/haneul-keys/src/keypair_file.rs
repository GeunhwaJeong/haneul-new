...
use haneul_types::crypto::{AuthorityKeyPair, NetworkKeyPair, HaneulKeyPair, ToFromBytes};
...
/// Read from file as Base64 encoded `flag || privkey` and return a HaneulKeypair.
