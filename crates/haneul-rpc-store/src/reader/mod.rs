...
//! `haneul-rpc-api` consumes — [`ObjectStore`], [`ReadStore`],
...
//!
//! [`ObjectStore`]: haneul_types::storage::ObjectStore
//! [`ReadStore`]: haneul_types::storage::ReadStore
//! [`ChildObjectResolver`]: haneul_types::storage::ChildObjectResolver
//! [`RpcStateReader`]: haneul_types::storage::RpcStateReader
//! [`RpcIndexes`]: haneul_types::storage::RpcIndexes
//! [`Reader`]: haneul_consistent_store::reader::Reader
...
/// `haneul-rpc-api` reader-trait stack.
///
...
/// `haneul-rpc-api::StateReader::new(Arc::new(reader))`.
