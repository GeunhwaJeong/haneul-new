...
//! Storage backend for `haneul-rpc-api`.
//!
//! Built on top of [`haneul_consistent_store`], this crate hosts the
...
//!   `haneul-core::rpc_index` and `haneul-indexer-alt-consistent-store`.
//!
//! Values are encoded with bespoke protobuf messages defined under
//! `proto/haneul/rpc_store/`, mirroring the build setup in
//! `haneul-consistent-store`.
...
///
/// [`IngestionClientTrait`]:
///   haneul_indexer_alt_framework::ingestion::ingestion_client::IngestionClientTrait
