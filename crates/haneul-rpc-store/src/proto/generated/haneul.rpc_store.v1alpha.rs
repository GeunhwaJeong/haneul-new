...
pub mod stored_object {
    ...
    pub enum Kind {
        /// BCS-encoded `haneul_types::object::Object`.
        #[prost(bytes, tag = "1")]
...
/// `haneul_types::transaction::Transaction` envelope.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct StoredTransaction {
    /// BCS-encoded `haneul_types::transaction::TransactionData`.
    #[prost(bytes = "bytes", tag = "1")]
    pub transaction_bcs: ::prost::bytes::Bytes,
    /// BCS-encoded `Vec<haneul_types::signature::GenericSignature>` —
...
pub struct StoredEffects {
    /// BCS-encoded `haneul_types::effects::TransactionEffects`.
    #[prost(bytes = "bytes", tag = "1")]
    pub bcs: ::prost::bytes::Bytes,
    /// BCS-encoded `Vec<haneul_types::storage::ObjectKey>` listing
...
pub struct StoredEvents {
    /// BCS-encoded `haneul_types::effects::TransactionEvents`.
    #[prost(bytes = "bytes", tag = "1")]
    pub bcs: ::prost::bytes::Bytes,
}
...
pub struct StoredCheckpointSummary {
    /// BCS-encoded `haneul_types::messages_checkpoint::CheckpointSummary`.
    #[prost(bytes = "bytes", tag = "1")]
    pub summary_bcs: ::prost::bytes::Bytes,
    /// BCS-encoded
    /// `haneul_types::crypto::AuthorityStrongQuorumSignInfo`.
    #[prost(bytes = "bytes", tag = "2")]
...
pub struct StoredEpoch {
    ...
    /// BCS-encoded `haneul_types::haneul_system_state::HaneulSystemState`
    ...
    /// BCS-encoded
    /// `Vec<haneul_types::messages_checkpoint::CheckpointCommitment>` from
