...
//! `haneul-core::rpc_index`. For every event in every transaction
//! the pipeline:
//!
//! 1. Visits dimension candidates via
//!    [`haneul_inverted_index::for_each_event_dimension`].
//! 2. Encodes the dimension key via
//!    [`haneul_inverted_index::encode_dimension_key`].
...
use haneul_inverted_index::event_seq::{MAX_EVENTS_PER_TX, MAX_TX_SEQ};
...
use haneul_inverted_index::event_seq::encode_event_seq;
