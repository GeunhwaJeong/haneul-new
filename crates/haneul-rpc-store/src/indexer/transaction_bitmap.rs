...
//! `haneul-core::rpc_index`. For every transaction in the checkpoint
//! the pipeline:
//!
//! 1. Visits every dimension candidate via
//!    [`haneul_inverted_index::for_each_transaction_dimension`].
//! 2. Encodes each `(dimension, value)` into a `dimension_key` via
//!    [`haneul_inverted_index::encode_dimension_key`] and dedupes
...
use haneul_inverted_index::encode_dimension_key;
use haneul_inverted_index::for_each_transaction_dimension;
