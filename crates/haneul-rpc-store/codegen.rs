...
---
[package]
name = "haneul-rpc-store-proto-codegen"
edition = "2024"
...
//! `crates/haneul-rpc-store/src/proto/generated/` from the `.proto`
//! files under `crates/haneul-rpc-store/proto/`. Mirrors
//! `haneul-consistent-store/codegen.rs`; see that file for design
//! notes.
//!
