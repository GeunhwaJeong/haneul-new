...
use haneul_bridge::utils::publish_coins_return_add_coins_on_haneul_action;
...
impl TestClusterBuilder {
    ...
    pub async fn build_with_bridge(
            ...
            .zip(bridge_authority_keys.iter())
        {
            ...
            test_cluster
                .transfer_haneul_must_exceed(sender_address, validator_address, 1000000000)
                .await;
        ...
        if deploy_tokens {
            ...
            let action = publish_coins_return_add_coins_on_haneul_action(
