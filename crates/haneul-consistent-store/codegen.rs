...
//! `crates/haneul-consistent-store/src/proto/generated/` from the
//! `.proto` files under `crates/haneul-consistent-store/proto/`.
//!
//! Mirrors the structure of the codegen `main.rs` in
//! [`haneul-rust-sdk/crates/proto-build`](https://github.com/GeunhwaJeong/haneul-rust-sdk/tree/master/crates/proto-build),
