...
//! [`haneul_indexer_alt_framework_store_traits`]'s `Store` /
...
//! [`transaction`](haneul_indexer_alt_framework_store_traits::SequentialStore::transaction)
//! commits.
//!
//! # Atomicity model
//!
...
use haneul_indexer_alt_framework_store_traits::SequentialConnection;
use haneul_indexer_alt_framework_store_traits::SequentialStore;
use haneul_indexer_alt_framework_store_traits::Store as _;
use haneul_indexer_alt_framework_store_traits::{self as store_traits};
