...
//!     fn cfs(_: &haneul_consistent_store::CfOptionsResolver) -> Vec<haneul_consistent_store::CfDescriptor> {
//!         vec![]
//!     }
//!     fn open(_: &Db) -> Result<Self, haneul_consistent_store::error::OpenError> {
//!         Ok(Self)
//!     }
//! }
//!
...
mod tests {
    ...
    #[test]
    fn cf_names_includes_schema_and_framework_cfs() {
        let (_dir, db) = open_db();
        ...
        // RocksDB's mandatory `default` CF is opened but not tracked.
