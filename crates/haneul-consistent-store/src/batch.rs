...
//! use haneul_consistent_store::DbMap;
...
//!     fn cfs(opts: &haneul_consistent_store::CfOptionsResolver) -> Vec<haneul_consistent_store::CfDescriptor> {
//!         vec![haneul_consistent_store::CfDescriptor::new("items", opts.options("items"))]
//!     }
//!
