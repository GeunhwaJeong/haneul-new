...
use haneul_mvr_graphql_rpc::client::simple_client::GraphqlQueryVariable;
use haneul_mvr_graphql_rpc::client::ClientError;
use haneul_mvr_graphql_rpc::config::Limits;
use haneul_mvr_graphql_rpc::config::ServiceConfig;
use haneul_mvr_graphql_rpc::test_infra::cluster::prep_executor_cluster;
use haneul_mvr_graphql_rpc::test_infra::cluster::start_cluster;
...
async fn test_simple_client_simulator_cluster() {
    ...
    let cluster = haneul_mvr_graphql_rpc::test_infra::cluster::serve_executor(
        Arc::new(sim),
        None,
        None,
...
async fn test_payload_using_vars_mutation_passes() {
    telemetry_subscribers::init_for_testing();
    let cluster = haneul_mvr_graphql_rpc::test_infra::cluster::start_cluster(ServiceConfig {
        limits: Limits {
