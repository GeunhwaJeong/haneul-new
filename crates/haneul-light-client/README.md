...
archive_store_config:
  object-store: "S3"
  bucket: "haneullabs-mainnet-archives"
  no-sign-request: true
  aws-region: "us-west-2"
  object-store-connection-limit: 20
```

The genesis blob for the Haneul mainnet can be found here: https://github.com/GeunhwaJeong/haneul-genesis/blob/main/mainnet/genesis.blob. Download and place it inside the checkpoint summary directory. 
...
```
$ haneul-light-client --config mainnet.yaml sync
```
...
```
$ haneul-light-client --config mainnet.yaml transaction -t 8RiKBwuAbtu8zNCtz8SrcfHyEUzto6zi6cMVA9t4WhWk
```
...
```
$ haneul-light-client --config light_client.yaml object -o 0xa514c85e1844189a54f4bfabc0928cbcac2137b928bef61adade84bbb486fd1f
```
