...
pub struct AuthenticatedEvent {
    /// The underlying Haneul event data.
    pub event: Event,
...
impl AuthenticatedEventsClient {
    ...
    fn extract_stream_head_from_object(
        ...
        match &object.data {
            haneul_types::object::Data::Move(move_obj) => {
                let field: haneul_types::dynamic_field::Field<
                    haneul_types::accumulator_root::AccumulatorKey,
                    EventStreamHead,
            ...
            haneul_types::object::Data::Package(_) => Err(ClientError::InternalError(
    ...
    /// # use haneul_types::base_types::HaneulAddress;
    /// # async fn example(client: Arc<AuthenticatedEventsClient>, stream_id: HaneulAddress) {
    ...
    pub(crate) async fn fetch_and_verify_stream_head(
        &self,
        stream_object_id: haneul_types::base_types::ObjectID,
        checkpoint: u64,
    ) -> Result<EventStreamHead, ClientError> {
        ...
        let request =
            haneul_rpc::proto::haneul::rpc::v2alpha::GetCheckpointObjectProofRequest::default()
    ...
    async fn fetch_and_verify_next_epoch(
        ...
        let checkpoint: haneul_types::full_checkpoint_content::Checkpoint =
