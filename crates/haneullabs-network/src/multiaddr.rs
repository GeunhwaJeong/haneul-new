...
mod test {
    ...
    fn test_to_socket_addr_unsupported_protocol() {
        let multi_addr_dns = Multiaddr(multiaddr!(Dnsaddr("haneullabs.haneul"), Tcp(10500u16)));
    ...
    fn test_is_loosely_valid_tcp_addr() {
        ...
        assert!(!multi_addr_ipv6.is_loosely_valid_tcp_addr());
        let multi_addr_dns = Multiaddr(multiaddr!(Dnsaddr("haneullabs.haneul"), Udp(10500u16)));
        assert!(!multi_addr_dns.is_loosely_valid_tcp_addr());
    ...
    fn test_get_hostname_port() {
        ...
        let multi_addr_dns = Multiaddr(multiaddr!(Dns("haneullabs.haneul"), Tcp(10501u16)));
        assert_eq!(Some("haneullabs.haneul".to_string()), multi_addr_dns.hostname());
    ...
    fn test_to_anemo_address() {
        ...
        let addr_dns = Multiaddr(multiaddr!(Dns("haneullabs.haneul"), Udp(10501u16)))
            .to_anemo_address()
            .unwrap();
        assert_eq!("haneullabs.haneul:10501".to_string(), addr_dns.to_string());

        let addr_invalid =
            Multiaddr(multiaddr!(Dns("haneullabs.haneul"), Tcp(10501u16))).to_anemo_address();
    ...
    fn test_with_zero_ip() {
        ...
        let multi_addr_dns = Multiaddr(multiaddr!(Dns("haneullabs.haneul"), Tcp(10501u16))).with_zero_ip();
    ...
    fn test_with_localhost_ip() {
        ...
        let multi_addr_dns =
            Multiaddr(multiaddr!(Dns("haneullabs.haneul"), Tcp(10501u16))).with_localhost_ip();
