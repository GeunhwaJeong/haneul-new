...
use haneul_types::crypto::{
    get_key_pair_from_rng, EncodeDecodeBase64, PublicKey, Signature, HaneulKeyPair,
};
...
pub struct FileBasedKeystore {
    keys: BTreeMap<HaneulAddress, HaneulKeyPair>,
    path: Option<PathBuf>,
}
...
impl FileBasedKeystore {
    ...
    pub fn key_pairs(&self) -> Vec<&HaneulKeyPair> {
...
impl HaneulKeystore {
    ...
    pub fn add_key(&mut self, keypair: HaneulKeyPair) -> Result<(), anyhow::Error> {
    ...
    pub fn generate_new_key(&mut self) -> Result<(HaneulAddress, String), anyhow::Error> {
        ...
        self.0.add_key(HaneulKeyPair::Ed25519HaneulKeyPair(kp))?;
...
impl InMemKeystore {
    pub fn new(initial_key_number: usize) -> Self {
        ...
        let keys = (0..initial_key_number)
            ...
            .map(|(ad, k)| (ad, HaneulKeyPair::Ed25519HaneulKeyPair(k)))
            .collect::<BTreeMap<HaneulAddress, HaneulKeyPair>>();
