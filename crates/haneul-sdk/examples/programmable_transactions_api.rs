...
// 2) splits the coin into one coin of 1000 GEUNHWA and the rest,
// 3  transfers the split coin to second Haneul address,
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let (haneul, sender, recipient) = setup_for_write().await?;
    ...
    // 2) split coin
    // the amount we want in the new coin, 1000 GEUNHWA
