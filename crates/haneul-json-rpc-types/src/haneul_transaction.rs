...
pub struct DevInspectResults {
    ...
    pub results: Result<Vec<HaneulExecutionResult>, String>,
}
...
pub enum HaneulCommand {
    ...
    Upgrade(HaneulArgument, Vec<ObjectID>, HaneulMovePackage),
...
impl From<Command> for HaneulCommand {
    fn from(value: Command) -> Self {
        match value {
            ...
            Command::Publish(modules) => HaneulCommand::Publish(HaneulMovePackage {
            ...
            Command::Upgrade(ticket, dep_ids, modules) => HaneulCommand::Upgrade(
