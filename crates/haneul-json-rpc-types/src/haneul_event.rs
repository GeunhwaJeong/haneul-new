...
impl From<EventEnvelope> for HaneulEvent {
...
impl EventFilter {
    fn try_matches(&self, item: &HaneulEvent) -> HaneulResult<bool> {
        Ok(match self {
...
impl Filter<HaneulEvent> for EventFilter {
    fn matches(&self, item: &HaneulEvent) -> bool {
