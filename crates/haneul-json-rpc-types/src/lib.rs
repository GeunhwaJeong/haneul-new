...
pub struct DynamicFieldInfo {
    pub name: haneul_types::dynamic_field::DynamicFieldName,
    #[serde(flatten)]
    pub bcs_name: BcsName,
    pub type_: haneul_types::dynamic_field::DynamicFieldType,
    pub object_type: String,
    pub object_id: ObjectID,
    pub version: haneul_types::base_types::SequenceNumber,
    pub digest: haneul_types::digests::ObjectDigest,
}

impl From<haneul_types::dynamic_field::DynamicFieldInfo> for DynamicFieldInfo {
    fn from(
        haneul_types::dynamic_field::DynamicFieldInfo {
            name,
            bcs_name,
            type_,
            object_type,
