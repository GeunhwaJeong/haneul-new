...
impl NodeSyncStore {
    ...
    pub fn store_cert(&self, cert: &CertifiedTransaction) -> HaneulResult {
    ...
    pub fn get_cert(&self, tx: &TransactionDigest) -> HaneulResult<Option<CertifiedTransaction>> {
    ...
    pub fn cleanup_cert(&self, digest: &TransactionDigest) -> HaneulResult {
    ...
    pub fn latest_seq_for_peer(&self, peer: &AuthorityName) -> HaneulResult<Option<TxSequenceNumber>> {
    ...
    pub fn clear_effects_votes(&self, digest: TransactionDigest) -> HaneulResult {
