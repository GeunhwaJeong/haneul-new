...
pub trait TransactionKeyValueStore {
    ...
    async fn get_tx(&self, digest: TransactionDigest) -> HaneulResult<Transaction> {
    ...
    async fn get_events(&self, digest: TransactionEventsDigest) -> HaneulResult<TransactionEvents> {
