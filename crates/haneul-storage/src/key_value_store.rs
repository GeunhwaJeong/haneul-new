...
impl TransactionKeyValueStore {
    ...
    ) -> HaneulResult<Vec<Option<CertifiedCheckpointSummary>>> {
    ...
    pub async fn get_tx(&self, digest: TransactionDigest) -> HaneulResult<Transaction> {
    ...
    ) -> HaneulResult<CertifiedCheckpointSummary> {
