...
use haneul_types::base_types::{
    ObjectID, ObjectType, HaneulAddress, TransactionDigest, TxSequenceNumber,
};
        ...
        Ok(self
            ...
            .filter(move |((object_owner, _), obj_info)| {
                let to_include: bool = match &filter {
                    Some(HaneulObjectDataFilter::StructType(struct_tag)) => {
                    ...
                    Some(HaneulObjectDataFilter::MoveModule { package, module }) => {
                    ...
                    Some(HaneulObjectDataFilter::Package(package_id)) => {
                        if let ObjectType::Struct(o) = obj_info.clone().type_ {
