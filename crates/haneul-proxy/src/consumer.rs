...
pub struct NodeMetric {
    pub host: String,                 // the haneul node name from the blockchain
    pub network: String,              // the haneul blockchain name, mainnet
    pub peer_addr: Multiaddr,         // the sockaddr source address from the incoming request
    pub public_key: Ed25519PublicKey, // the public key from the haneul blockchain
...
impl ProtobufDecoder {
    ...
    /// parse a delimited buffer of protobufs. this is used to consume data sent from a haneul-node
