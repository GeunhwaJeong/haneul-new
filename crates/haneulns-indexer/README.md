...
This indexer is used to cache the on-chain state of the HaneulNS registry to a database,
...
- `BACKFILL_PROGRESS_FILE_PATH`: Expects a file in the format `{ "haneulns_indexing": <starting_checkpoint> }`
