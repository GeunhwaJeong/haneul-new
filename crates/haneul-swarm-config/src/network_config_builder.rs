...
use haneul_types::crypto::{
    ...
    AuthorityPublicKeyBytes, KeypairTraits, NetworkKeyPair, PublicKey, HaneulKeyPair,
};
...
impl<R: rand::RngCore + rand::CryptoRng> ConfigBuilder<R> {
    ...
    fn build_with_validators(
        ...
        let genesis = {
            let mut builder = haneul_genesis_builder::Builder::new()
        ...
        let validator_configs = validators
            ...
            .map(|(idx, validator)| {
                ...
                NodeConfig {
                    ...
                    genesis: haneul_config::node::Genesis::new(genesis.clone()),
                    grpc_load_shed: None,
...
impl<'a> FullnodeConfigBuilder<'a> {
    ...
    pub fn build(self) -> Result<NodeConfig, anyhow::Error> {
        ...
        Ok(NodeConfig {
            ...
            account_key_pair: KeyPairWithPath::new(HaneulKeyPair::Ed25519(account_key_pair)),
            worker_key_pair: KeyPairWithPath::new(HaneulKeyPair::Ed25519(worker_key_pair)),
            network_key_pair: KeyPairWithPath::new(HaneulKeyPair::Ed25519(network_key_pair)),
...
mod test {
    ...
    fn genesis_transaction() {
        ...
        let move_vm = std::sync::Arc::new(
            haneul_adapter::adapter::new_move_vm(
                native_functions,
                &protocol_config,
