...
fn build_execute_read_mask(options: &HaneulTransactionBlockResponseOptions) -> FieldMask {
...
fn grpc_error_to_rpc_error(
    error: haneul_indexer_alt_reader::fullnode_client::Error,
) -> RpcError<Error> {
    use haneul_indexer_alt_reader::fullnode_client::Error;
    match error {
