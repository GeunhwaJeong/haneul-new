...
use futures::future;
use haneul_indexer_alt_consistent_store::ObjectByOwnerKey;
...
use haneul_types::coin::COIN_STRUCT_NAME;
...
trait CoinsApi {
    ...
    /// If no coin type is specified, HANEUL coins are returned.
    ...
    async fn get_coin_metadata(
        ...
        coin_type: String,
    ) -> RpcResult<Option<HaneulCoinMetadata>>;
    ...
    /// If no coin type is specified, HANEUL coin balance is returned.
    #[method(name = "getBalance")]
    async fn get_balance(
        &self,
        /// the owner's Haneul address
        owner: HaneulAddress,
        /// optional type names for the coin (e.g., 0x168da5bf1f48dafc111b0a488fa454aca95e0b5e::usdc::USDC), default to 0x2::haneul::HANEUL if not specified.
        coin_type: Option<String>,
    ) -> RpcResult<Balance>;
}
...
/// Given the inner coin type, i.e 0x2::haneul::HANEUL, load the CoinMetadata object.
