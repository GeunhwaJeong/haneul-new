...
use haneul_rpc::proto::haneul::rpc::v2::Event as ProtoEvent;
...
use haneul_rpc_api::ledger_history::query_options::EventScanBounds;
use haneul_rpc_api::ledger_history::query_options::QueryOptions;
use haneul_rpc_api::ledger_history::query_options::ResolvedEventRange;
...
const EVENT_READ_MASK_DEFAULT: &str = haneul_rpc_api::read_mask_defaults::EVENT;
...
async fn resolve_event_range(
    ...
    Ok(options.apply_event_cursor_bounds(ResolvedEventRange {
        ...
        end_position: match options.ordering {
            haneul_rpc_api::ledger_history::query_options::Ordering::Ascending => {
                EventPosition::start_of_tx(tx_range.end)
            }
            haneul_rpc_api::ledger_history::query_options::Ordering::Descending => {
