...
use haneul_kvstore::tables::epochs::col;
...
use haneul_rpc::proto::haneul::rpc::v2::ProtocolConfig as RpcProtocolConfig;
use haneul_rpc::proto::haneul::rpc::v2::{GetEpochRequest, GetEpochResponse};
use haneul_rpc_api::{
    ErrorReason,
