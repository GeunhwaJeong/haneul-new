...
use haneul_kvstore::EPOCH_END_PIPELINE;
use haneul_kvstore::EPOCH_START_PIPELINE;
...
impl KvRpcServer {
    ...
    pub async fn start_service(
        ...
        use haneul_rpc_api::{RpcMetrics, RpcMetricsMakeCallbackHandler};
        ...
        let service = haneul_futures::service::Service::new()
            .spawn(async move {
                server_future.await?;
                Ok(())
            })
