...
//!
//! This crate defines a service that combines a [`haneul_indexer_alt_framework`] indexer, with a gRPC
...
use schema::Schema;
use haneul_indexer_alt_consistent_api::proto::{
...
pub async fn start_service(
    ...
    let rpc = RpcService::new(rpc_args, version, cancel.child_token())
