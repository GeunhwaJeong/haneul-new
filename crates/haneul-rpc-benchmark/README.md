...
cargo run --bin haneul-rpc-benchmark direct --db-url postgres://postgres:postgres@localhost:5432/haneul --concurrency 50 --duration-secs 30

# JSON RPC endpoints:
cargo run --bin haneul-rpc-benchmark jsonrpc --endpoint http://127.0.0.1:9000 --concurrency 50 --requests-file requests.jsonl [--methods-to-skip method1,method2]
