...
mod tests {
    ...
    use haneul_indexer_alt_schema::{schema::obj_versions, MIGRATIONS};
    use haneul_pg_db::{temp::TempDb, Db, DbArgs};
    ...
    async fn test_version_bounded() {
        ...
        assert_eq!(
            ...
            HashMap::from_iter([(K(o0, 2), stored(o0, d0, 2)), (K(o0, 3), stored(o0, d0, 2))]),
        );
        ...
        assert_eq!(
            ...
            HashMap::from_iter([(K(o1, 2), stored(o1, d1, 2))]),
        );
        ...
        assert_eq!(
            ...
            .unwrap(),
            HashMap::from_iter([
                (K(o0, 1), stored(o0, d0, 1)),
                (K(o0, 2), stored(o0, d0, 2)),
                (K(o0, 3), stored(o0, d0, 2)),
                (K(o0, 4), stored(o0, d0, 4)),
                (K(o0, 5), stored(o0, d0, 4)),
                (K(o1, 2), stored(o1, d1, 2)),
            ])
        );
    }
}
