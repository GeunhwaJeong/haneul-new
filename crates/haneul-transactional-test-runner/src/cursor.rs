...
/// - Struct tags (e.g., `0x2::coin::Coin<0x2::haneul::HANEUL>>`)
...
mod tests {
    ...
    fn test_struct_tag() {
        ...
        assert_eq!(
            parse("bcs(0x2::table::Table<address, 0x2::coin::Coin<0x2::haneul::HANEUL>>)").unwrap(),
            bcs
        );
        assert_eq!(
            parse("bin(0x2::table::Table<address, 0x2::coin::Coin<0x2::haneul::HANEUL>>)").unwrap(),
            bin
        );
    }
}
