...
impl TestHarness {
    ...
    fn default_config(&self) -> IndexerConfig {
        IndexerConfig {
            rest_url: "https://checkpoints.testnet.haneul.io".to_string(),
            ...
            remote_store_url: "https://checkpoints.testnet.haneul.io".to_string(),
            streaming_url: None,
            rpc_api_url: None,
            rpc_username: None,
            rpc_password: None,
    ...
    async fn run_indexer(&self, config: IndexerConfig) {
        ...
        let service = haneul_analytics_indexer::build_analytics_indexer(config, metrics, registry)
            .await
...
async fn test_migration_no_files_after_checkpoint_error() {
    ...
    let result =
        haneul_analytics_indexer::build_analytics_indexer(migration_config, metrics, registry).await;
