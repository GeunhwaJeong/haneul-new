...
#[derive(Serialize, Clone, SerializeRow)]
pub struct TransactionObjectRow {
    // indexes
    pub(crate) object_id: String,
...
// Move call identity is via `transaction_digest` and `call_index`.
#[derive(Serialize, Clone, SerializeRow)]
