...
use haneul_storage::object_store::util::find_all_dirs_with_epoch_prefix;
use haneul_storage::object_store::util::find_all_files_with_epoch_prefix;
use tracing::info;
...
mod tests {
    ...
    use haneul_indexer_alt_framework::store::Connection;
    ...
    fn test_config(object_store: Arc<dyn object_store::ObjectStore>) -> IndexerConfig {
        IndexerConfig {
            ...
            remote_store_url: "https://checkpoints.mainnet.haneul.io".to_string(),
            streaming_url: None,
            rpc_api_url: None,
            rpc_username: None,
            rpc_password: None,
