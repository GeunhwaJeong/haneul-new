...
impl InputObjectTracker {
    pub fn new(txn_data: &TransactionData) -> Self {
    ...
    pub fn get_input_object_kind(&self, object_id: &ObjectID) -> Option<InputObjectKind> {
...
impl ObjectStatusTracker {
    pub fn new(effects: &TransactionEffects) -> Self {
    ...
    pub fn get_object_status(&self, object_id: &ObjectID) -> Option<ObjectStatus> {
...
pub fn initial_shared_version(object: &Object) -> Option<u64> {
    match object.owner {
        Owner::Shared {
...
pub fn get_owner_type(object: &Object) -> OwnerType {
    match object.owner {
...
pub fn get_owner_address(object: &Object) -> Option<String> {
    match object.owner {
...
pub fn get_is_consensus(object: &Object) -> bool {
    match object.owner {
    ...
    match move_value {
        MoveValue::Struct(move_struct) => {
            ...
            if "0x2::object::UID" == struct_name {
                ...
                // Option in haneul move is implemented as vector of size 1
