...
// gas coin by-ref
//> test::m::heat_imm<haneul::coin::Coin<haneul::haneul::HANEUL>>(Gas);
//> test::m::cool(Result(0));
//> test::m::play_coin(Gas);

//# programmable --sender A
// gas coin by-mut
//> test::m::heat_mut<haneul::coin::Coin<haneul::haneul::HANEUL>>(Gas);
//> test::m::cool(Result(0));
//> test::m::play_coin(Gas)
...
//> 0: test::m::heat_imm<haneul::transfer::Receiving<test::m::A>>(Input(0));
//> test::m::cool(Result(0));
//> test::m::play_receiving(Input(0));

//# programmable --sender A --inputs receiving(4,0)
// receiving input by-mut
//> 0: test::m::heat_mut<haneul::transfer::Receiving<test::m::A>>(Input(0));
//> test::m::cool(Result(0));
//> test::m::play_receiving(Input(0));

//# programmable --sender A --inputs receiving(4,0)
// receiving input by-val
//> 0: test::m::heat_val<haneul::transfer::Receiving<test::m::A>>(Input(0));
//> test::m::cool(NestedResult(0,1));
