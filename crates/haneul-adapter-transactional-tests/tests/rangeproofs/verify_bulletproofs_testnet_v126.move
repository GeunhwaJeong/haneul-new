...
//# init --addresses test=0x0 --protocol-version 126 --chain testnet

//# publish
#[allow(deprecated_usage)]
module test::bulletproofs;
use haneul::rangeproofs::verify_bulletproofs_ristretto255;
use haneul::ristretto255;

public entry fun verify() {
    let commitments = vector<haneul::group_ops::Element<ristretto255::G>>[];
