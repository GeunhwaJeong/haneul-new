...
module test::coin_in_vec {
    ...
    public fun deposit(wrapper: &mut Wrapper, c: Coin<HANEUL>) {
...
//# run test::coin_in_vec::deposit --args object(1,1) object(2,0) --sender A

//# run test::coin_in_vec::withdraw --args object(1,1) --sender A
