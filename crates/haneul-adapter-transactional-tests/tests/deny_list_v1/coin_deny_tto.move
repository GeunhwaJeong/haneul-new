...
// Deny account A.
//# run haneul::coin::deny_list_add --args object(0x403) object(1,3) @A --type-args test::regulated_coin::REGULATED_COIN --sender A

// Try to receive coin in Wallet. This should now fail.
//# run test::regulated_coin::receive_coin --args object(1,6) receiving(1,5) --sender A

// Undeny account A.
//# run haneul::coin::deny_list_remove --args object(0x403) object(1,3) @A --type-args test::regulated_coin::REGULATED_COIN --sender A
