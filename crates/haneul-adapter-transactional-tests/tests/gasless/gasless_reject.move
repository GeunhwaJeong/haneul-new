...
//# programmable --sender A --address-balance-gas --gas-price 0 --gas-budget 0 --inputs withdraw<haneul::balance::Balance<test::usdc::USDC>>(1000)
// Reject: coin::from_balance is not a whitelisted gasless function
//> 0: haneul::balance::redeem_funds<test::usdc::USDC>(Input(0));
//> 1: haneul::coin::from_balance<test::usdc::USDC>(Result(0));

//# programmable --sender A --address-balance-gas --gas-price 0 --gas-budget 0 --inputs withdraw<haneul::balance::Balance<test::usdc::USDC>>(500)
// Reject: balance::value is not a whitelisted gasless function
//> 0: haneul::balance::redeem_funds<test::usdc::USDC>(Input(0));
//> 1: haneul::balance::value<test::usdc::USDC>(Result(0));

//# programmable --sender A --address-balance-gas --gas-price 0 --gas-budget 0 --inputs withdraw<haneul::balance::Balance<test::usdc::USDC>>(500)
// Reject: funds_accumulator::withdrawal_owner is not a whitelisted gasless function
//> 0: haneul::funds_accumulator::withdrawal_owner<haneul::balance::Balance<test::usdc::USDC>>(Input(0));

//# programmable --sender A --address-balance-gas --gas-price 0 --gas-budget 1000 --inputs withdraw<haneul::balance::Balance<test::usdc::USDC>>(500) @B
...
//> 0: haneul::balance::redeem_funds<test::usdc::USDC>(Input(0));
//> 1: haneul::balance::send_funds(Result(0), Input(1));

//# programmable --sender A --address-balance-gas --gas-price 0 --gas-budget 0 --inputs withdraw<haneul::balance::Balance<test::usdc::USDC>>(500) @B
// Reject: send_funds with two type args
//> 0: haneul::balance::redeem_funds<test::usdc::USDC>(Input(0));
//> 1: haneul::balance::send_funds<test::usdc::USDC, test::usdc::USDC>(Result(0), Input(1));

//# programmable --sender A --address-balance-gas --gas-price 0 --gas-budget 0 --inputs withdraw<haneul::balance::Balance<test::usdc::USDC>>(500) 250u256
// Reject: withdrawal_split with non-Balance type arg
//> 0: haneul::funds_accumulator::withdrawal_split<test::usdc::USDC>(Input(0), Input(1));

//# programmable --sender A --address-balance-gas --gas-price 0 --gas-budget 0 --inputs withdraw<haneul::balance::Balance<test::not_allowed::NOT_ALLOWED>>(500) @B
// Reject: NOT_ALLOWED token type is not in the gasless allowlist
//> 0: haneul::balance::redeem_funds<test::not_allowed::NOT_ALLOWED>(Input(0));
//> 1: haneul::balance::send_funds<test::not_allowed::NOT_ALLOWED>(Result(0), Input(1));

//# programmable --sender A --address-balance-gas --gas-price 0 --gas-budget 0 --inputs object(1,1)
// Reject: object inputs are not allowed
//> 0: haneul::coin::value<test::usdc::USDC>(Input(0));
