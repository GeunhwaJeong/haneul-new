...
module tto::M1 {
    ...
    public entry fun pass_through(_x: &mut Receiving<B>) { }
...
// Pass through the receiving object by mut ref, and then try to reuse the input receiving object argument -- should succeed.
