...
public struct S has key, store { id: haneul::object::UID, v: u64 }

public fun make(ctx: &mut haneul::tx_context::TxContext) {
    haneul::transfer::share_object(S { id: haneul::object::new(ctx), v: 0 })
}
