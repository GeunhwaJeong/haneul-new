...
//> 0: Publish(Test, [DepV2, haneul, std]);
//> 1: DepV1::M1::f1();
...
//> 0: DepV1::M1::f1();
//> 1: Publish(Test, [DepV2, haneul, std]);
...
//> 0: Publish(Test, [DepV1, haneul, std]);
...
//> 0: Publish(Test, [DepV1, haneul, std]);
//> 1: Publish(NoInit, [DepV2, haneul, std]);
//> TransferObjects([Result(0), Result(1)], Input(0))
