...
public fun mint(ctx: &mut TxContext) {
    ...
    transfer::party_transfer(child, haneul::party::single_owner(ctx.sender()))
}
...
//> haneul::transfer::public_party_transfer<ex::m::A>(Input(0), Result(0))
...
//> 0: haneul::party::single_owner(Input(1));
//> haneul::transfer::public_party_transfer<ex::m::Child>(Input(0), Result(0))
