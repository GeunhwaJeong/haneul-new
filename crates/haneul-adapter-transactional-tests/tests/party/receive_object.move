...
public fun mint(ctx: &mut TxContext) {
    ...
    transfer::public_party_transfer(party_parent, haneul::party::single_owner(tx_context::sender(ctx)));
    ...
    transfer::public_party_transfer(fastpath_child_party_parent, haneul::party::single_owner(fastpath_address));
    ...
    transfer::public_party_transfer(party_child_party_parent, haneul::party::single_owner(party_address));
}

public entry fun receiver(parent: &mut PubA, x: haneul::transfer::Receiving<PubB>) {
