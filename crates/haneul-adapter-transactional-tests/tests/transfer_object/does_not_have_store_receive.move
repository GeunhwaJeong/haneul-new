...
//> 1: haneul::transfer::public_receive<test::m::S>(Result(0), Input(1));

//# programmable --sender A --inputs object(10,0) receiving(10,1)
//> 0: test::m::parent_uid(Input(0));
//> 1: haneul::transfer::receive<test::m::S>(Result(0), Input(1));
//> 2: haneul::object::delete(Result(0));
...
//> 0: test::m::parent_uid(Input(0));
//> 1: haneul::transfer::receive<test::m::Store>(Result(0), Input(1));
//> 2: haneul::object::delete(Result(0));
...
//# programmable --sender A --inputs object(15,0) receiving(15,1)
//> 0: test::m::parent_uid(Input(0));
//> 1: haneul::transfer::public_receive<test::m::Store>(Result(0), Input(1));
//> 2: test::m::destroy_store(Result(1));
//> 3: haneul::object::delete(Result(0));
