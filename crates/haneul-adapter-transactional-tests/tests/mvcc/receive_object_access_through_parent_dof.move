...
//# run tto::M1::receive_b_parent --args object(2,0) receiving(2,5) --sender A

//# run tto::M1::receive_b_parent --args object(2,0) receiving(2,1) --sender A

//# run tto::M1::receive_wrapped --args object(2,0) receiving(2,5) --sender A
