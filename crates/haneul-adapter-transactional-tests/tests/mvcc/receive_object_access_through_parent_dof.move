...
//# run tto::M1::receive_b_parent --args object(2,4) receiving(2,9) --sender A

//# run tto::M1::receive_b_parent --args object(2,4) receiving(2,5) --sender A

//# run tto::M1::receive_wrapped --args object(2,4) receiving(2,9) --sender A
