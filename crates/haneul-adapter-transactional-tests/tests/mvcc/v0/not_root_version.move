...
//# programmable --sender P2 --inputs object(2,0)@4 object(6,0)@2 0 --dev-inspect
...
//# programmable --sender P2 --inputs object(2,0)@4 object(6,0)@3 1 --dev-inspect
//> 0: test::m::append(Input(0), Input(1));
//> 1: test::m::check(Input(0), Input(2));

// @2 with value 1 aborts

//# programmable --sender P2 --inputs object(2,0)@4 object(6,0)@2 1 --dev-inspect
//> 0: test::m::append(Input(0), Input(1));
//> 1: test::m::check(Input(0), Input(2));

// @3 with value 0 aborts

//# programmable --sender P2 --inputs object(2,0)@4 object(6,0)@3 0 --dev-inspect
//> 0: test::m::append(Input(0), Input(1));
//> 1: test::m::check(Input(0), Input(2));
