...
//# programmable --sender A --inputs withdraw<haneul::balance::Balance<test::large_balance::MARKER>>(18446744073709551615) @B
//> 0: haneul::balance::redeem_funds<test::large_balance::MARKER>(Input(0));
//> 1: haneul::balance::send_funds<test::large_balance::MARKER>(Result(0), Input(1));
...
//# programmable --sender A --inputs withdraw<haneul::balance::Balance<test::large_balance::MARKER>>(18446744073709551615) withdraw<haneul::balance::Balance<test::large_balance::MARKER>>(18446744073709551615) @B
//> 0: haneul::balance::redeem_funds<test::large_balance::MARKER>(Input(0));
//> 1: haneul::balance::redeem_funds<test::large_balance::MARKER>(Input(1));
//> 2: haneul::balance::join<test::large_balance::MARKER>(Result(0), Result(1));
//> 3: haneul::balance::send_funds<test::large_balance::MARKER>(Result(0), Input(2));
