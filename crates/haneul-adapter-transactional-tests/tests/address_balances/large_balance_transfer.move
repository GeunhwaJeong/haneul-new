...
//# programmable --sender A --inputs withdraw<haneul::balance::Balance<test::large_balance::MARKER>>(18446744073709551614) @B
...
//# programmable --sender A --inputs withdraw<haneul::balance::Balance<test::large_balance::MARKER>>(18446744073709551614) withdraw<haneul::balance::Balance<test::large_balance::MARKER>>(18446744073709551614) @B
//> 0: haneul::balance::redeem_funds<test::large_balance::MARKER>(Input(0));
