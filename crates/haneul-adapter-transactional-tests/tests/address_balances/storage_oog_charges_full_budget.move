...
//# programmable --sender A --gas-budget 2500000 --gas-payment withdraw<haneul::balance::Balance<haneul::haneul::HANEUL>>(10000000) --inputs object(3,0) object(4,0) object(5,0) object(6,0) object(7,0) @A
