...
pub fn build_haneul_framework_modules(lib_dir: &Path) -> HaneulResult<Vec<CompiledModule>> {
...
pub fn verify_modules(modules: &[CompiledModule]) -> HaneulResult {
    for m in modules {
...
pub fn build_framework(framework_dir: &Path) -> HaneulResult<Vec<CompiledModule>> {
