...
mod tests {
    ...
    #[test]
    fn test_types() {
        assert_snapshot!(lexemes(r#"{0x2::table::Table<address, 0x2::coin::Coin<0x2::haneul::HANEUL>>}"#), @r###"
        L(false, LBrace, 0, "{")
        L(false, NumHex, 3, "2")
        L(false, CColon, 4, "::")
    ...
    fn test_positional_struct_literals() {
        assert_snapshot!(lexemes(r#"{0x2::balance::Balance<0x2::haneul::HANEUL>(42u64)}"#), @r###"
        L(false, LBrace, 0, "{")
        L(false, NumHex, 3, "2")
        L(false, CColon, 4, "::")
    ...
    fn test_struct_literals() {
        assert_snapshot!(lexemes(r#"{0x2::coin::Coin<0x2::haneul::HANEUL> { id: @0x123, value: 42u64 }}"#), @r###"
        L(false, LBrace, 0, "{")
        L(false, NumHex, 3, "2")
        L(false, CColon, 4, "::")
