...
use haneul_indexer_alt_schema::{objects::StoredObjInfoTemp, schema::obj_info_temp};
...
impl Handler for ObjInfoTemp {
    ...
    async fn prune(
        ...
        use haneul_indexer_alt_schema::schema::obj_info_temp::dsl;
...
mod tests {
    ...
    use haneul_indexer_alt_schema::{objects::StoredOwnerKind, MIGRATIONS};
