...
impl ObjectStore for RocksDbStore {
    fn get_object(&self, object_id: &haneul_types::base_types::ObjectID) -> Option<Object> {
...
where
    I: Iterator<Item = Result<crate::rpc_index::EventIndexKey, TypedStoreError>>,
{
    type Item = Result<(u64, u32, u32, haneul_types::event::Event), TypedStoreError>;
...
impl RpcIndexes for RestReadStore {
    ...
    fn authenticated_event_iter(
        ...
        Box<
            dyn Iterator<Item = Result<(u64, u32, u32, haneul_types::event::Event), TypedStoreError>>
                + '_,
        >,
    > {
