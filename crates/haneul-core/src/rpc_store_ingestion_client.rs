...
//! perpetual stores.
//!
//! The embedded `haneul-rpc-store` indexer fetches historical checkpoints by
...
//!
//! [`Checkpoint`]: haneul_types::full_checkpoint_content::Checkpoint

use async_trait::async_trait;
use haneul_indexer_alt_framework::ingestion::ingestion_client::CheckpointError;
use haneul_indexer_alt_framework::ingestion::ingestion_client::CheckpointResult;
use haneul_indexer_alt_framework::ingestion::ingestion_client::IngestionClientTrait;
