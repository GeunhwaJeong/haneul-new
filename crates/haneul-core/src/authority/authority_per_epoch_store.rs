...
use haneul_types::crypto::{AuthoritySignInfo, Signature};
...
impl AuthorityPerEpochStore {
    ...
    pub fn epoch_start_configuration(&self) -> HaneulResult<EpochStartConfiguration> {
        Ok(self
            .tables
            .epoch_start_configuration
            .get(&())?
