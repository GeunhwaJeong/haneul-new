...
use haneul_types::crypto::{AuthoritySignInfo, RandomnessRound};
...
use haneullabs_common::{debug_fatal, in_test_configuration};
...
impl AuthorityPerEpochStore {
    ...
    pub fn get_owned_object_locks_map(
        &self,
        obj_refs: &[ObjectRef],
    ) -> HaneulResult<HashMap<ObjectRef, LockDetails>> {
