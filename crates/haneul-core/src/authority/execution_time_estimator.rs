...
use lru::LruCache;
use haneullabs_common::{assert_reachable, debug_fatal, in_antithesis, in_test_configuration};
    ...
    pub fn spawn(
        ...
        let mut observer = Self {
            ...
            next_generation_number: SystemTime::now()
                ...
                .as_micros()
                .try_into()
                .expect("This build of haneul is not supported in the year 500,000"),
        };
...
// Key used to save StoredExecutionTimeObservations in the Haneul system state object's
// `extra_fields` Bag.
...
mod tests {
    ...
    use haneul_types::transaction::{Argument, CallArg, ObjectArg, ProgrammableMoveCall};
    use {
