...
impl AuthorityStore {
    ...
    pub async fn notify_read_root_state_hash(
        &self,
        epoch: EpochId,
    ) -> HaneulResult<(CheckpointSequenceNumber, GlobalStateHash)> {
...
impl GlobalStateHashStore for AuthorityStore {
    ...
    fn get_root_state_hash_for_epoch(
        &self,
        epoch: EpochId,
    ) -> HaneulResult<Option<(CheckpointSequenceNumber, GlobalStateHash)>> {
        self.perpetual_tables
    ...
    fn get_root_state_hash_for_highest_epoch(
        &self,
    ) -> HaneulResult<Option<(EpochId, (CheckpointSequenceNumber, GlobalStateHash))>> {
        Ok(self
            .perpetual_tables
            .root_state_hash_by_epoch
