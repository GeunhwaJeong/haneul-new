...
impl AuthorityStore {
    ...
    pub fn get_last_shared_object_deletion_info(
        ...
        object_id: &ObjectID,
        epoch_id: EpochId,
    ) -> HaneulResult<Option<(SequenceNumber, TransactionDigest)>> {
    ...
    pub fn get_latest_object_or_tombstone(
        &self,
        object_id: ObjectID,
    ) -> Result<Option<(ObjectKey, ObjectOrTombstone)>, HaneulError> {
    ...
    /// If the intent is for testing, you can use AuthorityState:: get_haneul_system_state_object_for_testing.
    pub fn get_haneul_system_state_object_unsafe(&self) -> HaneulResult<HaneulSystemState> {
