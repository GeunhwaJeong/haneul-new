...
impl AuthorityStore {
    ...
    pub(crate) async fn insert_genesis_object(&self, object: Object) -> HaneulResult {
    ...
    async fn insert_object_direct(&self, object_ref: ObjectRef, object: &Object) -> HaneulResult {
    ...
    ) -> Result<Vec<Option<VerifiedTransaction>>, HaneulError> {
        Ok(self
            .perpetual_tables
            .transactions
