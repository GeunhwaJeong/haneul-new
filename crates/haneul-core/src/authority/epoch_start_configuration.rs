...
use haneul_types::bridge::is_bridge_committee_initiated;
...
impl EpochStartConfiguration {
    ...
    pub fn authenticator_obj_initial_shared_version(&self) -> Option<SequenceNumber> {
        self.system_object_initial_shared_version(HANEUL_AUTHENTICATOR_STATE_OBJECT_ID)
    }

    pub fn randomness_obj_initial_shared_version(&self) -> Option<SequenceNumber> {
        self.system_object_initial_shared_version(HANEUL_RANDOMNESS_STATE_OBJECT_ID)
    }

    pub fn coin_deny_list_obj_initial_shared_version(&self) -> Option<SequenceNumber> {
        self.system_object_initial_shared_version(HANEUL_DENY_LIST_OBJECT_ID)
    }

    pub fn bridge_obj_initial_shared_version(&self) -> Option<SequenceNumber> {
        self.system_object_initial_shared_version(HANEUL_BRIDGE_OBJECT_ID)
    }

    pub fn accumulator_root_obj_initial_shared_version(&self) -> Option<SequenceNumber> {
        self.system_object_initial_shared_version(HANEUL_ACCUMULATOR_ROOT_OBJECT_ID)
    }

    pub fn coin_registry_obj_initial_shared_version(&self) -> Option<SequenceNumber> {
        self.system_object_initial_shared_version(HANEUL_COIN_REGISTRY_OBJECT_ID)
    }

    pub fn display_registry_obj_initial_shared_version(&self) -> Option<SequenceNumber> {
        self.system_object_initial_shared_version(HANEUL_DISPLAY_REGISTRY_OBJECT_ID)
    }
