...
pub struct AuthorityPerpetualTables {
    ...
    pub(crate) expected_network_haneul_amount: DBMap<(), u64>,
...
impl AuthorityPerpetualTables {
    ...
    // Constructs `haneul_types::object::Object` from `StoreObjectWrapper`.
    ...
    ) -> HaneulResult<Option<TrustedTransaction>> {
    ...
    pub fn reset_db_for_execution_since_genesis(&self) -> HaneulResult {
        ...
        self.expected_network_haneul_amount.unsafe_clear()?;
    ...
    pub fn insert_object_test_only(&self, object: Object) -> HaneulResult {
    ...
    // fallible get object methods for haneul-tool, which may need to attempt to read a corrupted database
    pub fn get_object_fallible(&self, object_id: &ObjectID) -> HaneulResult<Option<Object>> {
        let obj_entry = self
            .objects
            .unbounded_iter()
            .skip_prior_to(&ObjectKey::max_for_id(object_id))?
