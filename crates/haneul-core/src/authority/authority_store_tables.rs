...
impl AuthorityPerpetualTables {
    ...
    fn construct_object(&self, store_object: StoreObjectValue) -> Result<Object, HaneulError> {
    ...
    pub fn object(&self, store_object: StoreObjectWrapper) -> Result<Option<Object>, HaneulError> {
