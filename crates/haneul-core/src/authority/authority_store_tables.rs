...
use haneul_types::base_types::{ExecutionDigests, SequenceNumber};
use haneul_types::batch::{SignedBatch, TxSequenceNumber};
use haneul_types::messages::TrustedCertificate;
...
pub struct AuthorityPerpetualTables {
    ...
    // See https://github.com/GeunhwaJeong/haneul/pull/4395 for the reason why.
    //
...
impl AuthorityPerpetualTables {
    ...
    pub fn set_recovery_epoch(&self, epoch: EpochId) -> HaneulResult {
