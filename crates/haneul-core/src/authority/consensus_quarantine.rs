...
use haneul_types::base_types::{AuthorityName, SequenceNumber};
...
impl ConsensusOutputCache {
    pub(crate) fn new(
        ...
        assert!(
            ...
            "This version of haneul-node can only run after data quarantining has been enabled. Please run version 1.45.0 or later to the end of the current epoch and retry"
        );
