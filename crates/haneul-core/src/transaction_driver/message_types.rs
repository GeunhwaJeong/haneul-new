...
fn try_from_raw_rejected_status(rejected: RawRejectedStatus) -> Result<RejectReason, HaneulError> {
...
fn try_from_response_rejected(reason: RejectReason) -> Result<RawRejectedStatus, HaneulError> {
