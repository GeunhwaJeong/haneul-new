...
impl AuthorityState {
    ...
    pub async fn get_object_info(&self, object_id: &ObjectID) -> Result<ObjectRead, HaneulError> {
    ...
    pub async fn get_owned_objects(&self, account_addr: HaneulAddress) -> HaneulResult<Vec<ObjectRef>> {
