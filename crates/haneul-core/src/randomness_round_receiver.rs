...
use haneul_types::crypto::RandomnessSignature;
use haneul_types::effects::TransactionEffectsAPI;
use haneul_types::executable_transaction::VerifiedExecutableTransaction;
use haneul_types::execution_status::ExecutionStatus;
use haneul_types::transaction::{TransactionKey, VerifiedTransaction};
use haneullabs_common::debug_fatal_no_invariant;
...
pub struct RandomnessRoundReceiverHandle {
    consensus_signatures_tx: haneullabs_metrics::monitored_mpsc::Sender<bytes::Bytes>,
...
impl RandomnessRoundReceiverHandle {
    pub fn new_for_testing() -> Arc<Self> {
        let (consensus_signatures_tx, _) =
            haneullabs_metrics::monitored_mpsc::channel("test_auxiliary", 1);
...
pub struct RandomnessRoundReceiver {
    ...
    consensus_signatures_rx: haneullabs_metrics::monitored_mpsc::Receiver<bytes::Bytes>,
...
impl RandomnessRoundReceiver {
    ...
    pub fn spawn(
        ...
        let (consensus_signatures_tx, consensus_signatures_rx) =
            haneullabs_metrics::monitored_mpsc::channel(
