...
use crate::authority::authority_store::HaneulLockResult;
...
pub trait ExecutionCacheRead: Send + Sync {
    ...
    fn get_objects(&self, objects: &[ObjectID]) -> HaneulResult<Vec<Option<Object>>> {
    ...
    fn get_latest_object_or_tombstone(
        &self,
        object_id: ObjectID,
    ) -> HaneulResult<Option<(ObjectKey, ObjectOrTombstone)>>;
    ...
    fn multi_get_object_by_key(&self, object_keys: &[ObjectKey]) -> HaneulResult<Vec<Option<Object>>>;
    ...
    ) -> HaneulResult<Option<Arc<VerifiedTransaction>>> {
    ...
    fn is_tx_already_executed(&self, digest: &TransactionDigest) -> HaneulResult<bool> {
    ...
    fn get_events(&self, digest: &TransactionEventsDigest) -> HaneulResult<Option<TransactionEvents>> {
