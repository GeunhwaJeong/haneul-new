...
impl MysticetiClient {
    ...
    async fn submit_transaction(&self, transaction: &ConsensusTransaction) -> HaneulResult {
...
impl LazyMysticetiClient {
    ...
    async fn get(&self) -> Guard<Option<Arc<MysticetiClient>>> {
        ...
        // We expect this to get called during the HANEUL process start. After that at least one
