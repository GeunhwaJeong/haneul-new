...
//! stream.
//!
//! The embedded `haneul-rpc-store` indexer consumes the tip of the chain from the
...
//!     haneul_indexer_alt_framework::ingestion::streaming_client::CheckpointStreamingClient
...
use futures::stream;
use haneul_indexer_alt_framework::ingestion::error::Error;
use haneul_indexer_alt_framework::ingestion::streaming_client::CheckpointStream;
use haneul_indexer_alt_framework::ingestion::streaming_client::CheckpointStreamingClient;
