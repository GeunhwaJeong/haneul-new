...
use haneul_macros::{register_fail_point, sim_test};
use haneul_types::base_types::HaneulAddress;
use haneul_types::base_types::TransactionDigest;
use haneul_types::crypto::{AccountKeyPair, deterministic_random_account_key, get_key_pair};
use haneul_types::effects::TransactionEffectsAPI;
use haneul_types::object::{Object, generate_test_gas_objects};
...
async fn test_quorum_driver_object_locked() -> Result<(), anyhow::Error> {
    ...
    let (sender, keypair): (HaneulAddress, AccountKeyPair) = deterministic_random_account_key();
