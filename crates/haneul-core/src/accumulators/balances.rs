...
use haneul_types::{
    TypeTag, accumulator_root::AccumulatorValue, balance::Balance, base_types::HaneulAddress,
    error::HaneulResult, storage::ChildObjectResolver,
};

/// Get the balance for a given owner address (which can be a wallet or an object)
/// and currency type (e.g. 0x2::haneul::HANEUL)
pub fn get_balance(
    owner: HaneulAddress,
