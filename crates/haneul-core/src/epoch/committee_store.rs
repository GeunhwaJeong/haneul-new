...
impl CommitteeStore {
    ...
    pub fn init_genesis_committee(&self, genesis_committee: Committee) -> HaneulResult {
    ...
    pub fn insert_new_committee(&self, new_committee: &Committee) -> HaneulResult {
    ...
    pub fn get_committee(&self, epoch_id: &EpochId) -> HaneulResult<Option<Arc<Committee>>> {
    ...
    pub fn get_latest_committee(&self) -> HaneulResult<Committee> {
        Ok(self
            .tables
            .committee_map
    ...
    fn database_is_empty(&self) -> HaneulResult<bool> {
        Ok(self
            .tables
            .committee_map
            .safe_iter()
