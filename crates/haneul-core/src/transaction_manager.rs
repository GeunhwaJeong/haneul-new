...
use haneul_types::{base_types::TransactionDigest, error::HaneulResult, messages::VerifiedCertificate};
...
impl TransactionManager {
    ...
    pub(crate) async fn enqueue(&mut self, certs: Vec<VerifiedCertificate>) -> HaneulResult<()> {
        for cert in certs {
