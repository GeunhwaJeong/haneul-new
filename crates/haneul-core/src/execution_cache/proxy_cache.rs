...
use haneul_types::storage::{MarkerValue, ObjectKey, ObjectOrTombstone, PackageObject};
...
impl ObjectCacheRead for ProxyCache {
    ...
    fn get_haneul_system_state_object_unsafe(&self) -> HaneulResult<HaneulSystemState> {
        delegate_method!(self.get_haneul_system_state_object_unsafe())
    }
...
impl ExecutionCacheReconfigAPI for ProxyCache {
    ...
    fn expensive_check_haneul_conservation(
        ...
        delegate_method!(self.expensive_check_haneul_conservation(old_epoch_store))
    }
