...
impl CheckpointStore {
    ...
    fn load_locals(&mut self) -> Result<CheckpointLocals, HaneulError> {
    ...
    pub fn new_proposal(&mut self) -> Result<CheckpointProposal, HaneulError> {
    ...
    pub fn set_proposal(&mut self) -> Result<CheckpointProposal, HaneulError> {
        // Check that:
