...
impl CheckpointExecutor {
    ...
    pub async fn run_epoch(
        ...
        loop {
            let schedule_scope = haneullabs_metrics::monitored_scope("ScheduleCheckpointExecution");
            ...
            tokio::select! {
                ...
                Some(Ok((checkpoint, checkpoint_acc, checkpoint_data, tx_digests, randomness_rounds))) = pending.next() => {
                    let _process_scope = haneullabs_metrics::monitored_scope("ProcessExecutedCheckpoint");
...
async fn execute_transactions(
    ...
    data_ingestion_dir: Option<PathBuf>,
    subscription_service_enabled: bool,
) -> HaneulResult<(Option<Accumulator>, Option<CheckpointData>)> {
...
async fn finalize_checkpoint(
    ...
    data_ingestion_dir: Option<PathBuf>,
    subscription_service_enabled: bool,
) -> HaneulResult<(Accumulator, Option<CheckpointData>)> {
