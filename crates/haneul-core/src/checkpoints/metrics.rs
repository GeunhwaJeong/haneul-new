...
pub struct CheckpointMetrics {
    ...
    pub checkpoint_creation_latency_ms: HaneullabsHistogram,
    ...
    // TODO: delete once users are migrated to non-Haneullabs histogram.
    pub last_created_checkpoint_age_ms: HaneullabsHistogram,
    pub last_certified_checkpoint_age: Histogram,
    // TODO: delete once users are migrated to non-Haneullabs histogram.
    pub last_certified_checkpoint_age_ms: HaneullabsHistogram,
}
...
impl CheckpointMetrics {
    pub fn new(registry: &Registry) -> Arc<Self> {
        let this = Self {
            ...
            last_created_checkpoint_age_ms: HaneullabsHistogram::new_in_registry(
            ...
            last_certified_checkpoint_age_ms: HaneullabsHistogram::new_in_registry(
            ...
            checkpoint_creation_latency_ms: HaneullabsHistogram::new_in_registry(
