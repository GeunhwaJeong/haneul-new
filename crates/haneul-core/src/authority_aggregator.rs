                        ...
                        match result {
                            ...
                            maybe_err => {
                                ...
                                let err = match maybe_err {
                                    Err(err) => err,
                                    Ok(_) => HaneulError::ByzantineAuthoritySuspicion {
                                        authority: name,
                                    }
                                };
                                state.errors.push(err);
                    ...
                    match (resp.certified_transaction, resp.signed_effects) {
                        ...
                        _ => {
                            if authorities.is_some() {
                                ...
                                Err(HaneulError::ByzantineAuthoritySuspicion { authority })
                            } else {
                    ...
                    Box::pin(async move {
                        ...
                        match result {
                            ...
                            Ok(_) => {
                                ...
                                state.errors.push((
                                    name,
                                    HaneulError::ByzantineAuthoritySuspicion { authority: name },
                                ));
                            }
