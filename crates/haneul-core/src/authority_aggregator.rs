...
use haneullabs_metrics::{monitored_future, GaugeGuard};
    ...
    A: AuthorityAPI + Send + Sync + 'static + Clone,
{
    ...
    fn record_rpc_error_maybe(&self, name: ConciseAuthorityPublicKeyBytesRef, error: &HaneulError) {
    ...
    fn handle_process_certificate_response(
        ...
        response: HaneulResult<HandleCertificateResponse>,
        name: AuthorityName,
