...
use haneul_types::crypto::{AuthorityPublicKeyBytes, AuthoritySignature};
    ...
    A: AuthorityAPI + Send + Sync + 'static + Clone,
{
    ...
    > {
        ...
        struct GetObjectByIDRequestState {
            ...
            bad_weight: StakeUnit,
            responses: Vec<(AuthorityName, HaneulResult<ObjectInfoResponse>)>,
        }
    ...
    ) -> Result<CertifiedTransaction, HaneulError> {
                    ...
                    Box::pin(async move {
                        ...
                        if state.bad_stake > validity {
                            ...
                            if unique_errors.len() == 1 && state.good_stake == 0 {
                                ...
                                return Err(HaneulError::QuorumNotReached {
    ...
    pub async fn handle_transaction_and_effects_info_request(
        ...
        timeout_total: Option<Duration>,
    ) -> HaneulResult<(CertifiedTransaction, SignedTransactionEffects)> {
        self.quorum_once_with_timeout(
            None,
            authorities,
            |authority, client| {
