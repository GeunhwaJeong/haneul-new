    ...
    A: AuthorityAPI + Send + Sync + 'static + Clone,
{
    ...
    fn handle_process_transaction_response(
        ...
        response: HaneulResult<VerifiedTransactionInfoResponse>,
        name: AuthorityName,
        weight: StakeUnit,
    ...
    fn handle_process_certificate_response(
        ...
        response: HaneulResult<VerifiedHandleCertificateResponse>,
        name: AuthorityName,
    ) -> HaneulResult<Option<VerifiedCertifiedTransactionEffects>> {
        match response {
