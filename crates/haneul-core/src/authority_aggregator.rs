...
use haneullabs_metrics::{monitored_future, spawn_monitored_task, GaugeGuard, MonitorCancellation};
...
impl AuthorityAggregator<NetworkAuthorityClient> {
    ...
    pub fn new_from_epoch_start_state(
        ...
        let committee = epoch_start_state.get_haneul_committee_with_network_metadata();
