    ...
    A: AuthorityAPI + Send + Sync + 'static + Clone,
{
    ...
    pub async fn process_transaction(
                ...
                |mut state, name, weight, result| {
                    Box::pin(async move {
                        match result {
                            ...
                            _ => {
                                state.errors.push(HaneulError::ErrorWhileProcessingTransaction);
                                state.bad_stake += weight; // This is the bad stake counter
                            }
                        };
        ...
        state
            .certificate
            .ok_or(HaneulError::ErrorWhileProcessingTransaction)
    }
    ...
    async fn process_certificate(
        ...
        timeout_after_quorum: Duration,
    ) -> Result<TransactionEffects, HaneulError> {
                    ...
                    Box::pin(async move {
                        ...
                        }) = result
                        {
                            ...
                            if state.bad_stake > validity {
                                ...
                                return Err(HaneulError::ErrorWhileRequestingCertificate);
                            }
                        }
        ...
        // If none has, fail.
        Err(HaneulError::ErrorWhileRequestingCertificate)
    }
