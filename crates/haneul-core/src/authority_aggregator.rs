...
use haneul_authority_aggregation::{quorum_map_then_reduce_with_timeout, AsyncResult};
...
use haneul_types::committee::{CommitteeTrait, CommitteeWithNetworkMetadata, StakeUnit};
...
impl AuthorityAggregator<NetworkAuthorityClient> {
    ...
    pub fn new_from_local_system_state(
        ...
        let haneul_system_state = store.get_haneul_system_state_object_unsafe()?;
