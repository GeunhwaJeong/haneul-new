...
use haneullabs_metrics::{spawn_monitored_task, GaugeGuard, MonitorCancellation};
use haneullabs_network::config::Config;
use std::convert::AsRef;
use std::net::SocketAddr;
use haneul_authority_aggregation::quorum_map_then_reduce_with_timeout;
        ...
        if let Some(genesis) = self.get_genesis() {
            ...
            state
                ...
                .map(|v| {
                    ...
                    let name = metadata.haneul_pubkey_bytes();
