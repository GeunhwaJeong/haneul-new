...
async fn safe_mode_system_state_v1() {
    let haneul_system_state = HaneulSystemState::V1(HaneulSystemStateInnerV1 {
        safe_mode: ENABLED,
        ...
        ..mock::haneul_system_state_inner_v1()
    });
    ...
    let EpochSystemState {
        ...
        SAFE_MODE_QUERY,
        haneul_system_state.clone(),
        AdvanceEpochConfig {
            output_objects: mock::system_state_output_objects(haneul_system_state),
            ..Default::default()
        },
    )
    .await;
...
async fn safe_mode_system_state_v2() {
    let haneul_system_state = HaneulSystemState::V2(HaneulSystemStateInnerV2 {
        safe_mode: ENABLED,
        safe_mode_computation_rewards: Balance::new(COMPUTATION_COST),
        safe_mode_storage_rewards: Balance::new(STORAGE_COST),
        safe_mode_storage_rebates: STORAGE_REBATE,
        safe_mode_non_refundable_storage_fee: NON_REFUNDABLE_STORAGE_FEE,
        ..mock::haneul_system_state_inner_v2()
    });
...
async fn live_object_set_digest() {
    let haneul_system_state = HaneulSystemState::V2(mock::haneul_system_state_inner_v2());
...
async fn test_graphql<T: DeserializeOwned>(
    query: &str,
    genesis_haneul_system_state: HaneulSystemState,
        ...
        OffchainClusterConfig {
            ...
            bootstrap_genesis: Some(BootstrapGenesis {
                ...
                stored_epoch_start: StoredEpochStart {
                    ...
                    system_state: bcs::to_bytes(&genesis_haneul_system_state).unwrap(),
                },
            }),
            ..Default::default()
        },
