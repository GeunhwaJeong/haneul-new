...
module test::mod {
  ...
  fun init(otw: MOD, ctx: &mut TxContext) {
    ...
    let mut d = display::new_with_fields<Foo>(
      ...
      // Too deep to display
      vector[utf8(b"deep")],
      vector[utf8(b"{deep.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0.pos0}")],
      ctx,
    );
