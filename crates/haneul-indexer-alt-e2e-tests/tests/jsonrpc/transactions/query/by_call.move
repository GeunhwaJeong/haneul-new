...
module P0::M {
  ...
  public fun foo() { haneul::event::emit(P0MFoo()) }
}
...
module P0::N {
  ...
  public fun bar() { haneul::event::emit(P0NBar()) }
  public fun baz() { haneul::event::emit(P0NBaz()) }
}
...
module P1::M {
  ...
  public fun qux() { haneul::event::emit(P1MQux()) }
}
