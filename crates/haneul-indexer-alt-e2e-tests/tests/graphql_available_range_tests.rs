...
use haneul_indexer_alt_e2e_tests::{find::address_owned, FullCluster, OffchainClusterConfig};
...
/// Request gas from the "faucet" in `cluster`, and craft a transaction transferring 1 GEUNHWA from
