...
//> 1: haneul::object::id_address<haneul::coin::Coin<haneul::haneul::HANEUL>>(Gas);
...
//> 1: haneul::object::id_address<haneul::coin::Coin<haneul::haneul::HANEUL>>(NestedResult(0,0));
//> 2: TransferObjects([NestedResult(0,1)], Result(1));
//> 3: haneul::object::id_address<haneul::coin::Coin<haneul::haneul::HANEUL>>(Gas);
...
{ # ... and for balance point-lookups
  object(address: "@{obj_0_0}", version: 2) {
    balance(coinType: "0x2::haneul::HANEUL") { totalBalance }
  }
}
...
{ # ... and balance multi-gets
  object(address: "@{obj_0_0}", version: 2) {
    multiGetBalances(keys: ["0x2::haneul::HANEUL"]) { totalBalance }
  }
}
...
fragment Owned on IAddressable {
  ...
  haneul: balance(coinType: "0x2::haneul::HANEUL") { totalBalance }
