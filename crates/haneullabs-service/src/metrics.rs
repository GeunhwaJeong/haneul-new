...
pub use haneullabs_metrics::start_prometheus_server;
...
/// #[tokio::main]
/// async fn main() {
///      let prometheus_registry = haneullabs_service::metrics::start_basic_prometheus_server();
...
pub fn start_basic_prometheus_server() -> Registry {
    ...
    haneullabs_metrics::start_prometheus_server(addr).default_registry()
}
