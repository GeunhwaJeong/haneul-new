...
use haneul_rpc::proto::haneul::rpc::v2alpha::GetCheckpointObjectProofRequest;
use haneul_rpc::proto::haneul::rpc::v2alpha::get_checkpoint_object_proof_response;
use haneul_rpc::proto::haneul::rpc::v2alpha::proof_service_client::ProofServiceClient;
use haneul_types::base_types::ObjectID;
use test_cluster::{TestCluster, TestClusterBuilder};

fn create_rpc_config_with_indexing() -> haneul_config::RpcConfig {
