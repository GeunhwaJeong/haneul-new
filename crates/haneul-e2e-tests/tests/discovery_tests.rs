...
mod test {
    ...
    use haneul_simulator::anemo;
    use haneul_test_transaction_builder::{TestTransactionBuilder, emit_new_random_u128};
    ...
    async fn test_network_resilience_with_incorrect_discovery_addresses() {
        ...
        let bad_addr: haneul_types::multiaddr::Multiaddr = "/ip4/1.1.1.1/udp/9999".parse().unwrap();
        ...
        let package_id = {
            ...
            let publish_tx = test_cluster
                .wallet
                .sign_transaction(
                    &haneul_test_transaction_builder::TestTransactionBuilder::new(sender, gas, rgp)
