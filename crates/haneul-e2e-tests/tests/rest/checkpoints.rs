...
use haneul_rest_api::{CheckpointResponse, ListCheckpointsQueryParameters};
...
async fn list_checkpoint() {
    ...
    let bytes = client
        ...
        .await
        .unwrap();
    let _checkpoints = haneul_rest_api::proto::ListCheckpointResponse::decode(bytes).unwrap();
...
async fn get_checkpoint() {
    ...
    let bytes = client
        ...
        .await
        .unwrap();
    let _checkpoints = haneul_rest_api::proto::GetCheckpointResponse::decode(bytes).unwrap();
...
async fn get_full_checkpoint() {
    ...
    let bytes = client
        ...
        .await
        .unwrap();
    let _checkpoints = haneul_rest_api::proto::FullCheckpoint::decode(bytes).unwrap();
    ...
    let bytes = client
        ...
        .unwrap();
    let _checkpoints =
        bcs::from_bytes::<haneul_types::full_checkpoint_content::CheckpointData>(&bytes).unwrap();
}
