...
use haneul_rest_api::rest::transactions::{ListTransactionsQueryParameters, TransactionResponse};
...
async fn get_transaction() {
    ...
    let bytes = client
        ...
        .await
        .unwrap();
    let _transaction = haneul_rest_api::proto::GetTransactionResponse::decode(bytes).unwrap();
...
async fn list_checkpoint() {
    ...
    let bytes = client
        ...
        .await
        .unwrap();
    let _transactions = haneul_rest_api::proto::ListTransactionsResponse::decode(bytes).unwrap();
