...
use haneul_rpc::proto::haneul::rpc::v2::Balance;
...
async fn test_balance_apis() {
    ...
    verify_balances(
        ...
        address,
        &[Balance::default()
            .with_coin_type(HANEUL_COIN_TYPE)
            .with_balance(INITIAL_HANEUL_BALANCE)
            .with_coin_balance(INITIAL_HANEUL_BALANCE)],
    )
    .await;
}
...
async fn test_balance_changes_on_transfer() {
    ...
    verify_balances(
        ...
        &[Balance::default()
            .with_coin_type(HANEUL_COIN_TYPE)
            .with_balance(INITIAL_HANEUL_BALANCE - transfer_amount - gas_used)
            .with_coin_balance(INITIAL_HANEUL_BALANCE - transfer_amount - gas_used)],
    )
    .await;
    ...
    verify_balances(
        ...
        &[Balance::default()
            .with_coin_type(HANEUL_COIN_TYPE)
            .with_balance(INITIAL_HANEUL_BALANCE + transfer_amount)
            .with_coin_balance(INITIAL_HANEUL_BALANCE + transfer_amount)],
    )
    .await;
}
...
async fn test_address_balance_account_with_only_address_balance() {
    ...
    let sender = test_cluster.get_address_0();
    let receiver = HaneulAddress::ZERO;
...
async fn test_custom_coin_balance() {
    ...
    verify_balances(
        ...
        &[
            Balance::default()
                .with_coin_type(HANEUL_COIN_TYPE)
                .with_balance(INITIAL_HANEUL_BALANCE - publish_gas_used - mint_gas_used)
                .with_coin_balance(INITIAL_HANEUL_BALANCE - publish_gas_used - mint_gas_used),
            Balance::default()
    ...
    let haneul_client = test_cluster.grpc_client();
...
async fn test_multiple_concurrent_balance_changes() {
    ...
    verify_balances(
        ...
        &[Balance::default()
            .with_coin_type(HANEUL_COIN_TYPE)
            .with_balance(INITIAL_HANEUL_BALANCE - transfer_0_to_1 - gas_used_0)
            .with_coin_balance(INITIAL_HANEUL_BALANCE - transfer_0_to_1 - gas_used_0)],
    )
    .await;
    ...
    verify_balances(
        ...
        &[Balance::default()
            .with_coin_type(HANEUL_COIN_TYPE)
            .with_balance(
                INITIAL_HANEUL_BALANCE + transfer_0_to_1 - transfer_1_to_2 + transfer_2_to_1
                    - gas_used_1,
            )
            .with_coin_balance(
                INITIAL_HANEUL_BALANCE + transfer_0_to_1 - transfer_1_to_2 + transfer_2_to_1
    ...
    verify_balances(
        ...
        &[Balance::default()
            .with_coin_type(HANEUL_COIN_TYPE)
            .with_balance(INITIAL_HANEUL_BALANCE + transfer_1_to_2 - transfer_2_to_1 - gas_used_2)
            .with_coin_balance(
...
async fn test_fresh_address_with_no_coins() {
    ...
    let response = grpc_client
        ...
        .get_balance({
            ...
            message.coin_type = Some(HANEUL_COIN_TYPE.to_string());
            message
        })
        .await
        .unwrap()
