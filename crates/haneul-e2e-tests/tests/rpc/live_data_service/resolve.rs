...
use haneul_rpc_api::proto::rpc::v2beta::GasPayment;
...
use haneul_rpc_api::proto::rpc::v2beta::TransferObjects;
    ...
    let unresolved_transaction = Transaction {
        kind: Some(TransactionKind::from(ProgrammableTransaction {
            ...
            commands: vec![Command::from(MoveCall {
                ...
                module: Some("haneul_system".to_owned()),
...
async fn resolve_transaction_insufficient_gas() {
    ...
    let unresolved_transaction = Transaction {
        ...
        sender: Some(HaneulAddress::random_for_testing_only().to_string()), // random account with no
        // gas
        ..Default::default()
    };
