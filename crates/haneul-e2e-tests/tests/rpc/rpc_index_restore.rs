...
fn with_node<T>(cluster: &TestCluster, name: &AuthorityName, f: impl FnOnce(&HaneulNode) -> T) -> T {
...
async fn list_transaction_digests_by_sender(rpc_url: &str, sender: HaneulAddress) -> HashSet<String> {
