...
use haneul_rpc_api::proto::rpc::v2beta::BatchGetObjectsRequest;
use haneul_rpc_api::proto::rpc::v2beta::BatchGetObjectsResponse;
use haneul_rpc_api::proto::rpc::v2beta::GetObjectRequest;
use haneul_rpc_api::proto::rpc::v2beta::Object;
