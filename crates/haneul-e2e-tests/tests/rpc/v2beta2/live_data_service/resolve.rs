...
use haneul_rpc::proto::haneul::rpc::v2beta2::ObjectReference;
...
use haneul_types::transaction::{
    Command as HaneulCommand, ObjectArg, TransactionData, TransactionDataAPI,
};
...
async fn resolve_transaction_insufficient_gas_with_payment_objects() {
    ...
    let mut client = haneul_rpc::client::Client::new(test_cluster.rpc_url()).unwrap();

    let mut transaction = haneul_rpc::proto::haneul::rpc::v2beta2::Transaction::default();
    transaction.bcs = Some(
        haneul_rpc::proto::haneul::rpc::v2beta2::Bcs::serialize(signed_tx.transaction_data()).unwrap(),
    );
    ...
    let signatures = signed_tx
        ...
        .iter()
        .map(|s| {
            let mut message = haneul_rpc::proto::haneul::rpc::v2beta2::UserSignature::default();
            message.bcs = Some({
                let mut message = haneul_rpc::proto::haneul::rpc::v2beta2::Bcs::default();
    ...
    let mut request = haneul_rpc::proto::haneul::rpc::v2beta2::ExecuteTransactionRequest::default();
