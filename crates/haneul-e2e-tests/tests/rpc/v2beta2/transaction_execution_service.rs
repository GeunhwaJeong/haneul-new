...
use haneul_rpc::proto::haneul::rpc::v2beta2::transaction_execution_service_client::TransactionExecutionServiceClient;
...
async fn execute_transaction_transfer() {
    ...
    let gas_summary =
        haneul_sdk_types::GasCostSummary::try_from(&transaction.effects.unwrap().gas_used.unwrap())
            .unwrap();
