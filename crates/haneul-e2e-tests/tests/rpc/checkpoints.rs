...
async fn list_checkpoint() {
    ...
    let bytes = client
        ...
        .await
        .unwrap();
    let _checkpoints = haneul_rpc_api::proto::ListCheckpointResponse::decode(bytes).unwrap();
...
async fn get_checkpoint() {
    ...
    let bytes = client
        ...
        .await
        .unwrap();
    let _checkpoints = haneul_rpc_api::proto::GetCheckpointResponse::decode(bytes).unwrap();
...
async fn get_full_checkpoint() {
    ...
    let bytes = client
        ...
        .await
        .unwrap();
    let _checkpoints = haneul_rpc_api::proto::FullCheckpoint::decode(bytes).unwrap();
