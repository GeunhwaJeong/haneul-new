...
//! New kvstore binary using haneul-indexer-alt-framework.
//!
...
use haneul_kvstore::{BigTableClient, BigTableStore, KvStorePipeline};
use telemetry_subscribers::TelemetryConfig;
use tracing::info;

#[derive(Parser)]
#[command(name = "haneul-kvstore-alt")]
#[command(about = "KVStore indexer using haneul-indexer-alt-framework")]
struct Args {
