...
use haneul_types::{
    ...
    crypto::{
        ...
        Signature, HaneulAuthoritySignature,
    },
    messages::*,
    object::Object,
...
fn make_transfer_transaction(
    ...
    if use_move {
        ...
        SingleTransactionKind::Call(MoveCall {
            ...
            module: ident_str!("haneul").to_owned(),
...
fn create_gas_object(object_id: ObjectID, owner: HaneulAddress) -> Object {
...
fn make_transactions(
    ...
    account_gas_objects
        .par_iter()
        .map(|(objects, gas_obj)| {
            let next_recipient: HaneulAddress = get_key_pair::<AccountKeyPair>().0;
