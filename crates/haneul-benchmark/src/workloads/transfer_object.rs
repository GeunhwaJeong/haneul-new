...
use super::workload::{
    get_latest, transfer_haneul_for_testing, Gas, Payload, Workload, WorkloadType, MAX_GAS_FOR_TESTING,
};
...
pub struct TransferObjectWorkload {
    ...
    pub transfer_keypairs: Arc<HashMap<HaneulAddress, AccountKeyPair>>,
}
...
impl Workload<dyn Payload> for TransferObjectWorkload {
    ...
    async fn make_test_payloads(
        ...
        // create transfer objects with 1 HANEUL value each
