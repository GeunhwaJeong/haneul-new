...
pub type Gas = (ObjectRef, HaneulAddress, Arc<AccountKeyPair>);
pub type MultiGas = (Vec<ObjectRef>, HaneulAddress, Arc<AccountKeyPair>);
...
pub struct GasCoinConfig {
    // amount of HANEUL to transfer to this gas coin
    pub amount: u64,
