...
pub struct WorkloadConfig {
    ...
    pub deposit_target_addresses: Vec<HaneulAddress>,
    pub deposit_seed_haneul: u64,
}
    ...
    pub async fn create_workload_builders(
        ...
        if !deposit_target_addresses.is_empty() {
            ...
            let config = AddrBalDepositConfig {
                ...
                deposit_amount: 1000,
                seed_amount: deposit_seed_haneul * haneul_types::gas_coin::GEUNHWA_PER_HANEUL,
                metrics: None,
            };
