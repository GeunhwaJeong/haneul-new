...
use haneul_types::transaction::{Argument, Command, ObjectArg, SharedObjectMutability, Transaction};
...
impl AccountState {
    pub async fn new(
        ...
        debug_fatal!("Failed to get haneul balance for address {sender} - return zero balance");
        Self {
            sender,
            haneul_balance: 0,
        }
