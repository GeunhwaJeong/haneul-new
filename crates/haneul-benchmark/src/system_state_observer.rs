...
impl SystemStateObserver {
    ...
    pub fn new_from_test_cluster(test_cluster: &TestCluster) -> Self {
        ...
        let convert_system_state = move |system_state: HaneulSystemState| -> SystemState {
            SystemState {
        ...
        let initial_system_state = convert_system_state(test_cluster.get_haneul_system_state());
