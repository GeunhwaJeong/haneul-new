...
impl Env {
    ...
    async fn setup_local_env(
        ...
        let (primary_gas_owner, keypair): (HaneulAddress, AccountKeyPair) =
            ...
            server_runtime.block_on(async move {
                let cluster = TestClusterBuilder::new()
                    .with_accounts(vec![AccountConfig {
                        ...
                        // We can't use TOTAL_SUPPLY_GEUNHWA because we need to account for validator stakes in genesis allocation.
                        gas_amounts: vec![TOTAL_SUPPLY_GEUNHWA / 2],
                    }])
