...
mod ingestion_tests {
    ...
    use haneul_indexer::db::get_pool_connection;
    use haneul_indexer::errors::Context;
    ...
    use haneul_indexer::schema::{events, objects, transactions};
    ...
    const DEFAULT_DB_URL: &str = "postgres://postgres:postgrespw@localhost:5432/haneul_indexer";
    ...
    pub async fn test_transaction_table() -> Result<(), IndexerError> {
        ...
        let transfer_recipient = HaneulAddress::random_for_testing_only();
    ...
    pub async fn test_event_type() -> Result<(), IndexerError> {
        ...
        let event_type_tag = StructTag {
            ...
            module: Identifier::new("haneul_system_state_inner").unwrap(),
        ...
        assert_eq!(db_event.event_type_package, HANEUL_SYSTEM_PACKAGE_ID.to_vec());
        assert_eq!(db_event.event_type_module, "haneul_system_state_inner");
    ...
    pub async fn test_object_type() -> Result<(), IndexerError> {
        ...
        assert_eq!(
            ...
            Some(HANEUL_FRAMEWORK_PACKAGE_ID.to_vec())
        );
