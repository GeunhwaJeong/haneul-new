...
mod ingestion_tests {
    ...
    const DEFAULT_DB_URL: &str = "postgres://postgres:postgrespw@localhost:5432/haneul_indexer_v2";
    ...
    async fn set_up(
        ...
        let server_handle = tokio::spawn(async move {
            haneul_rest_api::start_service(server_url, sim, Some("/rest".to_owned())).await;
        });
        // Starts indexer
