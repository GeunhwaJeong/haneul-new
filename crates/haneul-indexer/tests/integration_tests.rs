...
pub mod pg_integration_test {
    ...
    use haneul_indexer::models::objects::{Object, ObjectStatus};
    ...
    async fn test_event_query_e2e() -> Result<(), anyhow::Error> {
        ...
        for item in query_response.data {
            ...
            assert_eq!(item.package_id, ObjectID::from(HANEUL_FRAMEWORK_ADDRESS));
    ...
    async fn test_get_last_checkpoint_of_epoch() {
        ...
        let decoded_checkpoint: haneul_json_rpc_types::Checkpoint = checkpoint.try_into().unwrap();
