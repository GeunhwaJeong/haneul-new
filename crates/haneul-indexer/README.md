...
```sh
POSTGRES_PORT=5432 cargo test --package haneul-indexer --test integration_tests --features pg_integration
```
...
```sh
POSTGRES_PORT=5432 cargo test --package haneul-indexer --test integration_tests --features pg_integration -- --test-threads=1
```

And to execute a single test such as just `test_event_query_e2e`, you can do
```sh
POSTGRES_PORT=5432 cargo test test_event_query_e2e --package haneul-indexer --test integration_tests --features pg_integration -- --test-threads=1
```
