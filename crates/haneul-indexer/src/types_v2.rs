...
use haneul_json_rpc_types::{EndOfEpochInfo, ObjectChange};
...
use haneul_types::messages_checkpoint::{CheckpointDigest, EndOfEpochData};
...
impl IndexedCheckpoint {
    pub fn from_haneul_checkpoint(
        checkpoint: &haneul_types::messages_checkpoint::CertifiedCheckpointSummary,
...
pub struct IndexedEpochInfo {
    pub epoch: u64,
    pub validators: Vec<HaneulValidatorSummary>,
    pub epoch_total_transactions: u64,
...
impl IndexedEvent {
    pub fn from_event(
        ...
        event: &haneul_types::event::Event,
        timestamp_ms: u64,
    ) -> Self {
        Self {
            tx_sequence_number,
...
pub fn owner_to_owner_info(owner: &Owner) -> (OwnerType, Option<HaneulAddress>) {
    match owner {
...
pub struct IndexedObject {
    ...
    pub owner_id: Option<HaneulAddress>,
    pub object: Object,
...
pub struct IndexedTransaction {
    ...
    pub balance_change: Vec<haneul_json_rpc_types::BalanceChange>,
    pub events: Vec<haneul_types::event::Event>,
