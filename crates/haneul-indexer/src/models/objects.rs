...
use haneul_types::base_types::{EpochId, ObjectID, ObjectRef, ObjectType, SequenceNumber, HaneulAddress};
...
impl TryFrom<Object> for haneul_types::object::Object {
    ...
    fn try_from(o: Object) -> Result<Self, Self::Error> {
        ...
        let owner = match o.owner_type {
            OwnerType::AddressOwner => Owner::AddressOwner(HaneulAddress::from_str(
                &o.owner_address.expect("Owner address should not be empty."),
            )?),
            OwnerType::ObjectOwner => Owner::ObjectOwner(HaneulAddress::from_str(
                &o.owner_address.expect("Owner address should not be empty."),
            )?),
