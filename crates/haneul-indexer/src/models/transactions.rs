...
use haneul_json_rpc_types::{
    OwnedObjectRef, HaneulObjectRef, HaneulTransaction, HaneulTransactionEffects, HaneulTransactionResponse,
};
...
pub fn commit_transactions(
    ...
    tx_resps: Vec<HaneulTransactionResponse>,
...
impl TryFrom<HaneulTransactionResponse> for NewTransaction {
    type Error = IndexerError;

    fn try_from(tx_resp: HaneulTransactionResponse) -> Result<Self, Self::Error> {
        ...
        // is always Some. This is also confirmed by the haneul-core team.
        ...
        Ok(NewTransaction {
            ...
            // max value of i64 is 9223372036854775807 MISTs, which is 9223372036.85 HANEUL, which is way bigger than budget or cost constant already.
...
impl TryInto<HaneulTransactionResponse> for Transaction {
    type Error = IndexerError;

    fn try_into(self) -> Result<HaneulTransactionResponse, Self::Error> {
        let txn: HaneulTransaction =
        ...
        let txn_effects: HaneulTransactionEffects = serde_json::from_str(&self.transaction_effects_content).map_err(|err| {
            IndexerError::InsertableParsingError(format!(
...
fn obj_ref_to_obj_id_string(obj_ref: HaneulObjectRef) -> String {
