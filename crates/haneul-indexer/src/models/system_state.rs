...
pub struct DBSystemStateSummary {
    ...
    pub governance_start_epoch: i64,
...
impl From<HaneulSystemStateSummary> for DBSystemStateSummary {
    fn from(s: HaneulSystemStateSummary) -> Self {
        Self {
            ...
            governance_start_epoch: s.governance_start_epoch as i64,
            epoch_duration_ms: s.epoch_duration_ms as i64,
            stake_subsidy_epoch_counter: s.stake_subsidy_epoch_counter as i64,
            stake_subsidy_balance: s.stake_subsidy_balance as i64,
            stake_subsidy_current_epoch_amount: s.stake_subsidy_current_epoch_amount as i64,
...
pub struct DBValidatorSummary {
    ...
    pub staking_pool_haneul_balance: i64,
    pub rewards_pool: i64,
    pub pool_token_balance: i64,
    pub pending_stake: i64,
    pub pending_total_haneul_withdraw: i64,
    pub pending_pool_token_withdraw: i64,
    pub exchange_rates_id: String,
    pub exchange_rates_size: i64,
}

impl From<(EpochId, HaneulValidatorSummary)> for DBValidatorSummary {
    fn from((epoch, v): (EpochId, HaneulValidatorSummary)) -> Self {
        Self {
            epoch: epoch as i64,
            haneul_address: v.haneul_address.to_string(),
            ...
            staking_pool_haneul_balance: v.staking_pool_haneul_balance as i64,
            rewards_pool: v.rewards_pool as i64,
            pool_token_balance: v.pool_token_balance as i64,
            pending_stake: v.pending_stake as i64,
            pending_total_haneul_withdraw: v.pending_total_haneul_withdraw as i64,
...
impl TryFrom<DBValidatorSummary> for HaneulValidatorSummary {
    type Error = IndexerError;
    fn try_from(db: DBValidatorSummary) -> Result<HaneulValidatorSummary, Self::Error> {
        Ok(HaneulValidatorSummary {
            haneul_address: HaneulAddress::from_str(&db.haneul_address)?,
            ...
            staking_pool_haneul_balance: db.staking_pool_haneul_balance as u64,
            rewards_pool: db.rewards_pool as u64,
            pool_token_balance: db.pool_token_balance as u64,
            pending_stake: db.pending_stake as u64,
            pending_total_haneul_withdraw: db.pending_total_haneul_withdraw as u64,
