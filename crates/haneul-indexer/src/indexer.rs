...
impl Indexer {
    ...
    pub async fn start_writer_with_config<S: IndexerStore + Sync + Send + Clone + 'static>(
        ...
        info!(
            "Haneul Indexer Writer (version {:?}) started...",
        ...
        let rest_client = haneul_rest_api::Client::new(&rest_api_url);
        ...
        crate::framework::runner::run(
            haneullabs_metrics::metered_channel::ReceiverStream::new(
    ...
    pub async fn start_reader(
        ...
        info!(
            "Haneul Indexer Reader (version {:?}) started...",
            env!("CARGO_PKG_VERSION")
        );
    ...
    pub async fn start_analytical_worker(
        ...
        info!(
            "Haneul Indexer Analytical Worker (version {:?}) started...",
            env!("CARGO_PKG_VERSION")
        );
