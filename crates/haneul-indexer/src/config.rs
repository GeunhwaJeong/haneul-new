...
pub enum Command {
    ...
    /// Example:
    ///  ./haneul-indexer --database-url <...> sql-back-fill
...
impl Default for RestoreConfig {
    fn default() -> Self {
        Self {
            ...
            snapshot_endpoint: "https://formal-snapshot.mainnet.haneul.io".to_string(),
            snapshot_bucket: "haneullabs-mainnet-formal".to_string(),
            snapshot_download_dir: "".to_string(), // not used b/c it's required
            gcs_archive_bucket: "haneullabs-mainnet-archives".to_string(),
            gcs_display_bucket: "haneullabs-mainnet-display-table".to_string(),
