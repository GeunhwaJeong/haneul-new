...
pub struct IndexerConfig {
    ...
    #[clap(long, default_value = Some("https://checkpoints.mainnet.haneul.io"), global = true)]
...
impl Default for IndexerConfig {
    fn default() -> Self {
        Self {
            db_url: Some("postgres://postgres:postgres@localhost:5432/haneul_indexer".to_string()),
            db_user_name: None,
            db_password: None,
            db_host: None,
            db_port: None,
            ...
            remote_store_url: Some("https://checkpoints.mainnet.haneul.io".to_string()),
