...
use haneul_indexer::metrics::IndexerEventHandlerMetrics;
use haneul_indexer::models::events::{commit_events, read_last_event, IndexerEventEnvelope};
    ...
    pub async fn start(&self) -> Result<(), IndexerError> {
        ...
        loop {
            ...
            let db_guard = self
                ...
                .start_timer();
            let mut errors = vec![];
            let txn_resp_vec: Vec<HaneulTransactionResponse> = txn_response_res_vec
                .into_iter()
