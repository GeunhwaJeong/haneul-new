...
use haneullabs_metrics::get_metrics;
...
pub async fn start_objects_snapshot_processor(
    ...
    let (indexed_obj_sender, indexed_obj_receiver) = haneullabs_metrics::metered_channel::channel(
...
impl ObjectsSnapshotProcessor {
    ...
    pub async fn commit_objects_snapshot(
        ...
        let batch_size = 100;
        let mut stream = haneullabs_metrics::metered_channel::ReceiverStream::new(indexed_obj_receiver)
