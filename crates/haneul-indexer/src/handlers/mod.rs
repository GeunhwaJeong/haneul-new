...
impl<T> CommonHandler<T> {
    ...
    async fn start_transform_and_load(
        &self,
        cp_receiver: haneullabs_metrics::metered_channel::Receiver<(CommitterWatermark, T)>,
        ...
        let checkpoint_commit_batch_size = std::env::var("CHECKPOINT_COMMIT_BATCH_SIZE")
            ...
            .parse::<usize>()
            .unwrap();
        let mut stream = haneullabs_metrics::metered_channel::ReceiverStream::new(cp_receiver)
