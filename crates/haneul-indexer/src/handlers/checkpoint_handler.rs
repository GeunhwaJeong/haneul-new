...
use haneul_json_rpc_types::{
    OwnedObjectRef, HaneulObjectData, HaneulObjectDataOptions, HaneulParsedData, HaneulTransactionDataAPI,
    ...
    S: IndexerStore + Sync + Send + 'static,
{
    ...
    async fn download_checkpoint_data(
        ...
        let all_mutated_objects = join_all(all_mutated.into_iter().map(|(id, version, status)| {
            rpc.read_api()
                .try_get_parsed_past_object(id, version, HaneulObjectDataOptions::full_content())
