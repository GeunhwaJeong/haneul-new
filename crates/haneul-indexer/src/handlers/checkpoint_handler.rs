...
use haneul_json_rpc_types::{
    OwnedObjectRef, HaneulCommand, HaneulGetPastObjectRequest, HaneulObjectData, HaneulObjectDataOptions,
    HaneulRawData, HaneulTransactionDataAPI, HaneulTransactionEffectsAPI, HaneulTransactionKind,
...
{
    pub fn new(state: S, rpc_client: HaneulClient, prometheus_registry: &Registry) -> Self {
        Self {
            state,
            rpc_client,
    ...
    fn index_packages(
        ...
        all_mutated_objects: &[(ObjectStatus, HaneulObjectData)],
        ...
        transactions
            ...
            .flat_map(|tx| {
                tx.effects
                    .as_ref()
                    .expect("Effects in HaneulTransactionResponse should not be empty")
                    .created()
                    .iter()
                    .map(|oref| {
