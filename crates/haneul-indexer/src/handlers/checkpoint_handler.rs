...
use haneul_types::haneul_system_state::{HaneulSystemStateTrait, get_haneul_system_state};
    ...
    async fn index_epoch(
        ...
        if epoch_event_opt.is_none() {
            ...
            assert!(
                ...
                "Haneul is not in safe mode but no SystemEpochInfoEvent found at end of epoch {}",
                checkpoint_summary.epoch
            );
        }
