...
impl PgIndexerStore {
    ...
    pub fn get_haneul_types_object(
        &self,
        object_id: &ObjectID,
    ...
    pub fn find_haneul_types_object_lt_or_eq_version(
        &self,
        id: &ObjectID,
        version: &SequenceNumber,
...
impl IndexerStore for PgIndexerStore {
    ...
    async fn compose_haneul_transaction_block_response(
        ...
        Ok(HaneulTransactionBlockResponse {
            ...
            events: Some(HaneulTransactionBlockEvents { data: events.data }),
            object_changes,
            balance_changes,
            errors: vec![],
        })
...
impl ObjectProvider for PgIndexerStore {
    ...
    async fn get_object(
        ...
        self.get_haneul_types_object(id, version)
    }
