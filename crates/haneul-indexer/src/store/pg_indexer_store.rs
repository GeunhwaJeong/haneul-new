...
use haneul_json_rpc::{ObjectProvider, ObjectProviderCache};
...
impl PgIndexerStore {
    ...
    pub async fn get_haneul_types_object(
        &self,
        object_id: &ObjectID,
        version: &SequenceNumber,
    ) -> Result<haneul_types::object::Object, IndexerError> {
        ...
        match pg_object {
            Ok(pg_object) => {
                let object = haneul_types::object::Object::try_from(pg_object)?;
                Ok(object)
            }
            Err(e) => Err(e),
        }
    ...
    pub async fn find_haneul_types_object_lt_or_eq_version(
        &self,
        id: &ObjectID,
        version: &SequenceNumber,
    ) -> Result<Option<haneul_types::object::Object>, IndexerError> {
...
impl IndexerStore for PgIndexerStore {
    ...
    async fn get_events(
        ...
        let mut haneul_event_vec = events_vec
            .into_iter()
            .map(|event| event.try_into(&self.module_cache))
            .collect::<Result<Vec<HaneulEvent>, _>>()?;
    ...
    async fn compose_haneul_transaction_block_response(
        &self,
        tx: Transaction,
        ...
        let sender = HaneulAddress::from_str(tx.sender.as_str())?;
        ...
        if let Some(options) = options {
            ...
            if options.show_events {
                let event_page = self
                    ...
                    .await?;
                events = Some(HaneulTransactionBlockEvents {
...
impl ObjectProvider for PgIndexerStore {
    ...
    async fn get_object(
        ...
        id: &ObjectID,
        version: &SequenceNumber,
    ) -> Result<haneul_types::object::Object, Self::Error> {
        self.get_haneul_types_object(id, version).await
    }
    ...
    async fn find_object_lt_or_eq_version(
        ...
        id: &ObjectID,
        version: &SequenceNumber,
    ) -> Result<Option<haneul_types::object::Object>, Self::Error> {
        self.find_haneul_types_object_lt_or_eq_version(id, version)
            .await
    }
}
