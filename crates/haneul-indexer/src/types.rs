...
use haneul_json_rpc_types::{
    ObjectChange, HaneulTransactionBlockResponse, HaneulTransactionBlockResponseOptions,
};
...
pub struct IndexedEpochInfo {
    ...
    pub system_state_summary: HaneulSystemStateSummary,
...
impl IndexedEpochInfo {
    pub fn from_new_system_state_summary(
        new_system_state_summary: HaneulSystemStateSummary,
