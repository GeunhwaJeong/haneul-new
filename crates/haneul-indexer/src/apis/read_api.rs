...
use haneul_json_rpc_types::{
    ...
    GetRawObjectDataResponse, MoveFunctionArgType, Page, HaneulMoveNormalizedFunction,
...
impl ReadApi {
    ...
    async fn get_transaction(
        ...
        let mut pg_pool_conn = get_pg_pool_connection(self.pg_connection_pool.clone())?;
        let txn_resp: HaneulTransactionResponse =
    ...
    async fn get_transactions(
        ...
        let digests_from_db = match query {
            ...
            // HaneulTransactionResponse, instead we should store the BCS
