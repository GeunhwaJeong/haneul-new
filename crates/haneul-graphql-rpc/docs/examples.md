...
### [Haneul System State Summary](#16)
#### &emsp;&emsp;[Haneul System State Summary](#1048560)
...
>  events(
>    filter: {
>      eventType: "0x3164fcf73eb6b41ff3d2129346141bd68469964c2d95a5b1533e8d16e6ea6e13::Market::ChangePriceEvent<0x2::haneul::HANEUL>"
>    }
>  ) {
>    nodes {
>      sendingModule {
...
>    filter: {
>      emittingModule: "0x3::haneul_system",
...
>  ) {
>    address
>    balance(type: "0x2::haneul::HANEUL") {
>      coinType {
>        repr
>      }
>      coinObjectCount
...
><pre>{
>  objectConnection(filter: {type: "0x3::staking_pool::StakedHaneul"}) {
>    edges {
>      node {
>        asMoveObject {
>          contents {
...
>  transactionBlocks(
>    filter: {
>      function: "0x3::haneul_system::request_withdraw_stake"
>    }
>  ) {
>    nodes {
>      sender {
