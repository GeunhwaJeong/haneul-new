...
mod tests {
    ...
    use haneul_graphql_rpc::context_data::db_query_cost::extract_cost;
    use haneul_graphql_rpc::test_infra::cluster::simulator_commands_test_impl;
    use haneul_indexer::indexer_reader::IndexerReader;
    use haneul_indexer::models_v2::objects::StoredObject;
    use haneul_indexer::new_pg_connection_pool_impl;
    use haneul_indexer::schema_v2::objects;
    use haneul_indexer::utils::reset_database;
    use haneul_indexer::PgConnectionPoolConfig;
    ...
    async fn test_simple_client_validator_cluster() {
        ...
        let cluster =
            haneul_graphql_rpc::test_infra::cluster::start_cluster(connection_config, None).await;
    ...
    async fn test_simple_client_simulator_cluster() {
        ...
        let connection_config = ConnectionConfig::ci_integration_test_cfg();
        let cluster = haneul_graphql_rpc::test_infra::cluster::serve_executor(
            connection_config,
            3000,
            Arc::new(sim),
        )
    ...
    async fn test_graphql_client_variables() {
        ...
        assert_eq!(
            data.get("obj1")
                ...
                .as_str()
                .unwrap(),
            HANEUL_FRAMEWORK_ADDRESS.to_canonical_string(true)
        );
        assert_eq!(
            data.get("obj2")
                .unwrap()
    ...
    use haneul_graphql_rpc::server::builder::tests::*;
