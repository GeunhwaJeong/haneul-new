...
mod tests {
    ...
    async fn test_simple_client_validator_cluster() {
        ...
        let cluster = haneul_graphql_rpc::cluster::start_cluster(connection_config, None).await;
    ...
    async fn test_simple_client_simulator_cluster() {
        ...
        let connection_config = ConnectionConfig::ci_integration_test_cfg();
        let cluster =
            haneul_graphql_rpc::cluster::serve_simulator(connection_config, 3000, Arc::new(sim)).await;
