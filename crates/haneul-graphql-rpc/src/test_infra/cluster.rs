...
pub use haneul_indexer::processors_v2::objects_snapshot_processor::SnapshotLagConfig;
use haneul_indexer::store::indexer_store_v2::IndexerStoreV2;
...
/// Takes in a simulated instantiation of a Haneul blockchain and builds a cluster around it. This
...
pub async fn serve_executor(
    ...
    let executor_server_handle = tokio::spawn(async move {
        haneul_rest_api::start_service(executor_server_url, executor, Some("/rest".to_owned())).await;
    });
