...
use crate::{
    ...
    context_data::{
        ...
        haneul_sdk_data_provider::{lru_cache_data_loader, haneul_sdk_client_v0},
    },
    extensions::{
...
impl Server {
    ...
    pub async fn from_config(config: &ServerConfig) -> Self {
        ...
        let haneul_sdk_client_v0 = haneul_sdk_client_v0(&config.connection.rpc_url).await;
...
mod tests {
    ...
    use crate::{
        ...
        context_data::{
            ...
            haneul_sdk_data_provider::haneul_sdk_client_v0,
        },
    ...
    async fn test_timeout() {
        ...
        async fn test_timeout(delay: Duration, timeout: Duration) -> Response {
            let sdk = haneul_sdk_client_v0("https://fullnode.testnet.haneul.io:443/").await;
