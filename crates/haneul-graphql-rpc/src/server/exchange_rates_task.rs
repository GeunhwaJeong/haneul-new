...
use haneul_indexer::apis::{governance_api::exchange_rates, GovernanceReadApi};
        ...
        loop {
            tokio::select! {
                ...
                _ = self.epoch_rx.changed() => {
                    ...
                    let latest_haneul_sytem_state = self.db.inner.spawn_blocking(move |this|
                        this.get_latest_haneul_system_state()
