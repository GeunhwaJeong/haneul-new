...
use crate::server::haneul_sdk_data_provider::HaneulClientLoader;
use crate::{
    server::{
...
async fn graphql_handler(
    schema: axum::Extension<HaneulGraphQLSchema>,
    req: GraphQLRequest,
) -> GraphQLResponse {
...
pub async fn start_example_server(config: Option<ServerConfig>) {
    ...
    let haneul_sdk_client_v0 = haneul_sdk::HaneulClientBuilder::default()
