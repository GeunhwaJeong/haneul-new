...
///
/// This is copied from the previous haneul-json-rpc/governance_api crate, together with tests, and
/// slightly altered to return one APY for each call instead of multiple ones.
///
/// See original code here:
/// <https://github.com/GeunhwaJeong/haneul/blob/c3feec3ac3b626bf2fd40c668ba32be9c73e7528/crates/haneul-json-rpc/src/governance_api.rs#L280>
...
mod tests {
    ...
    use haneul_json_rpc::governance_api::ValidatorExchangeRates;
