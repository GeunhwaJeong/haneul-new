...
fn functional_groups() -> &'static BTreeMap<(&'static str, &'static str), FunctionalGroup> {
    ...
    static GROUPS: Lazy<BTreeMap<(&str, &str), FunctionalGroup>> = Lazy::new(|| {
        BTreeMap::from_iter([
            ...
            (("Address", "defaultHaneulnsName"), G::NameService),
            (("Address", "dynamicField"), G::DynamicFields),
            (("Address", "dynamicObjectField"), G::DynamicFields),
            (("Address", "dynamicFields"), G::DynamicFields),
            ...
            (("Object", "defaultHaneulnsName"), G::NameService),
            ...
            (("Owner", "coins"), G::Coins),
            (("Owner", "defaultHaneulnsName"), G::NameService),
            ...
            (("Query", "resolveHaneulnsAddress"), G::NameService),
