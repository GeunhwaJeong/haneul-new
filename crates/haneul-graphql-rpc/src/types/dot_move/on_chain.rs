...
pub(crate) struct AppInfo {
    ...
    pub(crate) package_address: Option<HaneulAddress>,
...
impl Name {
    ...
    pub(crate) fn type_(package_address: HaneulAddress) -> StructTag {
        StructTag {
    ...
    pub(crate) fn to_dynamic_field_id(
        ...
        haneul_types::dynamic_field::derive_dynamic_field_id(
            config.registry_id,
            &haneul_types::TypeTag::Struct(Box::new(domain_type_tag)),
            &self.to_bytes(),
        )
    }
}
