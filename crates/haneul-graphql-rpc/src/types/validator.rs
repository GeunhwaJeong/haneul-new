...
impl Validator {
    ...
    pub fn staking_pool_id(&self) -> HaneulAddress {
        HaneulAddress::from_array(**self.validator_summary.staking_pool_id)
    }
    pub fn exchange_rates_id(&self) -> HaneulAddress {
        HaneulAddress::from_array(**self.validator_summary.exchange_rates_id)
    }
}
