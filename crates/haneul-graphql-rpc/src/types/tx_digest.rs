...
const HANEUL_TRANSACTION_DIGEST_LENGTH: usize = 32;

#[serde_as]
#[derive(Serialize, Deserialize, Clone, Eq, PartialEq, Ord, PartialOrd, Hash, Copy)]
pub(crate) struct TransactionDigest(
    #[serde_as(as = "Readable<Base58, Bytes>")] [u8; HANEUL_TRANSACTION_DIGEST_LENGTH],
);
...
impl TransactionDigest {
    pub fn into_array(self) -> [u8; HANEUL_TRANSACTION_DIGEST_LENGTH] {
        self.0
    }

    pub fn from_array(arr: [u8; HANEUL_TRANSACTION_DIGEST_LENGTH]) -> Self {
...
impl std::str::FromStr for TransactionDigest {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        let mut result = [0u8; HANEUL_TRANSACTION_DIGEST_LENGTH];
