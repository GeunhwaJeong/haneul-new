...
use haneul_indexer::{models_v2::transactions::StoredTransaction, schema_v2::transactions};
use haneul_types::{
...
impl TransactionBlock {
    ...
    async fn sender(&self) -> Option<Address> {
        ...
        (sender != NativeHaneulAddress::ZERO).then(|| Address {
            address: HaneulAddress::from(sender),
        })
    }
