...
use super::haneulns_registration::{DomainFormat, NameService, HaneulnsRegistration};
use crate::data::Db;
...
#[graphql(
    ...
    field(
        ...
        desc = "Total balance of all coins with marker type owned by this object or address. If \
                type is not supplied, it defaults to `0x2::haneul::HANEUL`."
    ),
    field(
        name = "balances",
        arg(name = "first", ty = "Option<u64>"),
    ...
    field(
        ...
        arg(name = "last", ty = "Option<u64>"),
        arg(name = "before", ty = "Option<object::Cursor>"),
        ty = "Connection<String, StakedHaneul>",
        desc = "The `0x3::staking_pool::StakedHaneul` objects owned by this object or address."
    ),
    field(
        name = "default_haneulns_name",
    ...
    field(
        ...
        arg(name = "last", ty = "Option<u64>"),
        arg(name = "before", ty = "Option<object::Cursor>"),
        ty = "Connection<String, HaneulnsRegistration>",
        desc = "The HaneulnsRegistration NFTs owned by this object or address. These grant the owner \
