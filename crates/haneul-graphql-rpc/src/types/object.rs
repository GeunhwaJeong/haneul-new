...
use haneul_indexer::models::obj_indices::StoredObjectVersion;
use haneul_indexer::models::objects::{StoredFullHistoryObject, StoredHistoryObject};
use haneul_indexer::schema::{full_objects_history, objects_version};
        ...
        match &native.owner {
            ...
            O::ConsensusV2 {
                ...
                authenticator: Some(Authenticator::SingleOwner(Address {
                    address: HaneulAddress::from(*authenticator.as_single_owner()),
                    checkpoint_viewed_at: self.0.checkpoint_viewed_at,
                })),
            })),
        }
