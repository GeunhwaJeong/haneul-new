...
use haneul_indexer::models::objects::{StoredDeletedHistoryObject, StoredHistoryObject};
use haneul_indexer::schema::{objects_history, objects_version};
...
impl Object {
    ...
    pub(crate) async fn default_haneulns_name(
        ...
        OwnerImpl::from(self).default_haneulns_name(ctx, format).await
    }
