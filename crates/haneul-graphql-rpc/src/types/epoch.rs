...
use async_graphql::*;
use haneul_indexer::models_v2::epoch::StoredEpochInfo;
use haneul_types::haneul_system_state::haneul_system_state_summary::HaneulSystemStateSummary as NativeHaneulSystemStateSummary;
...
impl Epoch {
    ...
    async fn validator_set(&self) -> Result<Option<ValidatorSet>> {
        let system_state: NativeHaneulSystemStateSummary = bcs::from_bytes(&self.stored.system_state)
            .map_err(|e| {
