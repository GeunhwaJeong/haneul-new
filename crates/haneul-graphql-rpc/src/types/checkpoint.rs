...
use haneul_indexer::{models_v2::checkpoints::StoredCheckpoint, schema_v2::checkpoints};
use haneul_types::messages_checkpoint::{CheckpointCommitment, CheckpointDigest};
