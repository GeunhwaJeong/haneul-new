...
use haneul_archival::{read_manifest_as_json, write_manifest_from_json};
            ...
            ToolCommand::DownloadFormalSnapshot {
                ...
                let archive_bucket = Some(
                    env::var("FORMAL_SNAPSHOT_ARCHIVE_BUCKET").unwrap_or_else(|_| match network {
                        Chain::Mainnet => "haneullabs-mainnet-archives".to_string(),
                        Chain::Testnet => "haneullabs-testnet-archives".to_string(),
                        Chain::Unknown => {
