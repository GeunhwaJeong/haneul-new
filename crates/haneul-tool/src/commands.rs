        ...
        match self {
            ...
            ToolCommand::DownloadDBSnapshot {
                ...
                let snapshot_bucket = snapshot_bucket.unwrap_or_else(|| match (formal, network) {
                    (true, Chain::Mainnet) => "haneullabs-mainnet-formal".to_string(),
                    (false, Chain::Mainnet) => "haneullabs-mainnet-snapshots".to_string(),
                    (true, Chain::Testnet) => "haneullabs-testnet-formal".to_string(),
                    (false, Chain::Testnet) => "haneullabs-testnet-snapshots".to_string(),
                    (_, Chain::Unknown) => {
