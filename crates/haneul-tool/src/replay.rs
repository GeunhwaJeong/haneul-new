...
impl LocalExec {
    ...
    pub async fn download_latest_object_impl(
        ...
        obj_from_haneul_obj_response(&object)
    }
...
fn obj_from_haneul_obj_response(o: &HaneulObjectResponse) -> Result<Object, LocalExecError> {
    let o: Result<HaneulObjectData, anyhow::Error> = Ok(o
        .object()
        .map_err(|q| LocalExecError::HaneulObjectResponseError { err: q })?
        .clone());

    obj_from_haneul_obj_data(&o.map_err(|q| LocalExecError::GeneralError { err: q.to_string() })?)
}
