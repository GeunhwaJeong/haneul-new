...
const GEUNHWA_PER_HANEUL: i128 = 1_000_000_000;
...
impl SchedulerService {
    ...
    async fn create_wallet_monitoring_incident(
        ...
        let incident_body = Body {
            details: format!(
                "Current balance: {} HANEUL, Lower bound: {} HANEUL",
                current_balance / GEUNHWA_PER_HANEUL,
                lower_bound / GEUNHWA_PER_HANEUL
            ),
            ..Default::default()
        };
        ...
        pagerduty
            .create_incident("sadhan@haneul-labs.com", create_incident)
            .await?;
        Ok(())
    }
