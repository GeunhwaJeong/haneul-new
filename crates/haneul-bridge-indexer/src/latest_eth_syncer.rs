...
use haneul_bridge::types::RawEthLog;
    ...
    P: ethers::providers::JsonRpcClient + 'static,
{
    ...
    pub async fn run(
        ...
        Vec<JoinHandle<()>>,
        haneullabs_metrics::metered_channel::Receiver<(EthAddress, u64, Vec<RawEthLog>)>,
    )> {
    ...
    async fn run_event_listening_task(
        ...
        mut start_block: u64,
        provider: Arc<Provider<Http>>,
        events_sender: haneullabs_metrics::metered_channel::Sender<(EthAddress, u64, Vec<RawEthLog>)>,
        eth_client: Arc<EthClient<P>>,
        metrics: BridgeIndexerMetrics,
    ) {
