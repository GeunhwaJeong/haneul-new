            ...
            event.data.iter().for_each(|ev| {
                if ev.type_.address == BRIDGE_ADDRESS {
                    let token_transfer = match ev.type_.name.as_str() {
                        "TokenDepositedEvent" => {
                            println!("Observed Haneul Deposit");
                            ...
                            Some(TokenTransfer {
                                ...
                                data: Some(TokenTransferData {
                                    ...
                                    amount: event.amount_haneul_adjusted,
                                }),
                            })
                        }
                        "TokenTransferApproved" => {
                            println!("Observed Haneul Approval");
                    ...
                    if let Some(transfer) = token_transfer {
                        println!("HANEUL: Storing bridge event : {:?}", ev.type_);
