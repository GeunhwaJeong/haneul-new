...
use crate::haneul_worker::HaneulBridgeWorker;
...
impl HaneulCheckpointSyncer {
    ...
    async fn start_executor(
        ...
        let worker = HaneulBridgeWorker::new(vec![], pool, indexer_metrics_cloned);
        let worker_pool =
