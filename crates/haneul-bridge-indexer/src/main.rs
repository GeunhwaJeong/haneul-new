...
use std::sync::Arc;
use haneul_bridge::{
    abi::{EthBridgeCommittee, EthHaneulBridge},
    eth_client::EthClient,
    eth_syncer::EthSyncer,
};
use haneul_bridge_indexer::postgres_writer::get_connection_pool;
...
async fn main() -> Result<()> {
    ...
    let haneul_bridge = EthHaneulBridge::new(bridge_address, provider.clone());
