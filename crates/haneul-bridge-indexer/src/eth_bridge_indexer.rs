...
use haneul_bridge::types::{EthEvent, EthLog, RawEthLog};
...
impl EthFinalizedDatasource {
    pub fn new(
        eth_haneul_bridge_contract_address: String,
        eth_rpc_url: String,
        bridge_metrics: Arc<BridgeMetrics>,
        indexer_metrics: BridgeIndexerMetrics,
    ) -> Result<Self, anyhow::Error> {
        let bridge_address = EthAddress::from_str(&eth_haneul_bridge_contract_address)?;
        Ok(Self {
            bridge_address,
            eth_rpc_url,
            bridge_metrics,
