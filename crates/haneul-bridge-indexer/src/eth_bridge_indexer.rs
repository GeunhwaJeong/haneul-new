    ...
    fn map(
        ...
        match bridge_event {
            EthBridgeEvent::EthHaneulBridgeEvents(bridge_event) => match &bridge_event {
                ...
                EthHaneulBridgeEvents::TokensDepositedV2Filter(bridge_event) => {
                    info!(
                        "Observed Eth Deposit at block: {}, tx_hash: {}",
                        log.block_number(),
                        log.tx_hash
                ...
                EthHaneulBridgeEvents::EmergencyOperationFilter(f) => {
                    info!(
                ...
                EthHaneulBridgeEvents::ContractUpgradedFilter(f) => {
                    info!(
