...
use crate::schema::{
    progress_store, haneul_error_transactions, haneul_progress_store, token_transfer, token_transfer_data,
};
...
#[derive(Queryable, Selectable, Insertable, Identifiable, Debug)]
#[diesel(table_name = haneul_progress_store, primary_key(txn_digest))]
pub struct HaneulProgressStore {
...
#[derive(Queryable, Selectable, Insertable, Identifiable, Debug)]
#[diesel(table_name = haneul_error_transactions, primary_key(txn_digest))]
pub struct HaneulErrorTransactions {
    pub txn_digest: Vec<u8>,
    pub sender_address: Vec<u8>,
    pub timestamp_ms: i64,
