...
impl Object {
    ...
    pub fn transfer_without_version_change(&mut self, new_owner: HaneulAddress) -> HaneulResult {
    ...
    pub fn transfer_and_increment_version(&mut self, new_owner: HaneulAddress) -> HaneulResult {
