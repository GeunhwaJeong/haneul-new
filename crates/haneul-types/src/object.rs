...
impl Object {
    ...
    pub fn transfer_without_version_change(&mut self, new_owner: HaneulAddress) {
    ...
    pub fn transfer_and_increment_version(&mut self, new_owner: HaneulAddress) {
    ...
    pub fn new_gas_coin_for_testing(value: u64, owner: HaneulAddress) -> Self {
