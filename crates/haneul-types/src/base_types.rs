...
pub enum MoveObjectType_ {
    ...
    /// A HANEUL balance accumulator metadata field
    /// (i.e., `Field<MetadataKey<Balance<HANEUL>>, Metadata<Balance<HANEUL>>`)
    HaneulBalanceAccumulatorMetadataField,
    /// A non-HANEUL balance accumulator metadata field
...
impl MoveObjectType {
    ...
    pub fn address(&self) -> AccountAddress {
        match &self.0 {
            ...
            | MoveObjectType_::HaneulBalanceAccumulatorMetadataField
            | MoveObjectType_::BalanceAccumulatorMetadataField(_)
            | MoveObjectType_::BalanceAccumulatorOwnerField => HANEUL_FRAMEWORK_ADDRESS,
    ...
    pub fn coin_type_maybe(&self) -> Option<TypeTag> {
        match &self.0 {
            ...
            MoveObjectType_::HaneulBalanceAccumulatorMetadataField => None,
    ...
    pub fn balance_accumulator_metadata_field_type_maybe(&self) -> Option<TypeTag> {
        match &self.0 {
            MoveObjectType_::HaneulBalanceAccumulatorMetadataField => Some(GAS::type_tag()),
    ...
    pub fn size_for_gas_metering(&self) -> usize {
        ...
        match &self.0 {
            ...
            MoveObjectType_::HaneulBalanceAccumulatorMetadataField => 1,
            MoveObjectType_::BalanceAccumulatorMetadataField(inner) => {
                bcs::serialized_size(inner).unwrap() + 1
            }
