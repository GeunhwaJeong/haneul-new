...
use crate::crypto::{
    ...
    SignatureScheme, HaneulSignature, HaneulSignatureInner, ToFromBytes, VerificationObligation,
};
...
impl Transaction {
    ...
    pub fn verify(self) -> HaneulResult<VerifiedTransaction> {
...
impl SignedTransaction {
    ...
    pub fn verify(self, committee: &Committee) -> HaneulResult<VerifiedSignedTransaction> {
        self.verify_signatures(committee)?;
        Ok(VerifiedTransactionEnvelope::<AuthoritySignInfo>::new_from_verified(self))
    }

    pub fn verify_signatures(&self, committee: &Committee) -> HaneulResult {
        self.verify_sender_signature()?;
...
impl CertifiedTransaction {
    ...
    pub fn verify(self, committee: &Committee) -> HaneulResult<VerifiedCertificate> {
        self.verify_signatures(committee)?;
