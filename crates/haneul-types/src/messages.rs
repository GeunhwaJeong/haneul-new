...
use crate::crypto::{
    ...
    Ed25519HaneulSignature, EmptySignInfo, InternalHash, Signature, Signer, HaneulSignatureInner,
    ToFromBytes,
};
...
impl CertifiedTransaction {
    ...
    pub fn verify_sender_signatures(&self) -> HaneulResult {
...
pub enum ExecutionFailureStatus {
    ...
    InsufficientGas,
    #[error("Invalid Gas Object. Possibly not address-owned or possibly not a HANEUL coin.")]
    InvalidGasObject,
