...
use crate::crypto::{
    ...
    Ed25519HaneulSignature, EmptySignInfo, Signature,
};
...
impl<S> Envelope<SenderSignedData, S> {
    ...
    pub fn touches_system_object(&self) -> bool {
        self.shared_input_objects()
            .any(|o| o.id() == HANEUL_SYSTEM_STATE_OBJECT_ID)
    }
    ...
    fn new_system_transaction(system_transaction: SingleTransactionKind) -> Self {
        system_transaction
            ...
            .pipe(|data| SenderSignedData {
                ...
                tx_signature: GenericSignature::Signature(Ed25519HaneulSignature::default().into()),
            })
