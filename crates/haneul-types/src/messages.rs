...
impl<S> TransactionEnvelope<S> {
    pub fn verify_signature(&self) -> Result<(), HaneulError> {
...
impl ExecutionStatus {
    pub fn new_failure(gas_used: GasCostSummary, error: HaneulError) -> ExecutionStatus {
    ...
    pub fn unwrap_err(self) -> (GasCostSummary, HaneulError) {
        match self {
