...
impl CertifiedCheckpoint {
    ...
    pub fn aggregate(
        ...
        committee: &Committee,
    ) -> Result<CertifiedCheckpoint, HaneulError> {
        fp_ensure!(
...
mod tests {
    ...
    fn test_signed_proposal() {
        ...
        let mut proposal =
            SignedCheckpoint::new(committee.epoch, 1, *name, &authority_key[0], &set, None);
    ...
    fn test_certified_checkpoint() {
        ...
        let signed_checkpoints: Vec<_> = keys
            ...
            .map(|k| {
                ...
                SignedCheckpoint::new(committee.epoch, 1, *name, k, &set, None)
            })
            .collect();
