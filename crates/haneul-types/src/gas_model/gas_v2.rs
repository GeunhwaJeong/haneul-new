...
use crate::gas::{GasCostSummary, HaneulGasStatusAPI};
use crate::{
...
use haneul_cost_tables::bytecode_tables::{GasStatus, INITIAL_COST_SCHEDULE};
...
// for a RPG of 1000 this amounts to about 5 HANEUL
...
pub struct HaneulGasStatus<'a> {
    ...
    /// execution. The value is in Haneul.
    storage_rebate: u64,
...
impl<'a> HaneulGasStatus<'a> {
    ...
    pub(crate) fn new_with_budget(
        ...
        // println!(
        //     "GAS - HaneulGasStatus: budget {}, gas_price {}, computation_gas_price {}, storage_unit_gas_price {}",
        //     gas_budget,
        //     gas_price,
        //     gas_price,
        //     storage_gas_price,
