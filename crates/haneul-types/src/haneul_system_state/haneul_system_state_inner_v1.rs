            ...
            active_validators: self
                ...
                .map(|validator| {
                    ...
                    EpochStartValidatorInfo {
                        ...
                        haneul_net_address: metadata.net_address,
    ...
    fn into_haneul_system_state_summary(self) -> HaneulSystemStateSummary {
        HaneulSystemStateSummary {
            ...
            active_validators: self
                ...
                .active_validators
                .into_iter()
                .map(|v| HaneulValidatorSummary {
                    haneul_address: v.metadata.haneul_address,
                    ...
                    staking_pool_deactivation_epoch: v
                        ...
                        .deactivation_epoch
                        .into_option(),
                    staking_pool_haneul_balance: v.staking_pool.haneul_balance,
                    ...
                    pending_total_haneul_withdraw: v.staking_pool.pending_total_haneul_withdraw,
