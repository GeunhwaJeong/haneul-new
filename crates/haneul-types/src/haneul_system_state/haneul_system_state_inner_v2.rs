...
use super::haneul_system_state_summary::HaneulSystemStateSummary;
...
/// Rust version of the Move haneul_system::haneul_system::HaneulSystemStateInnerV2 type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct HaneulSystemStateInnerV2 {
    pub epoch: u64,
...
impl HaneulSystemStateTrait for HaneulSystemStateInnerV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
