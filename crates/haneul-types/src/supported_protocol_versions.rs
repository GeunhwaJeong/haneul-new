...
pub use haneul_protocol_config::{Chain, ProtocolConfig, ProtocolVersion};
...
impl SupportedProtocolVersionsWithHashes {
    ...
    // Ideally this would be in haneul-protocol-config, but haneul-types depends on haneul-protocol-config,
