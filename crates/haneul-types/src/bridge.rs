...
pub const BRIDGE_CREATE_ADD_TOKEN_ON_HANEUL_MESSAGE_FUNCTION_NAME: &IdentStr =
    ident_str!("create_add_tokens_on_haneul_message");
...
/// Rust version of the Move haneul::bridge::Bridge type
...
pub trait BridgeTrait {
    ...
    fn frozen(&self) -> bool;
    fn try_into_bridge_summary(self) -> HaneulResult<BridgeSummary>;
}
...
pub fn get_bridge_wrapper(object_store: &dyn ObjectStore) -> Result<BridgeWrapper, HaneulError> {
...
pub fn get_bridge(object_store: &dyn ObjectStore) -> Result<Bridge, HaneulError> {
...
pub struct MoveTypeBridgeCommittee {
    ...
    pub member_registrations: VecMap<HaneulAddress, MoveTypeCommitteeMemberRegistration>,
...
pub struct BridgeCommitteeSummary {
    ...
    pub member_registration: Vec<(HaneulAddress, MoveTypeCommitteeMemberRegistration)>,
    pub last_committee_update_epoch: u64,
}
