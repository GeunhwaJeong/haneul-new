...
use crate::{base_types::TransactionDigest, error::HaneulError};
use crate::{
...
// Rust version of the Move haneul::coin::Coin type
...
impl Coin {
    ...
    pub fn is_coin(other: &StructTag) -> bool {
        other.address == HANEUL_FRAMEWORK_ADDRESS
...
// Rust version of the Move haneul::coin::TreasuryCap type
...
impl TreasuryCap {
    ...
    pub fn from_bcs_bytes(content: &[u8]) -> Result<Self, HaneulError> {
        bcs::from_bytes(content).map_err(|err| HaneulError::TypeError {
...
// A helper function for pay_haneul and pay_all_haneul.
...
// Rust version of the Move haneul::coin::CoinMetadata type
#[derive(Debug, Serialize, Deserialize, Clone, JsonSchema, Eq, PartialEq)]
...
// Rust version of the Move haneul::locked_coin::LockedCoin type
#[derive(Debug, Serialize, Deserialize, Clone, JsonSchema, Eq, PartialEq)]
