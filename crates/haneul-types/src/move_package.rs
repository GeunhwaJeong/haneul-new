...
/// Rust representation of upgrade policy constants in `haneul::package`.
...
/// Rust representation of `haneul::package::UpgradeCap`.
...
/// Rust representation of `haneul::package::UpgradeTicket`.
#[derive(Debug, Serialize, Deserialize)]
...
/// Rust representation of `haneul::package::UpgradeReceipt`.
#[derive(Debug, Serialize, Deserialize)]
...
impl MovePackage {
    ...
    pub fn deserialize_module(&self, module: &Identifier) -> HaneulResult<CompiledModule> {
    ...
    pub fn disassemble(&self) -> HaneulResult<BTreeMap<String, Value>> {
        disassemble_modules(self.module_map.values())
    }

    pub fn normalize(&self) -> HaneulResult<BTreeMap<String, normalized::Module>> {
...
pub fn disassemble_modules<'a, I>(modules: I) -> HaneulResult<BTreeMap<String, Value>>
where
...
pub fn normalize_modules<'a, I>(modules: I) -> HaneulResult<BTreeMap<String, normalized::Module>>
where
    I: Iterator<Item = &'a Vec<u8>>,
{
