...
pub trait Message {
    ...
    fn verify(&self, signature_epoch: Option<EpochId>) -> HaneulResult;
}
...
impl<T: Message> Envelope<T, EmptySignInfo> {
    ...
    pub fn verify_signature(&self) -> HaneulResult {
        self.data.verify(None)
    }

    pub fn verify(self) -> HaneulResult<VerifiedEnvelope<T, EmptySignInfo>> {
    ...
    T: Message + Serialize,
{
    ...
    pub fn verify_signature(&self, committee: &Committee) -> HaneulResult {
