...
impl From<crate::object::Owner> for Owner {
    fn from(value: crate::object::Owner) -> Self {
        match value {
            ...
            // TODO(ConsensusV2): Corresponding types need to be added to haneul-sdk-types.
...
impl From<crate::base_types::HaneulAddress> for ObjectId {
    fn from(value: crate::base_types::HaneulAddress) -> Self {
        Self::new(value.to_inner())
    }
}

impl From<ObjectId> for crate::base_types::HaneulAddress {
    fn from(value: ObjectId) -> Self {
        crate::base_types::ObjectID::new(value.into_inner()).into()
    }
}
