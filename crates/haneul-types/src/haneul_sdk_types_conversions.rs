        ...
        Self::new(
            ...
            match value.value {
                crate::effects::AccumulatorValue::Integer(value) => {
                    haneul_sdk_types::AccumulatorValue::Integer(value)
                }
                crate::effects::AccumulatorValue::IntegerTuple(a, b) => {
                    haneul_sdk_types::AccumulatorValue::IntegerTuple(a, b)
                }
                crate::effects::AccumulatorValue::EventDigest(digests) => {
                    haneul_sdk_types::AccumulatorValue::EventDigest(
                        digests
                            .into_iter()
...
impl From<crate::execution_status::ExecutionErrorKind> for ExecutionError {
    fn from(value: crate::execution_status::ExecutionErrorKind) -> Self {
        match value {
            ...
            crate::execution_status::ExecutionErrorKind::HaneulMoveVerificationError => Self::HaneulMoveVerificationError,
            ...
            crate::execution_status::ExecutionErrorKind::HaneulMoveVerificationTimedout => Self::HaneulMoveVerificationTimedout,
