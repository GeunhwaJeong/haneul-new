...
const HANEUL_SYSTEM_STATE_INNER_MODULE: &str = "haneul_system_state_inner";
...
/// Used by haneul-execution v1 and above, to capture the execution results from Move.
...
impl MoveTypeTagTrait for ExecutionTimeObservationChunkKey {
    fn get_type_tag() -> TypeTag {
        TypeTag::Struct(Box::new(StructTag {
            ...
            module: Identifier::new(HANEUL_SYSTEM_STATE_INNER_MODULE).unwrap(),
