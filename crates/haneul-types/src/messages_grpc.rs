...
/// Soft Bundle request.  See [SIP-19](https://github.com/haneul-foundation/sips/blob/main/sips/sip-19.md).
#[derive(Clone, Debug, Serialize, Deserialize)]
...
pub enum WaitForEffectsResponse {
    ...
    Rejected {
        ...
        error: Option<crate::error::HaneulError>,
    },
...
impl TryFrom<ExecutedData> for RawExecutedData {
    ...
    fn try_from(value: ExecutedData) -> Result<Self, Self::Error> {
        let effects = bcs::to_bytes(&value.effects)
            .map_err(
                |err| crate::error::HaneulErrorKind::GrpcMessageSerializeError {
...
impl TryFrom<RawExecutedData> for ExecutedData {
    ...
    fn try_from(value: RawExecutedData) -> Result<Self, Self::Error> {
        let effects = bcs::from_bytes(&value.effects).map_err(|err| {
            crate::error::HaneulErrorKind::GrpcMessageDeserializeError {
...
impl TryFrom<RawSubmitTxResult> for SubmitTxResult {
    ...
    fn try_from(value: RawSubmitTxResult) -> Result<Self, Self::Error> {
        match value.inner {
            ...
            None => Err(crate::error::HaneulErrorKind::GrpcMessageDeserializeError {
...
impl TryFrom<RawSubmitTxResponse> for SubmitTxResponse {
    ...
    fn try_from(value: RawSubmitTxResponse) -> Result<Self, Self::Error> {
        ...
        if value.results.len() != 1 {
            return Err(crate::error::HaneulErrorKind::GrpcMessageDeserializeError {
        ...
        let results = value
            ...
            .collect::<Result<Vec<SubmitTxResult>, crate::error::HaneulError>>()?;
...
fn try_from_raw_rejected_status(
    rejected: RawRejectedStatus,
) -> Result<Option<crate::error::HaneulError>, crate::error::HaneulError> {
...
fn try_from_response_rejected(
    error: Option<crate::error::HaneulError>,
) -> Result<RawRejectedStatus, crate::error::HaneulError> {
...
fn try_from_response_executed(
    ...
    details: Option<Box<ExecutedData>>,
    fast_path: bool,
) -> Result<RawExecutedStatus, crate::error::HaneulError> {
...
impl TryFrom<RawWaitForEffectsRequest> for WaitForEffectsRequest {
    ...
    fn try_from(value: RawWaitForEffectsRequest) -> Result<Self, Self::Error> {
        ...
        let ping_type = value
            .ping_type
            .map(|p| {
                PingType::try_from(p).map_err(|e| HaneulErrorKind::GrpcMessageDeserializeError {
...
mod tests {
    ...
    async fn test_submit_tx_request_into_raw() {
        ...
        );
        {
            ...
            let sender = crate::base_types::HaneulAddress::random_for_testing_only();
            let recipient = crate::base_types::HaneulAddress::random_for_testing_only();
