...
//! Rust bindings for `haneul::funds_accumulator`
...
/// Rust bindings for the Move struct `haneul::funds_accumulator::Withdrawal`.
...
impl Withdrawal {
    pub fn new(owner: HaneulAddress, limit: U256) -> Self {
        Self { owner, limit }
    }
    ...
    pub fn owner(&self) -> HaneulAddress {
        self.owner
    }
