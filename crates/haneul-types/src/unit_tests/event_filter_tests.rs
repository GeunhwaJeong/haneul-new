...
use crate::base_types::{SequenceNumber, HaneulAddress, TransactionDigest};
use crate::event::{Event, EventEnvelope};
use crate::event::{EventType, TransferType};
use crate::event_filter::{EventFilter, Filter};
use crate::gas_coin::GasCoin;
use crate::object::Owner;
use crate::{ObjectID, MOVE_STDLIB_ADDRESS, HANEUL_FRAMEWORK_ADDRESS};
...
fn test_move_event_filter() {
    ...
    let filters = vec![
        ...
        EventFilter::Package(ObjectID::from(HANEUL_FRAMEWORK_ADDRESS)),
