...
pub fn make_zklogin_tx() -> (HaneulAddress, Transaction, GenericSignature) {
    ...
    let user_address = HaneulAddress::from_bytes(hasher.finalize().digest).unwrap();
