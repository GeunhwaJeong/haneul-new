...
use crate::{
    ...
    crypto::{get_key_pair_from_rng, DefaultHash, SignatureScheme, HaneulKeyPair},
...
fn test_serde_zk_login_signature() {
    ...
    let user_address: HaneulAddress = (&sig).try_into().unwrap();
    assert_eq!(
        user_address,
        HaneulAddress::from_str("0xd5cb3a8f365cf9e0486df1675538fa7b95875e1ef3ebbe1d392e163f0aa12a11")
            .unwrap()
    );
}
