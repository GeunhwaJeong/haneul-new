...
pub struct CheckerResultObject {
    ...
    haneul_object: Option<HaneulObject<HaneulParsedMoveObject>>,
}
...
impl CheckerResultObject {
    ...
    pub fn into_haneul_object(self) -> HaneulObject<HaneulParsedMoveObject> {
...
impl TransferObjectEventChecker {
    ...
    pub fn sender(mut self, sender: HaneulAddress) -> Self {
    ...
    pub fn check(self, event: &HaneulEvent) {
