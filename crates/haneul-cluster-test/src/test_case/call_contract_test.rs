...
use haneul_json_rpc_types::{ObjectChange, HaneulEvent, HaneulTransactionEffectsAPI};
...
impl TestCaseImpl for CallContractTest {
    ...
    async fn run(&self, ctx: &mut TestContext) -> Result<(), anyhow::Error> {
        ...
        let data = ctx
            .build_transaction_remotely("haneul_moveCall", params)
            .await?;
        ...
        events.iter().find(|e| matches!(e, HaneulEvent{
            package_id,
            sender,
            bcs,
            type_,
