...
async fn test_transfer_single_gas_coin() {
    ...
    let input_objects = pt
        ...
        .collect::<Vec<_>>();
    let gas = vec![get_random_haneul(&client, sender, input_objects).await];
...
async fn test_balance_from_obj_paid_eq_gas() {
    ...
    let client = test_cluster.wallet.get_client().await.unwrap();
    let response: HaneulTransactionBlockResponse = serde_json::from_value(json!({
      ...
      "objectChanges": [
        {
          ...
          "objectType": "0x2::coin::Coin<0x2::haneul::HANEUL>",
          "objectId": "0x08d6f5f85a55933fff977c94a2d1d94e8e2fff241c19c20bc5c032e0989f16a4",
          "version": "9",
          "previousVersion": "8",
          "digest": "5fwFSzUqrKQbJZsfPLmPN8B3Vws3ffjpvRctEzbnaZTN"
