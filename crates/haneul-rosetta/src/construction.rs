...
pub async fn metadata(
    ...
    let (epoch, chain_id) = if needs_address_balance_metadata {
        ...
        let chain_id_str =
            haneul_types::digests::CheckpointDigest::new(*context.chain_id.as_bytes())
                .base58_encode();
...
fn verify_pay_coin_currency<'a>(
    ...
    let haneul =
        TypeTag::from_str("0x2::haneul::HANEUL").expect("0x2::haneul::HANEUL is a valid type tag");
...
mod tests {
    ...
    fn test_verify_pay_coin_currency() {
        ...
        assert!(
            verify_pay_coin_currency(&pay_coin("0x2::haneul::HANEUL"), ["0x2::haneul::HANEUL"])
                .is_err()
        );
