...
use haneul_types::base_types::{encode_bytes_hex, ObjectInfo, HaneulAddress};
...
use crate::operations::{Operation, HaneulAction};
use crate::types::{
...
pub async fn preprocess(
    ...
    env.check_network_identifier(&request.network_identifier)?;
    let action: HaneulAction = request.operations.try_into()?;
