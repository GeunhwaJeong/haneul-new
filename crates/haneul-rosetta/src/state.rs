...
use haneul_types::base_types::{HaneulAddress, TransactionDigest, TRANSACTION_DIGEST_LENGTH};
...
impl PseudoBlockProvider {
    pub fn spawn(client: HaneulClient, genesis: Genesis, db_path: &Path) -> Self {
        let blocks = Self {
