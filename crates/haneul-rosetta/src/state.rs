...
use haneul_sdk::apis::Checkpoint;
...
impl CheckpointBlockProvider {
    ...
    async fn update_balance(
        ...
        let balances: HashMap<HaneulAddress, i128> =
            transactions
                .into_iter()
                .try_fold(HashMap::new(), |mut changes, tx| {
                    ...
                    Ok::<HashMap<HaneulAddress, i128>, anyhow::Error>(changes)
                })?;
...
pub struct CheckpointIndexStore {
    ...
    balances: DBMap<(HaneulAddress, EpochId), HistoricBalance>,
    #[default_options_override_fn = "default_config"]
