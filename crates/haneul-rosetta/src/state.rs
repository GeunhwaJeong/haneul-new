...
fn extract_balance_changes_from_ops(ops: Operations) -> HashMap<HaneulAddress, i128> {
    ops.into_iter()
        .fold(HashMap::<HaneulAddress, i128>::new(), |mut changes, op| {
            match op.type_ {
...
pub struct CheckpointIndexStore {
    ...
    balances: DBMap<(HaneulAddress, EpochId), i128>,
    #[default_options_override_fn = "default_config"]
