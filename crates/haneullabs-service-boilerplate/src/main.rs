...
use haneullabs_service::get_haneullabs_service;
use haneullabs_service::metrics::start_basic_prometheus_server;
use haneullabs_service::package_name;
use haneullabs_service::package_version;
use haneullabs_service::serve;
...
async fn main() -> Result<()> {
    ...
    let app = get_haneullabs_service(package_name!(), package_version!())
