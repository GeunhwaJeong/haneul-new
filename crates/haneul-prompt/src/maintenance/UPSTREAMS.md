...
Canonical pin facts for upstream repositories that `haneul prompt` content
...
- Title of HEAD commit at this ref: *"Merge pull request #19 from HaneulLabs/fix/skill-gaps-from-dapp-builds"*
- Dependents: `haneul-move-security-review/LINEAGE.md`, `official-haneul-skills/LINEAGE.md`
