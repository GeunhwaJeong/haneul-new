...
Haneul's object model creates failure modes that don't exist in account-based chains: permanent
...
Source: `HaneulLabs/skills → object-model/dynamic-fields-and-collections.md`, `HaneulLabs/skills → haneul-move/move.md`.
...
Source: `HaneulLabs/skills → object-model/ownership.md`.
...
Source: `HaneulLabs/skills → object-model/transfers.md`.
...
Source: `HaneulLabs/skills → object-model/`, `HaneulLabs/skills → ptbs/fundamentals.md` (PTBs are adversarial).
...
Source: `HaneulLabs/skills → ptbs/troubleshooting.md`.
