...
Source: `HaneulLabs/skills → modern-move-syntax/SKILL.md`, `HaneulLabs/skills → haneul-move/SKILL.md`.
...
Source: [+domain]; `HaneulLabs/skills → ptbs/commands.md` (empty `SplitCoins` fails pre-execution).
...
Source: `HaneulLabs/skills → haneul-move/events-coins.md`, `HaneulLabs/skills → haneul-move/move.md`. See SM-G1-custody.
