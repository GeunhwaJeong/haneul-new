...
`copy` destroys the enforcement. **This also applies to the framework `haneul::borrow::Referent<T>`
...
whose returned obligation type is not ability-less; a wrapper around `haneul::borrow::Borrow` that
...
Source: `HaneulLabs/skills → object-model/patterns.md` (hot-potato + `haneul::borrow::Referent` /
`Borrow` patterns), `HaneulLabs/skills → naming-conventions/SKILL.md`.
...
Source: `HaneulLabs/skills → composable-move-functions/SKILL.md`, `HaneulLabs/skills → naming-conventions/SKILL.md`.
...
Source: `HaneulLabs/skills → ptbs/fundamentals.md`, `HaneulLabs/skills → ptbs/commands.md`.
...
Source: `HaneulLabs/skills → ptbs/building.md`, `HaneulLabs/skills → ptbs/fundamentals.md`,
`HaneulLabs/skills → ptbs/commands.md` (non-empty array preflights).
