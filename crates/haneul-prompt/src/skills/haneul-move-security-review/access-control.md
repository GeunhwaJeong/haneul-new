...
Capabilities are Haneul's primary authorization primitive: holding the object *is* the permission.
...
Source: `HaneulLabs/skills → haneul-move/move.md`, `HaneulLabs/skills → naming-conventions/SKILL.md`.
...
Source: `HaneulLabs/skills → haneul-move/move.md`, `HaneulLabs/skills → composable-move-functions/SKILL.md`.
...
Source: `HaneulLabs/skills → haneul-move/move.md`.
...
Source: `HaneulLabs/skills → haneul-move/move.md` (witness / OTW patterns).
...
Source: `HaneulLabs/skills → object-model/transfers.md` (`transfer_if_unlocked` example:
...
Source: `HaneulLabs/skills → haneul-move/events-coins.md`, `HaneulLabs/skills → haneul-publish/SKILL.md`. See SM-G1, SM-I1.
