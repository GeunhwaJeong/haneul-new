...
Source: `HaneulLabs/skills → object-model/dynamic-fields-and-collections.md`, `HaneulLabs/skills → object-model/patterns.md`.
...
Source: `HaneulLabs/skills → object-model/dynamic-fields-and-collections.md`.
...
to be initialized).
Source: `HaneulLabs/skills → object-model/dynamic-fields-and-collections.md` ("Accessing a
