...
Source: `HaneulLabs/skills → haneul-move/move.md`, `HaneulLabs/skills → haneul-overview/ecosystem.md`.

### SM-L2 — Randomness test-and-abort (composition leak)   [Critical]
Invariant: functions that consume `haneul::random` (`Random` object `0x8`) must be `entry` only,
...
Source: `HaneulLabs/skills → haneul-overview/ecosystem.md` (entry-only / test-and-abort) + Haneul randomness
