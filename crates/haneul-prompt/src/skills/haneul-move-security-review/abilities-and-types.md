...
Source: `HaneulLabs/skills → object-model/ownership.md`, `HaneulLabs/skills → object-model/transfers.md`.
...
Source: `HaneulLabs/skills → haneul-move/events-coins.md`, `HaneulLabs/skills → object-model/display.md`.
...
from upstream `HaneulLabs/skills` — verified empty in `modern-move-syntax/`,
`composable-move-functions/`, and `haneul-move/move.md` at the pinned ref).
