...
Source: `HaneulLabs/skills → haneul-publish/SKILL.md`, `HaneulLabs/skills → haneul-move/move.md`,
`HaneulLabs/skills → ptbs/commands.md` (UpgradeReceipt + `package::commit_upgrade`).
...
Source: `HaneulLabs/skills → haneul-publish/SKILL.md`, `HaneulLabs/skills → ptbs/commands.md` (upgrade does not call `init`).
