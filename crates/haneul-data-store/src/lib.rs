...
//! after the GQL schema in `crates/haneul-indexer-alt-graphql/schema.graphql`.
//!
//! ## Core Traits
//!
...
/// The data provided to `haneul_execution::executor::Executor::execute_transaction_to_effects`
...
/// `crates/haneul-indexer-alt-graphql/schema.graphql::multiGetObjects`.
