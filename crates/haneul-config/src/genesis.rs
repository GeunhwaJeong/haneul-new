...
pub struct GenesisChainParameters {
    pub initial_haneul_custody_account_address: HaneulAddress,
...
pub struct GenesisCeremonyParameters {
    ...
    /// The initial account address that will own the initial 9 Billion Haneul that is minted at
    /// genesis.
    #[serde(default)]
    pub initial_haneul_custody_account_address: HaneulAddress,

    /// The initial amount of Haneul (denominated in Geunhwa) given to genesis validators for their
    /// initial stake.
    #[serde(default = "GenesisCeremonyParameters::test_initial_validator_stake_geunhwa")]
    pub initial_validator_stake_geunhwa: u64,
...
impl GenesisCeremonyParameters {
    ...
    fn test_initial_validator_stake_geunhwa() -> u64 {
...
pub fn generate_genesis_system_object(
    ...
    let genesis_chain_parameters = GenesisChainParameters {
        initial_haneul_custody_account_address: parameters.initial_haneul_custody_account_address,
        initial_validator_stake_geunhwa: parameters.initial_validator_stake_geunhwa,
