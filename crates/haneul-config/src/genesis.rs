...
use haneul_types::messages::{InputObjects, SignedTransaction};
...
impl Genesis {
    ...
    pub fn validator_set(&self) -> Vec<ValidatorInfo> {
        ...
        for validator in &self.haneul_system_object().validators.active_validators {
...
impl Builder {
    ...
    pub fn build(mut self) -> Genesis {
        ...
        {
            assert_eq!(
                validator.haneul_address().to_vec(),
                onchain_validator.metadata.haneul_address.to_vec(),
            );
            assert_eq!(
...
fn build_unsigned_genesis_data(
    ...
    let objects = create_genesis_objects(
        ...
        parameters.initial_haneul_custody_account_address,
    );
...
fn create_genesis_objects(
    ...
    initial_haneul_custody_account_address: HaneulAddress,
) -> Vec<Object> {
    ...
    generate_genesis_system_object(
        ...
        protocol_version,
        initial_haneul_custody_account_address,
    )
    .unwrap();
...
pub fn generate_genesis_system_object(
    ...
    let mut haneul_addresses = Vec::new();
    ...
    adapter::execute::<execution_mode::Normal, _, _>(
        ...
        vec![],
        vec![
            CallArg::Pure(bcs::to_bytes(&initial_haneul_custody_account_address).unwrap()),
