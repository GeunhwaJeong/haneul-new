...
pub fn new_tcp_network_address() -> haneul_types::multiaddr::Multiaddr {
...
pub fn new_udp_network_address() -> haneul_types::multiaddr::Multiaddr {
    let host = format!("{}", get_local_ip_for_tests());
...
) -> haneul_types::multiaddr::Multiaddr {
    match address {
...
pub fn get_local_ip_for_tests() -> IpAddr {
    let node = haneul_simulator::runtime::NodeHandle::current();
