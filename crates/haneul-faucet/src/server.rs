...
const DEFAULT_FAUCET_WEB_APP_URL: &str = "https://faucet.haneul.io";
...
/// Redirect to faucet.haneul.io/?network if it's testnet/devnet network. For local network, keep the
...
pub fn create_wallet_context(
    ...
    let wallet_conf = config_dir.join(HANEUL_CLIENT_CONFIG);
