...
pub trait Faucet {
    ...
    /// Send `Coin<HANEUL>` of the specified amount to the recipient in a batch request
    async fn batch_send(
        &self,
        id: Uuid,
        recipient: HaneulAddress,
...
#[clap(
    name = "Haneul Faucet",
    about = "Faucet for requesting test tokens on Haneul",
...
pub struct FaucetConfig {
    ...
    /// Testnet faucet requires authentication via the Web UI at <https://faucet.haneul.io>
