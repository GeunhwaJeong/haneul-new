...
use haneul_types::{base_types::ObjectID, messages::TransactionData};
...
/// Persistent log of transactions paying out haneul from the faucet, keyed by the coin serving the
