...
pub(crate) struct HaneulClient<P> {
    inner: P,
}
...
mod tests {
    ...
    async fn test_query_events_by_module() {
        ...
        let event = HaneulEvent::random_for_testing();
        let events = EventPage {
        ...
        // page 1 (event 1)
        let event_1 = HaneulEvent::random_for_testing();
        ...
        let event_4 = HaneulEvent::random_for_testing();
