...
impl HaneulClient<HaneulSdkClient> {
    ...
    P: HaneulClientInner,
{
    ...
    /// Consideration: a Haneul transaction block should not contain too many
    /// Bridge events.
    pub async fn query_events_by_module(
    ...
    ) -> BridgeResult<Page<HaneulEvent, TransactionDigest>> {
        ...
        let mut all_events: Vec<haneul_json_rpc_types::HaneulEvent> = vec![];
        loop {
...
mod tests {
    ...
    async fn test_query_events_by_module() {
        ...
        let mut event = HaneulEvent::random_for_testing();
        ...
        // page 1 (event 1)
        let mut event_1 = HaneulEvent::random_for_testing();
        ...
        let mut event_2 = HaneulEvent::random_for_testing();
        ...
        let mut event_3 = HaneulEvent::random_for_testing();
        ...
        let mut event_4 = HaneulEvent::random_for_testing();
        ...
        let page: Page<HaneulEvent, TransactionDigest> = haneul_client
            .query_events_by_module(package, module.clone(), cursor)
            .await
            .unwrap();
