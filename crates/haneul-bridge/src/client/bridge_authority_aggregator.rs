...
use haneul_common::authority_aggregation::quorum_map_then_reduce_with_timeout_and_prefs;
use haneul_common::authority_aggregation::ReduceOutput;
...
async fn request_sign_bridge_action_into_certification(
    ...
    let preference = match action {
        BridgeAction::HaneulToEthBridgeAction(_) => Some(BTreeSet::new()),
