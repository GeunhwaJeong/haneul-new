...
mod tests {
    ...
    async fn test_bridge_client_request_sign_action() {
        ...
        mock_handler.add_haneul_event_response(tx_digest, event_idx, Ok(wrong_signed_action), None);
        let err = client
            .request_sign_bridge_action(action.clone())
            .await
            .unwrap_err();
        ...
        mock_handler.add_haneul_event_response(tx_digest, event_idx, Ok(signed_event), None);
        ...
        mock_handler.add_haneul_event_response(tx_digest, event_idx, Ok(signed_event2), None);
        let err = client
            .request_sign_bridge_action(action.clone())
            .await
            .unwrap_err();
        ...
        mock_handler.add_haneul_event_response(tx_digest, event_idx, Ok(signed_event3), None);
        let err = client
            .request_sign_bridge_action(action.clone())
            .await
            .unwrap_err();
