...
mod tests {
    ...
    async fn test_bridge_client() {
        ...
        let action = get_test_haneul_to_eth_bridge_action(TransactionDigest::random(), 1, 1, 100);
    ...
    async fn test_bridge_client_request_sign_action() {
        ...
        let action = get_test_haneul_to_eth_bridge_action(tx_digest, event_idx, 1, 100);
        ...
        let action2 = get_test_haneul_to_eth_bridge_action(tx_digest, event_idx, 2, 200);
