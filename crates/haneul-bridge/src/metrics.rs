...
use haneullabs_common::metrics::{push_metrics, MetricsPushClient};
...
pub struct BridgeMetrics {
    ...
    pub(crate) last_synced_haneul_checkpoints: IntGaugeVec,
    ...
    pub(crate) haneul_rpc_errors: IntCounterVec,
...
impl BridgeMetrics {
    pub fn new(registry: &Registry) -> Self {
        Self {
            ...
            .unwrap(),
            last_synced_haneul_checkpoints: register_int_gauge_vec_with_registry!(
                "bridge_last_synced_haneul_checkpoints",
                "The latest haneul checkpoints synced for each module",
                &["module_name"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            haneul_rpc_errors: register_int_counter_vec_with_registry!(
                "bridge_haneul_rpc_errors",
                "Total number of errors from haneul RPC, by RPC method",
                &["method"],
                registry,
            )
            .unwrap(),
