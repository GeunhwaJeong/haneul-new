...
pub struct WatchdogMetrics {
    ...
    pub haneul_bridge_paused: IntGauge,
}
    ...
    pub fn new(registry: &Registry) -> Self {
        Self {
            ...
            total_supplies: register_int_gauge_vec_with_registry!(
                ...
                "Current total supplies of coins on Haneul based on Treasury Cap",
                &["token_name"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            haneul_bridge_paused: register_int_gauge_with_registry!(
                "bridge_haneul_bridge_paused",
                "Whether the haneul bridge is paused",
                registry,
            )
            .unwrap(),
        }
