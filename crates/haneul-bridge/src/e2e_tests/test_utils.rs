...
use crate::abi::{EthBridgeCommittee, EthBridgeEvent, EthERC20, EthHaneulBridge, EthHaneulBridgeEvents};
...
use haneul_types::bridge::get_bridge_obj_initial_shared_version;
use haneul_types::bridge::{BRIDGE_MODULE_NAME, get_bridge};
...
impl EthBridgeEnvironment {
    ...
    pub async fn get_supported_token(&self, token_id: u8) -> (EthAddress, u8, u64) {
        ...
        let token_haneul_decimal = config.token_haneul_decimal_of(token_id).call().await.unwrap();
