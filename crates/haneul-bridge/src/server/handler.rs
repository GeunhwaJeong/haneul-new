...
mod tests {
    ...
    use crate::{
        ...
        events::{init_all_struct_tags, MoveTokenBridgeEvent, HaneulToEthTokenBridgeV1},
    ...
    async fn test_haneul_signer_with_cache() {
        ...
        let action =
            get_test_haneul_to_eth_bridge_action(Some(haneul_tx_digest), Some(haneul_event_idx), None, None);
        ...
        let emitted_event_1 = MoveTokenBridgeEvent {
            ...
            seq_num: 1,
            source_chain: BridgeChainId::HaneulLocalTest as u8,
    ...
    async fn test_signer_with_governace_verifier() {
        ...
        let action_2 = BridgeAction::LimitUpdateAction(LimitUpdateAction {
            chain_id: BridgeChainId::EthLocalTest,
            sending_chain_id: BridgeChainId::HaneulLocalTest,
            nonce: 1,
            new_usd_limit: 10000,
        });
        ...
        let action_4 = get_test_haneul_to_eth_bridge_action(None, None, None, None);
        assert!(matches!(
