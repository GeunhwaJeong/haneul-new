...
mod tests {
    ...
    async fn test_bridge_storage_basic() {
        ...
        let action1 = get_test_haneul_to_eth_bridge_action(None, Some(0), Some(99), Some(10000));

        let action2 = get_test_haneul_to_eth_bridge_action(None, Some(2), Some(100), Some(10000));
