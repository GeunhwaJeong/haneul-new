...
mod tests {
    ...
    async fn test_bridge_storage_basic() {
        ...
        let action1 = get_test_haneul_to_eth_bridge_action(TransactionDigest::random(), 0, 99, 10000);

        let action2 = get_test_haneul_to_eth_bridge_action(TransactionDigest::random(), 2, 100, 10000);
