...
use haneul_types::{crypto::Signer, message_envelope::VerifiedEnvelope};
use tap::TapFallible;
...
mod tests {
    ...
    use crate::types::{BridgeAction, BridgeAuthority, BridgeChainId, HaneulToEthBridgeAction};
    ...
    fn test_sign_and_verify_bridge_event_basic() -> anyhow::Result<()> {
        ...
        let event = BridgeAction::HaneulToEthBridgeAction(HaneulToEthBridgeAction {
            haneul_tx_digest: TransactionDigest::random(),
            haneul_tx_event_index: 1,
        ...
        let event2 = BridgeAction::HaneulToEthBridgeAction(HaneulToEthBridgeAction {
            haneul_tx_digest: TransactionDigest::random(),
            haneul_tx_event_index: 2, // <--------------------- this is different
            haneul_bridge_event: EmittedHaneulToEthTokenBridgeV1 {
                nonce: 1,
                haneul_chain_id: BridgeChainId::HaneulTestnet,
                haneul_address: HaneulAddress::random_for_testing_only(),
