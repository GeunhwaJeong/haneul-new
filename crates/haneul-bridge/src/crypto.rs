...
use haneul_types::{base_types::ConciseableName, crypto::Signer, message_envelope::VerifiedEnvelope};
use tap::TapFallible;
...
mod tests {
    ...
    fn test_sign_and_verify_bridge_event_basic() -> anyhow::Result<()> {
        ...
        let action: BridgeAction =
            get_test_haneul_to_eth_bridge_action(TransactionDigest::random(), 1, 1, 100);
        ...
        let mismatched_action: BridgeAction =
            get_test_haneul_to_eth_bridge_action(TransactionDigest::random(), 2, 3, 4);
        ...
        let action2: BridgeAction =
            get_test_haneul_to_eth_bridge_action(TransactionDigest::random(), 3, 5, 77);
