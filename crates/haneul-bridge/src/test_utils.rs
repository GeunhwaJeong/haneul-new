...
use crate::haneul_transaction_builder::{
    get_bridge_package_id, get_root_bridge_object_arg, get_haneul_token_type_tag,
};
...
use crate::{
    ...
    types::{
        BridgeAction, BridgeAuthority, BridgeChainId, EthToHaneulBridgeAction, SignedBridgeAction,
        HaneulToEthBridgeAction, TokenId,
    },
};
...
pub fn get_test_haneul_to_eth_bridge_action(
    ...
    BridgeAction::HaneulToEthBridgeAction(HaneulToEthBridgeAction {
        ...
        haneul_bridge_event: EmittedHaneulToEthTokenBridgeV1 {
            ...
            haneul_chain_id: BridgeChainId::HaneulLocalTest,
...
pub async fn mint_tokens(
    ...
    let tx = TestTransactionBuilder::new(sender, gas_obj_ref, rgp)
        ...
        .with_type_args(vec![get_haneul_token_type_tag(token_id)])
        .build();
...
pub async fn bridge_token(
    ...
    match bridge_events.remove(0) {
        HaneulBridgeEvent::HaneulToEthTokenBridgeV1(event) => event,
    }
}
