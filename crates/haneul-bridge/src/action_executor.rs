    ...
    C: HaneulClientInner + 'static,
{
    ...
    async fn run_onchain_execution_loop(
        ...
        while let Some(certificate_wrapper) = execution_queue_receiver.recv().await {
            ...
            info!("Building Haneul transaction for action: {:?}", action);
            ...
            let tx_data = match build_haneul_transaction(
                ...
                Ok(tx_data) => tx_data,
                Err(err) => {
                    metrics.total_err_build_haneul_transaction.inc();
                    error!(
                ...
                .await
            {
                ...
                Err(err) => {
                    ...
                    metrics.total_err_haneul_transaction_submission.inc();
    ...
    async fn handle_execution_effects(
        ...
        match status {
            ...
            HaneulExecutionStatus::Failure { error } => {
                ...
                metrics.total_err_haneul_transaction_execution.inc();
