...
use haneul_bridge::crypto::BridgeAuthorityKeyPair;
...
fn generate_bridge_node_config_and_write_to_file(
    ...
    let mut config = BridgeNodeConfig {
        ...
        haneul_bridge_modules: Some(vec!["modules_to_watch".into()]),
        db_path: None,
        eth_bridge_contracts_start_block_override: None,
        haneul_bridge_modules_last_processed_event_id_override: None,
    };
    if run_client {
        config.bridge_client_key_path_base64_haneul_key =
