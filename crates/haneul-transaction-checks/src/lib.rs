...
mod checked {
    ...
    use haneul_types::execution::DeletedSharedObjects;
    use haneul_types::metrics::BytecodeVerifierMetrics;
    use haneul_types::signature::GenericSignature;
    use haneul_types::storage::MarkerTableQuery;
    ...
    pub fn check_dev_inspect_input<S: ObjectStore + MarkerTableQuery>(
        ...
        gas_object: Object,
        epoch_id: EpochId,
    ) -> HaneulResult<(ObjectRef, InputObjects)> {
        let gas_object_ref = gas_object.compute_object_reference();
    ...
    pub fn check_sequenced_input_objects<S: ObjectStore + MarkerTableQuery, G: GetSharedLocks>(
        ...
        shared_lock_store: &G,
        epoch_id: EpochId,
    ) -> Result<(Vec<(InputObjectKind, Object)>, DeletedSharedObjects), HaneulError> {
    ...
    pub fn check_non_system_packages_to_be_published(
        ...
        let mut verifier = haneul_execution::verifier(protocol_config, is_metered, metrics);
