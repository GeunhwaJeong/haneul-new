...
impl JsonRpcMetrics {
    pub fn new(registry: &prometheus::Registry) -> Self {
        Self {
            ...
            .unwrap(),
            get_stake_haneul_result_size: register_histogram_with_registry!(
            ...
            .unwrap(),
            get_stake_haneul_latency: register_histogram_with_registry!(
            ...
            .unwrap(),
            get_delegated_haneul_latency: register_histogram_with_registry!(
