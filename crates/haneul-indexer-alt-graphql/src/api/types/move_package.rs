...
use serde::Serialize;
use haneul_indexer_alt_reader::packages::CheckpointBoundedOriginalPackageKey;
use haneul_indexer_alt_reader::packages::PackageOriginalIdKey;
use haneul_indexer_alt_reader::packages::VersionedOriginalPackageKey;
...
use haneul_package_resolver::Package as ParsedMovePackage;
use haneul_pg_db::sql;
use haneul_sql_macro::query;
use haneul_types::base_types::ObjectID;
use haneul_types::base_types::HaneulAddress as NativeHaneulAddress;
use haneul_types::move_package::MovePackage as NativeMovePackage;
...
impl MovePackage {
    ...
    pub(crate) fn address_impl(&self) -> NativeHaneulAddress {
        self.super_.super_.address
    }
