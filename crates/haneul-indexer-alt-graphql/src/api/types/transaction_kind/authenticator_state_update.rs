...
use haneul_types::authenticator_state::ActiveJwk as NativeActiveJwk;
use haneul_types::transaction::AuthenticatorStateUpdate as NativeAuthenticatorStateUpdate;
