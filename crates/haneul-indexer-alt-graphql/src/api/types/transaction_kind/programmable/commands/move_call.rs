...
use async_graphql::*;
use haneul_types::transaction::ProgrammableMoveCall as NativeMoveCall;
...
impl MoveCallCommand {
    ...
    async fn package(&self) -> Option<HaneulAddress> {
        Some(HaneulAddress::from(self.native.package))
    }
