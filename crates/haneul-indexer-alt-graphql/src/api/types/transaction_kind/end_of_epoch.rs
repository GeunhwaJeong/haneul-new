...
use haneul_types::transaction::AuthenticatorStateExpire as NativeAuthenticatorStateExpire;
use haneul_types::transaction::EndOfEpochTransactionKind as NativeEndOfEpochTransactionKind;
