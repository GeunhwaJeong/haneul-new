...
use haneul_indexer_alt_reader::object_versions::CheckpointBoundedObjectVersionKey;
use haneul_indexer_alt_reader::object_versions::VersionBoundedObjectVersionKey;
use haneul_indexer_alt_reader::object_versions::VersionedObjectVersionKey;
...
use haneul_types::transaction::GenesisObject;
...
#[graphql(
    ...
    field(
        ...
        desc = "The HANEUL returned to the sponsor or sender of the transaction that modifies or deletes this object."
    ),
    field(
...
impl Object {
    ...
    fn from_stored_version(
        ...
        let address = Address::with_address(
            scope,
            NativeHaneulAddress::from_bytes(stored.object_id)
                .context("Failed to deserialize HaneulAddress")?,
        );
