...
use haneul_types::haneul_system_state::haneul_system_state_inner_v1::StakeSubsidyV1;

/// Parameters that control the distribution of the stake subsidy.
#[derive(Clone, Debug, PartialEq, Eq, SimpleObject)]
pub(crate) struct StakeSubsidy {
    /// HANEUL set aside for stake subsidies -- reduces over time as stake subsidies are paid out over time.
