...
use std::fmt::Write;
use haneul_package_resolver::{CleverError, ErrorConstants};
use haneul_types::{
    execution_status::{
...
impl ExecutionError {
    ...
    ///
    /// Since protocol version 48, the Haneul protocol layer automatically resolves module ID, which makes
...
async fn resolve_module_id_for_move_abort(
    ...
    use haneul_types::execution_status::MoveLocationOpt;
        ...
        .await
    {
        ...
        Err(haneul_package_resolver::error::Error::LinkageNotFound(_)) => {
