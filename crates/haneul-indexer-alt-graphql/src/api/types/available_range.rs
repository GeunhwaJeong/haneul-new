...
fn collect_pipelines(
    ...
    match (type_, field, filters) {
        ...
        ("Address", Some("defaultHaneulnsName"), filters) => {
            collect_pipelines("IAddressable", Some("defaultHaneulnsName"), filters, pipelines);
        }
        ...
        ("CoinMetadata", Some("defaultHaneulnsName"), filters) => {
            collect_pipelines("IAddressable", Some("defaultHaneulnsName"), filters, pipelines);
        }
        (
            "CoinMetadata",
        ...
        ("IAddressable", Some("defaultHaneulnsName"), _) => {
            pipelines.insert("obj_versions".to_string());
        }
        ...
        ("Object", Some("defaultHaneulnsName"), filters) => {
            collect_pipelines("IAddressable", Some("defaultHaneulnsName"), filters, pipelines);
        }
        (
            "Object",
        ...
        ("MovePackage", Some("defaultHaneulnsName"), filters) => {
            collect_pipelines("IAddressable", Some("defaultHaneulnsName"), filters, pipelines);
        }
        (
            "MovePackage",
