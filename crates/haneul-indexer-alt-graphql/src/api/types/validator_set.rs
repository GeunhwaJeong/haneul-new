...
use haneul_types::haneul_system_state::VALIDATOR_MODULE_NAME;
use haneul_types::haneul_system_state::VALIDATOR_STRUCT_NAME;
...
impl ValidatorSetContents {
    ...
    fn deserialize(
        ...
        type ReportRecords = BTreeMap<NativeHaneulAddress, Vec<NativeHaneulAddress>>;
        type AtRiskValidators = BTreeMap<NativeHaneulAddress, u64>;

        #[derive(Default)]
        struct Contents<'b, 'l> {
            native: Option<(&'b [u8], &'l A::MoveTypeLayout)>,
            active_validators: Vec<(NativeHaneulAddress, &'b [u8])>,
            ...
            fn traverse_struct(
                ...
                if let Traversal::ActiveValidators(c) = self {
                    ...
                    let path = vec![
                        ...
                        AE::Element::Field("haneul_address"),
        ...
        impl AV::Visitor<'_, '_> for AddressVisitor {
            type Value = Option<NativeHaneulAddress>;
            type Error = Error;
