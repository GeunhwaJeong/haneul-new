...
use haneul_types::{
    ...
    haneul_system_state::haneul_system_state_inner_v1::{ValidatorSetV1, ValidatorV1},
};
...
pub(crate) struct ValidatorSet {
    ...
    #[graphql(skip)]
    at_risk_validators: VecMap<NativeHaneulAddress, u64>,
    ...
    pub pending_active_validators_id: Option<HaneulAddress>,
    ...
    pub staking_pool_mappings_id: Option<HaneulAddress>,

    /// Size of the stake pool mappings `Table`.
    pub staking_pool_mappings_size: Option<u64>,

    /// Object ID of the `Table` storing the inactive staking pools.
    pub inactive_pools_id: Option<HaneulAddress>,

    /// Size of the inactive pools `Table`.
    pub inactive_pools_size: Option<u64>,

    /// Object ID of the `Table` storing the validator candidates.
    pub validator_candidates_id: Option<HaneulAddress>,
...
impl ValidatorSet {
    ...
    async fn active_validators(
        ...
        edges.for_each(|(cursor, (_, validator))| {
            let at_risk = self
                .at_risk_validators
                .get(&validator.metadata.haneul_address)
