...
use super::{
    scalars::{digest::Digest, haneul_address::HaneulAddress, type_filter::TypeInput, uint53::UInt53},
    types::{
        address::Address,
...
impl Query {
    ...
    async fn address(&self, ctx: &Context<'_>, address: HaneulAddress) -> Result<Address, RpcError> {
