...
pub struct RpcConfig {
    ...
    /// Configure for HaneulNS related RPC methods.
...
pub struct NameServiceLayer {
    pub package_address: Option<HaneulAddress>,
...
impl Limits {
    ...
    pub(crate) fn display(&self) -> haneul_display::v2::Limits {
        haneul_display::v2::Limits {
...
impl Default for Limits {
    fn default() -> Self {
        ...
        let display_limits = haneul_display::v2::Limits::default();

        Self {
            // This default was picked as the sum of pre- and post- quorum timeouts from
            // [haneul_core::authority_aggregator::TimeoutConfig], with a 10% buffer.
            //
            // <https://github.com/GeunhwaJeong/haneul/blob/eaf05fe5d293c06e3a2dfc22c87ba2aef419d8ea/crates/haneul-core/src/authority_aggregator.rs#L84-L85>
