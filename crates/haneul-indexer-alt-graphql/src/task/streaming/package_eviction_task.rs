...
mod tests {
    ...
    use haneul_package_resolver::Result as PackageResult;
    ...
    impl haneul_package_resolver::PackageStore for MockStore {
        async fn fetch(
            &self,
            id: AccountAddress,
        ) -> PackageResult<Arc<haneul_package_resolver::Package>> {
    ...
    fn pkg(id: AccountAddress, version: u64) -> Arc<haneul_package_resolver::Package> {
        Arc::new(haneul_package_resolver::Package::for_test(
            id,
