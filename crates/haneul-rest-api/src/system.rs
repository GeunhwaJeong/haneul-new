...
use haneul_sdk_types::types::{Address, ObjectId};
...
pub struct SystemStateSummary {
    ...
    #[serde_as(as = "Vec<haneul_types::haneul_serde::BigInt<u64>>")]
    #[schemars(with = "Vec<crate::_schemars::U64>")]
    pub pending_removals: Vec<u64>,
    /// ID of the object that maps from staking pool's ID to the haneul address of a validator.
    ...
    #[serde_as(as = "Vec<(_, haneul_types::haneul_serde::BigInt<u64>)>")]
...
/// This is the REST type for the haneul validator. It flattens all inner structures
...
pub struct ValidatorSummary {
    // Metadata
    pub address: Address,
    pub protocol_public_key: haneul_sdk_types::types::Bls12381PublicKey,
    pub network_public_key: haneul_sdk_types::types::Ed25519PublicKey,
    pub worker_public_key: haneul_sdk_types::types::Ed25519PublicKey,
    ...
    pub next_epoch_protocol_public_key: Option<haneul_sdk_types::types::Bls12381PublicKey>,
    pub next_epoch_network_public_key: Option<haneul_sdk_types::types::Ed25519PublicKey>,
    pub next_epoch_worker_public_key: Option<haneul_sdk_types::types::Ed25519PublicKey>,
    ...
    #[serde_as(as = "haneul_types::haneul_serde::BigInt<u64>")]
    #[schemars(with = "crate::_schemars::U64")]
    pub pending_total_haneul_withdraw: u64,
...
impl From<haneul_types::haneul_system_state::haneul_system_state_summary::HaneulValidatorSummary>
    for ValidatorSummary
{
    fn from(
        value: haneul_types::haneul_system_state::haneul_system_state_summary::HaneulValidatorSummary,
    ) -> Self {
        let haneul_types::haneul_system_state::haneul_system_state_summary::HaneulValidatorSummary {
            haneul_address,
        ...
        Self {
            address: haneul_address.into(),
            protocol_public_key: haneul_sdk_types::types::Bls12381PublicKey::from_bytes(
                protocol_pubkey_bytes,
            )
            .unwrap(),
            network_public_key: haneul_sdk_types::types::Ed25519PublicKey::from_bytes(
                network_pubkey_bytes,
            )
            .unwrap(),
            worker_public_key: haneul_sdk_types::types::Ed25519PublicKey::from_bytes(
                worker_pubkey_bytes,
            )
            .unwrap(),
            proof_of_possession_bytes,
            ...
            next_epoch_protocol_public_key: next_epoch_protocol_pubkey_bytes
                .map(|bytes| haneul_sdk_types::types::Bls12381PublicKey::from_bytes(bytes).unwrap()),
            next_epoch_network_public_key: next_epoch_network_pubkey_bytes
                .map(|bytes| haneul_sdk_types::types::Ed25519PublicKey::from_bytes(bytes).unwrap()),
...
impl From<haneul_types::haneul_system_state::haneul_system_state_summary::HaneulSystemStateSummary>
    for SystemStateSummary
{
    fn from(
        value: haneul_types::haneul_system_state::haneul_system_state_summary::HaneulSystemStateSummary,
    ) -> Self {
        let haneul_types::haneul_system_state::haneul_system_state_summary::HaneulSystemStateSummary {
            epoch,
            protocol_version,
        ...
        OperationBuilder::new()
            ...
            .response(
                ...
                ResponseBuilder::new()
                    ...
                    .header::<String>(X_HANEUL_MIN_SUPPORTED_PROTOCOL_VERSION, generator)
                    .header::<String>(X_HANEUL_MAX_SUPPORTED_PROTOCOL_VERSION, generator)
                    .build(),
            )
            .build()
    }
...
pub const X_HANEUL_MIN_SUPPORTED_PROTOCOL_VERSION: &str = "x-haneul-min-supported-protocol-version";
/// Maximum supported protocol version by this node
pub const X_HANEUL_MAX_SUPPORTED_PROTOCOL_VERSION: &str = "x-haneul-max-supported-protocol-version";
...
fn supported_protocol_headers() -> SupportedProtocolHeaders {
    [
        (
            X_HANEUL_MIN_SUPPORTED_PROTOCOL_VERSION,
            ProtocolVersion::MIN.as_u64().to_string(),
        ),
        (
            X_HANEUL_MAX_SUPPORTED_PROTOCOL_VERSION,
