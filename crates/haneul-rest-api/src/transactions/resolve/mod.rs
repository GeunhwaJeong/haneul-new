...
use haneul_sdk_types::types::UnresolvedInputArgument;
use haneul_sdk_types::types::UnresolvedObjectReference;
...
fn resolve_arg(
    ...
    use haneul_sdk_types::types::UnresolvedInputArgumentKind::*;
