        ...
        OperationBuilder::new()
            ...
            .response(
                ...
                ResponseBuilder::new()
                    ...
                    .bcs_content()
                    .protobuf_content()
                    .header::<String>(crate::types::X_HANEUL_CURSOR, generator)
                    .build(),
            )
            .response(410, ResponseBuilder::new().build())
            .response(500, ResponseBuilder::new().build())
...
async fn get_full_checkpoint(
    ...
    accept: AcceptJsonProtobufBcs,
    State(state): State<StateReader>,
) -> Result<ProtobufBcs<proto::FullCheckpoint, haneul_types::full_checkpoint_content::CheckpointData>>
{
    match accept {
...
async fn list_full_checkpoints(
    ...
    accept: AcceptFormat,
    State(state): State<StateReader>,
) -> Result<Page<haneul_types::full_checkpoint_content::CheckpointData, CheckpointSequenceNumber>> {
    match accept {
        AcceptFormat::Bcs => {}
        _ => {
            return Err(RestError::new(
            ...
            result
                ...
                .and_then(|(checkpoint, contents)| {
                    state
                        .inner()
                        .get_checkpoint_data(
                            haneul_types::messages_checkpoint::VerifiedCheckpoint::new_from_verified(
                                checkpoint,
                            ),
                            contents,
                        )
