...
use haneul_sdk_types::types::{Object, ObjectDigest, ObjectId, TypeTag, Version};
...
impl From<haneul_types::dynamic_field::DynamicFieldType> for DynamicFieldType {
    fn from(value: haneul_types::dynamic_field::DynamicFieldType) -> Self {
        match value {
            haneul_types::dynamic_field::DynamicFieldType::DynamicField => Self::Field,
            haneul_types::dynamic_field::DynamicFieldType::DynamicObject => Self::Object,
        }
    }
}
