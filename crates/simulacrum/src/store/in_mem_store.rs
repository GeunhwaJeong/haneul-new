...
impl InMemoryStore {
    ...
    pub fn owned_objects(&self, owner: HaneulAddress) -> impl Iterator<Item = &Object> {
        self.live_objects
            .iter()
...
impl ParentSync for InMemoryStore {
    fn get_latest_parent_entry_ref_deprecated(
        &self,
        _object_id: ObjectID,
    ) -> haneul_types::error::HaneulResult<Option<haneul_types::base_types::ObjectRef>> {
...
pub struct KeyStore {
    ...
    #[allow(unused)]
    account_keys: BTreeMap<HaneulAddress, AccountKeyPair>,
}
...
impl KeyStore {
    ...
    pub fn accounts(&self) -> impl Iterator<Item = (&HaneulAddress, &AccountKeyPair)> {
