...
pub trait SimulatorStore:
    ...
    + haneul_types::storage::ReceivedMarkerQuery
{
    ...
    async fn get_system_state(&self) -> haneul_types::haneul_system_state::HaneulSystemState;

    async fn get_clock(&self) -> haneul_types::clock::Clock;

    async fn owned_objects(&self, owner: HaneulAddress) -> Box<dyn Iterator<Item = &Object> + '_>;
