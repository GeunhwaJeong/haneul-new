...
use haneul_types::{
    base_types::{AuthorityName, ObjectID, ObjectRef, SequenceNumber, HaneulAddress},
...
// haneul_core::TransactionInputLoad using an appropriate cache implementation.
impl InMemoryStore {
...
pub trait SimulatorStore:
    haneul_types::storage::BackingPackageStore + haneul_types::storage::ObjectStore
{
