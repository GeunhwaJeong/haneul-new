...
pub struct AdvanceEpochConfig {
    ...
    /// When enabled, includes current framework packages (Move stdlib, Haneul framework,
    /// Haneul system, DeepBook, and Bridge packages) in the change epoch transaction.
