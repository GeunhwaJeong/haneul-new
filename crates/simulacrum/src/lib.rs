...
use haneul_types::{
    ...
    committee::Committee,
    crypto::{AuthoritySignInfo, AuthoritySignature, HaneulAuthoritySignature},
...
mod tests {
    ...
    fn transfer() {
        ...
        let recipient = HaneulAddress::generate(sim.rng());
        ...
        let tx = Transaction::from_data_and_signer(tx_data, Intent::haneul_transaction(), vec![key]);
