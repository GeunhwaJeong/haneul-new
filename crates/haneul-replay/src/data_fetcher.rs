...
pub(crate) trait DataFetcher {
    ...
    ) -> Result<HaneulTransactionBlockResponse, LocalExecError>;
    ...
    async fn get_epoch_change_events(&self, reverse: bool)
        -> Result<Vec<HaneulEvent>, LocalExecError>;
}
...
pub fn extract_epoch_and_version(ev: HaneulEvent) -> Result<(u64, u64), LocalExecError> {
