...
use haneul_types::storage::{PackageObject, get_module, get_package};
    ...
    fn get_package_object(&self, package_id: &ObjectID) -> HaneulResult<Option<PackageObject>> {
        fn inner(self_: &LocalExec, package_id: &ObjectID) -> HaneulResult<Option<Object>> {
            ...
            self_
                ...
                .map_err(|e| HaneulErrorKind::Storage(e.to_string()).into())
        }
    ...
    fn read_child_object(
        ...
        fn inner(
            ...
            if child_object.version() > child_version_upper_bound {
                return Err(HaneulErrorKind::Unknown(format!(
...
pub fn get_executor(
    ...
    let silent = true;
    haneul_execution::executor(&protocol_config, silent)
