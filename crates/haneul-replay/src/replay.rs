...
use haneul_json_rpc_types::{EventFilter, HaneulEvent, HaneulTransactionBlockEffectsV1};
...
impl LocalExec {
    ...
    pub async fn execute(
        ...
        let HaneulTransactionBlockEffects::V1(new_effects) = res.1.try_into().unwrap();
