...
use haneul_config::p2p::{DiscoveryConfig, P2pConfig, SeedPeer};
use haneul_types::committee::{CommitteeWithNetworkMetadata, ProtocolVersion};
...
mod generated {
    include!(concat!(env!("OUT_DIR"), "/haneul.Discovery.rs"));
}
mod builder;
mod server;
#[cfg(test)]
...
use haneul_types::haneul_system_state::multiaddr_to_anemo_address;
