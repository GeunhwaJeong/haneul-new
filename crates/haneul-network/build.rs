    ...
    let validator_service = Service::builder()
        ...
        .method(
            Method::builder()
                ...
                .input_type("haneul_types::messages_grpc::RawSubmitTxRequest")
                .output_type("haneul_types::messages_grpc::RawSubmitTxResponse")
        ...
        .method(
            Method::builder()
                ...
                .input_type("haneul_types::messages_grpc::HandleCertificateRequestV3")
                .output_type("haneul_types::messages_grpc::HandleCertificateResponseV3")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("haneul_types::messages_grpc::HandleSoftBundleCertificatesRequestV3")
                .output_type("haneul_types::messages_grpc::HandleSoftBundleCertificatesResponseV3")
                .codec_path(codec_path)
                .build(),
        )
        .method(
        ...
        .method(
            Method::builder()
                ...
                .input_type("haneul_types::messages_checkpoint::CheckpointRequestV2")
                .output_type("haneul_types::messages_checkpoint::CheckpointResponseV2")
                .codec_path(codec_path)
                .build(),
        )
        .method(
