...
fn generate_paths_constant(
    ...
    let mut file = std::fs::File::create(out_dir.join("haneul.validator.paths.rs"))?;
    writeln!(
        file,
    ...
    let state_sync = anemo_build::manual::Service::builder()
        ...
        .method(
            anemo_build::manual::Method::builder()
                ...
                .response_type(
                    "Option<haneul_types::messages_checkpoint::CertifiedCheckpointSummary>",
                )
                .codec_path(codec_path)
                .build(),
        )
