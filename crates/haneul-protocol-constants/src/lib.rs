...
/// Maximum number of events that a single Move function can emit. Enforced by the Haneul adapter during execution.
...
// === Execution gas costs ====
// note: per-instruction and native function gas costs live in the haneul-cost-tables crate
