...
For external types, implement the trait found in [`external_impls.rs`](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneullabs-util-mem/src/external_impls.rs). See the existing implementations in that file for examples.
