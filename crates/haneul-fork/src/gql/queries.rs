...
pub(crate) mod txn_query {
    ...
    pub(crate) async fn query(
        ...
        let transaction = VerifiedTransaction::new_unchecked(
            HaneulTransaction::from_generic_sig_data(txn_data, signatures),
        );
...
pub(crate) mod address_owned_objects_query {
    ...
    use haneul_types::base_types::HaneulAddress as HaneulAddressType;
    ...
    pub(crate) struct AddressOwnedObject {
        ...
        pub(crate) owner: HaneulAddressType,
    ...
    pub(crate) struct HaneulAddress(pub String);

    pub(crate) async fn query(
        address: HaneulAddressType,
        ...
        loop {
            let operation = Query::build(AddressObjectsArgs {
                ...
                address: HaneulAddress(address.to_string()),
    ...
    fn coin_balance_from_json(
        ...
        if object_type.address != HANEUL_FRAMEWORK_ADDRESS
    ...
    fn parse_owner_address(
        address: Option<OwnerAddress>,
        object_id: &str,
    ) -> Result<HaneulAddressType, Error> {
        address
            .context("address seed entry is missing owner address")?
            .address
            .0
            .parse::<HaneulAddressType>()
    ...
    mod tests {
        ...
        use haneul_types::object::Owner as HaneulOwner;
        use wiremock::Mock;
        ...
        fn address_owned_node(object: &Object, owner: HaneulAddressType) -> serde_json::Value {
            serde_json::json!({
        ...
        fn consensus_owned_node(object: &Object, owner: HaneulAddressType) -> serde_json::Value {
            serde_json::json!({
                "address": object.id().to_string(),
                "version": object.version().value(),
                "digest": object.digest().to_string(),
...
pub(crate) mod object_query {
    ...
    async fn query_version_at_checkpoint(
        ...
        let query = VersionAtCheckpointQuery::build(VersionAtCheckpointVars {
            sequence_number: Some(checkpoint),
            address: HaneulAddress(object_id.to_string()),
