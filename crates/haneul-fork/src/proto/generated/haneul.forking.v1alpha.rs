...
pub mod forking_service_client {
    ...
    /// Administrative service for controlling a forked Haneul network.
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.forking.v1alpha.ForkingService/AdvanceClock",
            );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.forking.v1alpha.ForkingService/AdvanceCheckpoint",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.forking.v1alpha.ForkingService/GetStatus",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("haneul.forking.v1alpha.ForkingService", "GetStatus"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod forking_service_server {
    ...
    pub const SERVICE_NAME: &str = "haneul.forking.v1alpha.ForkingService";
