...
use haneul_json_rpc_types::{
    ...
    HaneulCoinMetadata, HaneulMoveNormalizedFunction, HaneulMoveNormalizedModule, HaneulMoveNormalizedStruct,
    HaneulObjectInfo, HaneulTransactionAuthSignersResponse, HaneulTransactionEffects,
