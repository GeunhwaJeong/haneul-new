...
use haneul_json_rpc_types::{
    ...
    EventFilter, ObjectChange, HaneulCheckpointSequenceNumber, HaneulEvent, HaneulGetPastObjectRequest,
    HaneulMoveStruct, HaneulMoveValue, HaneulObjectDataOptions, HaneulObjectResponse, HaneulPastObjectResponse,
...
impl ReadApiServer for ReadApi {
    ...
    fn get_events(&self, transaction_digest: TransactionDigest) -> RpcResult<Vec<HaneulEvent>> {
...
fn parse_template(template: &str, move_struct: &HaneulMoveStruct) -> RpcResult<String> {
...
fn get_value_from_move_struct(move_struct: &HaneulMoveStruct, var_name: &str) -> RpcResult<String> {
