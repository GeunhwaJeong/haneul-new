            ...
            let cursor = match cursor {
                Some(object_id) => {
                    ...
                    match obj {
                        ...
                        None => Err(HaneulRpcInputError::GenericInvalid(
    ...
    mod get_coin_metadata_tests {
        ...
        async fn test_valid_coin_metadata_object() {
            ...
            mock_internal
                ...
                .with(
                    predicate::always(),
                    predicate::eq(coin_metadata_struct),
                    predicate::always(),
                )
                .return_once(move |object_id, _, _| {
    ...
    mod get_total_supply_tests {
        ...
        async fn test_success_response_for_other_coin() {
            ...
            mock_internal
                ...
                .with(
                    predicate::always(),
                    predicate::eq(treasury_cap_struct),
                    predicate::always(),
                )
                .returning(move |object_id, _, _| {
                    if object_id == &package_id {
