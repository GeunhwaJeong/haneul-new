...
mod tests {
    ...
    fn haneul_balance_type() -> move_core_types::language_storage::TypeTag {
    ...
    async fn test_failed_txn_coin_gas_balance_change() {
        let gas_owner = HaneulAddress::random_for_testing_only();
    ...
    async fn test_failed_txn_sponsored_address_balance_gas() {
        let sponsor = HaneulAddress::random_for_testing_only();
    ...
    async fn test_failed_txn_coin_gas_and_accumulator_different_addresses() {
        let gas_owner = HaneulAddress::random_for_testing_only();
        let acc_address = HaneulAddress::random_for_testing_only();
