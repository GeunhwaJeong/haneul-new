...
use haneul_protocol_config_macros::{ProtocolConfigFeatureFlagsGetters, ProtocolConfigGetters};
...
pub struct ProtocolConfig {
    ...
    // === Execution gas costs ====
    // note: Option<per-instruction and native function gas costs live in the haneul-cost-tables crate
