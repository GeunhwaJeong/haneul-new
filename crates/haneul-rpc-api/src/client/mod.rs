...
impl Client {
    ...
    async fn get_checkpoint_internal(
        ...
        let signature = haneul_types::crypto::AuthorityStrongQuorumSignInfo::from(
            haneul_sdk_types::types::ValidatorAggregatedSignature::try_from(
    ...
    pub async fn get_full_checkpoint(
        ...
        let checkpoint_contents = contents_bcs
            ...
            .deserialize::<haneul_types::messages_checkpoint::CheckpointContents>()?;
        ...
        let transactions = transactions
            ...
            .map(
                |(
                    ...
                    Result::<_>::Ok(haneul_types::full_checkpoint_content::CheckpointTransaction {
                        transaction,
                        effects,
                        events,
                        input_objects,
    ...
    async fn get_object_internal(
        ...
        let request = crate::proto::node::GetObjectRequest {
            object_id: Some(haneul_sdk_types::types::ObjectId::from(object_id).into()),
            version,
    ...
    pub async fn execute_transaction(
        ...
        let signatures = transaction
            ...
            .clone()
            .into_iter()
            .map(haneul_sdk_types::types::UserSignature::try_from)
