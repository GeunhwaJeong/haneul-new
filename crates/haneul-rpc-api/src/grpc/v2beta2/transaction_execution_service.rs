...
use haneul_rpc::proto::haneul::rpc::v2beta2::transaction_execution_service_server::TransactionExecutionService;
use haneul_rpc::proto::haneul::rpc::v2beta2::transaction_finality::Finality;
use haneul_rpc::proto::haneul::rpc::v2beta2::ExecuteTransactionRequest;
use haneul_rpc::proto::haneul::rpc::v2beta2::ExecuteTransactionResponse;
...
use haneul_rpc::proto::haneul::rpc::v2beta2::TransactionEffects;
use haneul_rpc::proto::haneul::rpc::v2beta2::TransactionEvents;
use haneul_rpc::proto::haneul::rpc::v2beta2::UserSignature;
use haneul_sdk_types::ObjectId;
use haneul_types::balance_change::derive_balance_changes;
...
pub async fn execute_transaction(
    ...
    let transaction = request
        ...
        .pipe(haneul_sdk_types::Transaction::try_from)
        .map_err(|e| {
    ...
    let signatures = request
        ...
        .enumerate()
        .map(|(i, signature)| {
            haneul_sdk_types::UserSignature::try_from(signature).map_err(|e| {
    ...
    let signed_transaction = haneul_sdk_types::SignedTransaction {
    ...
    let request = {
        ...
        haneul_types::quorum_driver_types::ExecuteTransactionRequestV3 {
    ...
    let haneul_types::quorum_driver_types::ExecuteTransactionResponseV3 {
        effects:
            haneul_types::quorum_driver_types::FinalizedEffects {
                effects,
                finality_info,
            },
        events,
    ...
    let finality = {
        let finality = match finality_info {
            haneul_types::quorum_driver_types::EffectsFinalityInfo::Certified(sig) => {
                Finality::Certified(haneul_sdk_types::ValidatorAggregatedSignature::from(sig).into())
            }
            haneul_types::quorum_driver_types::EffectsFinalityInfo::Checkpointed(
                _epoch,
                checkpoint,
            ) => Finality::Checkpointed(checkpoint),
            haneul_types::quorum_driver_types::EffectsFinalityInfo::QuorumExecuted(_) => {
                Finality::QuorumExecuted(())
            }
        };
        haneul_rpc::proto::haneul::rpc::v2beta2::TransactionFinality {
    ...
    {
        let events = events
            .map(haneul_sdk_types::TransactionEvents::try_from)
            .transpose()?;
        ...
        let input_objects = input_objects
            .into_iter()
            .map(haneul_sdk_types::Object::try_from)
            .collect::<Result<Vec<_>, _>>()?;
        ...
        let effects = haneul_sdk_types::TransactionEffects::try_from(effects)?;
        let effects = mask
                    ...
                    for changed_object in effects.changed_objects.iter_mut() {
                            ...
                            .find(|o| o.object_id() == object_id)
                        {
                            changed_object.object_type = Some(match object.object_type() {
                                haneul_sdk_types::ObjectType::Package => "package".to_owned(),
                                haneul_sdk_types::ObjectType::Struct(struct_tag) => {
