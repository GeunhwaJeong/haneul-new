...
use bytes::Bytes;
use haneul_rpc::proto::haneul::rpc::v2beta2::dynamic_field::DynamicFieldKind;
use haneul_rpc::proto::haneul::rpc::v2beta2::DynamicField;
...
use haneul_types::storage::{DynamicFieldIndexInfo, DynamicFieldKey};
use tap::Pipe;
...
fn convert_into_proto(
    ...
    let kind = match dynamic_field_kind {
        haneul_types::dynamic_field::DynamicFieldType::DynamicField => DynamicFieldKind::Field,
        haneul_types::dynamic_field::DynamicFieldType::DynamicObject => DynamicFieldKind::Object,
    };
