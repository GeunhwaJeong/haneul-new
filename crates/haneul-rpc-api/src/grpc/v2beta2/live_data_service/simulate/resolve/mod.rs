    ...
    let ptb = unresolved_transaction
        ...
        .and_then(|kind| {
            kind.kind.as_ref().and_then(|kind| {
                match kind {
                haneul_rpc::proto::haneul::rpc::v2beta2::transaction_kind::Kind::ProgrammableTransaction(
                    ptb,
                ) => Some(ptb),
                _ => None,
            }
...
fn resolve_unresolved_transaction(
    ...
    unresolved_inputs: &[haneul_rpc::proto::haneul::rpc::v2beta2::Input],
    commands: Vec<Command>,
    gas_payment: Option<&haneul_rpc::proto::haneul::rpc::v2beta2::GasPayment>,
    expiration: Option<&haneul_rpc::proto::haneul::rpc::v2beta2::TransactionExpiration>,
) -> Result<TransactionData> {
...
fn resolve_arg(
    ...
    called_packages: &mut NormalizedPackages,
    commands: &[Command],
    arg: &haneul_rpc::proto::haneul::rpc::v2beta2::Input,
    arg_idx: usize,
) -> Result<CallArg> {
    use haneul_rpc::proto::haneul::rpc::v2beta2::input::InputKind;
...
impl TryFrom<&haneul_rpc::proto::haneul::rpc::v2beta2::ObjectReference> for UnresolvedObjectReference {
    ...
    fn try_from(
        value: &haneul_rpc::proto::haneul::rpc::v2beta2::ObjectReference,
...
impl<'a> UnresolvedInput<'a> {
    fn from_proto(
        input: &'a haneul_rpc::proto::haneul::rpc::v2beta2::Input,
