...
use haneul_rpc::proto::haneul::rpc::v2beta2::subscription_service_server::SubscriptionService;
use haneul_rpc::proto::haneul::rpc::v2beta2::Checkpoint;
use haneul_rpc::proto::haneul::rpc::v2beta2::SubscribeCheckpointsRequest;
use haneul_rpc::proto::haneul::rpc::v2beta2::SubscribeCheckpointsResponse;
    ...
    async fn subscribe_checkpoints(
        ...
        let response = Box::pin(async_stream::stream! {
            while let Some(checkpoint) = receiver.recv().await {
                let checkpoint: haneul_types::full_checkpoint_content::CheckpointData = checkpoint.as_ref().to_owned().into();
