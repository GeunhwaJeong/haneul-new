...
use haneul_rpc::proto::haneul::rpc::v2beta2::name_service_server::NameService;
use haneul_rpc::proto::haneul::rpc::v2beta2::LookupNameRequest;
use haneul_rpc::proto::haneul::rpc::v2beta2::LookupNameResponse;
use haneul_rpc::proto::haneul::rpc::v2beta2::ReverseLookupNameRequest;
use haneul_rpc::proto::haneul::rpc::v2beta2::ReverseLookupNameResponse;
...
fn name_service_config(service: &RpcService) -> Result<NameServiceConfig> {
    match service.chain_id.chain() {
        haneul_protocol_config::Chain::Mainnet => Ok(NameServiceConfig::mainnet()),
        haneul_protocol_config::Chain::Testnet => Ok(NameServiceConfig::testnet()),
        haneul_protocol_config::Chain::Unknown => Err(RpcError::new(
            tonic::Code::Unimplemented,
            "HaneulNS not configured for this network",
        )),
    }
}
...
fn lookup_name(service: &RpcService, request: LookupNameRequest) -> Result<LookupNameResponse> {
    ...
    if is_valid {
        let mut record = haneul_rpc::proto::haneul::rpc::v2beta2::NameRecord::default();
...
fn reverse_lookup_name(
    ...
    let domain = field_reverse_record_object
        .to_rust::<haneul_types::dynamic_field::Field<Address, Domain>>()
        .ok_or_else(|| {
            RpcError::new(
                tonic::Code::Internal,
