...
use haneul_rpc::proto::haneul::rpc::v2alpha::GetCheckpointObjectProofResponse;
use haneul_rpc::proto::haneul::rpc::v2alpha::OcsInclusionProof as ProtoOcsInclusionProof;
use haneul_rpc::proto::haneul::rpc::v2alpha::OcsNonInclusionProof as ProtoOcsNonInclusionProof;
use haneul_rpc::proto::haneul::rpc::v2alpha::get_checkpoint_object_proof_response;
use haneul_sdk_types::ObjectReference as SdkObjectReference;
...
fn build_inclusion_proof(
    ...
    let merkle_proof = tree
        ...
        .map_err(|e| RpcError::new(tonic::Code::Internal, e.to_string()))?;
    let tree_root = haneul_sdk_types::Digest::new(tree.root().bytes());
...
fn build_non_inclusion_proof(
    ...
    let target = SdkObjectReference::new(object_id.into(), 0, haneul_sdk_types::Digest::new([0; 32]));
