...
impl RpcService {
    ...
    pub fn render_json_with_budget(
        ...
        haneul_types::object::rpc_visitor::proto::ProtoVisitor::deserialize_value_with_budget(
            contents,
            &layout,
            size_budget,
        )
    ...
    pub fn render_object_display(&self, object: &haneul_types::object::Object) -> Option<Display> {
        let move_object = object.data.try_as_move()?;
        ...
        let display_template =
            haneul_display::v2::Display::parse(limits, display_object.fields()).ok()?;
        ...
        // The display api requires that the `haneul_display::v2::Store` is async. We know that the
