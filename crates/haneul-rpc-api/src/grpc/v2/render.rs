...
impl RpcService {
    ...
    pub fn render_json(
        ...
        haneul_types::proto_value::ProtoVisitorBuilder::new(self.config.max_json_move_value_size())
    ...
    where
        F: Fn(&haneul_types::base_types::ObjectID) -> Option<haneul_types::base_types::ObjectType>,
    {
