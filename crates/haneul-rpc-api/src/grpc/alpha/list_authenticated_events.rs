...
use haneul_rpc::proto::haneul::rpc::v2::{Bcs, Event};
...
fn to_grpc_event(ev: &haneul_types::event::Event) -> Event {
...
pub fn list_authenticated_events(
    ...
    let stream_addr = HaneulAddress::from_str(&stream_id).map_err(|e| {
        RpcError::new(
            tonic::Code::InvalidArgument,
