...
fn called_packages(
    ...
    let binary_config = haneul_types::execution_config_utils::to_binary_config(protocol_config);
...
fn resolve_unresolved_transaction(
    ...
    Ok(TransactionData::V1(
        haneul_types::transaction::TransactionDataV1 {
            kind: haneul_types::transaction::TransactionKind::ProgrammableTransaction(ptb),
            sender,
            gas_data,
            expiration,
        },
...
fn resolve_object_reference_with_object(
    object: &haneul_types::object::Object,
    unresolved_object_reference: unresolved::ObjectReference,
) -> Result<ObjectRef> {
    ...
    match object.owner() {
        haneul_types::object::Owner::AddressOwner(_) | haneul_types::object::Owner::Immutable => {}
        _ => {
...
fn resolve_arg(
    ...
    use haneul_sdk_types::types::unresolved::InputKind::*;
...
fn resolve_object(
    ...
    arg_idx: usize,
    object_id: ObjectId,
    version: Option<haneul_sdk_types::types::Version>,
    digest: Option<haneul_sdk_types::types::ObjectDigest>,
    ...
    match object.owner() {
        haneul_types::object::Owner::Immutable => resolve_object_reference_with_object(
            &object,
            unresolved::ObjectReference {
                object_id,
                version,
        ...
        haneul_types::object::Owner::AddressOwner(_) => {
        ...
        haneul_types::object::Owner::ObjectOwner(_) => Err(RpcServiceError::new(
            axum::http::StatusCode::BAD_REQUEST,
...
fn is_input_argument_receiving(
    ...
    let (receiving_package, receiving_module, receiving_struct) =
        haneul_types::transfer::RESOLVED_RECEIVING_STRUCT;
...
fn arg_type_of_move_call_input<'a>(
    ...
    move_call: &haneul_sdk_types::types::MoveCall,
    idx: usize,
