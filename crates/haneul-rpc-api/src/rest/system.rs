...
use haneul_sdk_types::{Address, ObjectId};
...
pub struct ValidatorSummary {
    // Metadata
    pub address: Address,
    pub protocol_public_key: haneul_sdk_types::Bls12381PublicKey,
    pub network_public_key: haneul_sdk_types::Ed25519PublicKey,
    pub worker_public_key: haneul_sdk_types::Ed25519PublicKey,
    ...
    pub next_epoch_protocol_public_key: Option<haneul_sdk_types::Bls12381PublicKey>,
    pub next_epoch_network_public_key: Option<haneul_sdk_types::Ed25519PublicKey>,
    pub next_epoch_worker_public_key: Option<haneul_sdk_types::Ed25519PublicKey>,
    ...
    for ValidatorSummary
{
    fn from(
        ...
        Self {
            ...
            protocol_public_key: haneul_sdk_types::Bls12381PublicKey::from_bytes(
                protocol_pubkey_bytes,
            )
            .unwrap(),
            network_public_key: haneul_sdk_types::Ed25519PublicKey::from_bytes(network_pubkey_bytes)
                .unwrap(),
            worker_public_key: haneul_sdk_types::Ed25519PublicKey::from_bytes(worker_pubkey_bytes)
                .unwrap(),
            proof_of_possession_bytes,
            name,
            description,
            ...
            next_epoch_protocol_public_key: next_epoch_protocol_pubkey_bytes
                .map(|bytes| haneul_sdk_types::Bls12381PublicKey::from_bytes(bytes).unwrap()),
            next_epoch_network_public_key: next_epoch_network_pubkey_bytes
                .map(|bytes| haneul_sdk_types::Ed25519PublicKey::from_bytes(bytes).unwrap()),
