...
impl From<haneul_types::haneul_sdk_types_conversions::SdkTypeConversionError> for RpcServiceError {
...
impl From<haneul_types::quorum_driver_types::QuorumDriverError> for RpcServiceError {
