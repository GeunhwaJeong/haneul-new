...
pub struct ObjectNotFoundError {
    object_id: haneul_sdk_types::ObjectId,
    version: Option<haneul_sdk_types::Version>,
}

impl ObjectNotFoundError {
    pub fn new(object_id: haneul_sdk_types::ObjectId) -> Self {
        Self {
            object_id,
            version: None,
        }
...
pub struct CheckpointNotFoundError {
    ...
    digest: Option<haneul_sdk_types::CheckpointDigest>,
}
...
impl CheckpointNotFoundError {
    ...
    pub fn digest(digest: haneul_sdk_types::CheckpointDigest) -> Self {
        Self {
