...
use haneul_sdk_types::{CheckpointSequenceNumber, EpochId, ValidatorCommittee};
...
impl StateReader {
    ...
    pub fn get_authenticator_state(
        &self,
    ) -> Result<Option<haneul_types::authenticator_state::AuthenticatorStateInner>> {
        haneul_types::authenticator_state::get_authenticator_state(self.inner())
            .map_err(StorageError::custom)
    }
    ...
    pub fn get_transaction(
        ...
        Vec<haneul_types::signature::GenericSignature>,
...
pub struct TransactionRead {
    ...
    pub transaction: haneul_types::transaction::TransactionData,
    pub signatures: Vec<haneul_types::signature::GenericSignature>,
...
pub struct CheckpointTransactionsIter {
    ...
    checkpoint: Option<(
        haneul_types::messages_checkpoint::CheckpointSummary,
        haneul_types::messages_checkpoint::CheckpointContents,
    )>,
}
...
impl Iterator for CheckpointTransactionsIter {
    type Item = Result<(CursorInfo, haneul_types::digests::TransactionDigest)>;
...
impl Iterator for CheckpointIter {
    type Item = Result<(
        haneul_types::messages_checkpoint::CertifiedCheckpointSummary,
        haneul_types::messages_checkpoint::CheckpointContents,
    )>;
