...
impl RpcService {
    ...
    pub async fn into_router(self) -> axum::Router {
        ...
        let router = {
            ...
            let ledger_service2 =
                haneul_rpc::proto::haneul::rpc::v2beta2::ledger_service_server::LedgerServiceServer::new(
                    self.clone(),
                );
            let transaction_execution_service2 = haneul_rpc::proto::haneul::rpc::v2beta2::transaction_execution_service_server::TransactionExecutionServiceServer::new(self.clone());
            let live_data_service2 =
                haneul_rpc::proto::haneul::rpc::v2beta2::live_data_service_server::LiveDataServiceServer::new(
                    self.clone(),
                ).send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let signature_verification_service2 = haneul_rpc::proto::haneul::rpc::v2beta2::signature_verification_service_server::SignatureVerificationServiceServer::new(self.clone());
            let move_package_service2 = haneul_rpc::proto::haneul::rpc::v2beta2::move_package_service_server::MovePackageServiceServer::new(self.clone());
...
haneul_rpc::proto::haneul::rpc::v2::subscription_service_server::SubscriptionServiceServer::new(subscription_service_handle.clone());
                health_reporter
                    .set_service_status(
...
haneul_rpc::proto::haneul::rpc::v2beta2::subscription_service_server::SubscriptionServiceServer::new(subscription_service_handle);
                health_reporter
                    .set_service_status(
