...
pub struct Epoch {
    ...
    /// Snapshot of Haneul's SystemState (`0x3::haneul_system::SystemState`) at the
...
pub mod execution_error {
    ...
    pub enum ExecutionErrorKind {
        ...
        HaneulMoveVerificationError = 11,
        ...
        HaneulMoveVerificationTimedout = 31,
    ...
    impl ExecutionErrorKind {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::HaneulMoveVerificationError => "HANEUL_MOVE_VERIFICATION_ERROR",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "HANEUL_MOVE_VERIFICATION_TIMEDOUT" => {
                    Some(Self::HaneulMoveVerificationTimedout)
                }
                "SHARED_OBJECT_OPERATION_NOT_ALLOWED" => {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2beta.LedgerService/GetServiceInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("haneul.rpc.v2beta.LedgerService", "GetServiceInfo"),
                );
        ...
        pub async fn get_object(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2beta.LedgerService/GetObject",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("haneul.rpc.v2beta.LedgerService", "GetObject"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2beta.LedgerService/BatchGetObjects",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("haneul.rpc.v2beta.LedgerService", "BatchGetObjects"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2beta.LedgerService/GetTransaction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("haneul.rpc.v2beta.LedgerService", "GetTransaction"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2beta.LedgerService/BatchGetTransactions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "haneul.rpc.v2beta.LedgerService",
        ...
        pub async fn get_checkpoint(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2beta.LedgerService/GetCheckpoint",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("haneul.rpc.v2beta.LedgerService", "GetCheckpoint"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_epoch(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2beta.LedgerService/GetEpoch",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("haneul.rpc.v2beta.LedgerService", "GetEpoch"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod ledger_service_server {
    ...
    pub const SERVICE_NAME: &str = "haneul.rpc.v2beta.LedgerService";
...
pub struct ValidatorSet {
    ...
    ///
    /// key: address (staking pool Id), value: address (haneul address of the validator)
    #[prost(message, optional, tag = "5")]
    ...
    ///
    /// key: address (haneul address of the validator), value: 0x3::validator_wrapper::ValidatorWrapper
    #[prost(message, optional, tag = "7")]
...
pub mod transaction_execution_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2beta.TransactionExecutionService/ExecuteTransaction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "haneul.rpc.v2beta.TransactionExecutionService",
                        "ExecuteTransaction",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod transaction_execution_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "haneul.rpc.v2beta.TransactionExecutionService";
