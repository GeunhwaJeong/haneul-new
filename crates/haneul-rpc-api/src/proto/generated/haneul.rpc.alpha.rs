...
pub struct ListAuthenticatedEventsRequest {
    /// Required. Stream identifier (Haneul address) of the event stream.
...
pub struct AuthenticatedEvent {
    ...
    pub event: ::core::option::Option<::haneul_rpc::proto::haneul::rpc::v2::Event>,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.alpha.EventService/ListAuthenticatedEvents",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "haneul.rpc.alpha.EventService",
...
pub mod event_service_server {
    ...
    pub const SERVICE_NAME: &str = "haneul.rpc.alpha.EventService";
...
pub mod proof_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.alpha.ProofService/GetObjectInclusionProof",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "haneul.rpc.alpha.ProofService",
...
pub mod proof_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "haneul.rpc.alpha.ProofService";
