        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.LiveDataService/ListDynamicFields",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "haneul.rpc.v2alpha.LiveDataService",
                        "ListDynamicFields",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.LiveDataService/ListOwnedObjects",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.LiveDataService/GetCoinInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("haneul.rpc.v2alpha.LiveDataService", "GetCoinInfo"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.LiveDataService/GetBalance",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("haneul.rpc.v2alpha.LiveDataService", "GetBalance"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.LiveDataService/ListBalances",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("haneul.rpc.v2alpha.LiveDataService", "ListBalances"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.LiveDataService/SimulateTransaction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod live_data_service_server {
    ...
    pub const SERVICE_NAME: &str = "haneul.rpc.v2alpha.LiveDataService";
...
pub mod move_package_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.MovePackageService/GetPackage",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("haneul.rpc.v2alpha.MovePackageService", "GetPackage"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.MovePackageService/GetModule",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("haneul.rpc.v2alpha.MovePackageService", "GetModule"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.MovePackageService/GetDatatype",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("haneul.rpc.v2alpha.MovePackageService", "GetDatatype"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.MovePackageService/GetFunction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("haneul.rpc.v2alpha.MovePackageService", "GetFunction"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.MovePackageService/ListPackageVersions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "haneul.rpc.v2alpha.MovePackageService",
                        "ListPackageVersions",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod move_package_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "haneul.rpc.v2alpha.MovePackageService";
...
pub mod signature_verification_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.SignatureVerificationService/VerifySignature",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "haneul.rpc.v2alpha.SignatureVerificationService",
                        "VerifySignature",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod signature_verification_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "haneul.rpc.v2alpha.SignatureVerificationService";
...
pub mod subscription_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.SubscriptionService/SubscribeCheckpoints",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "haneul.rpc.v2alpha.SubscriptionService",
...
pub mod subscription_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "haneul.rpc.v2alpha.SubscriptionService";
