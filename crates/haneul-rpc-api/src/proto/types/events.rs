...
impl From<haneul_sdk_types::Event> for super::Event {
    fn from(value: haneul_sdk_types::Event) -> Self {
        Self {
...
impl TryFrom<&super::Event> for haneul_sdk_types::Event {
...
impl From<haneul_sdk_types::TransactionEvents> for super::TransactionEvents {
    fn from(value: haneul_sdk_types::TransactionEvents) -> Self {
        Self {
...
impl TryFrom<&super::TransactionEvents> for haneul_sdk_types::TransactionEvents {
    type Error = TryFromProtoError;
