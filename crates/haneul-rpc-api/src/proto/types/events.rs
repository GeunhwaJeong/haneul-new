...
impl From<haneul_sdk_types::types::Event> for super::Event {
    fn from(value: haneul_sdk_types::types::Event) -> Self {
        Self {
...
impl TryFrom<&super::Event> for haneul_sdk_types::types::Event {
...
impl From<haneul_sdk_types::types::TransactionEvents> for super::TransactionEvents {
    fn from(value: haneul_sdk_types::types::TransactionEvents) -> Self {
        Self {
...
impl TryFrom<&super::TransactionEvents> for haneul_sdk_types::types::TransactionEvents {
    type Error = TryFromProtoError;
