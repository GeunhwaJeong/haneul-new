...
impl From<haneul_sdk_types::types::ObjectReference> for super::ObjectReference {
    fn from(value: haneul_sdk_types::types::ObjectReference) -> Self {
...
impl TryFrom<&super::ObjectReference> for haneul_sdk_types::types::ObjectReference {
...
impl From<haneul_sdk_types::types::Object> for super::Object {
    fn from(value: haneul_sdk_types::types::Object) -> Self {
        Self {
...
impl TryFrom<&super::Object> for haneul_sdk_types::types::Object {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::Owner> for super::Owner {
    fn from(value: haneul_sdk_types::types::Owner) -> Self {
...
impl TryFrom<&super::Owner> for haneul_sdk_types::types::Owner {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::ObjectData> for super::ObjectData {
    fn from(value: haneul_sdk_types::types::ObjectData) -> Self {
        use super::object_data::Kind;
        use haneul_sdk_types::types::ObjectData::*;
...
impl TryFrom<&super::ObjectData> for haneul_sdk_types::types::ObjectData {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::MoveStruct> for super::MoveStruct {
    fn from(value: haneul_sdk_types::types::MoveStruct) -> Self {
        Self {
            object_id: Some(value.object_id().into()),
...
impl TryFrom<&super::MoveStruct> for haneul_sdk_types::types::MoveStruct {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::MovePackage> for super::MovePackage {
    fn from(value: haneul_sdk_types::types::MovePackage) -> Self {
        let modules = value
            .modules
            .into_iter()
        ...
        let linkage_table = value
            ...
            .map(
                |(
                    original_id,
                    haneul_sdk_types::types::UpgradeInfo {
                        upgraded_id,
                        upgraded_version,
                    },
                )| {
...
impl TryFrom<&super::MovePackage> for haneul_sdk_types::types::MovePackage {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::TypeOrigin> for super::TypeOrigin {
    fn from(value: haneul_sdk_types::types::TypeOrigin) -> Self {
        Self {
...
impl TryFrom<&super::TypeOrigin> for haneul_sdk_types::types::TypeOrigin {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::GenesisObject> for super::GenesisObject {
    fn from(value: haneul_sdk_types::types::GenesisObject) -> Self {
        Self {
            object_id: Some(value.object_id().into()),
            version: Some(value.version()),
            owner: Some(value.owner().to_owned().into()),
...
impl TryFrom<&super::GenesisObject> for haneul_sdk_types::types::GenesisObject {
    type Error = TryFromProtoError;
