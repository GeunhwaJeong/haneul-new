...
impl From<haneul_sdk_types::Object> for super::Object {
...
impl TryFrom<&super::Object> for haneul_sdk_types::Object {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ObjectData> for super::ObjectData {
    fn from(value: haneul_sdk_types::ObjectData) -> Self {
...
impl TryFrom<&super::ObjectData> for haneul_sdk_types::ObjectData {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::MoveStruct> for super::MoveStruct {
    fn from(value: haneul_sdk_types::MoveStruct) -> Self {
        Self {
            object_id: Some(value.object_id().into()),
...
impl TryFrom<&super::MoveStruct> for haneul_sdk_types::MoveStruct {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::MovePackage> for super::MovePackage {
    fn from(value: haneul_sdk_types::MovePackage) -> Self {
        let modules = value
            .modules
            .into_iter()
...
impl TryFrom<&super::MovePackage> for haneul_sdk_types::MovePackage {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::GenesisObject> for super::GenesisObject {
...
impl TryFrom<&super::GenesisObject> for haneul_sdk_types::GenesisObject {
    type Error = TryFromProtoError;
