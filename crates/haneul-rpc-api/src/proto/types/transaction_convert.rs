...
impl From<haneul_sdk_types::CanceledTransaction> for super::CancelledTransaction {
    fn from(value: haneul_sdk_types::CanceledTransaction) -> Self {
        Self {
...
impl TryFrom<&super::CancelledTransaction> for haneul_sdk_types::CanceledTransaction {
    type Error = TryFromProtoError;
