...
impl From<haneul_sdk_types::Transaction> for super::Transaction {
    fn from(value: haneul_sdk_types::Transaction) -> Self {
...
impl TryFrom<&super::Transaction> for haneul_sdk_types::Transaction {
...
impl From<haneul_sdk_types::Transaction> for super::transaction::TransactionV1 {
    fn from(value: haneul_sdk_types::Transaction) -> Self {
        Self {
...
impl TryFrom<&super::transaction::TransactionV1> for haneul_sdk_types::Transaction {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::GasPayment> for super::GasPayment {
    fn from(value: haneul_sdk_types::GasPayment) -> Self {
        Self {
...
impl TryFrom<&super::GasPayment> for haneul_sdk_types::GasPayment {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::TransactionExpiration> for super::TransactionExpiration {
    fn from(value: haneul_sdk_types::TransactionExpiration) -> Self {
        use super::transaction_expiration::Expiration;
        use haneul_sdk_types::TransactionExpiration::*;
...
impl TryFrom<&super::TransactionExpiration> for haneul_sdk_types::TransactionExpiration {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::TransactionKind> for super::TransactionKind {
    fn from(value: haneul_sdk_types::TransactionKind) -> Self {
...
impl TryFrom<&super::TransactionKind> for haneul_sdk_types::TransactionKind {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ConsensusCommitPrologue> for super::ConsensusCommitPrologue {
    fn from(value: haneul_sdk_types::ConsensusCommitPrologue) -> Self {
        Self {
...
impl TryFrom<&super::ConsensusCommitPrologue> for haneul_sdk_types::ConsensusCommitPrologue {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ConsensusCommitPrologueV2> for super::ConsensusCommitPrologue {
    fn from(value: haneul_sdk_types::ConsensusCommitPrologueV2) -> Self {
        Self {
            epoch: Some(value.epoch),
            round: Some(value.round),
            commit_timestamp_ms: Some(value.commit_timestamp_ms),
...
impl TryFrom<&super::ConsensusCommitPrologue> for haneul_sdk_types::ConsensusCommitPrologueV2 {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ConsensusCommitPrologueV3> for super::ConsensusCommitPrologue {
    fn from(value: haneul_sdk_types::ConsensusCommitPrologueV3) -> Self {
        Self {
            epoch: Some(value.epoch),
            round: Some(value.round),
            commit_timestamp_ms: Some(value.commit_timestamp_ms),
...
impl TryFrom<&super::ConsensusCommitPrologue> for haneul_sdk_types::ConsensusCommitPrologueV3 {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ConsensusCommitPrologueV4> for super::ConsensusCommitPrologue {
    fn from(
        haneul_sdk_types::ConsensusCommitPrologueV4 {
            epoch,
            round,
            sub_dag_index,
            commit_timestamp_ms,
...
impl TryFrom<&super::ConsensusCommitPrologue> for haneul_sdk_types::ConsensusCommitPrologueV4 {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ConsensusDeterminedVersionAssignments>
    for super::ConsensusDeterminedVersionAssignments
{
    fn from(value: haneul_sdk_types::ConsensusDeterminedVersionAssignments) -> Self {
        use super::consensus_determined_version_assignments::Kind;
        use haneul_sdk_types::ConsensusDeterminedVersionAssignments::*;
...
impl TryFrom<&super::ConsensusDeterminedVersionAssignments>
    for haneul_sdk_types::ConsensusDeterminedVersionAssignments
{
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::CancelledTransaction> for super::CancelledTransaction {
    fn from(value: haneul_sdk_types::CancelledTransaction) -> Self {
        Self {
...
impl TryFrom<&super::CancelledTransaction> for haneul_sdk_types::CancelledTransaction {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::VersionAssignment> for super::VersionAssignment {
    fn from(value: haneul_sdk_types::VersionAssignment) -> Self {
        Self {
...
impl TryFrom<&super::VersionAssignment> for haneul_sdk_types::VersionAssignment {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::GenesisTransaction> for super::GenesisTransaction {
    fn from(value: haneul_sdk_types::GenesisTransaction) -> Self {
        Self {
            objects: value.objects.into_iter().map(Into::into).collect(),
        }
    }
...
impl TryFrom<&super::GenesisTransaction> for haneul_sdk_types::GenesisTransaction {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::RandomnessStateUpdate> for super::RandomnessStateUpdate {
    fn from(value: haneul_sdk_types::RandomnessStateUpdate) -> Self {
        Self {
            epoch: Some(value.epoch),
...
impl TryFrom<&super::RandomnessStateUpdate> for haneul_sdk_types::RandomnessStateUpdate {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::AuthenticatorStateUpdate> for super::AuthenticatorStateUpdate {
    fn from(value: haneul_sdk_types::AuthenticatorStateUpdate) -> Self {
        Self {
            epoch: Some(value.epoch),
            round: Some(value.round),
...
impl TryFrom<&super::AuthenticatorStateUpdate> for haneul_sdk_types::AuthenticatorStateUpdate {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::Jwk> for super::Jwk {
    fn from(haneul_sdk_types::Jwk { kty, e, n, alg }: haneul_sdk_types::Jwk) -> Self {
        Self {
            kty: Some(kty),
            e: Some(e),
            n: Some(n),
...
impl TryFrom<&super::Jwk> for haneul_sdk_types::Jwk {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::JwkId> for super::JwkId {
    fn from(haneul_sdk_types::JwkId { iss, kid }: haneul_sdk_types::JwkId) -> Self {
        Self {
            iss: Some(iss),
            kid: Some(kid),
        }
...
impl TryFrom<&super::JwkId> for haneul_sdk_types::JwkId {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ActiveJwk> for super::ActiveJwk {
    fn from(value: haneul_sdk_types::ActiveJwk) -> Self {
        Self {
...
impl TryFrom<&super::ActiveJwk> for haneul_sdk_types::ActiveJwk {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ChangeEpoch> for super::ChangeEpoch {
    fn from(value: haneul_sdk_types::ChangeEpoch) -> Self {
        Self {
            epoch: Some(value.epoch),
...
impl TryFrom<&super::ChangeEpoch> for haneul_sdk_types::ChangeEpoch {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::SystemPackage> for super::SystemPackage {
    fn from(value: haneul_sdk_types::SystemPackage) -> Self {
        Self {
            version: Some(value.version),
...
impl TryFrom<&super::SystemPackage> for haneul_sdk_types::SystemPackage {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::EndOfEpochTransactionKind> for super::EndOfEpochTransactionKind {
    fn from(value: haneul_sdk_types::EndOfEpochTransactionKind) -> Self {
        use super::end_of_epoch_transaction_kind::Kind;
        use haneul_sdk_types::EndOfEpochTransactionKind::*;
...
impl TryFrom<&super::EndOfEpochTransactionKind> for haneul_sdk_types::EndOfEpochTransactionKind {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::AuthenticatorStateExpire> for super::AuthenticatorStateExpire {
    fn from(value: haneul_sdk_types::AuthenticatorStateExpire) -> Self {
        Self {
...
impl TryFrom<&super::AuthenticatorStateExpire> for haneul_sdk_types::AuthenticatorStateExpire {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ProgrammableTransaction> for super::ProgrammableTransaction {
    fn from(value: haneul_sdk_types::ProgrammableTransaction) -> Self {
        Self {
...
impl TryFrom<&super::ProgrammableTransaction> for haneul_sdk_types::ProgrammableTransaction {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::Input> for super::Input {
    fn from(value: haneul_sdk_types::Input) -> Self {
...
impl TryFrom<&super::Input> for haneul_sdk_types::Input {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::Argument> for super::Argument {
    fn from(value: haneul_sdk_types::Argument) -> Self {
...
impl TryFrom<&super::Argument> for haneul_sdk_types::Argument {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::Command> for super::Command {
    fn from(value: haneul_sdk_types::Command) -> Self {
...
impl TryFrom<&super::Command> for haneul_sdk_types::Command {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::MoveCall> for super::MoveCall {
    fn from(value: haneul_sdk_types::MoveCall) -> Self {
        Self {
...
impl TryFrom<&super::MoveCall> for haneul_sdk_types::MoveCall {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::TransferObjects> for super::TransferObjects {
    fn from(value: haneul_sdk_types::TransferObjects) -> Self {
        Self {
            objects: value.objects.into_iter().map(Into::into).collect(),
...
impl TryFrom<&super::TransferObjects> for haneul_sdk_types::TransferObjects {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::SplitCoins> for super::SplitCoins {
    fn from(value: haneul_sdk_types::SplitCoins) -> Self {
        Self {
...
impl TryFrom<&super::SplitCoins> for haneul_sdk_types::SplitCoins {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::MergeCoins> for super::MergeCoins {
    fn from(value: haneul_sdk_types::MergeCoins) -> Self {
        Self {
            coin: Some(value.coin.into()),
...
impl TryFrom<&super::MergeCoins> for haneul_sdk_types::MergeCoins {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::Publish> for super::Publish {
    fn from(value: haneul_sdk_types::Publish) -> Self {
        Self {
            modules: value.modules.into_iter().map(Into::into).collect(),
            dependencies: value.dependencies.into_iter().map(Into::into).collect(),
        }
...
impl TryFrom<&super::Publish> for haneul_sdk_types::Publish {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::MakeMoveVector> for super::MakeMoveVector {
    fn from(value: haneul_sdk_types::MakeMoveVector) -> Self {
        Self {
...
impl TryFrom<&super::MakeMoveVector> for haneul_sdk_types::MakeMoveVector {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::Upgrade> for super::Upgrade {
    fn from(value: haneul_sdk_types::Upgrade) -> Self {
        Self {
            modules: value.modules.into_iter().map(Into::into).collect(),
            dependencies: value.dependencies.into_iter().map(Into::into).collect(),
            package: Some(value.package.into()),
...
impl TryFrom<&super::Upgrade> for haneul_sdk_types::Upgrade {
    type Error = TryFromProtoError;
