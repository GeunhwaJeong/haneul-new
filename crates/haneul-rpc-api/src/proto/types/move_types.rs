...
impl From<haneul_sdk_types::types::Identifier> for super::Identifier {
    fn from(value: haneul_sdk_types::types::Identifier) -> Self {
        Self {
...
impl TryFrom<&super::Identifier> for haneul_sdk_types::types::Identifier {
...
impl From<haneul_sdk_types::types::StructTag> for super::StructTag {
    fn from(value: haneul_sdk_types::types::StructTag) -> Self {
        Self {
...
impl TryFrom<&super::StructTag> for haneul_sdk_types::types::StructTag {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::TypeTag> for super::TypeTag {
    fn from(value: haneul_sdk_types::types::TypeTag) -> Self {
        use super::type_tag::Tag;
        use haneul_sdk_types::types::TypeTag;
...
impl TryFrom<&super::TypeTag> for haneul_sdk_types::types::TypeTag {
    type Error = TryFromProtoError;
