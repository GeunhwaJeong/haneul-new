...
impl From<haneul_sdk_types::Identifier> for super::Identifier {
    fn from(value: haneul_sdk_types::Identifier) -> Self {
        Self {
...
impl TryFrom<&super::Identifier> for haneul_sdk_types::Identifier {
...
impl From<haneul_sdk_types::StructTag> for super::StructTag {
    fn from(value: haneul_sdk_types::StructTag) -> Self {
        Self {
...
impl TryFrom<&super::StructTag> for haneul_sdk_types::StructTag {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::TypeTag> for super::TypeTag {
    fn from(value: haneul_sdk_types::TypeTag) -> Self {
...
impl TryFrom<&super::TypeTag> for haneul_sdk_types::TypeTag {
    type Error = TryFromProtoError;
