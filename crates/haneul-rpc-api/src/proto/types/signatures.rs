...
impl From<haneul_sdk_types::types::ValidatorAggregatedSignature>
    for super::ValidatorAggregatedSignature
{
    fn from(value: haneul_sdk_types::types::ValidatorAggregatedSignature) -> Self {
        Self {
...
impl TryFrom<&super::ValidatorAggregatedSignature>
    for haneul_sdk_types::types::ValidatorAggregatedSignature
{
    ...
    fn try_from(value: &super::ValidatorAggregatedSignature) -> Result<Self, Self::Error> {
        ...
        let signature = value
            ...
            .as_ref()
            .pipe(haneul_sdk_types::types::Bls12381Signature::from_bytes)
...
impl From<haneul_sdk_types::types::ValidatorCommitteeMember> for super::ValidatorCommitteeMember {
...
impl TryFrom<&super::ValidatorCommitteeMember> for haneul_sdk_types::types::ValidatorCommitteeMember {
    type Error = TryFromProtoError;
    ...
    fn try_from(
        ...
        let public_key = public_key
            ...
            .as_ref()
            .pipe(haneul_sdk_types::types::Bls12381PublicKey::from_bytes)
            .map_err(TryFromProtoError::from_error)?;
...
impl From<haneul_sdk_types::types::ValidatorCommittee> for super::ValidatorCommittee {
...
impl TryFrom<&super::ValidatorCommittee> for haneul_sdk_types::types::ValidatorCommittee {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::Bn254FieldElement> for super::Bn254FieldElement {
    fn from(value: haneul_sdk_types::types::Bn254FieldElement) -> Self {
        Self {
...
impl TryFrom<&super::Bn254FieldElement> for haneul_sdk_types::types::Bn254FieldElement {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::CircomG1> for super::CircomG1 {
    fn from(value: haneul_sdk_types::types::CircomG1) -> Self {
...
impl TryFrom<&super::CircomG1> for haneul_sdk_types::types::CircomG1 {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::CircomG2> for super::CircomG2 {
    fn from(value: haneul_sdk_types::types::CircomG2) -> Self {
...
impl TryFrom<&super::CircomG2> for haneul_sdk_types::types::CircomG2 {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::Claim> for super::ZkLoginClaim {
    fn from(
        haneul_sdk_types::types::Claim { value, index_mod_4 }: haneul_sdk_types::types::Claim,
    ) -> Self {
        Self {
            value: Some(value),
...
impl TryFrom<&super::ZkLoginClaim> for haneul_sdk_types::types::Claim {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::ZkLoginProof> for super::ZkLoginProof {
    fn from(value: haneul_sdk_types::types::ZkLoginProof) -> Self {
        Self {
            a: Some(value.a.into()),
            b: Some(value.b.into()),
            c: Some(value.c.into()),
...
impl TryFrom<&super::ZkLoginProof> for haneul_sdk_types::types::ZkLoginProof {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::ZkLoginInputs> for super::ZkLoginInputs {
    fn from(
        haneul_sdk_types::types::ZkLoginInputs {
            proof_points,
            iss_base64_details,
            header_base64,
            address_seed,
...
impl TryFrom<&super::ZkLoginInputs> for haneul_sdk_types::types::ZkLoginInputs {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::ZkLoginAuthenticator> for super::ZkLoginAuthenticator {
    fn from(value: haneul_sdk_types::types::ZkLoginAuthenticator) -> Self {
        Self {
...
impl TryFrom<&super::ZkLoginAuthenticator> for haneul_sdk_types::types::ZkLoginAuthenticator {
    type Error = TryFromProtoError;
...
impl From<&haneul_sdk_types::types::ZkLoginPublicIdentifier> for super::ZkLoginPublicIdentifier {
    fn from(value: &haneul_sdk_types::types::ZkLoginPublicIdentifier) -> Self {
        Self {
...
impl TryFrom<&super::ZkLoginPublicIdentifier> for haneul_sdk_types::types::ZkLoginPublicIdentifier {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::SignatureScheme> for super::SignatureScheme {
    fn from(value: haneul_sdk_types::types::SignatureScheme) -> Self {
        use haneul_sdk_types::types::SignatureScheme::*;
...
impl TryFrom<&super::SignatureScheme> for haneul_sdk_types::types::SignatureScheme {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::SimpleSignature> for super::SimpleSignature {
    fn from(value: haneul_sdk_types::types::SimpleSignature) -> Self {
        let scheme: super::SignatureScheme = value.scheme().into();
        let (signature, public_key) = match &value {
            haneul_sdk_types::types::SimpleSignature::Ed25519 {
                signature,
                public_key,
            } => (signature.as_bytes(), public_key.as_bytes()),
            haneul_sdk_types::types::SimpleSignature::Secp256k1 {
                signature,
                public_key,
            } => (signature.as_bytes(), public_key.as_bytes()),
            haneul_sdk_types::types::SimpleSignature::Secp256r1 {
                signature,
                public_key,
            } => (signature.as_bytes(), public_key.as_bytes()),
        };
...
impl TryFrom<&super::SimpleSignature> for haneul_sdk_types::types::SimpleSignature {
    type Error = TryFromProtoError;

    fn try_from(value: &super::SimpleSignature) -> Result<Self, Self::Error> {
        use super::SignatureScheme::*;
        use haneul_sdk_types::types::{Ed25519PublicKey, Ed25519Signature};
...
impl From<haneul_sdk_types::types::PasskeyAuthenticator> for super::PasskeyAuthenticator {
    fn from(value: haneul_sdk_types::types::PasskeyAuthenticator) -> Self {
        Self {
...
impl TryFrom<&super::PasskeyAuthenticator> for haneul_sdk_types::types::PasskeyAuthenticator {
    type Error = TryFromProtoError;
...
impl From<&haneul_sdk_types::types::MultisigMemberPublicKey> for super::MultisigMemberPublicKey {
    fn from(value: &haneul_sdk_types::types::MultisigMemberPublicKey) -> Self {
        use super::multisig_member_public_key::Scheme;
        use haneul_sdk_types::types::MultisigMemberPublicKey::*;
...
impl TryFrom<&super::MultisigMemberPublicKey> for haneul_sdk_types::types::MultisigMemberPublicKey {
    type Error = TryFromProtoError;

    fn try_from(value: &super::MultisigMemberPublicKey) -> Result<Self, Self::Error> {
        use super::multisig_member_public_key::Scheme;
        use haneul_sdk_types::types::{Ed25519PublicKey, Secp256k1PublicKey, Secp256r1PublicKey};
...
impl From<&haneul_sdk_types::types::MultisigMember> for super::MultisigMember {
    fn from(value: &haneul_sdk_types::types::MultisigMember) -> Self {
        Self {
...
impl TryFrom<&super::MultisigMember> for haneul_sdk_types::types::MultisigMember {
    type Error = TryFromProtoError;
...
impl From<&haneul_sdk_types::types::MultisigCommittee> for super::MultisigCommittee {
    fn from(value: &haneul_sdk_types::types::MultisigCommittee) -> Self {
        Self {
...
impl TryFrom<&super::MultisigCommittee> for haneul_sdk_types::types::MultisigCommittee {
    type Error = TryFromProtoError;
...
impl From<&haneul_sdk_types::types::MultisigMemberSignature> for super::MultisigMemberSignature {
    fn from(value: &haneul_sdk_types::types::MultisigMemberSignature) -> Self {
        use super::multisig_member_signature::Signature;
        use haneul_sdk_types::types::MultisigMemberSignature::*;
...
impl TryFrom<&super::MultisigMemberSignature> for haneul_sdk_types::types::MultisigMemberSignature {
    type Error = TryFromProtoError;

    fn try_from(value: &super::MultisigMemberSignature) -> Result<Self, Self::Error> {
        use super::multisig_member_signature::Signature;
        use haneul_sdk_types::types::{Ed25519Signature, Secp256k1Signature, Secp256r1Signature};
...
impl From<&haneul_sdk_types::types::MultisigAggregatedSignature>
    for super::MultisigAggregatedSignature
{
    fn from(value: &haneul_sdk_types::types::MultisigAggregatedSignature) -> Self {
        Self {
...
impl TryFrom<&super::MultisigAggregatedSignature>
    for haneul_sdk_types::types::MultisigAggregatedSignature
{
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::types::UserSignature> for super::UserSignature {
    fn from(value: haneul_sdk_types::types::UserSignature) -> Self {
        use super::user_signature::Signature;
        use haneul_sdk_types::types::UserSignature::*;
...
impl TryFrom<&super::UserSignature> for haneul_sdk_types::types::UserSignature {
    type Error = TryFromProtoError;
