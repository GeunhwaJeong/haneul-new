...
pub mod v2 {
    include!("generated/haneul.node.v2.rs");

    /// Byte encoded FILE_DESCRIPTOR_SET.
    pub const FILE_DESCRIPTOR_SET: &[u8] = include_bytes!("generated/haneul.node.v2.fds.bin");
...
pub mod v2alpha {
    include!("generated/haneul.node.v2alpha.rs");

    /// Byte encoded FILE_DESCRIPTOR_SET.
    pub const FILE_DESCRIPTOR_SET: &[u8] = include_bytes!("generated/haneul.node.v2alpha.fds.bin");
...
pub mod node_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/haneul.node.v2.Node/GetNodeInfo" => {
                ...
                "/haneul.node.v2.Node/GetCommittee" => {
                    #[allow(non_camel_case_types)]
                ...
                "/haneul.node.v2.Node/GetTransaction" => {
                    #[allow(non_camel_case_types)]
                ...
                "/haneul.node.v2.Node/GetCheckpoint" => {
                    #[allow(non_camel_case_types)]
                ...
                "/haneul.node.v2.Node/GetFullCheckpoint" => {
                    #[allow(non_camel_case_types)]
                ...
                "/haneul.node.v2.Node/ExecuteTransaction" => {
                    #[allow(non_camel_case_types)]
    ...
    pub const SERVICE_NAME: &str = "haneul.node.v2.Node";
