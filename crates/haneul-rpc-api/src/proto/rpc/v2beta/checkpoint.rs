...
impl MessageMerge<haneul_sdk_types::CheckpointSummary> for CheckpointSummary {
    fn merge(
        &mut self,
        source: haneul_sdk_types::CheckpointSummary,
...
impl MessageMerge<haneul_sdk_types::CheckpointContents> for CheckpointContents {
    fn merge(
        &mut self,
        source: haneul_sdk_types::CheckpointContents,
        mask: &crate::field_mask::FieldMaskTree,
    ) {
        if mask.contains(Self::BCS_FIELD.name) {
            self.bcs = Some(Bcs::serialize(&source).unwrap());
...
impl MessageMerge<&haneul_sdk_types::CheckpointSummary> for Checkpoint {
    fn merge(
        &mut self,
        source: &haneul_sdk_types::CheckpointSummary,
        mask: &crate::field_mask::FieldMaskTree,
...
impl MessageMerge<haneul_sdk_types::ValidatorAggregatedSignature> for Checkpoint {
    fn merge(
        &mut self,
...
impl MessageMerge<haneul_sdk_types::CheckpointContents> for Checkpoint {
    fn merge(
        &mut self,
        source: haneul_sdk_types::CheckpointContents,
        mask: &crate::field_mask::FieldMaskTree,
