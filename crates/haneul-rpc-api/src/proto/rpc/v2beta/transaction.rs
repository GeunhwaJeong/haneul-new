...
impl From<haneul_sdk_types::CancelledTransaction> for super::CanceledTransaction {
...
impl TryFrom<&super::CanceledTransaction> for haneul_sdk_types::CancelledTransaction {
    type Error = TryFromProtoError;
