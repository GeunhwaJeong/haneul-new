...
impl MessageMerge<haneul_sdk_types::Event> for Event {
    fn merge(&mut self, source: haneul_sdk_types::Event, mask: &crate::field_mask::FieldMaskTree) {
...
impl MessageMerge<haneul_sdk_types::TransactionEvents> for TransactionEvents {
    fn merge(
        &mut self,
        source: haneul_sdk_types::TransactionEvents,
