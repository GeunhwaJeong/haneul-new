...
impl From<haneul_sdk_types::ExecutionStatus> for super::ExecutionStatus {
    fn from(value: haneul_sdk_types::ExecutionStatus) -> Self {
        match value {
            haneul_sdk_types::ExecutionStatus::Success => Self {
                success: Some(true),
                error: None,
            },
            haneul_sdk_types::ExecutionStatus::Failure { error, command } => {
                let mut error_message = super::ExecutionError::from(error.clone());
                error_message.command = command;
                error_message.description = {
                    let error = haneul_types::execution_status::ExecutionFailureStatus::from(error);
...
impl TryFrom<&super::ExecutionStatus> for haneul_sdk_types::ExecutionStatus {
...
impl From<haneul_sdk_types::ExecutionError> for super::ExecutionError {
    fn from(value: haneul_sdk_types::ExecutionError) -> Self {
        use super::execution_error::ExecutionErrorKind;
        use haneul_sdk_types::ExecutionError::*;
        ...
        let kind = match value {
            ...
            HaneulMoveVerificationError => ExecutionErrorKind::HaneulMoveVerificationError,
            ...
            HaneulMoveVerificationTimedout => ExecutionErrorKind::HaneulMoveVerificationTimedout,
...
impl TryFrom<&super::ExecutionError> for haneul_sdk_types::ExecutionError {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::CommandArgumentError> for super::CommandArgumentError {
    fn from(value: haneul_sdk_types::CommandArgumentError) -> Self {
        use super::command_argument_error::CommandArgumentErrorKind;
        use haneul_sdk_types::CommandArgumentError::*;
...
impl TryFrom<&super::CommandArgumentError> for haneul_sdk_types::CommandArgumentError {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::TypeArgumentError> for super::type_argument_error::TypeArgumentErrorKind {
    fn from(value: haneul_sdk_types::TypeArgumentError) -> Self {
        use haneul_sdk_types::TypeArgumentError::*;
...
impl TryFrom<super::type_argument_error::TypeArgumentErrorKind>
    for haneul_sdk_types::TypeArgumentError
{
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::PackageUpgradeError> for super::PackageUpgradeError {
    fn from(value: haneul_sdk_types::PackageUpgradeError) -> Self {
        use super::package_upgrade_error::PackageUpgradeErrorKind;
        use haneul_sdk_types::PackageUpgradeError::*;
...
impl TryFrom<&super::PackageUpgradeError> for haneul_sdk_types::PackageUpgradeError {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::MoveLocation> for super::MoveLocation {
    fn from(value: haneul_sdk_types::MoveLocation) -> Self {
        Self {
...
impl TryFrom<&super::MoveLocation> for haneul_sdk_types::MoveLocation {
    type Error = TryFromProtoError;
