...
impl MessageMerge<&haneul_sdk_types::TransactionEffects> for TransactionEffects {
    fn merge(
        &mut self,
        source: &haneul_sdk_types::TransactionEffects,
...
impl MessageMerge<&haneul_sdk_types::TransactionEffectsV1> for TransactionEffects {
    fn merge(
        &mut self,
...
impl MessageMerge<&haneul_sdk_types::TransactionEffectsV2> for TransactionEffects {
    fn merge(
        &mut self,
