...
impl MessageMerge<haneul_sdk_types::Transaction> for Transaction {
    fn merge(
        &mut self,
        source: haneul_sdk_types::Transaction,
...
impl From<haneul_sdk_types::CanceledTransaction> for super::CanceledTransaction {
...
impl TryFrom<&super::CanceledTransaction> for haneul_sdk_types::CanceledTransaction {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::CanceledTransactionV2> for super::CanceledTransaction {
...
impl TryFrom<&super::CanceledTransaction> for haneul_sdk_types::CanceledTransactionV2 {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::VersionAssignmentV2> for super::VersionAssignment {
...
impl TryFrom<&super::VersionAssignment> for haneul_sdk_types::VersionAssignmentV2 {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ExecutionTimeObservations> for super::ExecutionTimeObservations {
...
impl TryFrom<&super::ExecutionTimeObservations> for haneul_sdk_types::ExecutionTimeObservations {
    type Error = TryFromProtoError;
        ...
        let key = match value.kind() {
            ...
            ExecutionTimeObservationKind::MoveEntryPoint => {
                let move_call = value
                    ...
                    .pipe(haneul_sdk_types::MoveCall::try_from)?;
                ExecutionTimeObservationKey::MoveEntryPoint {
