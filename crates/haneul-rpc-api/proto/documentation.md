...
- [haneul/node/v2/node_service.proto](#haneul_node_v2_node_service-proto)
...
- [haneul/node/v2alpha/node_service.proto](#haneul_node_v2alpha_node_service-proto)
    - [AccountObject](#haneul-node-v2alpha-AccountObject)
    - [CoinMetadata](#haneul-node-v2alpha-CoinMetadata)
    - [CoinTreasury](#haneul-node-v2alpha-CoinTreasury)
    - [DynamicField](#haneul-node-v2alpha-DynamicField)
    - [GetCoinInfoRequest](#haneul-node-v2alpha-GetCoinInfoRequest)
    - [GetCoinInfoResponse](#haneul-node-v2alpha-GetCoinInfoResponse)
    - [GetGasInfoRequest](#haneul-node-v2alpha-GetGasInfoRequest)
    - [GetGasInfoResponse](#haneul-node-v2alpha-GetGasInfoResponse)
    - [GetProtocolConfigRequest](#haneul-node-v2alpha-GetProtocolConfigRequest)
    - [GetProtocolConfigResponse](#haneul-node-v2alpha-GetProtocolConfigResponse)
    - [GetProtocolConfigResponse.AttributesEntry](#haneul-node-v2alpha-GetProtocolConfigResponse-AttributesEntry)
    - [GetProtocolConfigResponse.FeatureFlagsEntry](#haneul-node-v2alpha-GetProtocolConfigResponse-FeatureFlagsEntry)
    - [ListAccountObjectsRequest](#haneul-node-v2alpha-ListAccountObjectsRequest)
    - [ListAccountObjectsResponse](#haneul-node-v2alpha-ListAccountObjectsResponse)
    - [ListDynamicFieldsRequest](#haneul-node-v2alpha-ListDynamicFieldsRequest)
    - [ListDynamicFieldsResponse](#haneul-node-v2alpha-ListDynamicFieldsResponse)
    - [RegulatedCoinMetadata](#haneul-node-v2alpha-RegulatedCoinMetadata)
    - [ResolveTransactionRequest](#haneul-node-v2alpha-ResolveTransactionRequest)
    - [ResolveTransactionResponse](#haneul-node-v2alpha-ResolveTransactionResponse)
    - [SimulateTransactionRequest](#haneul-node-v2alpha-SimulateTransactionRequest)
    - [SimulateTransactionResponse](#haneul-node-v2alpha-SimulateTransactionResponse)
  
    - [NodeService](#haneul-node-v2alpha-NodeService)
  
- [haneul/node/v2alpha/subscription_service.proto](#haneul_node_v2alpha_subscription_service-proto)
    - [SubscribeCheckpointsRequest](#haneul-node-v2alpha-SubscribeCheckpointsRequest)
    - [SubscribeCheckpointsResponse](#haneul-node-v2alpha-SubscribeCheckpointsResponse)
  
    - [SubscriptionService](#haneul-node-v2alpha-SubscriptionService)
  
- [haneul/types/signature_scheme.proto](#haneul_types_signature_scheme-proto)
    - [SignatureScheme](#haneul-types-SignatureScheme)
  
- [haneul/types/types.proto](#haneul_types_types-proto)
...
<a name="haneul_node_v2_node_service-proto"></a>
<p align="right"><a href="#top">Top</a></p>

## haneul/node/v2/node_service.proto
...
| signatures | [haneul.types.UserSignature](#haneul-types-UserSignature) | repeated | Optional. Set of `UserSiganture`s authorizing the execution of the provided transaction. |
...
| effects | [haneul.types.TransactionEffects](#haneul-types-TransactionEffects) | optional | The `TransactionEffects` for this transaction. |
| effects_bcs | [haneul.types.Bcs](#haneul-types-Bcs) | optional | The [TransactionEffects](https://docs.rs/haneul-sdk-types/latest/haneul_sdk_types/struct.TransactionEffects.html) for this transaction encoded as BCS bytes. |
| events | [haneul.types.TransactionEvents](#haneul-types-TransactionEvents) | optional | The `TransactionEvents` for this transaction.
...
| events_bcs | [haneul.types.Bcs](#haneul-types-Bcs) | optional | The [TransactionEvents](https://docs.rs/haneul-sdk-types/latest/haneul_sdk_types/struct.TransactionEvents.html) for this transaction encoded as BCS bytes. |
| balance_changes | [BalanceChange](#haneul-node-v2-BalanceChange) | repeated | Set of balance change events as a result of this transaction.
...
| object | [haneul.types.Object](#haneul-types-Object) | optional | The object itself. |
| object_bcs | [haneul.types.Bcs](#haneul-types-Bcs) | optional | The [object](https://docs.rs/haneul-sdk-types/latest/haneul_sdk_types/struct.Object.html) encoded as BCS bytes. |
...
| transaction | [haneul.types.Transaction](#haneul-types-Transaction) | optional | The transaction itself. |
| transaction_bcs | [haneul.types.Bcs](#haneul-types-Bcs) | optional | The [Transaction](https://docs.rs/haneul-sdk-types/latest/haneul_sdk_types/struct.Transaction.html) encoded as BCS bytes. |
| effects | [haneul.types.TransactionEffects](#haneul-types-TransactionEffects) | optional | The `TransactionEffects` for this transaction. |
| effects_bcs | [haneul.types.Bcs](#haneul-types-Bcs) | optional | The [TransactionEffects](https://docs.rs/haneul-sdk-types/latest/haneul_sdk_types/struct.TransactionEffects.html) for this transaction encoded as BCS bytes. |
| events | [haneul.types.TransactionEvents](#haneul-types-TransactionEvents) | optional | The `TransactionEvents` for this transaction.
...
This field might be empty, even if it was explicitly requested, if the transaction didn&#39;t produce any events. `haneul.types.TransactionEffects.events_digest` is populated if the transaction produced any events. |
| events_bcs | [haneul.types.Bcs](#haneul-types-Bcs) | optional | The [TransactionEvents](https://docs.rs/haneul-sdk-types/latest/haneul_sdk_types/struct.TransactionEvents.html) for this transaction encoded as BCS bytes. |
| input_objects | [FullCheckpointObject](#haneul-node-v2-FullCheckpointObject) | repeated | Set of input objects used during the execution of this transaction. |
| output_objects | [FullCheckpointObject](#haneul-node-v2-FullCheckpointObject) | repeated | Set of output objects produced from the execution of this transaction. |
...
| summary | [haneul.types.CheckpointSummary](#haneul-types-CheckpointSummary) | optional | The `CheckpointSummary` for this checkpoint. |
| summary_bcs | [haneul.types.Bcs](#haneul-types-Bcs) | optional | The [CheckpointSummary](https://docs.rs/haneul-sdk-types/latest/haneul_sdk_types/struct.CheckpointSummary.html) for this checkpoint encoded as BCS bytes. |
| signature | [haneul.types.ValidatorAggregatedSignature](#haneul-types-ValidatorAggregatedSignature) | optional | An aggregated quorum signature from the validator committee that certifies this checkpoint. |
| contents | [haneul.types.CheckpointContents](#haneul-types-CheckpointContents) | optional | The `CheckpointContents` for this checkpoint. |
| contents_bcs | [haneul.types.Bcs](#haneul-types-Bcs) | optional | The [CheckpointContents](https://docs.rs/haneul-sdk-types/latest/haneul_sdk_types/struct.CheckpointContents.html) for this checkpoint encoded as BCS bytes. |
...
| transaction | [haneul.types.Transaction](#haneul-types-Transaction) | optional | The transaction itself. |
| transaction_bcs | [haneul.types.Bcs](#haneul-types-Bcs) | optional | The [Transaction](https://docs.rs/haneul-sdk-types/latest/haneul_sdk_types/struct.Transaction.html) encoded as BCS bytes. |
| signatures | [haneul.types.UserSignature](#haneul-types-UserSignature) | repeated | List of user signatures that are used to authorize the execution of this transaction. |
| signatures_bytes | [bytes](#bytes) | repeated | List of [UserSignature](https://docs.rs/haneul-sdk-types/latest/haneul_sdk_types/struct.UserSignature.html)s encoded as bytes. |
| effects | [haneul.types.TransactionEffects](#haneul-types-TransactionEffects) | optional | The `TransactionEffects` for this transaction. |
| effects_bcs | [haneul.types.Bcs](#haneul-types-Bcs) | optional | The [TransactionEffects](https://docs.rs/haneul-sdk-types/latest/haneul_sdk_types/struct.TransactionEffects.html) for this transaction encoded as BCS bytes. |
| events | [haneul.types.TransactionEvents](#haneul-types-TransactionEvents) | optional | The `TransactionEvents` for this transaction.
...
<a name="haneul_node_v2alpha_node_service-proto"></a>
<p align="right"><a href="#top">Top</a></p>

## haneul/node/v2alpha/node_service.proto
The haneul.node.v2alpha package contains experimental services that have yet to
stabilize
...
<a name="haneul-node-v2alpha-AccountObject"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| owner | [haneul.types.Address](#haneul-types-Address) | optional |  |
| object_id | [haneul.types.ObjectId](#haneul-types-ObjectId) | optional |  |
| version | [uint64](#uint64) | optional |  |
| object_type | [haneul.types.StructTag](#haneul-types-StructTag) | optional |  |
...
<a name="haneul-node-v2alpha-CoinMetadata"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| id | [haneul.types.ObjectId](#haneul-types-ObjectId) | optional | ObjectId of the `0x2::coin::CoinMetadata` object. |
...
<a name="haneul-node-v2alpha-CoinTreasury"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| id | [haneul.types.ObjectId](#haneul-types-ObjectId) | optional | ObjectId of the `0x2::coin::TreasuryCap` object. |
...
<a name="haneul-node-v2alpha-DynamicField"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| parent | [haneul.types.ObjectId](#haneul-types-ObjectId) | optional | Required. ObjectId of this dynamic field&#39;s parent. |
| field_id | [haneul.types.ObjectId](#haneul-types-ObjectId) | optional | Required. ObjectId of this dynamic field. |
| name_type | [haneul.types.TypeTag](#haneul-types-TypeTag) | optional | Required. The type of the dynamic field &#34;name&#34; |
| name_value | [bytes](#bytes) | optional | Required. The serialized move value of &#34;name&#34; |
| dynamic_object_id | [haneul.types.ObjectId](#haneul-types-ObjectId) | optional | The ObjectId of the child object when a child is a dynamic object field.
...
<a name="haneul-node-v2alpha-GetCoinInfoRequest"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| coin_type | [haneul.types.TypeTag](#haneul-types-TypeTag) | optional | The coin type to request information about |
...
<a name="haneul-node-v2alpha-GetCoinInfoResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| coin_type | [haneul.types.TypeTag](#haneul-types-TypeTag) | optional | Required. The coin type. |
| metadata | [CoinMetadata](#haneul-node-v2alpha-CoinMetadata) | optional | This field will be populated with information about this coin type&#39;s `0x2::coin::CoinMetadata` if it exists and has not been wrapped. |
| treasury | [CoinTreasury](#haneul-node-v2alpha-CoinTreasury) | optional | This field will be populated with information about this coin type&#39;s `0x2::coin::TreasuryCap` if it exists and has not been wrapped. |
...
<a name="haneul-node-v2alpha-GetGasInfoRequest"></a>
...
<a name="haneul-node-v2alpha-GetGasInfoResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| reference_gas_price | [uint64](#uint64) | optional | Reference gas price denominated in GEUNHWA |
...
<a name="haneul-node-v2alpha-GetProtocolConfigRequest"></a>
...
<a name="haneul-node-v2alpha-GetProtocolConfigResponse"></a>
...
| feature_flags | [GetProtocolConfigResponse.FeatureFlagsEntry](#haneul-node-v2alpha-GetProtocolConfigResponse-FeatureFlagsEntry) | repeated |  |
| attributes | [GetProtocolConfigResponse.AttributesEntry](#haneul-node-v2alpha-GetProtocolConfigResponse-AttributesEntry) | repeated |  |
...
<a name="haneul-node-v2alpha-GetProtocolConfigResponse-AttributesEntry"></a>
...
<a name="haneul-node-v2alpha-GetProtocolConfigResponse-FeatureFlagsEntry"></a>
...
<a name="haneul-node-v2alpha-ListAccountObjectsRequest"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| owner | [haneul.types.Address](#haneul-types-Address) | optional | Required. The address of the account that owns the objects. |
...
<a name="haneul-node-v2alpha-ListAccountObjectsResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| objects | [AccountObject](#haneul-node-v2alpha-AccountObject) | repeated | Page of dynamic fields owned by the specified parent. |
...
<a name="haneul-node-v2alpha-ListDynamicFieldsRequest"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| parent | [haneul.types.ObjectId](#haneul-types-ObjectId) | optional | Required. The `UID` of the parent, which owns the collections of dynamic fields. |
...
<a name="haneul-node-v2alpha-ListDynamicFieldsResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| dynamic_fields | [DynamicField](#haneul-node-v2alpha-DynamicField) | repeated | Page of dynamic fields owned by the specified parent. |
| next_page_token | [string](#string) | optional | A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. |
...
<a name="haneul-node-v2alpha-RegulatedCoinMetadata"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| id | [haneul.types.ObjectId](#haneul-types-ObjectId) | optional | ObjectId of the `0x2::coin::RegulatedCoinMetadata` object. |
| coin_metadata_object | [haneul.types.ObjectId](#haneul-types-ObjectId) | optional | The ID of the coin&#39;s `CoinMetadata` object. |
| deny_cap_object | [haneul.types.ObjectId](#haneul-types-ObjectId) | optional | The ID of the coin&#39;s `DenyCap` object. |
...
<a name="haneul-node-v2alpha-ResolveTransactionRequest"></a>
...
<a name="haneul-node-v2alpha-ResolveTransactionResponse"></a>
...
| simulation | [SimulateTransactionResponse](#haneul-node-v2alpha-SimulateTransactionResponse) | optional |  |
...
<a name="haneul-node-v2alpha-SimulateTransactionRequest"></a>
...
<a name="haneul-node-v2alpha-SimulateTransactionResponse"></a>
...
| balance_changes | [haneul.node.v2.BalanceChange](#haneul-node-v2-BalanceChange) | repeated |  |
...
<a name="haneul-node-v2alpha-NodeService"></a>
...
| Method Name | Request Type | Response Type | Description |
| ----------- | ------------ | ------------- | ------------|
| GetCoinInfo | [GetCoinInfoRequest](#haneul-node-v2alpha-GetCoinInfoRequest) | [GetCoinInfoResponse](#haneul-node-v2alpha-GetCoinInfoResponse) | Request information for the specified coin type. |
| ListDynamicFields | [ListDynamicFieldsRequest](#haneul-node-v2alpha-ListDynamicFieldsRequest) | [ListDynamicFieldsResponse](#haneul-node-v2alpha-ListDynamicFieldsResponse) | List the dynamic fields for provided parent. |
| ListAccountObjects | [ListAccountObjectsRequest](#haneul-node-v2alpha-ListAccountObjectsRequest) | [ListAccountObjectsResponse](#haneul-node-v2alpha-ListAccountObjectsResponse) |  |
| GetProtocolConfig | [GetProtocolConfigRequest](#haneul-node-v2alpha-GetProtocolConfigRequest) | [GetProtocolConfigResponse](#haneul-node-v2alpha-GetProtocolConfigResponse) |  |
| GetGasInfo | [GetGasInfoRequest](#haneul-node-v2alpha-GetGasInfoRequest) | [GetGasInfoResponse](#haneul-node-v2alpha-GetGasInfoResponse) |  |
| SimulateTransaction | [SimulateTransactionRequest](#haneul-node-v2alpha-SimulateTransactionRequest) | [SimulateTransactionResponse](#haneul-node-v2alpha-SimulateTransactionResponse) |  |
| ResolveTransaction | [ResolveTransactionRequest](#haneul-node-v2alpha-ResolveTransactionRequest) | [ResolveTransactionResponse](#haneul-node-v2alpha-ResolveTransactionResponse) |  |

 



<a name="haneul_node_v2alpha_subscription_service-proto"></a>
<p align="right"><a href="#top">Top</a></p>

## haneul/node/v2alpha/subscription_service.proto
The haneul.node.v2alpha package contains experimental services that have yet to
stabilize
...
<a name="haneul-node-v2alpha-SubscribeCheckpointsRequest"></a>
...
<a name="haneul-node-v2alpha-SubscribeCheckpointsResponse"></a>
...
| checkpoint | [haneul.node.v2.GetFullCheckpointResponse](#haneul-node-v2-GetFullCheckpointResponse) | optional | The requested data for this checkpoint |
...
<a name="haneul-node-v2alpha-SubscriptionService"></a>

### SubscriptionService
Service for subscribing to data from a Haneul Fullnode

| Method Name | Request Type | Response Type | Description |
| ----------- | ------------ | ------------- | ------------|
| SubscribeCheckpoints | [SubscribeCheckpointsRequest](#haneul-node-v2alpha-SubscribeCheckpointsRequest) | [SubscribeCheckpointsResponse](#haneul-node-v2alpha-SubscribeCheckpointsResponse) stream | Subscribe to the stream of checkpoints.

This API provides a subscription to the checkpoint stream for the Haneul blockchain. When a subscription is initialized the stream will begin with the latest executed checkpoint as seen by the server. Responses are gaurenteed to return checkpoints in-order and without gaps. This enables clients to know exactly the last checkpoint they have processed and in the event the subscription terminates (either by the client/server or by the connection breaking), clients will be able to reinitailize a subscription and then leverage other APIs (e.g. haneul.node.v2.NodeService.GetFullCheckpoint) in order to request data for the checkpoints they missed. |

 



<a name="haneul_types_signature_scheme-proto"></a>
<p align="right"><a href="#top">Top</a></p>

## haneul/types/signature_scheme.proto
...
<a name="haneul_types_types-proto"></a>
<p align="right"><a href="#top">Top</a></p>

## haneul/types/types.proto
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| address | [Address](#haneul-types-Address) | optional | Denied address. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| object_id | [ObjectId](#haneul-types-ObjectId) | optional | ID of the object. |
...
| status | [FailureStatus](#haneul-types-FailureStatus) | optional | The error if `success` is false. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| package | [ObjectId](#haneul-types-ObjectId) | optional | The package ID. |
| module | [Identifier](#haneul-types-Identifier) | optional | The module name. |
...
| function_name | [Identifier](#haneul-types-Identifier) | optional | The name of the function, if available. |
...
| legacy_bitmap | [RoaringBitmap](#haneul-types-RoaringBitmap) | optional | If present, means this signature&#39;s on-chain format uses the old legacy multisig format. |
| committee | [MultisigCommittee](#haneul-types-MultisigCommittee) | optional | The committee to use to validate this signature. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| public_key | [MultisigMemberPublicKey](#haneul-types-MultisigMemberPublicKey) | optional | The public key of the committee member. |
...
| ----- | ---- | ----- | ----------- |
| version | [uint64](#uint64) | optional | Version of the object. |
| digest | [Digest](#haneul-types-Digest) | optional | Digest of the object. |
| owner | [Owner](#haneul-types-Owner) | optional | Owner of the object. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| reference | [ObjectReference](#haneul-types-ObjectReference) | optional | `ObjectReference`. |
| owner | [Owner](#haneul-types-Owner) | optional | `Owner`. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| digest | [Digest](#haneul-types-Digest) | optional | Digest of the new version of the object. |
| owner | [Owner](#haneul-types-Owner) | optional | Owner of the new version of the object. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| package_id | [ObjectId](#haneul-types-ObjectId) | optional | The package ID. |
| ticket_id | [ObjectId](#haneul-types-ObjectId) | optional | The ticket ID. |
...
| digest | [Digest](#haneul-types-Digest) | optional | Digest of the new package. |
...
| signature | [SimpleSignature](#haneul-types-SimpleSignature) | optional | A secp256r1 signature. |
...
| digest | [Digest](#haneul-types-Digest) | optional | Digest of the shared object. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| scheme | [int32](#int32) | optional | The signature scheme of the signautre and public key, which should be an enum value of [haneul.types.SignatureScheme][haneul.types.SignatureScheme] |
...
| bitmap | [RoaringBitmap](#haneul-types-RoaringBitmap) | optional | Bitmap indicating which members of the committee contributed to this signature. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| inputs | [ZkLoginInputs](#haneul-types-ZkLoginInputs) | optional | Zklogin proof and inputs required to perform proof verification. |
| max_epoch | [uint64](#uint64) | optional | Maximum epoch for which the proof is valid. |
| signature | [SimpleSignature](#haneul-types-SimpleSignature) | optional | User signature with the public key attested to by the provided proof. |
