        ...
        // TODO: use node_config for this instead?
          ...
          if cfg!(debug_assertions) {
              ...
              if !Mode::allow_arbitrary_values() {
                  ...
                  temporary_store
                      .check_haneul_conserved(advance_epoch_gas_summary, do_expensive_checks)
                      .unwrap();
              ...
              let conservation_result = temporary_store.check_haneul_conserved(advance_epoch_gas_summary, do_expensive_checks);
              if let Err(conservation_err) = conservation_result {
                  ...
                  temporary_store.check_haneul_conserved(advance_epoch_gas_summary, do_expensive_checks).unwrap();
              }
          }
      } // else, genesis transactions mint the HANEUL supply, and hence does not satisfy HANEUL conservation.
