...
use haneul_types::{is_system_package, HANEUL_FRAMEWORK_OBJECT_ID, HANEUL_SYSTEM_OBJECT_ID};
    ...
    if protocol_config.gas_model_version() > 1 {
        ...
        if !is_genesis_tx && !Mode::allow_arbitrary_values() {
            ...
            let conservation_result = temporary_store
                .check_haneul_conserved(advance_epoch_gas_summary, enable_expensive_checks);
