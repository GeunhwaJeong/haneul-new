...
use haneul_framework::natives::object_runtime::{self, ObjectRuntime};
...
use haneul_types::{error::convert_vm_error, storage::SingleTxContext};
use haneul_verifier::{
...
>(
    ...
    use haneul_types::messages::EntryTypeArgumentErrorKind;
