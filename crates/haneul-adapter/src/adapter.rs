...
use haneul_verifier::{
    entry_points_verifier::{is_tx_context, RESOLVED_STD_OPTION, RESOLVED_HANEUL_ID},
...
>(
    ...
    let is_unwrapped = !(newly_generated_ids.contains(&id) || id == HANEUL_SYSTEM_STATE_OBJECT_ID);
