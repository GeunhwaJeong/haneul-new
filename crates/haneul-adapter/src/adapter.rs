...
>(
    ...
    // This means that either the object was wrapped inside another object that is in the Haneul object
    // pool
...
>(
    ...
    let mut is_unwrapped = !(newly_generated_ids.contains(&id) || id == HANEUL_SYSTEM_STATE_OBJECT_ID);
