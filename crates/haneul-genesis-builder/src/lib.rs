...
fn get_genesis_protocol_config(version: ProtocolVersion) -> ProtocolConfig {
    ...
    // HANEUL_PROTOCOL_CONFIG_CHAIN_OVERRIDE if necessary
...
fn build_unsigned_genesis_data(
    ...
    // framework.
    let system_packages =
        haneul_framework_snapshot::load_bytecode_snapshot(parameters.protocol_version.as_u64())
...
=======
    ...
    let executor = haneul_execution::executor(&protocol_config, paranoid_checks, silent, None)
