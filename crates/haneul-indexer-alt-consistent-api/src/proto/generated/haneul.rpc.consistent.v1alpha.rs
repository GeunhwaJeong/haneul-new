...
pub struct AvailableRangeResponse {
    ...
    /// The (exclusive) transaction upperbound (by sequence number) that the
    /// service can answer questions for.
    #[prost(uint64, optional, tag = "102")]
    pub max_transaction: ::core::option::Option<u64>,
...
pub struct BatchGetBalancesRequest {
    ...
    pub requests: ::prost::alloc::vec::Vec<GetBalanceRequest>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct ListBalancesRequest {
    ...
    /// this value.
    ///
    /// Consult `haneul.rpc.consistent.v1alpha/ServiceConfig` for default and maximum
    /// page sizes.
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.consistent.v1alpha.ConsistentService/AvailableRange",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "haneul.rpc.consistent.v1alpha.ConsistentService",
                        "AvailableRange",
                    ),
                );
        ...
        pub async fn batch_get_balances(
            &mut self,
            request: impl tonic::IntoRequest<super::BatchGetBalancesRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.consistent.v1alpha.ConsistentService/BatchGetBalances",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn get_balance(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.consistent.v1alpha.ConsistentService/GetBalance",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.consistent.v1alpha.ConsistentService/ListBalances",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.consistent.v1alpha.ConsistentService/ListObjectsByType",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.consistent.v1alpha.ConsistentService/ListOwnedObjects",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.consistent.v1alpha.ConsistentService/ServiceConfig",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod consistent_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/haneul.rpc.consistent.v1alpha.ConsistentService/BatchGetBalances" => {
                    #[allow(non_camel_case_types)]
                    struct BatchGetBalancesSvc<T: ConsistentService>(pub Arc<T>);
                    impl<
                        T: ConsistentService,
                    ...
                    for BatchGetBalancesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ConsistentService>::batch_get_balances(
                                        &inner,
                                        request,
                                    )
                                    .await
    ...
    pub const SERVICE_NAME: &str = "haneul.rpc.consistent.v1alpha.ConsistentService";
