...
use haneul_types::messages::{ExecutionStatus, OrderEffects};
...
pub struct WalletContext {
    ...
    pub client_states: BTreeMap<HaneulAddress, ClientState<AuthorityClient>>,
}
...
impl WalletContext {
    ...
    pub fn find_owner(&self, object_id: &ObjectID) -> Result<HaneulAddress, HaneulError> {
        self.client_states
            .iter()
    ...
    fn create_client_state(
        &self,
        owner: &HaneulAddress,
    ) -> Result<ClientState<AuthorityClient>, HaneulError> {
    ...
    pub fn get_account_info(&self, address: &HaneulAddress) -> Result<&AccountInfo, HaneulError> {
        self.config
            .accounts
            .iter()
