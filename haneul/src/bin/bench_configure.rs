...
#[derive(Debug, Parser)]
#[clap(
    name = "Haneul Distributed Benchmark Config Creator",
...
fn main() {
    ...
    let genesis_config = GenesisConfig {
        ...
        move_packages: vec![],
        haneul_framework_lib_path: Path::new("../../haneul_programmability/framework").to_path_buf(),
        move_framework_lib_path: Path::new("../../haneul_programmability/framework/deps/move-stdlib")
            .to_path_buf(),
    };
