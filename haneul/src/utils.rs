...
use haneul_types::base_types::{decode_bytes_hex, encode_bytes_hex, HaneulAddress};
...
pub fn optional_address_from_hex<'de, D>(deserializer: D) -> Result<Option<HaneulAddress>, D::Error>
where
