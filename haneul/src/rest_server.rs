...
/**
 * [HANEUL] Use to provide server configurations for genesis.
 */
#[endpoint {
    method = POST,
    path = "/debug/haneul/genesis",
}]
async fn genesis(
...
/**
 * [HANEUL] Start servers with specified configurations.
 */
#[endpoint {
    method = POST,
    path = "/debug/haneul/start",
}]
async fn start(
    rqctx: Arc<RequestContext<ServerContext>>,
...
/**
 * [HANEUL] Stop servers and delete storage.
 */
#[endpoint {
    method = POST,
    path = "/debug/haneul/stop",
}]
async fn stop(
    rqctx: Arc<RequestContext<ServerContext>>,
