...
use haneul_network::network::NetworkServer;
use haneul_types::base_types::HaneulAddress;
use haneul_types::crypto::{random_key_pairs, KeyPair, PublicKeyBytes};
use haneul_types::gas_coin::GasCoin;
use haneul_types::object::Object;
use haneul_types::{base_types::*, committee::*};
...
impl ValidatorPreparer {
    pub fn new(
        ...
        let main_authority_address_hex = format!(
            "{}",
            HaneulAddress::from(genesis_config.key_pair.public_key_bytes())
        );
    ...
    pub fn update_objects_for_validator(&mut self, objects: Vec<Object>, address: HaneulAddress) {
        match self.running_mode {
            RunningMode::LocalSingleValidatorProcess => {
