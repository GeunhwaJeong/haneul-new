...
use haneul_core::client::ClientState;
...
impl AccountsConfig {
    ...
    pub fn addresses(&mut self) -> impl Iterator<Item = &HaneulAddress> {
        self.accounts.keys()
    }
