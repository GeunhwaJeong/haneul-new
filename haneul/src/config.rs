...
use haneul_network::network::{NetworkClient, PortAllocator};
...
impl WalletConfig {
    ...
    pub fn get_account_cfg_info(&self, address: &HaneulAddress) -> Result<&AccountInfo, HaneulError> {
        self.accounts
            .iter()
...
pub struct GenesisConfig {
    ...
    #[serde(default = "default_haneul_framework_lib")]
...
fn default_haneul_framework_lib() -> PathBuf {
...
impl GenesisConfig {
    pub fn default_genesis(path: &Path) -> Result<Self, anyhow::Error> {
        ...
        Ok(Self {
            ...
            accounts,
            move_packages: vec![],
            haneul_framework_lib_path: default_haneul_framework_lib(),
