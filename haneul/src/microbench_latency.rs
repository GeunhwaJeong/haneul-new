...
use haneul_types::crypto::{get_key_pair, AuthoritySignature, KeyPair, PublicKeyBytes, Signature};
...
#[structopt(
    name = "Haneul Latency Microbenchmark",
    about = "Local test and latency microbenchmark of the Haneul authorities"
)]
...
fn create_object(object_id: ObjectID, owner: HaneulAddress, use_move: bool) -> Object {
    if use_move {
