...
const HANEUL_SIGNATURE_LENGTH: usize =
    ed25519_dalek::PUBLIC_KEY_LENGTH + ed25519_dalek::SIGNATURE_LENGTH;

#[serde_as]
#[derive(Eq, PartialEq, Copy, Clone, Serialize, Deserialize)]
pub struct Signature(#[serde_as(as = "Bytes")] [u8; HANEUL_SIGNATURE_LENGTH]);
...
impl Signature {
        ...
        T: Signable<Vec<u8>>,
    {
        ...
        // TODO: perform stricter key validation, sp. small order points, see https://github.com/GeunhwaJeong/fastnft/issues/101
        let public_key =
