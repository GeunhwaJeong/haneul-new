...
impl OrderEffects {
    ...
    pub fn mutated_and_created(&self) -> impl Iterator<Item = &(ObjectRef, HaneulAddress)> {
        self.mutated.iter().chain(self.created.iter())
    }

    /// Return an iterator of mutated objects, but excluding the gas object.
    pub fn mutated_excluding_gas(&self) -> impl Iterator<Item = &(ObjectRef, HaneulAddress)> {
