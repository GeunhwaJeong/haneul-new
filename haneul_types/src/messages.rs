...
impl TransactionData {
    pub fn new(kind: TransactionKind, sender: HaneulAddress, gas_payment: ObjectRef) -> Self {
        TransactionData {
            kind,
            sender,
            gas_payment,
...
impl InputObjectKind {
    ...
    pub fn object_not_found_error(&self) -> HaneulError {
        match *self {
            ...
            Self::OwnedMoveObject((object_id, _, _)) => HaneulError::ObjectNotFound { object_id },
