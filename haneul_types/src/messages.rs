...
//
// see also https://github.com/GeunhwaJeong/fastnft/issues/266
//
...
pub enum ExecutionStatus {
    ...
    Failure { gas_used: u64, error: Box<HaneulError> },
}

impl ExecutionStatus {
    pub fn new_failure(gas_used: u64, error: HaneulError) -> ExecutionStatus {
    ...
    pub fn unwrap_err(self) -> (u64, HaneulError) {
        match self {
...
impl OrderEffects {
    ...
    pub fn all_mutated(&self) -> impl Iterator<Item = &(ObjectRef, HaneulAddress)> {
        self.mutated
            .iter()
...
impl InputObjectKind {
    ...
    pub fn object_not_found_error(&self) -> HaneulError {
        match *self {
            ...
            Self::MoveObject((object_id, _, _)) => HaneulError::ObjectNotFound { object_id },
        }
    }
}
...
impl Order {
    ...
    pub fn check_signature(&self) -> Result<(), HaneulError> {
    ...
    // TODO: support orders with multiple objects (https://github.com/GeunhwaJeong/fastnft/issues/8)
    pub fn object_id(&self) -> &ObjectID {
        use OrderKind::*;
        match &self.kind {
...
impl SignedOrder {
    ...
    pub fn check(&self, committee: &Committee) -> Result<usize, HaneulError> {
...
impl<'a> SignatureAggregator<'a> {
    ...
    pub fn try_new(order: Order, committee: &'a Committee) -> Result<Self, HaneulError> {
...
impl CertifiedOrder {
    ...
    pub fn check(&self, committee: &Committee) -> Result<(), HaneulError> {
        // Check the quorum.
        let mut weight = 0;
