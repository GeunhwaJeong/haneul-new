...
pub fn check_transfer_gas_requirement(gas_object: &Object, transfer_object: &Object) -> HaneulResult {
...
pub fn check_move_gas_requirement(gas_object: &Object, gas_budget: u64) -> HaneulResult {
    ok_or_gas_error!(
        gas_budget >= MIN_MOVE,
        format!(
...
pub fn try_deduct_gas(gas_object: &mut Object, amount: u64) -> HaneulResult {
...
pub fn check_gas_balance(gas_object: &Object, amount: u64) -> HaneulResult {
    let balance = get_gas_balance(gas_object)?;
    ok_or_gas_error!(
        balance >= amount,
        format!("Gas balance is {}, not enough to pay {}", balance, amount)
