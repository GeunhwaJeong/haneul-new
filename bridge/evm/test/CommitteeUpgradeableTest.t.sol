...
contract CommitteeUpgradeableTest is BridgeBaseTest {
    ...
    function setUp() public {
        ...
        address _config = Upgrades.deployUUPSProxy(
            ...
            abi.encodeCall(
                ...
                (_committee, _chainID, supportedTokens, tokenPrices, tokenIds, haneulDecimals, _supportedDestinationChains)
            ),
            opts
        );
        ...
        address _bridge = Upgrades.deployUUPSProxy(
            "HaneulBridge.sol",
            abi.encodeCall(HaneulBridge.initialize, (_committee, address(0), address(0))),
            opts
        );

        bridge = HaneulBridge(_bridge);
        bridgeV2 = new MockHaneulBridgeV2();
    }

    function testUpgradeWithSignaturesSuccess() public {
        bytes memory initializer = abi.encodeCall(MockHaneulBridgeV2.initializeV2, ());
    ...
    function testUpgradeRegressionTestWithV2Initializer() public {
        bytes memory messagePrefix = hex"48414e45554c5f4252494447455f4d455353414745050100000000000000000c";
    ...
    function testUpgradeRegressionTestWith1CalldataArg() public {
        ...
        MockHaneulBridgeV2 newBridgeV2 = MockHaneulBridgeV2(address(bridge));
    ...
    function testUpgradeRegressionTestWithNoCalldata() public {
        ...
        MockHaneulBridgeV2(address(bridge));
        assertEq(Upgrades.getImplementationAddress(address(bridge)), address(bridgeV2));
    }
}
