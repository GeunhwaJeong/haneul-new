...
contract HaneulBridgeTest is BridgeBaseTest, IHaneulBridge {
    ...
    function testBridgeERC20InsufficientAllowance() public {
        ...
        bridge.bridgeERC20(BridgeMessage.ETH, type(uint256).max, abi.encode("haneulAddress"), 0);
    }
    ...
    function testBridgeWETH() public {
        ...
        bridge.bridgeERC20(BridgeMessage.ETH, 1 ether, abi.encode("haneulAddress"), 0);
        ...
        bridge.bridgeERC20(
            BridgeMessage.ETH, 2_000_000_011_000_000_888, abi.encode("haneulAddress"), 0
        );
    ...
    //     tokenPrices[0] = 10000; // HANEUL PRICE
    ...
    //     skip(2 days);
    //     HaneulBridge _bridge = new HaneulBridge();
