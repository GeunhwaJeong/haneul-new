...
contract HaneulBridgeV2Test is BridgeBaseTest {
    HaneulBridgeV2 bridgeV2;
    uint8 _chainID = 12;
    ...
    function _deployBridgeV2() internal {
        ...
        // deploy HaneulBridgeV2 directly (not upgrading from V1)
        ...
        bridgeV2 = HaneulBridgeV2(_bridgeV2);
    ...
    function testBridgeETHV2() public {
        ...
        emit TokensDepositedV2(
            ...
            BridgeUtils.ETH,
            1_00_000_000, // 1 ether in haneul decimals
            deployer,
    ...
    function testTransferBridgedTokensWithSignaturesV2() public {
        ...
        bytes memory payload = _createV2TransferPayload(
            ...
            BridgeUtils.ETH,
            100000000,
            block.timestamp // 1 ether in haneul decimals
        );
    ...
    function testTransferBridgedTokensV2InvalidVersion() public {
        ...
        vm.expectRevert(bytes("HaneulBridge: Invalid message version"));
        bridgeV2.transferBridgedTokensWithSignaturesV2(signatures, message);
    }
    ...
    function testMatureMessageBypassesLimit() public {
        ...
        uint64 largeAmount = 100_00000000; // 100 ETH in haneul decimals
    ...
    function testFreshMessageRespectsLimit() public {
        ...
        // totalLimit is 1_000_000 USD, ETH price ~$2597, so ~386 ETH exceeds limit
        uint64 largeAmount = 400_00000000; // 400 ETH in haneul decimals - exceeds $1M limit
    ...
    function testMatureUSDCTransferBypassesLimit() public {
        ...
        uint64 largeAmount = 1_500_000_000000; // $1.5M USDC in haneul decimals (6 decimals)
    ...
    function testUpgradeFromV1ToV2() public {
        ...
        HaneulBridge bridgeV1 = HaneulBridge(_bridgeV1);
        ...
        HaneulBridgeV2 v2Implementation = new HaneulBridgeV2();
        ...
        HaneulBridgeV2 upgradedBridge = HaneulBridgeV2(address(bridgeV1));
