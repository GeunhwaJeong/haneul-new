...
The release branch naming convention is `releases/haneul-v<version>.0-release`.
```bash
git fetch origin releases/haneul-v<version>.0-release
git checkout releases/haneul-v<version>.0-release
```
...
```bash
gh pr create --base releases/haneul-v<version>.0-release \
