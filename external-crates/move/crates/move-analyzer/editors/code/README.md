...
language [documentation](https://docs.haneul.io/concepts/haneul-move-concepts).
...
In order to trace Move code execution, the `haneul` binary must be built with the `tracing` feature flag.
