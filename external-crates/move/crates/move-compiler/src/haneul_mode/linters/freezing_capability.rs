...
//! Implements lint to warn against freezing capability-like types in Haneul, identifying function calls that may incorrectly freeze such types.
...
use crate::{
    ...
    haneul_mode::linters::{FREEZE_FUN, PUBLIC_FREEZE_FUN, HANEUL_PKG_NAME, TRANSFER_MOD_NAME},
    typing::{
        ast as T, core,
...
const FREEZE_FUNCTIONS: &[(&str, &str, &str)] = &[
    (HANEUL_PKG_NAME, TRANSFER_MOD_NAME, PUBLIC_FREEZE_FUN),
    (HANEUL_PKG_NAME, TRANSFER_MOD_NAME, FREEZE_FUN),
];
