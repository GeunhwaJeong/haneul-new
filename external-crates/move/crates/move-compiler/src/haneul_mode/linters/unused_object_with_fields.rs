...
/// Checks whether a parameter type is a Haneul object with key ability, no type
...
fn is_qualifying_obj(
    ...
    // id: UID (guaranteed by Haneul type checker for key objects) plus at least one other field.
    fields.len() >= 2
}
