...
use crate::{
    ...
    haneul_mode::{
        ...
        REGISTRY_CREATE_FUNCTION_NAME, HANEUL_ADDR_NAME, HANEUL_ADDR_VALUE, HANEUL_CLOCK_CREATE,
        HANEUL_SYSTEM_ADDR_VALUE, HANEUL_SYSTEM_CREATE, HANEUL_SYSTEM_MODULE_NAME,
...
pub const FUNCTIONS_TO_SKIP: &[(AccountAddress, Symbol, Symbol)] = &[
    ...
    (HANEUL_ADDR_VALUE, ACCUMULATOR_MODULE_NAME, ACCUMULATOR_CREATE),
    (
        HANEUL_ADDR_VALUE,
