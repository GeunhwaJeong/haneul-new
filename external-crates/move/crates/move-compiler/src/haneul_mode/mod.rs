...
pub const HANEUL_ADDR_VALUE: AccountAddress = AccountAddress::from_suffix(0x2);
pub const HANEUL_SYSTEM_ADDR_VALUE: AccountAddress = AccountAddress::from_suffix(0x3);
...
pub const HANEUL_MODULE_NAME: Symbol = symbol!("haneul");
pub const HANEUL_OTW_NAME: Symbol = symbol!("HANEUL");
