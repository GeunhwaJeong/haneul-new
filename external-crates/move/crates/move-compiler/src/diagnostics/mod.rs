...
pub const ICE_BUG_REPORT_MESSAGE: &str =
    ...
    Please report this this issue to the Haneul Labs Move language team,\n \
    including this error and any relevant code, to the Haneul Labs issue tracker\n \
    at : https://github.com/GeunhwaJeong/haneul/issues";
