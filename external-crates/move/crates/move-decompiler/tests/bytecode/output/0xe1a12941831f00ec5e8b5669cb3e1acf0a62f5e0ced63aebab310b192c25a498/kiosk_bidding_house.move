...
public entry fun buy_nft_to_new_kiosk<T0: key + store>(l0: &mut Kiosk_Bidding_Store, l1: &mut AuctionHouse, l2: ID, l3: &mut Kiosk, l4: &mut TransferPolicy<T0>, l5: Coin<HANEUL>, l6: Coin<HANEUL>, l7: &mut TxContext) {
    ...
    let l12 = reg_12;
    let l9 = reg_11;
    kiosk::lock(&mut l8, &l10, freeze(l4), l9);
...
public fun buy_nft_with_request<T0: key + store>(l0: &mut Kiosk_Bidding_Store, l1: &mut AuctionHouse, l2: ID, l3: &mut Kiosk, l4: &TransferPolicy<T0>, l5: Coin<HANEUL>, l6: &mut TxContext): ( T0, TransferRequest<T0>) {
    ...
    if (option::is_some(&l14)) {
        ...
        if (dynamic_object_field::exists_with_type(&l0.id, l20)) {
            ...
            let l7 = reg_90 : 0x2::balance::Balance<0x2::haneul::HANEUL>;
...
public fun cancel_listing<T0: key + store>(l0: &mut Kiosk_Bidding_Store, l1: ID, l2: &mut Kiosk, l3: &mut TxContext) {
    ...
    if (option::is_some(&l7)) {
        ...
        if (dynamic_object_field::exists_with_type(&l0.id, l6)) {
            ...
            let l4 = reg_63 : 0x2::balance::Balance<0x2::haneul::HANEUL>;
    ...
    if (dynamic_object_field::exists_with_type(&l0.id, l2)) {
        ...
        if (option::is_some(&l8)) {
            ...
            if (dynamic_object_field::exists_with_type(&l0.id, l6)) {
                ...
                let l4 = reg_61 : 0x2::balance::Balance<0x2::haneul::HANEUL>;
    ...
    *(&mut l12.highest_bidder) = option::some(l8);
    if (option::is_some(&l15)) {
        ...
        if (dynamic_object_field::exists_with_type(&l0.id, l14)) {
            ...
            let l5 = reg_107 : 0x2::balance::Balance<0x2::haneul::HANEUL>;
