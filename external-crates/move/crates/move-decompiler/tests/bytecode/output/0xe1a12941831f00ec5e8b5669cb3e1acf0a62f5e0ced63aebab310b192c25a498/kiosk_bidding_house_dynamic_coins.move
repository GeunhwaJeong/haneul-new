...
public fun accept_bid<T0: key + store, T1>(l0: &mut Kiosk_Bidding_Store, l1: &mut AuctionHouse, l2: ID, l3: &mut Kiosk, l4: &TransferPolicy<T0>, l5: &mut TxContext) {
    ...
    (reg_129, reg_130, reg_131) = transfer_policy::confirm_request(l4, reg_126);
    let l12 = tx_context::epoch(freeze(l5));
    let l6 = AcceptedBid { id: object::new(l5), listing_id: l2, bidder: l10, nft: reg_125, timestamp: l12, coin_type: l11 };
    dynamic_object_field::add(&mut l0.id, l2, l6);
    object::delete(reg_14 : 0x2::object::UID);
    object::delete(reg_94 : 0x2::object::UID);
    event::emit(BidReadyForClaim { listing_id: l2, seller: l23, bidder: l10, amount: reg_20 : u64, nft_id: reg_17 : 0x2::object::ID, timestamp: l12, coin_type: l11 })
}
...
public fun buy_nft_with_request<T0: key + store, T1>(l0: &mut Kiosk_Bidding_Store, l1: &mut AuctionHouse, l2: ID, l3: &mut Kiosk, l4: &TransferPolicy<T0>, l5: Coin<T1>, l6: &mut TxContext): ( T0, TransferRequest<T0>) {
    ...
    let (reg_115, reg_116) = kiosk::purchase_with_cap(l3, reg_17 : 0x2::kiosk::PurchaseCap<T0>, coin::zero(l6));
    object::delete(reg_13 : 0x2::object::UID);
    event::emit(NftBoughtOut { listing_id: l2, seller: l24, buyer: tx_context::sender(freeze(l6)), amount: l10, nft_id: reg_16 : 0x2::object::ID, coin_type: l11 });
...
public fun cancel_listing<T0: key + store, T1>(l0: &mut Kiosk_Bidding_Store, l1: ID, l2: &mut Kiosk, l3: &mut TxContext) {
    ...
    event::emit(ListingCancelled { listing_id: l1, seller: l14, nft_id: reg_15 : 0x2::object::ID, coin_type: l8 })
}
...
public entry fun emergency_reset_listing<T0: key + store>(l0: &mut Kiosk_Bidding_Store, l1: &AuctionHouse, l2: ID, l3: &mut TxContext) {
    ...
    if (dynamic_object_field::exists_with_type(&l0.id, l2)) {
        ...
        let l9 = OrphanedPurchaseCap { id: object::new(l3), cap: reg_21 : 0x2::kiosk::PurchaseCap<T0>, kiosk_id: l7, orphaned_at: tx_context::epoch(freeze(l3)) };
