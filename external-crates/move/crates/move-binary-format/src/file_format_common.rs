...
const _: () = {
    ...
    assert!(BinaryFlavor::mask_and_shift_to_unflavor(x) == BinaryFlavor::HANEUL_FLAVOR);
};
...
impl BinaryFlavor {
    ...
    // The Haneul flavor is 0x05
    pub const HANEUL_FLAVOR: u8 = 0x05;
    ...
    const fn shift_and_flavor(unflavored: u32) -> u32 {
        ((Self::HANEUL_FLAVOR as u32) << Self::SHIFT_AMOUNT) | unflavored
    }
}
