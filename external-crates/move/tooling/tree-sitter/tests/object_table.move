...
/// Similar to `haneul::table`, an `ObjectTable<K, V>` is a map-like collection. But unlike
/// `haneul::table`, the values bound to these dynamic fields _must_ be objects themselves. This allows
