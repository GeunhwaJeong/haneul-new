...
1. Download the snapshot to a temporary directory. For example, if the `db-path` value points to `/opt/haneul/db/authorities_db/full_node_db` and you want to restore from epoch 10, use one of these commands:
