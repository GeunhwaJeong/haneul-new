---
title: Haneul Validator Alert Reference
...
When running a Haneul Validator or full node, it is recommended to monitor the health of the nodes and set up alerts on problems.
...
The following sections cover the alert queries, but the details are meant to be customized to haneult your infrastructure.
...
Please notify Haneul community on Discord if this cannot be resolved on your own.
...
Please notify Haneul community on Discord when this is observed.
