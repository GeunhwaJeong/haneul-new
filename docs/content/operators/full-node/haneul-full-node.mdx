...
Refer to the [full node YAML template](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-config/data/fullnode-template.yaml) for the complete list of available `rpc` options.
