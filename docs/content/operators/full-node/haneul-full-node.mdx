...
You must enable gRPC support on your full nodes. JSON-RPC is **deprecated**. See [Haneul's data serving roadmap](/develop/accessing-data/data-serving#grpc-api) for guidance on the overall transition plan.
