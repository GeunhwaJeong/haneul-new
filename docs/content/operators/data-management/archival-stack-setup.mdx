...
- Access to the Haneul checkpoint buckets for your target network:
   - **Mainnet:** GCS bucket `haneullabs-mainnet-checkpoints` or `https://checkpoints.mainnet.haneul.io`
   - **Testnet:** GCS bucket `haneullabs-testnet-checkpoints` or `https://checkpoints.testnet.haneul.io`
...
haneul-kvstore-alt \
    ...
    --remote-store-gcs haneullabs-mainnet-checkpoints
```
