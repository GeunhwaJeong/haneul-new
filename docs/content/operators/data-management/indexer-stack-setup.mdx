...
`https://checkpoints.mainnet.haneul.io` and `https://checkpoints.testnet.haneul.io` retain only the most recent 30 days of checkpoints. For full-retention backfills older than 30 days or from genesis, use `gs://haneullabs-mainnet-checkpoints-use4` through `--remote-store-gcs haneullabs-mainnet-checkpoints-use4` for Mainnet or `gs://haneullabs-testnet-checkpoints-use4` through `--remote-store-gcs haneullabs-testnet-checkpoints-use4` for Testnet.
...
`https://checkpoints.mainnet.haneul.io` and `https://checkpoints.testnet.haneul.io` retain only the most recent 30 days of checkpoints. For full-retention backfills older than 30 days, use `gs://haneullabs-mainnet-checkpoints-use4` through `--remote-store-gcs haneullabs-mainnet-checkpoints-use4` for Mainnet or `gs://haneullabs-testnet-checkpoints-use4` through `--remote-store-gcs haneullabs-testnet-checkpoints-use4` for Testnet instead of `--remote-store-url`.
...
For full-retention backfill, use `gs://haneullabs-mainnet-checkpoints-use4` through `--remote-store-gcs haneullabs-mainnet-checkpoints-use4` for Mainnet or `gs://haneullabs-testnet-checkpoints-use4` through `--remote-store-gcs haneullabs-testnet-checkpoints-use4` for Testnet rather than `--remote-store-url`.
