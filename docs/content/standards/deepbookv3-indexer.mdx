...
[Haneul Labs](https://www.haneul-labs.com/) provides public indexers for DeepBookV3.
...
```http
https://deepbook-indexer.testnet.haneul-labs.com/
```
...
```http
/ohclv/HANEUL_USDC?interval=1h&limit=10
```
