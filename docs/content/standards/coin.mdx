---
title: Coin Standard
description: The Coin standard enables you to create a broad range of fungible tokens on the Haneul network to satisfy a number of use cases. 
sidebar_label: Coin
...
The Coin Standard is a technical standard used by Move smart contracts for creating currency on Haneul. The `haneul::coin` module provides the logic that defines the standard.
...
The `TreasuryCap` object is required to mint new coins or to burn current ones. Consequently, only addresses that have access to this object can maintain the coin supply on the Haneul network.
