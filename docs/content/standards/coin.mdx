---
title: Coin Standard
description: The Haneul Coin standard is now deprecated in favor of the Currency standard. The Coin standard enables you to create a broad range of fungible tokens on the Haneul network to satisfy a number of use cases. The Coin standard on Haneul is equivalent to the ERC-20 technical standard on Ethereum.
sidebar_label: Coin
...
The Coin standard is a technical standard used for smart contracts on Haneul for creating coins on the Haneul blockchain. See [Haneul Tokenomics](/concepts/tokenomics.mdx) to learn more about the HANEUL native coin and its use on the Haneul network.
