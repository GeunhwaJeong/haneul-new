...
{@inject: ../../../crates/haneul-framework/packages/haneul-framework/sources/coin.move#fun=mint noComments}
...
{@inject: ../../../crates/haneul-framework/packages/haneul-framework/sources/coin.move#fun=burn noComments}
...
{@inject: ../../../crates/haneul-framework/packages/haneul-framework/sources/coin.move#fun=deny_list_v2_add noComments}
...
{@inject: ../../../crates/haneul-framework/packages/haneul-framework/sources/coin.move#fun=deny_list_v2_remove noComments}
...
{@inject: ../../../crates/haneul-framework/packages/haneul-framework/sources/coin.move#fun=deny_list_v2_enable_global_pause noComments}
...
{@inject: ../../../crates/haneul-framework/packages/haneul-framework/sources/coin.move#fun=deny_list_v2_disable_global_pause noComments}
...
- [Closed-Loop Token Standard](./closed-loop-token.mdx): Details the Token standard on Haneul.
- [`coin` module rustdoc documentation](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/docs/haneul/coin.md): Automated documentation output for the Haneul framework `coin` module.
- [`token` module rustdoc documentation](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/docs/haneul/token.md): Automated documentation output for the Haneul framework `token` module.
- [Tokenomics](../concepts/tokenomics.mdx): Discover the Haneul ecosystem and where HANEUL coins fit within it.
