...
txb.moveCall({
    ...
    arguments: [
        txb.object(<HANEUL-DENY-LIST-OBJECT-ID>),
...
- [Create a Coin](../guides/developer/haneul-101/create-coin.mdx): Guide for creating coins and regulated coins in your smart contracts.
