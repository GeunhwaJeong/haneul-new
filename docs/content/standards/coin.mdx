---
title: Coin Standard
description: The Haneul Coin standard enables you to create a broad range of fungible tokens on the Haneul network to satisfy a number of use cases. The Coin standed on Haneul is equivalent to the ERC-20 technical standard on Ethereum.
sidebar_label: Coin
---
...
See the [coin module](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/docs/haneul-framework/coin.md) documentation for all available options when creating a coin-type token on Haneul.
...
- [`coin` module rustdoc documentation](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/docs/haneul-framework/coin.md): Automated documentation output for the Haneul framework `coin` module.
- [`token` module rustdoc documentation](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/docs/haneul-framework/token.md): Automated documentation output for the Haneul framework `token` module.
