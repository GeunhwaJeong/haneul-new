...
- [NFT Rental repository](https://github.com/GeunhwaJeong/haneul/tree/main/examples/move/nft-rental): GitHub repo that contains the source code for the NFT Rental app.
