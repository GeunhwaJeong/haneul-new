...
{@inject: github:HaneulLabs/deepbookv3/packages/deepbook/sources/pool.move#fun=swap_exact_base_for_quote noComments}
...
{@inject: github:HaneulLabs/deepbookv3/packages/deepbook/sources/pool.move#fun=swap_exact_quote_for_base noComments}
...
{@inject: github:HaneulLabs/deepbookv3/packages/deepbook/sources/pool.move#fun=swap_exact_quantity noComments}
