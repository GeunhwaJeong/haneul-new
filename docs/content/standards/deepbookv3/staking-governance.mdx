...
{@inject: github:HaneulLabs/deepbookv3/packages/deepbook/sources/pool.move#fun=stake noComments}
...
{@inject: github:HaneulLabs/deepbookv3/packages/deepbook/sources/pool.move#fun=unstake noComments}
...
{@inject: github:HaneulLabs/deepbookv3/packages/deepbook/sources/pool.move#fun=submit_proposal noComments}
...
{@inject: github:HaneulLabs/deepbookv3/packages/deepbook/sources/pool.move#fun=vote noComments}
...
{@inject: github:HaneulLabs/deepbookv3/packages/deepbook/sources/pool.move#fun=claim_rebates noComments}
