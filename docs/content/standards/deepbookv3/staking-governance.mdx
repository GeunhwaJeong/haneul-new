...
{@inject: ../deepbook-ref/pool.move#fun=stake noComments}
...
{@inject: ../deepbook-ref/pool.move#fun=unstake noComments}
...
{@inject: ../deepbook-ref/pool.move#fun=submit_proposal noComments}
...
{@inject: ../deepbook-ref/pool.move#fun=vote noComments}
...
{@inject: ../deepbook-ref/pool.move#fun=claim_rebates noComments}
