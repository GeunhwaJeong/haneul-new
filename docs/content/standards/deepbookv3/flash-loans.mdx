...
{@inject: ../deepbook-ref/pool.move#fun=borrow_flashloan_base noComments}
...
{@inject: ../deepbook-ref/pool.move#fun=borrow_flashloan_quote noComments}
...
{@inject: ../deepbook-ref/pool.move#fun=return_flashloan_base noComments}
...
{@inject: ../deepbook-ref/pool.move#fun=return_flashloan_quote noComments}
