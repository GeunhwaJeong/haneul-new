...
<ImportContent source="packages/deepbook/sources/balance_manager.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="new" noComments />
...
<ImportContent source="packages/deepbook/sources/balance_manager.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="new_with_owner" noComments />
...
<ImportContent source="packages/deepbook/sources/balance_manager.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="mint_trade_cap,revoke_trade_cap" />
...
<ImportContent source="packages/deepbook/sources/balance_manager.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="mint_deposit_cap,mint_withdraw_cap" />
...
<ImportContent source="packages/deepbook/sources/balance_manager.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="generate_proof_as_owner,generate_proof_as_trader" />

### Deposit funds

Only the owner can call this function to deposit funds into the `BalanceManager`.

<ImportContent source="packages/deepbook/sources/balance_manager.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="deposit" />

### Withdraw funds

Only the owner can call this function to withdraw funds from the `BalanceManager`.

<ImportContent source="packages/deepbook/sources/balance_manager.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="withdraw,withdraw_all" />
...
<ImportContent source="packages/deepbook/sources/balance_manager.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="deposit_with_cap" />
...
<ImportContent source="packages/deepbook/sources/balance_manager.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="withdraw_with_cap" />

### Read endpoints

<ImportContent source="packages/deepbook/sources/balance_manager.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="validate_proof,balance,owner,id" />
