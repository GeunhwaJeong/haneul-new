...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="stake" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="unstake" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="submit_proposal" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="vote" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="claim_rebates" noComments />
