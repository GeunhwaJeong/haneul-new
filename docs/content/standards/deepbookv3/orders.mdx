...
{@inject: ../deepbook-ref/helper/constants.move#variable=NO_RESTRICTION,IMMEDIATE_OR_CANCEL,FILL_OR_KILL,POST_ONLY}

### Self-matching options

The following constants define the options available for self-matching orders.

{@inject: ../deepbook-ref/helper/constants.move#variable=SELF_MATCHING_ALLOWED,CANCEL_TAKER,CANCEL_MAKER}
...
{@inject: ../deepbook-ref/pool.move#fun=place_limit_order noComments}
...
{@inject: ../deepbook-ref/pool.move#fun=place_market_order noComments}
...
{@inject: ../deepbook-ref/pool.move#fun=modify_order noComments}
...
{@inject: ../deepbook-ref/pool.move#fun=cancel_order noComments}
...
{@inject: ../deepbook-ref/pool.move#fun=withdraw_settled_amounts noComments}
