...
```json
{
    ...
    "image_url": "https://haneul-heroes.io/hero/{image_url}",
...
fun init(otw: MY_HERO, ctx: &mut TxContext) {
    ...
    let values = vector[
        ...
        b"https://haneul-heroes.io/hero/{id}".to_string(),
        // For `image_url` use an IPFS template + `image_url` property.
        b"ipfs://{image_url}".to_string(),
        // Description is static for all `Hero` objects.
        b"A true Hero of the Haneul ecosystem!".to_string(),
        // Project URL is usually static
        b"https://haneul-heroes.io".to_string(),
        // Creator field can be any
        b"Unknown Haneul Fan".to_string(),
    ];
