...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="addConditionalOrder" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="cancelConditionalOrder" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="cancelAllConditionalOrders" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="executeConditionalOrders" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="newCondition" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="newPendingLimitOrder" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="newPendingMarketOrder" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="conditionalOrderIds" signatureOnly />

### `conditionalOrder`

Query a specific conditional order by ID.

<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="conditionalOrder" signatureOnly />

### `triggerBelowOrders`, `triggerAboveOrders`

Query the lists of conditional orders sorted by trigger price.

<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="triggerBelowOrders,triggerAboveOrders" signatureOnly />

### `numConditionalOrders`

Query the total number of conditional orders for a margin manager.

<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="numConditionalOrders" signatureOnly />

### `lowestTriggerAbovePrice`, `highestTriggerBelowPrice`

Query trigger prices for conditional orders.

<ImportContent source="packages/deepbook-v3/src/transactions/marginTPSL.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="lowestTriggerAbovePrice,highestTriggerBelowPrice" signatureOnly />
