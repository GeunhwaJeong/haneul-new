...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="riskRatio" signatureOnly />
...
<RelatedLink
	href="https://github.com/GeunhwaJeong/deepbookv3/tree/main/packages/deepbook_margin"
