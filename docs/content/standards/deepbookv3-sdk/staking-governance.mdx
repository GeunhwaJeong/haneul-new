...
See [Staking and Governance](../deepbookv3/contract-information/staking-governance.mdx) for more information on the staking and governance API.
...
<ImportContent source="packages/deepbook-v3/src/transactions/deepbook.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="claimRebates" signatureOnly/>
