...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="createAndShareBalanceManager" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="createBalanceManagerWithOwner" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="shareBalanceManager" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="depositIntoManager" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="withdrawFromManager" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="withdrawAllFromManager" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="checkManagerBalance" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="generateProof" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="generateProofAsOwner" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="generateProofAsTrader" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="mintTradeCap" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="mintDepositCap" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="mintWithdrawalCap" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="depositWithCap" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="withdrawWithCap" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="revokeTradeCap" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="setBalanceManagerReferral" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="unsetBalanceManagerReferral" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="getBalanceManagerReferralId" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="registerBalanceManager" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="owner" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="id" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="balanceManagerReferralOwner" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="balanceManagerReferralPoolId" signatureOnly/>
...
// Example: Withdraw HANEUL from a balance manager
withdrawFunds = (tx: Transaction) => {
	const managerKey = 'MANAGER_1';
	const coinKey = 'HANEUL';
	const amount = 100; // 100 HANEUL
...
<RelatedLink
	href="https://github.com/GeunhwaJeong/ts-sdks/tree/main/packages/deepbook-v3"
	label="DeepBookV3 Indexer repository"
	desc="The DeepBookV3 SDK repository on GitHub."
/>
<RelatedLink
	href="https://www.npmjs.com/package/@haneullabs/deepbook-v3"
	label="DeepBookV3 SDK node package"
	desc="The DeepBookV3 SDK node package on NPM."
/>
<RelatedLink
	href="https://github.com/GeunhwaJeong/deepbookv3"
