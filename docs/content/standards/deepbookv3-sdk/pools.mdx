...
Pools are shared objects that represent a market. See [Query the Pool](../deepbookv3/contract-information/query-the-pool.mdx) for more information on pools.
...
Input amounts, quantities, and prices should be provided in standard decimal format (e.g., `10.5` HANEUL, `0.00001` nBTC). The SDK handles conversion to base units internally. Returned amounts are also in standard decimal format.
:::
