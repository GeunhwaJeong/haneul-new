...
You can use PAS through the [TypeScript package](https://www.npmjs.com/package/@haneullabs/pas) or learn more in the [GitHub repo](https://github.com/GeunhwaJeong/pas). 
...
See the [KYC example `kyc_registry`](https://github.com/GeunhwaJeong/pas/blob/main/packages/examples/kyc/sources/kyc_registry.move) for a complete implementation.
...
Given the approval function from the [KYC example `kyc_registry`](https://github.com/GeunhwaJeong/pas/blob/main/packages/examples/kyc/sources/kyc_registry.move):
