...
sidebar_position: 2
description: DeepBook Margin contract addresses, supported coins, margin pools, and risk parameters on Haneul Mainnet.
keywords:
  [
    deepbook margin,
    contract address,
...
This page contains the contract addresses, supported coins, margin pools, and risk parameters for DeepBook Margin on Haneul Mainnet.
...
<details>
<summary>HANEULUSDE Token</summary>
...
<details>
<summary>HANEULUSDE Margin Pool</summary>

| Parameter | Value |
|-----------|-------|
| Pool ID | `0xbb990ca04a7743e6c0a25a7fb16f60fc6f6d8bf213624ff03a63f1bb04c3a12f` |
| Supply Cap | 1,000,000 HANEULUSDE |
| Max Utilization Rate | 90% |
| Referral Spread | 20% |
| Min Borrow | 0.1 HANEULUSDE |

</details>

## Risk parameters

Risk parameters determine the leverage limits and liquidation thresholds for each trading pair. See [Risk Ratio](./contract-information/risk-ratio.mdx) for a detailed explanation of how these parameters work.

### HANEUL/USDC (5x leverage)
