...
<RelatedLink
	...
	desc="Learn how interest rates are calculated for margin pool borrowing."
/>
<RelatedLink
	href="./supply-referral"
	label="Supply Referral"
	desc="Learn how to earn referral fees by referring liquidity suppliers."
/>
<RelatedLink
