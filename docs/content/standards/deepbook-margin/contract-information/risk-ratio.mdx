...
## Example: HANEUL/USDC position lifecycle

Consider a HANEUL/USDC position with the following risk parameters:
...
2. You borrow 400 USDC worth of HANEUL
3. Total assets = 100 USDC collateral + 400 USDC worth of HANEUL = 500 USDC
4. Total debt = 400 USDC
5. Risk ratio = 500/400 = 1.25 (at the minimum borrow ratio)
6. You now have 5x leveraged exposure to HANEUL

**Price moves in your favor:**
1. HANEUL price increases 10%, your HANEUL is now worth 440 USDC
...
1. HANEUL price drops 10%, your HANEUL is now worth 360 USDC
2. Total assets = 100 + 360 = 460 USDC, debt is still 400 USDC
3. Risk ratio = 460/400 = 1.15 (approaching liquidation)
4. If HANEUL drops further to 340 USDC worth, ratio = (100 + 340)/400 = 1.1 (liquidation threshold)
