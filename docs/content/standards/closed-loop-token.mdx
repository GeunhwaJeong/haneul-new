...
The [Currency Standard](/standards/currency.mdx) on Haneul is an example of an open-loop system. Coins are free-flowing, [wrappable](/guides/developer/objects/object-ownership/wrapped.mdx), [freely transferable](/guides/developer/objects/transfers/custom-rules.mdx#the-store-ability-and-transfer-rules) and you can store them in any application. 
