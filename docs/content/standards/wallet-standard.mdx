...
Legacy methods:
- `haneul:signTransactionBlock` - The legacy version of `haneul:signTransaction`. Many existing dApps still rely on this method.
- `haneul:signAndExecuteTransactionBlock` - The legacy version of `haneul:signAndExecuteTransaction`. Many existing dApps still rely on this method.
