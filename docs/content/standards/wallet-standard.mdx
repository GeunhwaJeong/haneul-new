...
```tsx
wallet.features[haneul:signTransaction].singTransaction(<Transaction>, <WalletAccount>);
```
...
Haneul Labs offers a bare bones scaffold for React-based applications called `@haneullabs/dapp-kit`. See the [dApp Kit documentation](https://sdk.haneul-labs.com/dapp-kit) for more informqtion.
