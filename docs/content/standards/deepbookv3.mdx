...
keywords: [ deepbook, deep book, limit order book, order book, orderbook, deepbookv3, deep book v3, deep book 3, decentralized central limit order book, clob, DEEP token, deep, liquidity support, digital ledger ]
---
...
The DEEP token pays for trading fees on the exchange. Users can pay trading fees using DEEP tokens or input tokens, but owning, using, and staking DEEP continues to provide the most benefits to active DeepBook traders on the Haneul network.
...
Similar to order books for other market places, DeepBook's CLOB architecture enables you to enter market and limit orders. You can sell HANEUL tokens, referred to as an "ask," can set your price, referred to as a limit order, or sell at the market's going rate. If you are seeking to buy HANEUL, referred to as a "bid," you can pay the current market price or set a limit price. Limit orders only get fulfilled if the CLOB finds a match between a buyer and seller.

If you put in a limit order for 1,000 HANEUL, and no single seller is currently offering that quantity of tokens, DeepBook automatically pools the current asks to meet the quantity of your bid.
...
[DeepBook repository on GitHub](https://github.com/GeunhwaJeong/deepbookv3).
