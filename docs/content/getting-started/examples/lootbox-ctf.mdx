...
<ImportContent source="contracts/sources/lootboxes.move" mode="code" org="HaneulLabs" repo="CTF" fun="open_lootbox" />
...
<ImportContent source="contracts/sources/lootboxes.move" mode="code" org="HaneulLabs" repo="CTF" fun="extract_flag" />
...
<ImportContent source="contracts/sources/lootboxes.move" mode="code" org="HaneulLabs" repo="CTF" struct="MaybeFlag" />
