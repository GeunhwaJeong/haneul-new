...
<ImportContent source="C1/capability/sources/hero.move" mode="code" org="HaneulLabs" repo="haneul-move-bootcamp" branch="solution" struct="AdminCap" />

The struct has only the `key` ability (not `store`), which means it can exist as a Haneul object but cannot be wrapped inside another object. It has a single `id` field. The struct carries no data because its purpose is purely authorization: if you can pass a `&AdminCap` reference, you have permission.
...
<ImportContent source="C1/capability/sources/hero.move" mode="code" org="HaneulLabs" repo="haneul-move-bootcamp" branch="solution" fun="init" />
...
<ImportContent source="C1/capability/sources/hero.move" mode="code" org="HaneulLabs" repo="haneul-move-bootcamp" branch="solution" fun="create_hero" />
...
<ImportContent source="C1/capability/sources/hero.move" mode="code" org="HaneulLabs" repo="haneul-move-bootcamp" branch="solution" fun="new_admin" />
