...
<ImportContent source="F1/move/hero/sources/hero.move" mode="code" org="HaneulLabs" repo="haneul-move-bootcamp" branch="solution" struct="Hero" />
...
<ImportContent source="F1/move/hero/sources/hero.move" mode="code" org="HaneulLabs" repo="haneul-move-bootcamp" branch="solution" fun="equip_weapon" />
...
<ImportContent source="F1/move/hero/sources/hero.move" mode="code" org="HaneulLabs" repo="haneul-move-bootcamp" branch="solution" fun="new_hero" />
