...
<ImportContent source="crates/haneul-indexer-alt-framework/src/pipeline/processor.rs" mode="code" variable="FANOUT" />

Each worker calls your `Handler::process()` method independently. 

<ImportContent source="crates/haneul-indexer-alt-framework/src/pipeline/processor.rs" mode="code" variable="values" />
