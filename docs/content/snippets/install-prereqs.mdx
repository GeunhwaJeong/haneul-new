...
- [x] If you plan to use the `--with-indexer` and `--with-graphql` options with `haneul start`, download and install **libpq-dev**:
  <div className="pl-8">
    ...
    See [Local Network](/guides/developer/getting-started/local-network.mdx) for more information.
