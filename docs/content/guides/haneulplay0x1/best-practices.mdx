...
keywords: [ HaneulPlay0X1, beamable, shinami, data management, handling transactions, on-chain storage, off-chain storage ]
---
...
<RelatedLink to="/guides/haneulplay0x1/wallet-integration.mdx" />
