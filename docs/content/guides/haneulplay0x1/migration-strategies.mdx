---
title: Broader Haneul Ecosystem Support
description: HaneulPlay0X1 is part of the Haneul gaming ecosystem. Users can migrate accounts between on-device and off-device versions of a game. 
keywords: [ haneulplayx01, playtron, haneul dApp kit, off-device users, on-device users, haneul gaming, on-device gaming, off-device gaming, playtron wallet, off-device play, on-device play, dApp kit, migrate off-device to on-device, migrate on-device to off-device ]
---

<ImportContent source="haneulplay.mdx" mode="snippet" />

The HaneulPlay0X1 is one part of a larger ecosystem of Haneul gaming. Users might play your game for the first time on the device, and later decide to continue playing your game on PC. Or, they might have already played your game before on PC with their own mnemonic wallet and want to continue playing on the device.
...
- Integrate Haneul dApp Kit in your off-device version.
- Enable Playtron wallet as connection option.
- Users can seamlessly continue with same wallet across platforms.

:::info

The Playtron wallet is portable and can connect to any dApp using the Haneul dApp Kit.
...
If you are using a game-specific zkLogin wallet, a properly configured [Enoki Connect](https://docs.enoki.haneul-labs.com/enoki-connect) can link your game-specific zkLogin wallet with the Playtron wallet.  
...
<RelatedLink href="https://wallet.playtron.one) (in development" label="Companion web application" desc="Support linking the Playtron wallet to other self-custodied wallets using Haneul Link, enabling read-access of associated wallets while on the device." />
