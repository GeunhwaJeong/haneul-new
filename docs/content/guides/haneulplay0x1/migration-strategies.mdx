...
<RelatedLink href="https://wallet.playtron.one" label="Companion web application" desc="Support linking the Playtron wallet to other self-custodied wallets using Haneul Link, enabling read-access of associated wallets while on the device." />
