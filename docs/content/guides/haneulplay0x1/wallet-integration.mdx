...
A companion web application is in development to support linking the Playtron wallet to other self-custodied wallets using Haneul Link, enabling read-access of associated wallets while on the device.
