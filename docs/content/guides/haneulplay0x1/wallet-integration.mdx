...
<RelatedLink href="https://wallet.playtron.one" label="Companion web application" desc="Support linking the Playtron wallet to other self-custody wallets using HaneulLink, enabling read-access of associated wallets while on the device." />
