...
A HaneulLink connection is automatically established for HaneulPlay0X1 users onboarded in the Playtron wallet app. You can query a user's HaneulLink objects to validate that they own a specific asset. For more information, refer to our [separate guide on using HaneulLink](/guides/developer/wallets/haneullink.mdx).
