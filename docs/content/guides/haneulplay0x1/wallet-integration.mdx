...
keywords: [ self-custodial wallets, zkLogin wallets, Playtron wallets, custodial wallets, wallet integrations, integrate with a wallet, haneulplay0x1, integrate wallet with haneulplay0x1, integrate with haneulplay0x1, haneul link, haneullink, enoki, soulbound, nfts  ]
mdx:
  format: md
---
...
- [Companion web application](https://wallet.playtron.one) (in development): Support linking the Playtron wallet to other self-custody wallets using HaneulLink, enabling read-access of associated wallets while on the device.
