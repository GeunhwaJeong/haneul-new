...
A withdrawal (un-stake) request is processed immediately as soon as it is received. The staker obtains the originally deposited HANEUL together with all accrued stake rewards up to the previous epoch boundary, meaning they do not include stake rewards for the current epoch.
