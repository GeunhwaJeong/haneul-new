...
The default GraphQL RPC configuration is provided in the `examples` directory of the Haneul repo.

<ImportContent source="/examples/prod-config/graphql.toml" mode="code" />
|-----------------------------------------------------------------------------------------------|-----------------------------------|
| [`graphql.toml`](https://github.com/GeunhwaJeong/haneul/blob/main/examples/prod-config/graphql.toml) | Default GraphQL API configuration |
...
<RelatedLink
	href="https://github.com/GeunhwaJeong/haneul/tree/main/crates/haneul-indexer-alt"
	label="Haneul Indexer Alt"
	desc="The `haneul-indexer-alt` crate in the Haneul repo."
/>
<RelatedLink
	href="https://github.com/GeunhwaJeong/mvr/tree/main/crates/mvr-indexer"
	label="Move Registry"
	desc="The indexer that the Move Registry (MVR) implements."
/>
<RelatedLink
	href="https://github.com/GeunhwaJeong/deepbookv3/tree/main/crates/indexer"
	label="DeepBook Indexer"
	desc="The indexer that DeepBook implements."
/>
<RelatedLink
	href="/references/haneul-api/haneul-graphql/beta/reference"
