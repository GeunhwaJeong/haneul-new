...
Haneullabs operated buckets. In order to access the Haneullabs operated buckets you'll need to configure the `awscli` with any set of valid credentials.

Testnet: `s3://haneullabs-testnet-snapshots/`
Mainnet: `s3://haneullabs-mainnet-snapshots/`
