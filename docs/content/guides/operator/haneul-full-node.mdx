...
You must enable gRPC support on your full nodes. JSON-RPC is **deprecated**. Refer to [Haneul's data serving roadmap](/guides/developer/haneul-101/data-serving.mdx#grpc-api) for guidance on the overall transition plan.
