...
keywords: [ update a full node, update full node, update node, haneul release schedule, release schedule, release process, how to update node, when should nodes be updated, when are updates released ]
---

## Haneul release process

Each Haneul network is deployed on a consistent schedule. There are extenuating circumstances that might delay releases occasionally, but these delays are rare and communicated through [official channels](#communication).
...
For additional details, see each network's [release schedule and configuration](https://haneul.io/networkinfo).
...
Releases are announced on [Haneul Discord server](https://discord.com/invite/haneul) and [node-operators](https://groups.google.com/a/groups.haneul.io/g/node-operators) Google group.
