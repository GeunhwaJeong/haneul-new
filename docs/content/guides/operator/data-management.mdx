...
![Basic Haneul full node functionality](./images/basic-functionality_data-management_v1.png "A diagram that shows the operations of a basic Haneul full node.")
...
* **General metadata**, such as `haneul_getProtocolConfig` and `haneul_getChainIdentifier`. These requests don't depend on additional indexing and don't require historic data to process.
