...
With a policy now available onchain, you need a package to upgrade. If you don't have a package available, use the `haneul move new` command to create the template for a new package called `example`.
