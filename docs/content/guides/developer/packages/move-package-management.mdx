...
You can also publish or upgrade using the `haneul client ptb` command. See [Building Programmable Transaction Blocks](/guides/developer/haneul-101/building-ptb.mdx) for details.
