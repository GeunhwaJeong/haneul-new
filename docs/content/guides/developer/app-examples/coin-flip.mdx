...
- [x] [Deployed the complete `satoshi_flip` Move package](#smart-contracts) and understand its design.

- [x] Installed [`pnpm`](https://pnpm.io/installation) or [`yarn`](https://classic.yarnpkg.com/lang/en/docs/install/#mac-stable) to use as the package manager.
