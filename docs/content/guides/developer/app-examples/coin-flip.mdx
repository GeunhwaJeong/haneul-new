...
To expose the backend you have created to your users, you need a frontend (UI). In this section, you create a React frontend project using the [Haneul Typescript SDK](https://sdk.haneul-labs.com/typescript) and the [Haneul dApp Kit](https://sdk.haneul-labs.com/dapp-kit) that interacts with the deployed smart contracts.
...
First, initialize your frontend project. To do this rapidly, use the [`create-dapp` tool](https://sdk.haneul-labs.com/dapp-kit/create-dapp) to bootstrap the project using [dApp Kit](https://sdk.haneul-labs.com/dapp-kit). Run the following command in your terminal or console:
