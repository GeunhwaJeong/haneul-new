...
{@inject: github:HaneulLabs/ts-sdks/packages/create-dapp/templates/react-e2e-counter/move/counter/Move.toml}
...
{@inject: github:HaneulLabs/ts-sdks/packages/create-dapp/templates/react-e2e-counter/move/counter/sources/counter.move#struct=Counter noComments}

- The `Counter` type stores the address of its `owner`, its current `value`, and its own `id`.

### Creating `Counter`

{@inject: github:HaneulLabs/ts-sdks/packages/create-dapp/templates/react-e2e-counter/move/counter/sources/counter.move#fun=create noComments}
...
{@inject: github:HaneulLabs/ts-sdks/packages/create-dapp/templates/react-e2e-counter/move/counter/sources/counter.move#fun=increment noComments}

The `increment` function accepts a mutable reference to any shared `Counter` object and increments its `value` field.

{@inject: github:HaneulLabs/ts-sdks/packages/create-dapp/templates/react-e2e-counter/move/counter/sources/counter.move#fun=set_value noComments}
...
Learn more about taking [object references as input](../../../concepts/haneul-move-concepts.mdx#entry-points)
...
{@inject: github:HaneulLabs/ts-sdks/packages/create-dapp/templates/react-e2e-counter/move/counter/sources/counter.move noComments}
...
<details>
  ...
  {@inject: github:HaneulLabs/ts-sdks/packages/create-dapp/templates/react-e2e-counter/src/networkConfig.ts noComments}
</details>
...
<details>
  ...
  {@inject: github:HaneulLabs/ts-sdks/packages/create-dapp/templates/react-e2e-counter/src/CreateCounter.tsx noComments}
</details>
...
<details>
  ...
  {@inject: github:HaneulLabs/ts-sdks/packages/create-dapp/templates/react-e2e-counter/src/Counter.tsx noComments}
</details>
...
<details>
  ...
  {@inject: github:HaneulLabs/ts-sdks/packages/create-dapp/templates/react-e2e-counter/src/App.tsx noComments}
</details>
