...
{@inject: ./ts-sdk-ref/move/counter/Move.toml}
...
{@inject: ./ts-sdk-ref/move/counter/sources/counter.move#struct=Counter noComments}

- The `Counter` type stores the address of its `owner`, its current `value`, and its own `id`.

### Creating `Counter`

{@inject: ./ts-sdk-ref/move/counter/sources/counter.move#fun=create noComments}
...
{@inject: ./ts-sdk-ref/move/counter/sources/counter.move#fun=increment noComments}

The `increment` function accepts a mutable reference to any shared `Counter` object and increments its `value` field.

{@inject: ./ts-sdk-ref/move/counter/sources/counter.move#fun=set_value noComments}
...
{@inject: ./ts-sdk-ref/move/counter/sources/counter.move noComments}
...
{@inject: ./ts-sdk-ref/src/networkConfig.ts noComments}
...
{@inject: ./ts-sdk-ref/src/CreateCounter.tsx noComments}
...
{@inject: ./ts-sdk-ref/src/Counter.tsx noComments}
...
{@inject: ./ts-sdk-ref/src/App.tsx noComments}
