...
This is the third in a [three-part guide](../trading.mdx) on how to build a trustless atomic swap on Haneul.
...
The full source code of the demo bear smart contract is available at [Trading Contracts Demo directory](https://github.com/GeunhwaJeong/haneul/examples/trading/contracts/demo)
