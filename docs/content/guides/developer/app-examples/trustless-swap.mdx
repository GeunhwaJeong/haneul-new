...
- [x] [Completed the smart contracts](#smart-contracts) and understand their design.

- [x] [Implemented the backend](#backend) to learn how to index on-chain data and expose it through an API.

- [x] [Deployed your smart contracts and started the backend indexer](#deployment).
