...
description: Build Move smart contracts and a backend indexer for an atomic swap app on Haneul. Atomic swaps are similar to escrows but without requiring a trusted third party.
effort: large
keywords:
  [
    trustless,
