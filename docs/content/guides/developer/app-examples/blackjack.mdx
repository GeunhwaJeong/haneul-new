...
- **Randomness and fair play:** Both games emphasize randomness for fairness. Both games use Haneul's [on-chain randomness module](/guides/developer/advanced/randomness-onchain.mdx), ensuring verifiable and truly random outcomes for every game.
