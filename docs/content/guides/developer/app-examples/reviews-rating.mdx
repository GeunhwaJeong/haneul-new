...
<RelatedLink href="https://github.com/GeunhwaJeong/haneul/tree/main/examples/move/reviews_rating" label="Reviews Rating repository" desc="Repo with the Revies Rating codebase." />
