...
The most basic unit of storage on Haneul is an [_object_](/concepts/object-model.mdx). Other blockchains typically structure storage using key-value stores. Haneul centers storage around objects with unique ID addresses on-chain. Every Haneul smart contract is an object that manipulates other objects.
...
```
$ git clone https://github.com/GeunhwaJeong/haneul-stack-hello-world.git
...
<div className="next-steps-module">
  ...
  <div className="next-steps-grid">
    <Card className="plausible-event-name=hello+data+button"
      ...
      href="/guides/developer/haneul-101/data-serving"
    >
