...
The `App.tsx` file contains code that creates a basic starter template for your React dApp. It includes a button to connect a Slush wallet to the dApp and a button to open the Haneul Faucet to obtain Testnet HANEUL. 
...
Follow the [Testnet HANEUL](/guides/developer/getting-started/get-coins.mdx) instructions to send Testnet tokens to your Slush address. 
...
[Obtain Testnet HANEUL](/guides/developer/getting-started/get-coins.mdx) or [confirm you have the correct Move package ID](/guides/developer/getting-started/hello-world.mdx) to resolve these errors.
