...
After you install VS Code and the `move-analyzer` extension, see the [haneul_programmability](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/examples) for Move code examples.
...
- [examples](https://github.com/GeunhwaJeong/haneul/tree/main/examples): Contains examples of smart contracts written in Move.
...
- [haneul_programmability/examples](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/examples): Contains lots of Move code examples, partitioned by category, that are provided for demonstration purposes only.
...
- [haneul_programmability](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/examples) - Move code examples.
