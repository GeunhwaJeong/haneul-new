...
description: Get the background information you need before you start developing on Haneul. Learn the layout of the Haneul monorepository and the suggested development environment for working with Move.
---
...
The recommended IDE for Move development is Visual Studio Code with the Move extension [available](https://marketplace.visualstudio.com/items?itemName=haneullabs.move) in the Visual Studio Marketplace. Follow the Visual Studio Marketplace instructions to install the extension.
...
- [apps](https://github.com/GeunhwaJeong/haneul/tree/main/apps): Contains the source code for the main web applications that Haneul Labs runs, `Haneul Wallet`.
