...
The Haneul Testnet and Devnet networks consist of four validator nodes operated by Haneul Labs. Clients send transactions and read requests via this endpoint: `https://fullnode.<HANEUL-NETWORK-VERSION>.haneul.io:443` using [JSON-RPC](/references/haneul-api/json-rpc-format.mdx).
