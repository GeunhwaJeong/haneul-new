...
<RelatedLink href="https://haneul-testnet.haneul-labs.com/graphql" label="Haneul Testnet GraphiQL" desc="Haneul GraphiQL IDE for the Testnet network." />
<RelatedLink href="https://haneul-mainnet.haneul-labs.com/graphql" label="Haneul Mainnet GraphiQL" desc="Haneul GraphiQL IDE for the Mainnet network." />
