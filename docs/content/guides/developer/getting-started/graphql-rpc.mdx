...
The quickest way to access the Haneul GraphQL service is through the online IDE that provides a complete toolbox for fetching data and executing transactions on the network. The online IDE provides
...
The online IDE is available for [mainnet](https://haneul-mainnet.haneul-labs.com/graphql) and [testnet](https://haneul-testnet.haneul-labs.com/graphql).
...
Many examples can also be found in the [repository](https://github.com/GeunhwaJeong/haneul/tree/main/crates/haneul-graphql-rpc/examples). For example, in that folder you can find examples on [transaction block effects](https://github.com/GeunhwaJeong/haneul/tree/main/crates/haneul-graphql-rpc/examples/transaction_block_effects), [protocol configs](https://github.com/GeunhwaJeong/haneul/tree/main/crates/haneul-graphql-rpc/examples/protocol_configs), [stake connection](https://github.com/GeunhwaJeong/haneul/tree/main/crates/haneul-graphql-rpc/examples/stake_connection), and more. Each folder contains one or more examples that you can use in your queries.
