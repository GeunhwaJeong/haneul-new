...
Now that you have Haneul installed, it's time to start developing. Checkout the following topics to start working with Haneul:

- [Get coins](./get-coins.mdx) - Get some coins on a development network to start using Haneul.
- [Connect to a Haneul network](./connect.mdx) - Learn about the available networks and connect to one.
- [Haneul CLI](/references/cli.mdx) - The Haneul CLI is the most straightforward way to start exploring Haneul networks.
- [Build your first dApp](../first-app.mdx) - You have Haneul, time to start your on-chain journey.