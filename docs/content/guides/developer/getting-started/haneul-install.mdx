...
You can install the extension either by searhing the fully-qualified extension name, `Haneullabs.move`, in the extension view, or by pressing `Ctrl-P` or `Cmd-P` and typing `ext install haneullabs.move`.
