...
## Install using Haneul binaries {#install-binaries}
...
### Install Haneul binaries from source {#install-haneul-binaries-from-source}

Run the following command to install Haneul binaries from the `testnet` branch:

```shell
cargo install --locked --git https://github.com/GeunhwaJeong/haneul.git --branch testnet haneul
```
