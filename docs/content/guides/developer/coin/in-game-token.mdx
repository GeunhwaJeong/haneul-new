...
<RelatedLink href="https://github.com/GeunhwaJeong/haneul/blob/main/examples/move/token/sources/gems.move" label="Source code" desc="The source code in GitHub for this example." />
