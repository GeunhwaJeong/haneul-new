...
{@inject: ../../../../../examples/move/token/sources/loyalty.move#struct=LOYALTY}
...
- [Source code](https://github.com/GeunhwaJeong/haneul/blob/main/../../../../../examples/move/token/sources/loyalty.move): The source code in GitHub for this example.
