...
To learn about the features available, see the [Coin standard](../../../standards/coin.mdx) documentation and the `coin` module in the <UnsafeLink href="/references/framework/haneul/coin">Haneul framework</UnsafeLink>.
...
<ImportContent source="crates/haneul-framework/packages/haneul-framework/sources/coin.move" mode="code" fun="mint" />
...
<ImportContent source="crates/haneul-framework/packages/haneul-framework/sources/coin.move" mode="code" fun="mint_balance" />
...
<ImportContent source="crates/haneul-framework/packages/haneul-framework/sources/coin.move" mode="code" fun="mint_and_transfer" />
...
<ImportContent source="crates/haneul-framework/packages/haneul-framework/sources/coin.move" mode="code" fun="burn" />
...
<RelatedLink href="https://github.com/GeunhwaJeong/haneul/tree/main/examples/regulated-coin" label="Source code" desc="The source code in GitHub for this example." />
