...
The regulated coin example is in the `examples/regulated-coin` directory of the Haneul repo. The example provides both TypeScript- and Rust-based command line access to an onchain package that demonstrates some of the features of regulated coins on Haneul.
