---
title: Using gRPC
description: Learn how to use gRPC clients for the Haneul network with grpcurl, Buf CLI, and popular programming languages.
keywords: [ grpc, grpc client, grpcurl, typescript grpc, golang grpc, python grpc, haneul grpc tutorial ]
---

This guide provides practical examples for querying the Haneul network using gRPC. For core concepts, see the [corresponding concepts page](/concepts/data-access/grpc).

<Tabs className="tabsHeadingCentered--small">
<TabItem value="prereq" label="Prerequisites">

Before you begin, ensure you have access to a [gRPC](/concepts/data-access/grpc)-enabled Haneul full node. Check the [list of RPC and data providers](https://www.notion.so/haneullabs/RPC-providers-offering-future-Haneul-data-primitives-2466d9dcb4e980a99a36e9aafd8c17e0?source=copy_link) that support gRPC on their full nodes, and contact a provider directly to request access.

If your provider doesn't yet support gRPC, you can:

- Ask them to enable it.

- Reach out to the Haneul Foundation team on Discord or Telegram for help.
...
This example shows how to build a TypeScript client for the Haneul gRPC API. 
...
This example shows how to build a Go client for the Haneul gRPC API. 
...
This example shows how to build a Python client for the Haneul gRPC API. Optionally, refer to [`pyhaneul`](https://github.com/FrankC01/pyhaneul/), a community contributed SDK.
...
<RelatedLink to="/references/fullnode-protocol" label="Haneul gRPC proto spec" />
<RelatedLink to="/guides/operator/haneul-full-node#considerations-to-enable-grpc" label="Configuration options to enable gRPC on your full node" />
<RelatedLink to="/concepts/data-access/grpc.mdx" label="Haneul gRPC overview" />
