...
Switch any apps that still use the GraphQL Alpha endpoints (`https://graphql.mainnet.haneul.io/graphql`, `https://haneul-testnet.haneul-labs.com/graphql`, and `https://haneul-devnet.haneul-labs.com/graphql`) as soon as possible. Migrate your apps to the GraphQL Beta endpoints to avoid disruption of service.
