...
Refer to [Custom Indexing Framework](/guides/developer/accessing-data/custom-indexing-framework.mdx) and [Indexer Pipeline Architecture](/guides/developer/accessing-data/pipeline-architecture.mdx) for a conceptual overview of the indexer framework.
...
- [x] Read the [Custom Indexing Framework](/guides/developer/accessing-data/custom-indexing-framework.mdx) and [Indexer Pipeline Architecture](/guides/developer/accessing-data/pipeline-architecture.mdx) topics first to understand the overall architecture and concurrent pipeline concepts.
...
Use the `cargo run` command to run your indexer against Testnet. You can choose from multiple checkpoint data sources (see [Checkpoint Data Sources](/guides/developer/accessing-data/custom-indexer/indexer-data-integration.mdx#checkpoint-data-sources) for details):
