...
You can use the [custom indexer framework](/guides/developer/accessing-data/custom-indexing-framework) to extend the existing functionality of Walrus.
...
<RelatedLink href="https://github.com/GeunhwaJeong/haneul/tree/main/examples/rust/walrus-attributes-indexer" label="Indexer with Walrus example files" desc="Directory in the Haneul repo containing the files for this example." />
