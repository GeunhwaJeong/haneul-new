...
The framework tracks extensive metrics across ingestion, pipeline processing, database operations, and watermark management. For a complete list of available metrics with descriptions, refer to the `IndexerMetrics` struct in [`haneul-indexer-alt-framework/src/metrics.rs`](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-indexer-alt-framework/src/metrics.rs).
