...
- Incorporate a [custom indexer](/guides/developer/accessing-data/custom-indexing-framework.mdx) to take advantage of Haneul's micro-data ingestion framework.
