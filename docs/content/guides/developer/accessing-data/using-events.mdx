...
- Incorporate a [custom indexer](/guides/developer/accessing-data/custom-indexer.mdx) to take advantage of Haneul's micro-data ingestion framework.
...
<RelatedLink to="/guides/developer/accessing-data/custom-indexer.mdx" />
