...
Sequential and concurrent pipeline types and their trade-offs are detailed in [Pipeline Architecture](/guides/developer/accessing-data/pipeline-architecture.mdx).
