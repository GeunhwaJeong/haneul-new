...
- [NFT Rental example](https://github.com/GeunhwaJeong/haneul/tree/main/examples/move/nft-rental): The source code that this document references.
- [Haneul Kiosk](../../../standards/kiosk.mdx): Kiosk is a decentralized system for commerce applications on Haneul.
- [Kiosk Apps](../../../standards/kiosk-apps.mdx): The Kiosk Apps standard extends the functionality of Haneul Kiosk.  
