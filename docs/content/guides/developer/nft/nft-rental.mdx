...
- Creator-defined royalties are respected by encompassing [transfer policy rules](/guides/developer/objects/transfers/custom-rules.mdx).
...
<RelatedLink href="https://github.com/GeunhwaJeong/haneul/tree/main/examples/move/nft-rental" label="NFT Rental example" desc="The source code that this document references." />
<RelatedLink to="/standards/kiosk.mdx" />
<RelatedLink to="/standards/kiosk-apps.mdx" />
<RelatedLink to="/guides/developer/objects/transfers/custom-rules.mdx" />
