...
You can find a public facing reference to the WASM library in the [move-binary-format-wasm](https://www.npmjs.com/package/@haneullabs/move-bytecode-template) Haneul repo subfolder.
