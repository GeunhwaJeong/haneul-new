...
For the full specification, see [SIP-58: Haneul Address Balances](https://github.com/haneul-foundation/sips/blob/main/sips/sip-58.md). For implementation details on sending, withdrawing, and paying gas from address balances, see [Using Address Balances](/guides/developer/digital-assets/address-balances/using-address-balances).
...
- Implement manual withdrawal logic as described in [Using Address Balances](/guides/developer/digital-assets/address-balances/using-address-balances).
...
Migration is optional. The SDK automatically selects coins or address balances as needed. To consolidate existing coin objects into an address balance, see [Converting Existing Coins to Address Balances](/guides/developer/digital-assets/address-balances/using-address-balances#converting-existing-coins-to-address-balances) in the usage guide.
