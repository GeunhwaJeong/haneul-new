...
[View the full example](https://github.com/GeunhwaJeong/haneul-move-bootcamp/blob/main/I1) or learn more about the [Coin Standard](https://docs.haneul.io/standards/coin).
...
See [Address Balances Migration Guide](/guides/developer/digital-assets/address-management/migrate-address-balances.mdx) for the full reference on using address balances, including withdrawal patterns, gas payment, sponsored transactions, and balance queries.
...
You can convert coin objects into an address balance at any time by calling `coin::send_funds` with your own address as the recipient. See [Converting Existing Coins to Address Balances](/guides/developer/digital-assets/address-management/migrate-address-balances.mdx#converting-existing-coins-to-address-balances) for instructions.
