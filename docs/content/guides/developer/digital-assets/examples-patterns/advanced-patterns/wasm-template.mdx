...
The output format is similar to the template module but smaller in length. Copy this output and paste it in the bytecode constant variable located in the [genesis_bytecode.ts](https://github.com/GeunhwaJeong/asset-tokenization/blob/main/setup/src/utils/genesis_bytecode.ts) file.
