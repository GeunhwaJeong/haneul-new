...
- Follow the [Move conventions](/guides/developer/move-best-practices.mdx) for consistent naming and coding style.
...
- Avoid “self-transfers." When possible, return the object from the current function, so it can be used in a different command in a [programmable transaction block](/guides/developer/transactions/ptbs/building-ptb).
