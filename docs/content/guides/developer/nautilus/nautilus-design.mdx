...
As an app developer, follow these steps to deploy a self-managed TEE. Alternatively, you can use the [Marlin Oyster marketplace](/guides/developer/nautilus/community-dev-tools) for Docker-based simplicity.
