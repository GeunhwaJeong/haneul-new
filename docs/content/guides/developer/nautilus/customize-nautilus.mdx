...
The Nautilus server logic is located in the directory [`src/nautilus-server`](https://github.com/GeunhwaJeong/nautilus/tree/main/src/nautilus-server). To customize the application, refer to the [Using Nautilus guide](/guides/developer/nautilus/using-nautilus.mdx) as a template.

:::info 

These customization, testing, and management steps are for self-managed TEEs. Alternatively, you can use the [Marlin Oyster marketplace](/guides/developer/nautilus/community-dev-tools) for Docker-based simplicity that removes testing and management overhead.
