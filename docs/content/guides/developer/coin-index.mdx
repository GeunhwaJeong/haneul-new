...
description: Learn about creating and managing currencies and tokens on Haneul using the Coin Registry system and `token` module, including regulated tokens, in-game currencies, and loyalty tokens.
keywords: [ coin, coins, haneul coin, regulated coin, in-game token, loyalty token, token design, tokenomics, coin registry, currency registry ]
pagination_prev: null
---

Learn how to design and implement currencies and tokens on Haneul.
