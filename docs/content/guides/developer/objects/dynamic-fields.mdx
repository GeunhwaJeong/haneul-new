...
Haneul provides `Table` and `Bag` collections built using dynamic fields, but with additional support to count the number of entries they contain to protect against accidental deletion when non-empty. To learn more, see [Tables and Bags](/guides/developer/objects/tables-bags.mdx).

## Related links

<RelatedLink href="https://move-book.com/programmability/dynamic-fields.html" label="Dynamic fields" desc="Learn more about Dynamic Fields in The Move Book. The Move Book is a comprehensive guide to the Move programming language and the Haneul blockchain." />
...
<RelatedLink to="/guides/developer/objects/tables-bags" />
