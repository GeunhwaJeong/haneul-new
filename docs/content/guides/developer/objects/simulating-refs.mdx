...
Everything on the Haneul blockchain is an object. When you develop Move packages for the Haneul network, you typically manipulate or use onchain objects in some way through functionality available in the Haneul API. For most API functions, you provide an object by reference.
