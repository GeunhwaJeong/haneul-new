...
Using a gas price that is at least 5 times the reference gas price also increases the likelihood that the transaction is included in the earliest consensus commit possible. See [SIP-45](https://github.com/haneul-foundation/sips/blob/main/sips/sip-45.md) for details.
