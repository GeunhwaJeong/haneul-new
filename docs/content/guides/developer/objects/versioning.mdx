...
Objects on Haneul are versioned either through the [fastpath](#fastpath-objects) or through [consensus](/concepts/haneul-architecture/consensus.mdx). The choice affects object ownership options and has performance trade-offs.
...
View the [complete code](https://github.com/GeunhwaJeong/haneul/blob/93e6b4845a481300ed4a56ab4ac61c5ccb6aa008/examples/move/escrow/sources/lock.move) on GitHub.
