...
## How to transfer USDC on Haneul {#usdc-guide}
...
Here's a quickstart guide for developers to build an app to perform their first USDC transfer on Haneul.

### Contract addresses

- [Testnet](https://haneulscan.xyz/testnet/coin/0xa1ec7fc00a6f40db9693ad1415d0c193ad3906494428cf252621037bd7117e29::usdc::USDC)
  ```
  0xa1ec7fc00a6f40db9693ad1415d0c193ad3906494428cf252621037bd7117e29::usdc::USDC
  ```
- [Mainnet](https://haneulscan.xyz/coin/0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC)
  ```
...
- [Haneul Wallet](https://chromewebstore.google.com/detail/haneul-wallet/opcgpfmipidbgpenhmajoajpbobppdil): Install the Haneul Wallet browser extension, set up your wallet, and connect it to the appropriate network. Ensure that your wallet is funded with:
  - Some HANEUL tokens to cover transaction fees. (**Request Testnet HANEUL Tokens** from the **Wallet Settings** page)
...
Install Haneul dependencies next:

```bash
pnpm add @haneullabs/dapp-kit @haneullabs/haneul @tanstack/react-query
```
...
1. Click the **Request Testnet HANEUL Tokens** button from your Haneul Wallet to source gas tokens. The button is visible only when your wallet is connected to Testnet.
