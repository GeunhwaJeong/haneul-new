...
:::info
While this example uses USDC, the same principles can be applied to any asset on Haneul that uses the [Haneul Coin standard](../../standards/coin.mdx).
:::
...
USDC uses the [Haneul Coin standard](../../standards/coin.mdx) and can be used just like any other coin type in the Haneul framework.
...
Use USDC in your [PTBs](/guides/developer/haneul-101/building-ptb) just like any other coin type.
