...
Copy the output you receive and paste it in the return instruction of the `getBytecode` method, which is located inside the [bytecode-template.ts](https://github.com/GeunhwaJeong/asset-tokenization/blob/main/setup/src/utils/genesis_bytecode.ts) file.
