...
- Connects to Haneul Testnet: Uses the remote checkpoint store at https://checkpoints.testnet.haneul.io.
...
- Testnet: `https://checkpoints.testnet.haneul.io`
- Mainnet: `https://checkpoints.mainnet.haneul.io`
...
<ImportContent source="crates/haneul-indexer-alt-framework/src/pipeline/sequential/committer.rs" mode="code" tag="batch" />
...
<ImportContent source="crates/haneul-indexer-alt-framework/src/pipeline/sequential/committer.rs" mode="code" trait="Handler" />
...
Use the `cargo run` command to run your indexer against Testnet. You can choose from multiple checkpoint data sources (see [Checkpoint Data Sources](/guides/developer/advanced/custom-indexer/indexer-data-integration.mdx#checkpoint-data-sources) for details):
...
<RelatedLink href="https://github.com/GeunhwaJeong/haneul/tree/main/crates/haneul-indexer-alt" label="Haneul Indexer Alt" desc="The `haneul-indexer-alt` crate in the Haneul repo." />
<RelatedLink href="https://github.com/GeunhwaJeong/mvr/tree/main/crates/mvr-indexer" label="Move Registry" desc="The indexer that the Move Registry (MVR) implements." />
<RelatedLink href="https://github.com/GeunhwaJeong/deepbookv3/tree/main/crates/indexer" label="DeepBook Indexer" desc="The indexer that DeepBook implements." />
