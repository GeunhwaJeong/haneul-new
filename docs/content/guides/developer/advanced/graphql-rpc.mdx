...
For more details about some concepts used in the following examples, see the [GraphQL concepts](../../../concepts/graphql-rpc.mdx) page. Consult the [GraphQL reference](../../../references/haneul-graphql.mdx) for full documentation on the supported schema.
