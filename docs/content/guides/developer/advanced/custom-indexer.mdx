...
Find more examples of custom ingestion pipelines in the [Haneul repository](https://github.com/GeunhwaJeong/haneul/tree/main/crates/haneul-data-ingestion/src/workers).
