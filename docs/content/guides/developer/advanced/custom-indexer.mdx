...
The checkpoint files are stored in the following format: `https://storage.googleapis.com/haneullabs-testnet-checkpoints/<checkpoint_id>.chk`. You can download the checkpoint file by sending an HTTP GET request to the relevant URL. Try it yourself for checkpoint 1 at [https://storage.googleapis/haneullabs-testnet-checkpoints/1.chk](https://storage.googleapis/haneullabs-testnet-checkpoints/1.chk).
