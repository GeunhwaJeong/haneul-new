...
{@include: ../../../snippets//custom-indexer-source.mdx}
...
Find more examples of custom ingestion pipelines in the Haneul repository:
* Haneul data ingestion daemon that runs internal [pipelines](https://github.com/GeunhwaJeong/haneul/tree/main/crates/haneul-data-ingestion/src/).
* Haneul Name Service's custom [indexer](https://github.com/GeunhwaJeong/haneul/tree/main/crates/haneulns-indexer/src).
