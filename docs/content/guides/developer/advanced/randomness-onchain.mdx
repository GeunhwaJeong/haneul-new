...
See <a href="/references/framework/haneul-framework/random" data-noBrokenLinkCheck='true'>random.move</a> for the Move APIs for accessing randomness on Haneul.
