...
See [random_nft](https://github.com/GeunhwaJeong/haneul/blob/main/examples/move/random/random_nft) for examples.
...
- [Randomness NFT example](https://github.com/GeunhwaJeong/haneul/blob/main/examples/move/random/random_nft)
- [Raffle example](https://github.com/GeunhwaJeong/haneul/blob/main/examples/move/random/raffles)
