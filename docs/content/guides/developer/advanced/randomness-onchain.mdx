...
`Random` has a reserved address `0x8`. See <UnsafeLink href="/references/framework/haneul-framework/haneul_haneul/random">random.move</UnsafeLink> for the Move APIs for accessing randomness on Haneul.
