...
<ImportContent source="crates/haneul-protocol-config/src/lib.rs" mode="code" struct="ProtocolConfig" />
...
<RelatedLink href="https://docs.haneul.io/references/framework/haneul_haneul/random" label="random.move" desc="Documentation for the `random` module." />
<RelatedLink href="https://github.com/GeunhwaJeong/haneul/blob/main/examples/move/random/raffles" label="Raffle example" desc="GitHub repo containing a raffle smart contract demonstrating randomness." />
