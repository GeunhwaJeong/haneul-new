...
For more information on the Haneul TypeScript SDK, see the [Haneul TypeScript SDK documentation](https://haneul-typescript-docs.vercel.app/typescript).

## What is dApp Kit?

dApp Kit (@haneullabs/dapp-kit) is a collection of React hooks, components, and utilities that make building dApps on Haneul straightforward. For more information on dApp Kit, see the [dApp Kit documentation](https://haneul-typescript-docs.vercel.app/dapp-kit).
