...
- **[addresses]:** Declares named addresses that your package uses. By default, the section includes the package you create with the `haneul move new` command and an address of `0x0`. The publish process replaces the `0x0` address with an actual on-chain address.
