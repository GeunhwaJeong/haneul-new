...
`new_sword` function signature change. The changes required for the tests to run again is an exercise left for you. If you need help, you can refer to the source code for the package (with all the tests properly adjusted) in [first_package](https://github.com/GeunhwaJeong/haneul/tree/main/examples/move/first_package/sources/example.move).
