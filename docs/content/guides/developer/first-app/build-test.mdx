...
Haneul includes support for the Move testing framework that enables you to write unit tests that analyze Move code much like test frameworks for other languages (for example, the built-in Rust testing framework or the JUnit framework for Java).
...
Now that you have built a tested package, the next topic walks you through publishing your package to a Haneul network.
