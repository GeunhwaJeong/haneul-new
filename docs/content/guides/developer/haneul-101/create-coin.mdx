...
Publishing a coin on Haneul is nearly as straightforward as publishing a new type. The main difference is the requirement of a [one-time witness](/concepts/haneul-move-concepts/one-time-witness.mdx) when creating a coin.
