...
Everything on the Haneul blockchain is an object. When you develop Move packages for the Haneul network, you're typically manipulating or using on-chain objects in some way through functionality available in the Haneul API. For most API functions, you provide an object by reference.
