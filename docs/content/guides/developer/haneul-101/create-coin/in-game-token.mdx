...
```move title="haneul/examples/move/token/sources/gems.move"
...
module examples::sword {
    ...
    use haneul::token::{Self, Token, ActionRequest};
...
/// HANEUL and used to buy swords (in the `sword` module).
module examples::gem {
    use std::option::none;
    ...
    /// 10 HANEUL is the price of a small bundle of Gems.
    const SMALL_BUNDLE: u64 = 10_000_000_000;
    const SMALL_AMOUNT: u64 = 100;

    /// 100 HANEUL is the price of a medium bundle of Gems.
    const MEDIUM_BUNDLE: u64 = 100_000_000_000;
    const MEDIUM_AMOUNT: u64 = 5_000;

    /// 1000 HANEUL is the price of a large bundle of Gems.
    ...
    /// constants...
    public fun buy_gems(
        self: &mut GemStore, payment: Coin<HANEUL>, ctx: &mut TxContext
