...
- Inadvertent logic traps in smart contract code, for example, when handling [sponsored transactions](/guides/developer/haneul-101/sponsor-txn#client-equivocation-risk).
