...
### `Locked<T>` and `Key`
[Code Sample](https://github.com/GeunhwaJeong/haneul/blob/main/examples/move/escrow/sources/lock.move)
...
[Code Sample](https://github.com/GeunhwaJeong/haneul/blob/main/examples/move/escrow/sources/owned.move)
