...
description: On Haneul, you can use shared objects, owned objects, or both in your programmable transaction blocks. Weigh the benefits of each to decide the best approach for your project. 
---
...
In other blockchains every object is shared. On Haneul, however, you often have the choice to implement a particular use case with either shared objects, owned objects, or a combination of the two. The choice of which object type to use can have implications for performance, security, and implementation complexity. For example, you should avoid using a shared object for objects that you expect high contention over. This might be unavoidable, though, based on increased complexity of the implementation, or because of security or liveness implications.
