...
{@inject: crates/haneul-graphql-rpc/examples/event_connection/event_connection.graphql}
</details>
...
{@inject: crates/haneul-graphql-rpc/examples/event_connection/filter_by_sender.graphql}
</details>
