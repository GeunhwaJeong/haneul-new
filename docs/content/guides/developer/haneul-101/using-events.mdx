...
https://haneulexplorer.com/txblock/bZnc1E7k1fJYLxWihfre5xCw1tX1CyAN6579zypJeiU

Here's an example of a transaction that is using the original `dee9` package.
https://haneulexplorer.com/txblock/896CKHod5GQ4kzhF7EwTAGyhQBdaTb9rQS41dcL76gj8
...
To create the event subscription, you can use a basic Node.js app. You need the Haneul TypeScript SDK, so install the module using `npm install @haneullabs/haneul.js` at the root of your project. In your TypeScript code, import `JsonRpcProvider` and a connection from the library.
