...
On Haneul, everything is an object. Moreover, in Haneul, everything is a non-fungible token (NFT) as its objects are unique, non-fungible, and owned. So technically, a basic type publishing is enough to create a specific NFT.
