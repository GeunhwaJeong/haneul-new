...
This guide continues from [Data Storage Using Walrus](/haneul-stack/walrus-seal/haneul-stack-walrus) and builds on the same [OnlyFins](https://github.com/GeunhwaJeong/onlyfins-example-app) app. The Walrus guide covers how OnlyFins stores and reads images. This guide covers how it protects them: encrypting images before upload and enforcing onchain access control so only authorized users can decrypt them.

By the end of this guide, you understand how to design a [Seal](https://seal-docs.wal.app/) access control policy in [Move](/develop/write-move/haneul-move-concepts), how to encrypt data before uploading it to [Walrus](https://docs.wal.app/), and how to implement the full client-side decryption flow in a browser app.
