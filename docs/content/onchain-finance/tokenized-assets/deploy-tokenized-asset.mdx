...
- [x] [Install Haneul](/getting-started/onboarding/haneul-install)
- [x] [Configure a Haneul client](/getting-started/onboarding/configure-haneul-client)
- [x] [Get HANEUL from faucet](/getting-started/onboarding/get-coins)
...
<ImportContent source="initialize-haneul-client-cli" mode="snippet" />
