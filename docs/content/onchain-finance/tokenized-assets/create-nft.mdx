...
On Haneul, both NFTs and [tokenized assets](/onchain-finance/tokenized-assets/asset-tokenization) are objects. The protocol does not distinguish between them. The difference is in how you design your smart contract.
