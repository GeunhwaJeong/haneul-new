...
description: A Pool is a shared object that represents a unique market pair, such as HANEUL/USDC. 
...
The `Pool` shared object represents a market, such as a HANEUL/USDC market. That `Pool` is the only one representing that unique pairing (HANEUL/USDC) and the pairing is the only member of that particular `Pool`. See [DeepBookV3 Design](/onchain-finance/deepbookv3/design#pool) to learn more about the structure of pools.
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="whitelisted" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_quote_quantity_out" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_base_quantity_out" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_quote_quantity_out_input_fee" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_base_quantity_out_input_fee" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_quantity_out" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_order_deep_required" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="mid_price" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="account_open_orders" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_level2_range" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_level2_ticks_from_mid" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="vault_balances" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_pool_id_by_asset" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_order" noComments />

Returns a vector of `Order` structs using a vector of order IDs.

<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_orders" noComments />

Returns a vector of `Order` structs for all orders that belong to a `BalanceManager` in the pool.

<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_account_order_details" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="locked_balance" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="pool_trade_params" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="pool_trade_params_next" noComments />

Returns the quorum needed to pass proposal in the current epoch.

<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="quorum" noComments />

Returns the book parameters for the pool (`tick_size`, `lot_size`, `min_size`).

<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="pool_book_params" noComments />

Returns the `OrderDeepPrice` struct for the pool, which determines the conversion for DEEP fees.

<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_order_deep_price" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_base_quantity_in" noComments />

Dry run to determine the quote quantity needed to receive a given base quantity out.

<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="get_quote_quantity_in" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="can_place_limit_order" noComments />

Check if a market order can be placed with the given parameters. Returns `true` if the order can be placed, `false` otherwise.

<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="can_place_market_order" noComments />

Validate limit order parameters and return detailed error information if invalid.

<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="check_limit_order_params" noComments />

Validate market order parameters and return detailed error information if invalid.

<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="check_market_order_params" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="stable_pool" noComments />

Check if the pool is registered in the registry.

<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="registered_pool" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="account_exists" noComments />

Get the `Account` struct for a `BalanceManager` in the pool.

<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="account" noComments />
