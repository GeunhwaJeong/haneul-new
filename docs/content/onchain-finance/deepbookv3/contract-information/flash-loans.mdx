---
title: Flash Loans
description: Use DeepBookV3 to perform flash loans, uncollateralized loans that are borrowed and repaid within the same programmable transaction block.
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="borrow_flashloan_base" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="borrow_flashloan_quote" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="return_flashloan_base" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="HaneulLabs" repo="deepbookv3" fun="return_flashloan_quote" noComments />
