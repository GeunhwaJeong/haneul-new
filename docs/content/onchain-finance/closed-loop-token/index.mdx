...
The [Currency Standard](/onchain-finance/fungible-tokens/currency) on Haneul is an example of an open-loop system. Coins are free-flowing, [wrappable](/develop/objects/object-ownership/wrapped), [freely transferable](/develop/objects/transfers/custom-rules), and you can store them in any application.
