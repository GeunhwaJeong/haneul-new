...
2. **Only prompt when necessary**: Call `connect()` only when:
   ...
   - The current accounts don't meet your requirements (for example, you need an account on a specific chain)
...
Subscribe your app to events with the following call:
