...
To use Ledger with Haneul, install the Haneul app on your Ledger device through [Ledger Wallet](https://shop.ledger.com/pages/ledger-wallet). Connect your Ledger device to a wallet such as Ledger Wallet or a compatible Haneul wallet such as [Slush](/onchain-finance/asset-custody/wallets/slush).
