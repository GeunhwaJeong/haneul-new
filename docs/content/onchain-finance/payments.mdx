---
title: Payments
description: "Accept payments, manage balances, and handle transaction fees on Haneul."
---
...
description: 'Overview of address balance management on Haneul.', 
},
{
type: 'link',
...
description: 'Overview of transaction payment options on Haneul.',
}, 
{
type: 'link',
...
description: 'The Haneul Payment Kit is a robust, open-source payment processing toolkit that provides secure payment verification, receipt management, and duplicate prevention for applications built on the Haneul blockchain.',
},
]} />
