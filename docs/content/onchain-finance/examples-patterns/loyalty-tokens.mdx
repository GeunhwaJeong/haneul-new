...
Using the Haneul [Closed-Loop Token](/onchain-finance/closed-loop-token) standard, you can create tokens that are valid only for a specific service, like an airline that wants to grant tokens to frequent flyers to purchase tickets or upgrades.
...
[View the full example on GitHub](https://github.com/GeunhwaJeongLabs/haneul/tree/main/examples/move/token/sources/loyalty.move).
