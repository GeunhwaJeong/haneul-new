...
<ImportContent source="packages/deepbook-v3/src/transactions/marginPool.ts" mode="code" org="HaneulLabs" repo="ts-sdks" fun="getId,deepbookPoolAllowed,supplyCap,maxUtilizationRate,protocolSpread,minBorrow" signatureOnly />
