...
In Move, everything is an object. Objects serve as the fundamental data storage unit on Haneul, containing Move packages (smart contracts), addresses, coins, NFTs, and all other onchain data.
