...
- **Archival Store**: A long-term storage system (e.g., [Bigtable](https://cloud.google.com/bigtable)) that holds checkpoint-indexed Haneul data.
...
Access the Archival Service hosted by any participating provider. Haneul Foundation offers a public good service on a [Bigtable](https://cloud.google.com/bigtable)-based store. This service has strict rate limits:
...
Run an indexer pipeline to keep the Archival Store updated. Haneul Foundation provides an ingestion mechanism for [Bigtable](https://cloud.google.com/bigtable):
