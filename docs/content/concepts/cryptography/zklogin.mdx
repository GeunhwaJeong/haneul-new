...
A ceremony generates the CRS, which is used to produce the proving key in the proving service and the verifying key in Haneul authorities. See [ceremony](#ceremony) for details.
