...
If you want to use the Haneullabs hosted ZK Proving Service for Mainnet, please refer to [Enoki docs](https://docs.enoki.haneul-labs.com/) and contact us for accessing it.

Use the `prover-dev` endpoint (https://prover-dev.haneul-labs.com/v1) freely for testing on Devnet. Note that you can submit proofs generated with this endpoint for Devnet zkLogin transactions only; submitting them to Testnet or Mainnet fails.
...
services:
  ...
  frontend:
    image: haneullabs/zklogin:prover-fe-stable
    command: "8080"
    ports:
