...
- **Rigorousness:** The code for zkLogin has been independently [audited](https://github.com/haneul-foundation/security-audits/blob/main/docs/zksecurity_zklogin-circuits.pdf) by two firms specializing in zero knowledge. The public zkLogin ceremony for creating the common reference string attracted contributions from more than 100 participants.
...
2. Use a self hosted server endpoint: See usage in [zklogin-verifier](https://github.com/GeunhwaJeong/zklogin-verifier). 
