...
Unlike traditional blockchains that create blocks before execution, Haneul creates checkpoints after transaction execution to provide a certified record of chain history.
