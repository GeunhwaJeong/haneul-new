...
description: On the Haneul network, checkpoints define the blockchain's history. Unlike traditional blockchains that create blocks before execution, Haneul creates checkpoints after transaction execution to provide a certified record of chain history.
---
...
1. Use the state sync network or Haneul archive to obtain the next checkpoint.  
