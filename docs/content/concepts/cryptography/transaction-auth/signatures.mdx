---
title: Signatures
description: Haneul supports multiple cryptography algorithms and primitives. Switching between them rapidly is supported.
...
For more on passkey signature, see [SIP-8](https://github.com/haneul-foundation/sips/blob/main/sips/sip-9.md).

## Authority signature

The Authority on Haneul (collection of validators) holds 3 distinctive key pairs:
