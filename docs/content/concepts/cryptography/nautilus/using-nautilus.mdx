...
The [Nautilus framework](https://github.com/GeunhwaJeong/nautilus) helps you deploy an AWS Nitro Enclave with scaffolding such as reproducible builds, signature formatting, and HTTPS traffic forwarding. This allows you to focus on implementing the off-chain computation logic inside the enclave.
...
Refer to the [GitHub repository](https://github.com/GeunhwaJeong/nautilus) for the latest structure and related instructions.
