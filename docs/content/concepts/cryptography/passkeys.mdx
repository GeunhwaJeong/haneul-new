...
Passkey provides a secure and user-friendly alternative for submitting transactions to Haneul. Built on the **WebAuthn standard**, passkey allows users to authenticate and sign transactions using:
