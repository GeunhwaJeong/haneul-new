...
- Work with multisig wallets by combining passkey with other authentication types to build 2-of-2 or m-of-n [multisig wallets](/guides/developer/transactions/transaction-auth/multisig.mdx). This enables secure recovery options and shared access patterns.
