...
:::info
Passkey support is available in beta in Haneul Devnet and Testnet. The Mainnet release is not yet scheduled.  
:::

## Benefits of using passkey

- **Sign transactions securely:**  Users can sign transactions in Haneul using passkey, while the private key stays securely stored within the authenticator. This reduces the risk of key extraction attacks.
  Users can sign transactions in Haneul using passkey, while the private key stays securely stored within the authenticator. This reduces the risk of key extraction attacks.  
