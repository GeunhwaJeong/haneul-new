...
The Haneul repository includes [several examples](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/examples) that demonstrate Haneul capabilities. The following [Flash Loan](https://github.com/GeunhwaJeong/haneul/blob/main/haneul_programmability/examples/defi/sources/flash_lender.move) code from the set of examples demonstrates the pattern this topic describes: 

<ExampleImport file="/haneul_programmability/examples/defi/sources/flash_lender.move" type="move" />
