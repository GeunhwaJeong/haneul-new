...
The Haneul repository includes [several examples](https://github.com/GeunhwaJeong/haneul/tree/main/examples/move) that demonstrate Haneul capabilities. The following [Flash Loan](https://github.com/GeunhwaJeong/haneul/blob/main//examples/move/flash_lender/sources/example.move) code from the set of examples demonstrates the pattern this topic describes:

<ExampleImport file="/examples/move/flash_lender/sources/example.move" type="move" />
