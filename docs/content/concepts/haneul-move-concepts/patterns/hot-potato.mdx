...
The Haneul repository includes [several examples](https://github.com/GeunhwaJeong/haneul/tree/main/examples/move) that demonstrate Haneul capabilities. The [Flash Loan](https://github.com/GeunhwaJeong/haneul/blob/main/examples/move/flash_lender/sources/example.move) code in those examples demonstrates the pattern this topic describes.
