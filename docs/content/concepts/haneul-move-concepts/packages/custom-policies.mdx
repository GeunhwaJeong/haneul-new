...
To address the security risk of single-key upgrade ownership while still providing the opportunity to [upgrade live packages](./upgrade.mdx), Haneul offers _custom upgrade policies_. These policies protect `UpgradeCap` access and issue `UpgradeTicket` objects that authorize upgrades on a case-by-case basis.
...
{@inject:  ../../../../../crates/haneul-framework/packages/haneul-framework/sources/package.move#fun=authorize_upgrade,commit_upgrade noComments}
...
{@inject:  ../../../../../crates/haneul-framework/packages/haneul-framework/sources/package.move#struct=UpgradeCap noComments}
...
{@inject:  ../../../../../crates/haneul-framework/packages/haneul-framework/sources/package.move#struct=UpgradeTicket noComments}
...
{@inject:  ../../../../../crates/haneul-framework/packages/haneul-framework/sources/package.move#struct=UpgradeReceipt noComments}
