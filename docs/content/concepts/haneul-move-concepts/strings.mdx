...
Haneul Move does not have a native type for strings, but it has a handy wrapper.
...
Define string literals in Haneul Move as byte strings. To do so, prepend `b` to your string.
