...
- `pageInfo`, of type [PageInfo](../../references/haneul-graphql/reference/objects/page-info.mdx), which indicates whethere there are further pages before or after the page returned.
