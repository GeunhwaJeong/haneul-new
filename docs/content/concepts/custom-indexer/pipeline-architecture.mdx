...
<ImportContent source="crates/haneul-indexer-alt-framework/src/ingestion/regulator.rs" tag="regulator" />
...
<ImportContent mode="code" source="crates/haneul-indexer-alt-framework/src/ingestion/mod.rs" struct="IngestionConfig" highlight="ingest_concurrency" />
...
<ImportContent mode="code" source="crates/haneul-indexer-alt-framework/src/ingestion/regulator.rs" tag="bound" /> 
...
<RelatedLink to="/concepts/haneul-architecture/transaction-lifecycle.mdx" />
