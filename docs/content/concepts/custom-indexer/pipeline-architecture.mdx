...
<ImportContent mode="code" source="crates/haneul-indexer-alt-framework/src/pipeline/concurrent/mod.rs" struct="buff" highlight="ingest_concurrency" />
...
<ImportContent mode="code" source="crates/haneul-indexer-alt-framework/src/ingestion/mod.rs" variable="processor_tx" />
