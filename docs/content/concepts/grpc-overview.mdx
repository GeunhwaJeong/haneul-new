...
Refer to [when to use gRPC vs GraphQL](../guides/developer/getting-started/data-serving#when-to-use-grpc-vs-graphql-with-indexer-20) to access Haneul data.
...
This is an example to build a python client for Haneul gRPC API. Feel free to use another set of tools or modules that you’re comfortable with.
