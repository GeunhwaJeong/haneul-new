...
Refer to [when to use gRPC vs GraphQL](../guides/developer/haneul-101/data-serving#when-to-use-grpc-vs-graphql-with-general-purpose-indexer) to access Haneul data.
