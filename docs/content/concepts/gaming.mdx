...
For more information on the computation of gas fees, see [Haneul Gas Pricing](./tokenomics/gas-in-haneul.mdx).
...
See [Transfer to Object](/guides/developer/objects/transfers/transfer-to-object.mdx) for more details on how to effectively transfer objects to other objects on Haneul.
...
<RelatedLink href="https://blog.haneul.io/tag/gaming/" label="Haneul Foundation blog" desc="Blog posts from the Haneul Foundation with the `gaming` tag." />
...
<RelatedLink href="https://github.com/GeunhwaJeong/mysticon-legends" label="Mysticon Legends" desc="GitHub repo for a blockchain-based game where players collect, train, and battle with mythical creatures called Mysticons." />
<RelatedLink href="https://mini-games.haneul.io/" label="Web3 Mini Games built on Haneul" desc="A collection of mini games, to inspire the community of Haneul." />
