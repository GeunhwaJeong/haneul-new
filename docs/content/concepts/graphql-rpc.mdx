...
- `pageInfo`, of type <a href="/references/haneul-api/haneul-graphql/reference/objects/page-info" data-noBrokenLinkCheck='true'>PageInfo</a>, which indicates whether there are more pages before or after the page returned.
