...
- `pageInfo`, of type [PageInfo](../references/haneul-api/haneul-graphql/reference/objects/page-info.mdx), which indicates whether there are more pages before or after the page returned.
