---
title: GraphQL for Haneul RPC (Alpha)
...
```sh
$ curl -i -X POST https://haneul-mainnet.haneul-labs.com/graphql \
...
- `pageInfo`, of type <a href="/references/haneul-api/haneul-graphql/beta/reference/types/objects/page-info" data-noBrokenLinkCheck='true'>PageInfo</a>, which indicates whether there are more pages before or after the page returned.
...
- [Querying Haneul RPC with GraphQL](../guides/developer/getting-started/graphql-rpc.mdx): Gets you started using GraphQL to query the Haneul RPC for on-chain data.  
- [Migrating to GraphQL](../guides/developer/advanced/graphql-migration.mdx): Guides you through migrating Haneul RPC projects from JSON-RPC to GraphQL. 
- [GraphQL for Haneul RPC](../references/haneul-graphql.mdx): Auto-generated GraphQL reference for Haneul RPC.
