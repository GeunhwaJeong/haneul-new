...
<RelatedLink href="https://blog.haneul.io/haneul-storage-fund-deflationary/" label="Haneul Storage Fund: Bringing Deflationary Pressure to HANEUL" desc="Learn how the storage fund creates deflationary pressure on HANEUL tokens." />

<RelatedLink href="https://blog.haneul.io/storage-fund-demystified/" label="Haneul Storage Fund Demystified" desc="Understand the mechanics of the Haneul storage fund." />

<RelatedLink href="https://blog.haneul.io/storage-fees-explained/" label="Storage Fees on Haneul Explained" desc="Detailed explanation of how storage fees work on Haneul." />