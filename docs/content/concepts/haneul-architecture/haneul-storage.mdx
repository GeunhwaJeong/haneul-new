...
Compute is relatively fixed on Haneul, with hundreds of validators running 24-core, 128GB RAM machines.  

Because Haneul achieves high throughput compared to other blockchains, storage costs can vary significantly.  
...
- [Custom indexers](../../guides/developer/advanced/custom-indexer.mdx): Build custom indexers with the Haneul micro-data ingestion framework.  
- [Snapshots](../../guides/operator/snapshots.mdx): Bootstrap a full node without replaying all transactions from genesis.  
- [Haneul archives](../../guides/operator/archives.mdx): Enable archiving on full nodes for a complete record of all transactions.  
