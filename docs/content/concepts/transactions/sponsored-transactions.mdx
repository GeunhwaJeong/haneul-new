...
The following code block describes the `TransactionData` structure for sponsored transactions and `GasObject`. You can view the [source code](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-types/src/messages.rs) in the Haneul GitHub repository.
