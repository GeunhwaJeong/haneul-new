...
- `Publish`: Returns the upgrade capability `haneul::package::UpgradeCap` for the newly published package.

- `Upgrade`: Returns the upgrade receipt `haneul::package::UpgradeReceipt` for the upgraded package.
