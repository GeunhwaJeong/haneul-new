...
| `SignatureVerificationService` | `haneul/rpc/v2/signature_verification_service.proto` | Validate signatures outside transaction execution. Helps pre-verify payloads that might include [zkLogin](/concepts/cryptography/zklogin) or other signatures, simulate authentication, or build custom signing workflows. |
...
<RelatedLink to="/guides/developer/accessing-data/grpc-overview" label="Using Haneul gRPC" />
