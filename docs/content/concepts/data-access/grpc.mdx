...
| `SignatureVerificationService` | `haneul/rpc/v2/signature_verification_service.proto` | Validate signatures outside transaction execution. Helps pre-verify payloads that might include [zkLogin](/guides/developer/cryptography/zklogin-integration) or other signatures, simulate authentication, or build custom signing workflows. |
