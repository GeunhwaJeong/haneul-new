...
Switch any apps that still use the GraphQL Alpha endpoints (`https://graphql.mainnet.haneul.io/graphql`, `https://haneul-testnet.haneul-labs.com/graphql`, and `https://haneul-devnet.haneul-labs.com/graphql`) to the GraphQL Beta endpoints as soon as possible to avoid disruption of service.
