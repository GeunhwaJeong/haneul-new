...
{@inject: ../../../crates/haneul-framework/packages/haneul-framework/sources/dynamic_field.move#fun=add noComments}

**Dynamic object field**

{@inject: ../../../crates/haneul-framework/packages/haneul-framework/sources/dynamic_object_field.move#fun=add noComments}
...
{@inject:  ../../../examples/move/dynamic_fields/sources/example.move#struct=Parent noComments}

{@inject:  ../../../examples/move/dynamic_fields/sources/example.move#struct=Child noComments}
...
{@inject:  ../../../crates/haneul-framework/packages/haneul-framework/sources/dynamic_field.move#fun=borrow noComments}

{@inject:  ../../../crates/haneul-framework/packages/haneul-framework/sources/dynamic_field.move#fun=borrow_mut noComments}
...
{@inject:  ../../../examples/move/dynamic_fields/sources/example.move#fun=mutate_child noComments}

{@inject:  ../../../examples/move/dynamic_fields/sources/example.move#fun=mutate_child_via_parent noComments}
...
{@inject:  ../../../crates/haneul-framework/packages/haneul-framework/sources/dynamic_field.move#fun=remove noComments}
...
{@inject:  ../../../examples/move/dynamic_fields/sources/example.move#fun=delete_child noComments}

{@inject:  ../../../examples/move/dynamic_fields/sources/example.move#fun=reclaim_child noComments}
...
Haneul provides `Table` and `Bag` collections built using dynamic fields, but with additional support to count the number of entries they contain to protect against accidental deletion when non-empty. To learn more, see [Tables and Bags](./dynamic-fields/tables-bags.mdx).

## Related links

- [Dynamic fields](https://move-book.com/programmability/dynamic-fields.html) in The Move Book: The Move Book is a comprehensive guide to the Move programming language and the Haneul blockchain. This page explores using dynamic fields in your Move development.
