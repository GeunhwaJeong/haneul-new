...
At the same time, John decides to send 2 HANEUL coins to Anna. The output of this transaction is:
...
After receiving 2 HANEUL coins, Anna sends them to Tom. Now Tom has 6 HANEUL coins, 4 from Object A and 2 from Object B.
