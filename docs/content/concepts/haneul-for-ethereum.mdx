...
| Contract upgrades | Proxy contract forwards user transactions. | New contracts must be [layout-compatible](/concepts/haneul-move-concepts/packages/upgrade#upgrade-requirements) with the old one. Need to consider versioning shared objects. |
