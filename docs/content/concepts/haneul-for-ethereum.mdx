...
| Mutate contract state | Sending transactions through compile time ABI interface. | Sending transaction through runtime [programmable transaction block](/guides/developer/transactions/ptbs/prog-txn-blocks) (PTB) construction. |
...
For all types of ownership on Haneul, see [Object Ownership](/guides/developer/objects/object-ownership).
...
See [Programmable Transaction Blocks](/guides/developer/transactions/ptbs/prog-txn-blocks) for details on PTBs.
