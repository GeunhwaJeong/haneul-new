...
Sequential and concurrent pipeline types and their trade-offs are detailed in [Pipeline Architecture](/develop/accessing-data/custom-indexer/pipeline-architecture).
