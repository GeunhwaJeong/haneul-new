...
Use the `cargo run` command to run your indexer against Testnet. You can choose from multiple checkpoint data sources (see [Checkpoint Data Sources](/develop/accessing-data/custom-indexer/indexer-data-integration#checkpoint-data-sources) for details):
