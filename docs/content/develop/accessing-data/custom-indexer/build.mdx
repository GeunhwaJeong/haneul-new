...
description: Build a custom indexer using the `haneul-indexer-alt-framework` module. The example indexer demonstrates a sequential pipeline that extracts transaction digests from Haneul checkpoints and stores them in a local PostgreSQL.
