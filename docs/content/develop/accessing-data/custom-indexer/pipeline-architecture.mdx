...
The `haneul-indexer-alt-framework` provides two distinct pipeline architectures. Understand their differences to choose the right approach.
...
<ul className="list-none pl-2">
<li><span className="text-haneul-success-dark">✓</span> You need performance optimization.</li>
<li><span className="text-haneul-success-dark">✓</span> Sequential processing does not keep up with your data volume.</li>
...
![Concurrent Backpressure Pipeline](../images/architecture_concurrent-backpressure_v1.png)
...
<ImportContent mode="code" source="crates/haneul-indexer-alt-framework/src/pipeline/mod.rs" struct="IngestionConfig" highlight="subscriber_channel_size" />
