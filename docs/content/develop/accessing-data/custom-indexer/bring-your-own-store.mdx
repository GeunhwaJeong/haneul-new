    ...
    let indexer = Indexer::new(
        ...
        ClientArgs {
            ingestion: IngestionClientArgs {
                ...
                remote_store_gcs: Some("haneullabs-testnet-checkpoints-use4".to_string()),
            ...
            streaming: StreamingClientArgs {
                ...
                streaming_url: Some("https://fullnode.testnet.haneul.io:443".parse()?),
                ..Default::default()
            },
            ..Default::default()
        },
...
1. Define the `Event` struct in Rust.
    ...
    Define the same structure in Rust as declared in Move. You can do this manually or use [`move-binding`](https://github.com/GeunhwaJeong/move-binding) to auto-generate it from onchain packages.
