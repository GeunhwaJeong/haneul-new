...
- **Remote stores** connect to public checkpoint repositories such as [`https://checkpoints.mainnet.haneul.io`](https://checkpoints.mainnet.haneul.io/). This option offers the most straightforward setup and does not require you to operate any infrastructure.
