...
<AgentPrompt
  prompt={"Convert this Haneul JSON-RPC usage to the current gRPC API. Generate/use the client, map request/response types, and add a working example."}
/>

This guide provides practical examples for querying the Haneul network using gRPC. For core concepts, see the [corresponding concepts page](/develop/accessing-data/grpc/what-is-grpc).

<Tabs className="tabsHeadingCentered--small">
<TabItem value="prereq" label="Prerequisites">

Before you begin, ensure you have access to a [gRPC](/develop/accessing-data/grpc)-enabled Haneul full node. Check the [list of RPC and data providers](https://www.notion.so/haneullabs/RPC-providers-offering-future-Haneul-data-primitives-2466d9dcb4e980a99a36e9aafd8c17e0?source=copy_link) that support gRPC on their full nodes, and contact a provider directly to request access.
