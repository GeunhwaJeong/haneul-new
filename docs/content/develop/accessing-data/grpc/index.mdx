---
title: gRPC
description: Use the Haneul Full Node gRPC API for high-performance, type-safe blockchain data access with Protocol Buffers serialization.
keywords: ['gRPC', 'Protocol Buffers', 'Haneul API', 'full node', 'data access', 'indexer', 'low latency', 'type-safe API']
---
