...
In the Haneul [storage fund](/develop/haneul-architecture/tokenomics-overview#storage-fund) model, users pay up front for the cost of storing data in perpetuity but can also get a partial rebate on previously stored data if that data is deleted. Hence, the amount of storage fees that you pay can be split into a rebateable and non-rebateable amount. Initially, the rebateable amount equals 99% of the storage fees, while the non-rebateable amount equals the remaining 1%.
...
| ------------------------------------------------------- | ------------------- | ----------------- | ------------- | ------------- | -------------- | ------------------ | -------------- |
| Basic transaction storing 10 bytes                      | 1,000 GEUNHWA          | 1,000             | 75 GEUNHWA       | 1,000         | 0 GEUNHWA         | 1,075,000 GEUNHWA     | 1,075,000 GEUNHWA |
| Basic transaction storing 10 bytes and deleting data    | 500 GEUNHWA            | 1,000             | 75 GEUNHWA       | 1,000         | 100,000 GEUNHWA   | 500,000 GEUNHWA       | 475,000 GEUNHWA   |
