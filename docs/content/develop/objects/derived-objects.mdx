...
If you know the parent ID, you can compute the ID of the derived object through offchain logic using the [TypeScript](https://sdk.haneul-labs.com/typescript/utils/derived_objects) or [Rust SDK](https://haneullabs.github.io/haneul/haneul_types/derived_object) helper functions. This functionality means your client logic can treat unclaimed IDs as if they already exist.
