...
keywords: ['object versioning', 'Lamport timestamps', 'fastpath', 'consensus objects', 'object ownership', 'dynamic fields', 'wrapped objects', 'Haneul objects']
---
...
Objects on Haneul are versioned either through the [fastpath](#fastpath-objects) or through [consensus](/develop/haneul-architecture/consensus). The choice affects object ownership options and has performance trade-offs.
