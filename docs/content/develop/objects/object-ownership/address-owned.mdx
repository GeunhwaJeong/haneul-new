...
- Use the [`haneul::transfer::transfer`](/references/framework/haneul_haneul/transfer#haneul_transfer_transfer) function if you are defining [custom transfer rules](/develop/objects/transfers/custom-rules) for the object. 
