...
const guides = [
  ...
  },
  {
    ...
    items: [
      {
        type: 'category',
        label: 'Install Haneul',
        collapsed: false,
        link: {
          type: 'doc',
          id: 'guides/developer/getting-started/haneul-install',
        },
        items: [
      ...
      'guides/developer/getting-started/configure-haneul-client',
  ...
  },
  {
    ...
    items: [
      ...
      'guides/developer/haneul-101/move-package-management',
...

      {
        ...
        link: {
          type: 'doc',
          id: 'guides/developer/haneul-101/working-with-ptbs',
        },
        items: [
  ...
  'guides/developer/dev-cheat-sheet',
  {
    ...
    items: [
      'guides/operator/haneul-full-node',
