...
> To learn more, see [Examples of Haneul Smart Contracts](/getting-started/).
...
> Before you install Haneul, make sure to install the [prerequisites](/getting-started/onboarding/haneul-install#prerequisites).
