...
This document defines the styles, word and term usage, and content formatting for Haneul documentation. Entries are in alphabetical order. A style guide is never finished. Expect continued iterations to add additional styles, additional information to existing styles, and infrequently a change to an existing style.
...
- **Indicative –** The Haneul Explorer displays transactions on the network.
- **Imperative –** Open Haneul Explorer to view transactions on the network.
- **Subjunctive –** We suggest that you view your transaction in Haneul Explorer after you complete a transfer.
...
> You can view transaction history in Haneul Explorer.

**Rather than:**

> We can view transaction history in Haneul Explorer.
...
> Find transaction details in Haneul Explorer.

> After you complete a transaction in your Haneul Wallet, view details about the transaction on Haneul Explorer.
