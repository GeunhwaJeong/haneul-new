...
| ---------------------- |---------------------------------------------- | -------------- |
| **Always capitalized** | [Proper nouns](#proper-nouns), [Product names](#product-names), Archival Store and Service, Archival Store, Archival Service, DeepBook Indexer, DeepBookV3, Devnet, ID, Localnet, Kiosk (when referring to the standard), Mainnet, Mysticeti, Operation Cap, Haneul, Haneul CLI, Haneul Client PTB CLI, Haneul Closed-Loop Token / Closed-Loop Token, Haneul dApp Kit, Haneul Explorer, HaneulJSON, Haneul Keystore, Haneul Keytool, HaneulLink, Haneul Object Display, HaneulPlay0X1, HANEUL, HANEUL token, Testnet, Wallet Standard, Web2, Web3, zkSend SDK | Use capitalization consistently for branding and product-specific references |
