...
| **Always lowercase**   | dApp, kiosk (when referring to an instance), object, oracle, recovery passphrase (mnemonic), soulbound, Haneul framework, Haneul object, wallet | Use lowercase when referring to general concepts rather than branded terms   |
