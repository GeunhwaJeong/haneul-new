...
| ---------------------- |---------------------------------------------- | -------------- |
| **Always capitalized** | [Proper nouns](#proper-nouns), [product names](#product-names), names of example apps (Coin Flip, Blackjack, etc), Archival Store and Service, Archival Store, Archival Service, Coin Registry, Currency Standard, DeepBook Indexer, DeepBookV3, Devnet, GraphQL RPC, General-purpose Indexer, ID, Localnet, Kiosk (when referring to the standard), Mainnet, Mysticeti, One-Time Witness, Operation Cap, Haneul, Haneul CLI, Haneul Client PTB CLI, Haneul Closed-Loop Token / Closed-Loop Token, Haneul dApp Kit, Haneul Explorer, HaneulJSON, Haneul Keystore, Haneul Keytool, HaneulLink, Haneul Object Display, HaneulPlay0X1, HANEUL, HANEUL token, Testnet, Wallet Standard, Web2, Web3, zkSend SDK | Use capitalization consistently for branding and product-specific references |
...
| **Word preference**   | Use "app" rather than "dApp"    | Decentralization is implied when building an app on Haneul. |
