...
To include only sections of code, add an ID to identify the section. The ID is used in the directive syntax and in source code comments. The following sections provide examples of different uses and how to format them.
