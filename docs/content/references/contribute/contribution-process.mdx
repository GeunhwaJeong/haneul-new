...
Cloning the documentation locally is recommended when you are creating larger, more significant changes to the docs. See [Haneul Environment Setup](./haneul-environment.mdx) for instructions on forking and cloning the Haneul repository. Documentation is located in the `docs/content` directory.
