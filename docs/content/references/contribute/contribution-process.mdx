...
Cloning the documentation locally is recommended when you are creating larger, more significant changes to the docs. See [Haneul Environment Setup](./haneul-environment.mdx) for instructions on forking the Haneul repository, if necessary. The documentation is in the `docs/content` directory.
