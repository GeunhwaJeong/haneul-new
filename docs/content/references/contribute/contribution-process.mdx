...
description: Help the Haneul community through documentation contributions. Whether it's to fix errors or add new content, the entire Haneul community benefits from your contributions.
keywords: [ contribute docs, style guide compliance, add new docs page, change existing docs page ]
pagination_prev: null
---

The Haneul documentation is open source and thrives on community contributions. Whether you’re fixing a typo, clarifying explanations, or adding entirely new content, your work benefits the whole community. This page explains how to contribute to the documentation using either GitHub’s web editor or your local development environment.

## Follow the style guide

All documentation changes must follow the [Haneul style guide](/references/contribute/style-guide). Reviewers will provide feedback to ensure consistency in tone and quality. Don’t be discouraged if your pull request (PR) receives multiple review comments, as this process helps maintain clarity and uniformity across all docs. After your PR is merged, future updates might refine your content further.
...
Cloning the documentation locally is recommended when you are creating larger, more significant changes to the docs. See [Haneul Environment Setup](/references/contribute/haneul-environment) for instructions on forking and cloning the Haneul repository. Documentation is located in the `docs/content` directory.
...
1. Submit a PR to the `main` branch of the Haneul repository.  
