...
- Prefer white text on Black (`#000000`) or Gray 500 (`#6C7584`) fills. White (`#FFFFFF`) on Haneul Blue 500 (`#298DFF`) achieves approximately 3.31:1 contrast, which passes the 3:1 graphic AA threshold and is permitted.
