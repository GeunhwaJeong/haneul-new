...
An extensive list of query examples is available in the Haneul repository: https://github.com/GeunhwaJeong/haneul/tree/main/crates/haneul-graphql-rpc/examples. 
This doc collects all the examples into one file: https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-graphql-rpc/docs/examples.md.
