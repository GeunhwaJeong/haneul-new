...
There are currently two available playgrounds for Haneul GraphQL Service:
- `mainnet`: https://graphql-beta.mainnet.haneul.io/
- `testnet`: https://graphql-beta.testnet.haneul.io/
...
- Testnet - https://graphql-beta.testnet.haneul.io/schema
