---
title: Haneul GraphQL RPC Overview
description: The Haneul GraphQL RPC is a public service that enables interacting with the Haneul network. 
---

The Haneul GraphQL RPC is a public service that enables interacting with the Haneul [network](https://haneul.io/networkinfo).
...
As Haneul uses an object-centric model, it might be of interest to explore the [Object](/references/haneul-api/graphql/reference/objects/object.mdx) and [Address](/references/haneul-api/graphql/reference/objects/address.mdx) types too. For other types and reference API, consult the pages under GraphQL RPC API shown in the left sidebar.
