...
Haneul Full nodes support publish/subscribe using JSON-RPC notifications via the WebSocket API. You can use this service with Haneul client to filter and subscribe to a real-time event stream generated from Move or from the Haneul network.
...
## Haneul event query criteria {#haneul-event-query-criteria}
...
## Subscribe to Haneul events {#subscribe-events}
