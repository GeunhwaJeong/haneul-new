...
**1. Generate execution traces**
   ...
   - Run the `Move: Trace Move test execution` command.
      ...
      <img src="./images/trace_palette.png" style={{ width: "50%", height: "auto" }} alt="Command palette" />
...
Run the following query against the mainnet's GraphQL [endpoint](https://graphql.mainnet.haneul.io/graphql) where the `address` parameter is the ID of the user package (`0xb29d83c26cdd2a64959263abbcfc4a6937f0c9fccaf98580ca56faded65be244` in this example).
