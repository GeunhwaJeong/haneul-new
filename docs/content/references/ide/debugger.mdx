...
Use the debugger to debug unit tests and existing on-chain transactions (including [PTB](/guides/developer/transactions/ptbs/prog-txn-blocks) debugging support) with the help of the [replay tool](/references/cli/replay).
