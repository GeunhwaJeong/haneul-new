...
To get the a summary of the test coverage, you must first run the `haneul move test --coverage` command, and then the `haneul move coverage summary --test` to get a summary of the test coverage in the example project.
