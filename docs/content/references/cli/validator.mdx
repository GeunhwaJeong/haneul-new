...
Typing `haneul validator --help` into your terminal or console displays the following information on available commands.
...
Each command has its own help section. For example `haneul validator report-validator --help` will display the following prompt:
