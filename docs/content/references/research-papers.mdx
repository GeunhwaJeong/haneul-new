...
- **Relevance:** Provides a performant leader election algorithm for partially-synchronous consensus protocol (such as Bullshark). Haneul might want to use it
...
- **Relevance:** Provides a partially-synchronous consensus protocol running over Narwhal. Haneul might want to use it instead of Tusk.
...
Haneul blockchain protocol uses a variant of the Bullshark consensus
...
- **Relevance:** The consensus system that we will likely use to support shared-objects in Haneul.
