...
export default {
  ...
  developSidebar: [
    'develop',
    {
      ...
      link: { type: 'doc', id: 'develop/haneul-architecture/index' },
      items: [
        'develop/haneul-architecture/components',
        'develop/haneul-architecture/networks',
        'develop/haneul-architecture/consensus',
        'develop/haneul-architecture/tokenomics-overview',
        'develop/haneul-architecture/object-model',
        'develop/haneul-architecture/epochs',
        'develop/haneul-architecture/checkpoint-verification',
        'develop/haneul-architecture/haneul-storage',
        'develop/haneul-architecture/haneul-security',
        'develop/haneul-architecture/protocol-upgrades',
      ],
    },
    {
      type: 'category',
      ...
      },
      {
        ...
        items: [
            ...
            'develop/write-move/haneul-move-concepts',
    ...
    },
    {
      ...
      items: [
        'develop/transaction-payment/gas-in-haneul',
  ...
  gettingStartedSidebar: [
    ...
    'getting-started/agent-skills',
    {
      ...
      items: [
          ...
          link: { type: 'doc', id: 'getting-started/onboarding/haneul-install'},
          items: [
    ...
    'getting-started/haneul-for-solana',
  ],
...
haneulStackSidebar: [
    ...
    },
    {
      type: 'category',
      label: 'Nautilus',
      link: { type: 'doc', id: 'haneul-stack/nautilus/index' },
      items: [
        'haneul-stack/nautilus/nautilus-overview',
    ...
    },
    {
	  ...
	  items: [
        ...
        },
		{
          type: 'link',
          label: 'DeepBook Margin',
          href: 'https://docs.haneul.io/onchain-finance/deepbook-margin/deepbook-margin',
        },
		{
          type: 'link',
          label: 'DeepBook Predict',
          href: 'https://docs.haneul.io/onchain-finance/deepbook-predict/deepbook-predict',
        },
      ],
    },
    {
    ...
    'operators/snapshots',
     {
      ...
      items: [
        'operators/full-node/haneul-full-node',
