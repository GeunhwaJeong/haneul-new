...
function CheckpointAdmonition(props) {
  return (
    <div className="bg-haneul-ghost-white dark:bg-haneul-blue-dark my-8 pr-4 border border-solid border-haneul-blue-dark dark:border-haneul-blue rounded-lg flex">
