        ...
        <div className={`${modalBg} shrink-0 px-5 pt-4 pb-0`}>
          ...
          >
            ...
            <div className="text-left flex-1">
              <div className="font-semibold text-[15px] leading-tight">Ask Haneul AI</div>
              <div className="text-xs text-white/70 mt-0.5">Get instant answers from the Haneul knowledge base</div>
            </div>
