...
const pageItemStyle =
  "px-3 py-[9px] border border-solid border-haneul-gray-50 hover:border-haneul-blue-dark cursor-pointer rounded-md text-sm text-haneul-steel-dark dark:text-haneul-blue dark:hover:border-haneul-blue";
const disabledItemStyle =
  "px-3 py-[9px] opacity-50 cursor-not-allowed border border-solid border-haneul-gray-50 rounded-md";
        ...
        return (
          <li
            ...
            className={`${pageItemStyle} ${
              isActive
                ? "bg-haneul-blue-light/40 dark:bg-haneul-blue-light text-haneul-blue-dark"
                : ""
            }`}
          >
            {page + 1}
