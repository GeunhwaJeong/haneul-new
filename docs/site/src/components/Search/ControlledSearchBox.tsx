...
export default function ControlledSearchBox({
  ...
  return (
    <div className="flex items-center mb-8 border border-haneul-gray-40 dark:border-haneul-gray-70 rounded-lg bg-haneul-gray-40 dark:bg-haneul-gray-80 pl-2">
      {searchSvg}
      <input
        ref={inputRef}
        type="search"
        className="cursor-pointer w-full py-2 pr-4 h-[40px] text-lg border-transparent bg-transparent focus-visible:outline-none dark:text-haneul-gray-50 dark:placeholder-haneul-gray-50"
