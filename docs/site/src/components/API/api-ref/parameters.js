...
export const Parameter = (props) => {
  ...
  return (
    <>
      <div className="grid grid-cols-6 ml-4 odd:bg-haneul-ghost-white dark:odd:bg-haneul-ghost-dark rounded-lg">
    ...
    <div className="border-b mb-8">
      {hasParams && (
        <div className="grid grid-cols-6 ml-4">
          ...
          <div className="p-2 bg-haneul-blue dark:bg-haneul-blue-dark text-haneul-gray-95 dark:text-haneul-gray-50 text-haneul-gray-35 font-bold">
            Required
          </div>
          <div className="rounded-tr-lg rounded-br-lg col-span-3 p-2 bg-haneul-blue dark:bg-haneul-blue-dark text-haneul-gray-95 dark:text-haneul-gray-50 text-haneul-gray-35 font-bold">
            Description
          </div>
        </div>
      )}
