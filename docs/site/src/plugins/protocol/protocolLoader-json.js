...
const protocolInject = async function (source) {
  ...
  for (const file of spec.files) {
    ...
    for (const message of file.messages) {
      ...
      if (allFields.length > 0) {
        const attrStyle =
          "text-lg before:pr-2 before:mr-2 before:text-sm before:border before:border-solid before:border-transparent before:border-r-haneul-gray-65";
        const fieldStyle =
          "p-2 font-medium text-lg rounded-lg bg-haneul-ghost-white dark:bg-haneul-ghost-dark";
        const borderStyle =
          "border border-solid border-y-transparent border-r-transparent border-l-haneul-gray-65";
        const leftArrowStyle =
          "relative inline-flex items-center before:content-[''] before:border-t-transparent before:border-b-transparent before:border-solid before:border-y-5 before:border-r-0 before:border-l-8 before:border-l-haneul-gray-65";
  ...
  const titleStyle =
    "p-4 pb-2 font-bold text-haneul-ghost-dark dark:text-haneul-ghost-white bg-haneul-ghost-white dark:bg-haneul-ghost-dark border border-solid border-transparent rounded-t-lg";
  const valStyle =
