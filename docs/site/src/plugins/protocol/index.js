...
const fullnodeProtocolPlugin = (context, options) => {
  return {
    name: "haneul-fullnode-protocol-plugin",
    configureWebpack() {
      return {
        module: {
          rules: [
...
<title>Haneul gRPC Message Definitions — Full Reference</title>
<style>
...
<h1>Haneul gRPC Message Definitions</h1>
<p>Complete field-level reference for all Haneul Full Node gRPC message types.
