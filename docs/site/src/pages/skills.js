...
// Skill data is generated at build time from the haneullabs/skills repository
...
const REPO = "https://github.com/GeunhwaJeong/skills";
...
export default function Skills() {
  ...
  return (
    <Layout
      ...
      description="Pre-built agent skills for building on Haneul. Install them into Claude Code, Cursor, Codex, and other AI coding agents."
    >
      <div className={styles.page}>
        <header className={styles.hero}>
          <h1 className={styles.heroTitle}>Haneul Agent Skills</h1>
          <p className={styles.heroTagline}>
            Pre-built skills you can drop into your AI coding agent to build on
            Haneul. Install them into Claude Code, Cursor, Codex, and other agents
            with the <code>skills</code> CLI.
          </p>
          <CopyCommand command="npx skills add haneullabs/skills --all" />
        ...
        <p className={styles.installHint}>
          ...
          <code>npx skills add haneullabs/skills --skill &lt;name&gt;</code>.
        </p>
