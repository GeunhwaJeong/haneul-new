        ...
        <div className="bg-haneul-black overflow-hidden">
          ...
          <div className="flex flex-row flex-wrap justify-center gap-2 max-w-[1066px] mx-auto">
            <HomeCard title="Developers">
              ...
              <Link className={styles.cardLink} to="./guides/developer/haneul-101">
          ...
          <div className={styles.sectionHeader}>
            <h2 className="h1 text-white font-twkeverett">Why Haneul?</h2>
          ...
          <div className={styles.TwoColParagraph}>
            <div className={styles.TwoColItem}>
              ...
              <p>
                Haneul scales horizontally to meet the demands of applications.
                Network capacity grows in proportion to the increase in Haneul
            ...
            <div className={styles.TwoColItem}>
              ...
              <p>
                ...
                safety and expressivity provides a more straightforward
                transition from web 2.0 to web3 for developers, without the need
                to understand the intricacies of the underlying infrastructure.
              </p>
            </div>
            <div className={styles.TwoColItem}>
              ...
              <p>
                ...
                changes in avatars and customizable items based on gameplay.
                This capability delivers stronger in-game economies as NFT
                behavior gets fully reflected on-chain, making NFTs more
                valuable and delivering more engaging feedback loops.
              </p>
            </div>
            <div className={styles.TwoColItem}>
              ...
              <p>
                ...
                empowering developers to create great user experiences in web3.
                To usher in the next billion users, Haneul empowers developers with
                various tools to take advantage of the power of the Haneul
                blockchain. The Haneul Development Kit (SDK) will enable developers
