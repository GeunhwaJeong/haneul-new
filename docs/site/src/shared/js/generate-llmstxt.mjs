...
const PINNED_SECTIONS = ["Move", "Top Level Navigation", "Haneul Developer Skills"];
...
const IGNORE_FILES = new Set([
  ...
  "guides/developer/getting-started/haneul-wallets.md",
  "guides/developer/coin/stablecoins.md",
  "guides/developer/app-examples/recaptcha.md",
  "guides/developer/accessing-data/index.md",
  "references/framework/haneul_bridge/message_types.md",
  "references/framework/haneul_std/address.md",
  "references/framework/haneul_std/bool.md",
  "references/framework/haneul_haneul/hex.md",
  "references/framework/haneul_haneul/prover.md",
  "references/framework/haneul_haneul_system/validator_wrapper.md",
...
function collectSkills() {
  ...
  const dirs = ["haneul-move", "haneul-frontend", "haneul-app"];
  const out = [];
  ...
  for (const d of dirs) {
    ...
    for (const file of files) {
      ...
      out.push({
        section: "Haneul Developer Skills",
        subsection: d,
        title,
...
grouped["Move"] = [
  {
    ...
    description:
      "Complete reference for the Move programming language as used on Haneul. " +
      "Covers syntax, types, functions, structs, abilities (copy, drop, store, key), " +
      "generics, ownership and the Haneul object model, entry functions, public functions, " +
      ...
      "Essential reference for all Move smart contract development on Haneul."
  }
];

// ── Skills (pinned) ──────────────────────────────────────────────────────────
const skills = collectSkills();
if (skills.length) grouped["Haneul Developer Skills"] = skills;
...
function build(ratio = 1, { includeFull = false } = {}) {
  ...
  lines.push("# Haneul Documentation for LLMs", "");
  lines.push(
    "> Comprehensive reference for Haneul blockchain development, including Move smart contract programming, " +
    "Haneul framework concepts, frontend integration, and fullstack application architecture. " +
