...
const SPECS = [
  { network: "mainnet", relPath: "../../crates/haneul-open-rpc/spec/openrpc.json", strictJson: true },
  { network: "testnet", relPath: "../../crates/haneul-open-rpc/spec/openrpc.json", strictJson: true },
  { network: "devnet", relPath: "../../crates/haneul-open-rpc/spec/openrpc.json", strictJson: true },
];
