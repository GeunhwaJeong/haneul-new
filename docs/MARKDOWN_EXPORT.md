...
The Haneul documentation now supports viewing raw markdown versions of any documentation page by appending `.md` to the URL. This makes the documentation LLM-ready and easier to consume programmatically.
...
```
HTML version: https://docs.haneul.io/guides/developer/getting-started
Markdown version: https://docs.haneul.io/guides/developer/getting-started.md
```
...
|-----------|----------|--------------|
| Guide | `https://docs.haneul.io/guides/developer/haneul-101` | `https://docs.haneul.io/guides/developer/haneul-101.md` |
| Concept | `https://docs.haneul.io/concepts/architecture` | `https://docs.haneul.io/concepts/architecture.md` |
| Reference | `https://docs.haneul.io/references/cli` | `https://docs.haneul.io/references/cli.md` |
| Standard | `https://docs.haneul.io/standards/kiosk` | `https://docs.haneul.io/standards/kiosk.md` |
