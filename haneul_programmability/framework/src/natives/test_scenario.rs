        ...
        match event_type {
            ...
            | EventType::FreezeObject => {
                ...
                let owner = match event_type {
                    ...
                    EventType::TransferToAddress => {
                        Owner::AddressOwner(HaneulAddress::try_from(recipient.clone()).unwrap())
                    }
                    EventType::TransferToObject => {
                        Owner::ObjectOwner(HaneulAddress::try_from(recipient.clone()).unwrap())
                    }
...
fn get_inventory_for(
    ...
    inventory
        ...
        .filter_map(|(_, obj)| {
            ...
            // https://github.com/GeunhwaJeong/fastnft/issues/673
