...
module Haneul::CrossChainAirdrop {
    use Std::Vector;
    use Haneul::ERC721Metadata::{Self, ERC721Metadata, TokenID};
    ...
    struct PerContractAirdropInfo has store {
        ...
        // <https://github.com/GeunhwaJeong/fastnft/issues/618>
        // TODO: replace this with SparseSet for O(1) on-chain uniqueness check
        claimed_source_token_ids: vector<TokenID>
    }

    /// The Haneul representation of the original ERC721 NFT on Eth
