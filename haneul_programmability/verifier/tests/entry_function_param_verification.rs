...
use haneul_verifier::entry_function_param_verifier::verify_module;
...
fn add_tx_context(builder: &mut ModuleBuilder) -> StructInfo {
    let addr_module_idx = builder.add_module(HANEUL_FRAMEWORK_ADDRESS, "Address");
    ...
    let tx_context_module_idx = builder.add_module(HANEUL_FRAMEWORK_ADDRESS, "TxContext");
    builder.add_struct(
