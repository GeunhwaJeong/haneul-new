module NFTs::Geniteam {
    ...
    // === Constructors. These create new Haneul objects. ===
    ...
    // === Entrypoints. Each of these functions can be called from a Haneul transaction, whereas functions above cannot. ===
