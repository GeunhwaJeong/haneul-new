...
module nfts::random_nft_airdrop {
    use std::string;
    use std::vector;
    use haneul::object::{Self, UID, delete};
    use haneul::random;
...
module nfts::random_nft_airdrop_tests {
    ...
    use std::vector;
    use haneul::random;
    use haneul::random::{Random, update_randomness_state_for_testing};
    use haneul::test_scenario::{ctx, take_from_sender, next_tx, return_to_sender};
