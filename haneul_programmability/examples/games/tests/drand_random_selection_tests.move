...
module games::drand_random_selection_tests {
    ...
    use games::drand_random_selection::{Self, Game, Ticket, GameWinner};
    ...
    fun test_play_drand_random_selection() {
        ...
        drand_random_selection::create(10, test_scenario::ctx(scenario));
        ...
        // curl https://drand.cloudflare.com/8990e7a9aaed2ffed73dbd7092123d6f289930540d7651336225dc172e51b2ce/public/8
        drand_random_selection::complete(
            game,
