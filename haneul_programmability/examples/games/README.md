...
Examples of toy games built on top of Haneul!

* TicTacToe: the pencil and paper classic, now on Haneul, implemented using single-owner objects only.
* SharedTicTacToe: the pencil and paper classic, now on Haneul, using shared objects.
