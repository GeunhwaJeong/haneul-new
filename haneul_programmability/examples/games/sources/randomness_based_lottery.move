...
module games::randomness_based_lottery {
    use std::option;
    use haneul::balance::{Self, Balance, zero};
    ...
    public entry fun create(ctx: &mut TxContext) {
        ...
        haneul::transfer::share_object(lottery);
    }

    /// Buy a ticket for the lottery.
    public entry fun buy_ticket(lottery: &mut Lottery, coin: Coin<HANEUL>, ctx: &mut TxContext) {
        ...
        haneul::transfer::transfer(ticket, tx_context::sender(ctx));
    }
