...
module capy::capy_winter {
    ...
    struct CapyPost has key { id: UID, balance: Balance<HANEUL> }
    ...
    fun merge_and_split(
        coins: vector<Coin<HANEUL>>, amount: u64, ctx: &mut TxContext
    ...
    fun get_link_url(id: &UID, type: u8): Url {
        ...
        vec::append(&mut res, haneul::hex::encode(object::uid_to_bytes(id)));
