# run a haneul devnet fullnode locally

Run a Haneul DevNet fullnode locally for testing/experimenting by following the instructions below. This has been tested and should work for:
...
Get the latest version of the fullnode config [here](https://github.com/GeunhwaJeong/haneul/raw/main/crates/haneul-config/data/fullnode-template.yaml), or:

```wget https://github.com/GeunhwaJeong/haneul/raw/main/crates/haneul-config/data/fullnode-template.yaml```

## haneul devnet genesis

Get the latest version of the Haneul DevNet genesis blob [here](https://github.com/GeunhwaJeong/haneul-genesis/raw/main/devnet/genesis.blob), or:
...
- Open https://explorer.devnet.haneul.io
