...
[![Build Status](https://github.com/GeunhwaJeong/fastnft/actions/workflows/rust.yml/badge.svg)](https://github.com/GeunhwaJeong/fastnft/actions/workflows/rust.yml)
[![License](https://img.shields.io/badge/license-Apache-green.svg)](LICENSE.md)

This repository is dedicated to sharing material related to the Haneul protocol, developed at Novi Financial (formerly Calibra). Software is provided for research-purpose only and is not meant to be used in production.

## Summary

Haneul extends Haneul by allowing objects to be transacted.
...
## Quickstart with local Haneul network and interactive wallet
...
#### Example
```shell
haneul@HaneullabsLab release % ./wallet --no-shell addresses                                                                         
Showing 5 results.
...
## Quickstart with Haneul Prototype
...
# * `committee.json` is the public description of the Haneul committee.
for I in 1 2 3 4
do
    mkdir ./db"$I"
...
* Haneul is based on FastPay: [FastPay: High-Performance Byzantine Fault Tolerant Settlement](https://arxiv.org/pdf/2003.11506.pdf)
...
The content of this repository is licensed as [Apache 2.0](https://github.com/GeunhwaJeong/fastnft/blob/update-readme/LICENSE)
