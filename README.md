...
Haneul is backed by a number of state-of-the-art [peer-reviewed works](https://github.com/GeunhwaJeong/haneul/blob/main/docs/content/references/research-papers.mdx) and years of open source development.
