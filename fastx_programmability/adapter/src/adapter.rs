                ...
                for (struct_tag, bytes_opt) in addr_changes.into_resources() {
                    match bytes_opt {
                        Some(bytes) => {
                            ...
                            // TODO (https://github.com/GeunhwaJeong/fastnft/issues/30):
...
pub fn publish<E: Debug, S: ResourceResolver<Error = E> + ModuleResolver<Error = E> + Storage>(
    ...
    // TODO(https://github.com/GeunhwaJeong/fastnft/issues/57):
    ...
    for module in modules.iter_mut() {
        ...
        // TODO(https://github.com/GeunhwaJeong/fastnft/issues/56):
