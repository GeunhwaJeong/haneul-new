...
import { ObjectId, HaneulAddress, HaneulObjectResponse } from '@haneullabs/haneul.js';
import {
	Kiosk,
	KioskData,
	KioskItem,
 ...
 */
export function useOwnedKiosk(address: HaneulAddress | undefined) {
	...
	return useQuery({
		...
		queryFn: async (): Promise<{
			caps: KioskOwnerCap[];
			kioskId: HaneulAddress | undefined;
			kioskCap: HaneulAddress | undefined;
		} | null> => {
