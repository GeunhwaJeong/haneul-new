    ...
    <div className="max-w-4xl w-full mx-auto text-center">
      <Card spacing="xl">
        ...
        <div className="mt-8 mb-12 grid grid-cols-1 sm:grid-cols-3 gap-x-10 gap-y-4">
          <InfoItem title="A Haneul Wallet">
            You can download Haneul Wallet from{" "}
            <InfoLink href="https://chrome.google.com/webstore/detail/haneul-wallet/opcgpfmipidbgpenhmajoajpbobppdil">
              Chrome store here
            </InfoLink>
            .
          </InfoItem>
          <InfoItem title="Connect to Haneul Testnet">
            Frenemies game only works on Testnet network.{" "}
            <InfoLink href="https://docs.haneul.io/devnet/explore/wallet-browser#change-the-active-network">
              Learn more
            </InfoLink>
            .
          </InfoItem>
          <InfoItem title="HANEUL in your wallet">
            You can{" "}
            <InfoLink href="https://discord.com/channels/916379725201563759/1037811694564560966">
              request HANEUL on Discord
            </InfoLink>{" "}
