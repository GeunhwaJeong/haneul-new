...
import { MoveCallTransaction, LocalTxnDataSerializer, UnserializedSignableTransaction } from "@haneullabs/haneul.js";
...
export function Setup() {
  ...
  const createScorecard = useMutation(
    ...
    async (username: string) => {
      ...
      if (!gas) {
        throw new Error(`Gas object with at least '${gasSearch}' GEUNHWA not found`);
      }
      ...
      const submitTx: UnserializedSignableTransaction = {
        ...
        data: {
          ...
          module: "frenemies",
          function: "register",
          arguments: [username, config.VITE_REGISTRY, HANEUL_SYSTEM_ID],
          typeArguments: [],
          gasPayment: gas.reference.objectId,

          // TODO: Fix in haneul.js - add option to use bigint...
