  ...
  return (
    <div>
      ...
      <div className="mt-4 text-steel-darker text-heading6 leading-normal">
        Haneul Testnet Wave 2 will end Wednesday February 15 at 4pm PST. If you are
  ...
  return (
    <div>
      ...
      <div className="mt-4 text-steel-darker text-heading6 leading-tight">
        Thank you for helping test the Haneul network by playing the Haneul Frenemies
        game.
      </div>
    </div>
  );
    ...
    async (values: z.infer<typeof Schema>) => {
      const res = await fetch(
        import.meta.env.DEV
          ...
          : "https://apps-backend.haneul.io/frenemies",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div>
      ...
      <div className="mt-4 text-steel-darker text-heading6 leading-normal text-left">
        ...
        ownership of your Haneul address.
      </div>
      <form
      ...
      >
        ...
        <label className="text-bodySmall text-gray-60 font-medium flex items-center justify-center">
          ...
          <a
            ...
            className="text-haneul-dark ml-1"
          >
            Terms of Service
          </a>
        </label>
