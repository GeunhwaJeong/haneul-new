...
import { bcs as haneulBcs } from "@haneullabs/haneul.js";
import {
  ASSIGNMENT,
  DELEGATION,
  GENERIC_COIN,
...
export const bcs = haneulBcs
  ...
  // Haneul System + Validators schema
  .registerStructType(GENERIC_COIN, {
    id: "address",
    value: "u64",
  })
  .registerStructType(STAKED_HANEUL, {
    id: "address",
    validatorAddress: "address",
    poolStartingEpoch: "u64",
    delegationRequestEpoch: "u64",
    staked: "u64",
    haneulTokenLock: "Option<u64>",
  })
  .registerStructType(DELEGATION, {
    id: "address",
    stakedHaneulId: "address",
    // Balance<DelegationToken> = u64
    poolTokens: "u64",
    principalHaneulAmount: "u64",
  })
  .registerStructType(HANEUL_SYSTEM, {
    id: "address",
    epoch: "u64",
