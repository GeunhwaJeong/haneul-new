...
import { ValidatorMetaData } from "@haneullabs/haneul.js";
import { useWalletKit } from "@haneullabs/wallet-kit";
import clsx from "clsx";
import { FormEvent, useState } from "react";
import { useScorecard } from "../../network/queries/scorecard";
import { convertToString } from "../../network/queries/haneul-system";
...
export function ValidatorItem({ index, validator, stake, delegation }: Props) {
  ...
  return (
    ...
    >
      <div id={`validator-${validator.haneul_address}`}>{index + 1}</div>
        ...
        <div className="w-3/4">
          <div className="relative flex items-center">
            ...
            {delegation ? (
              ...
              <AddDelegation
                validator={validator.haneul_address}
                amount={amount}
              />
            )}
          </div>
      ...
      {validator.haneul_address.replace("0x", "") ===
