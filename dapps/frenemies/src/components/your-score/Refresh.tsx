...
import { HANEUL_SYSTEM_ID, useHaneulSystem } from "../../network/queries/haneul-system";
import { useMyType, useRawObject } from "../../network/queries/use-raw";
import { ObjectData } from "../../network/rawObject";
import { Coin, Leaderboard, LEADERBOARD, Scorecard, HANEUL_COIN } from "../../network/types";
