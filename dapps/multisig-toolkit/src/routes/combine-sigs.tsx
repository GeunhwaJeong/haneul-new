...
export default function MultiSigCombineSignatureGenerator() {
	...
	const { register, control, handleSubmit } = useForm({
		defaultValues: {
			pubKeys: [{ pubKey: 'Haneul Pubkey', weight: '', signature: 'Haneul Signature' }],
			threshold: 1,
		},
	});
	...
	const onSubmit = (data: FieldValues) => {
		...
		const multisigHaneulAddress = multiSigPublicKey.toHaneulAddress();
		setMSAddress(multisigHaneulAddress);
	...
	return (
		<div className="flex flex-col gap-4">
			...
			<form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
				<p>The following demo allow you to create Haneul MultiSig Combined Signatures.</p>
				<p>Haneul Pubkeys, weights, signatures for testing/playing with:</p>
				<div className="flex flex-col gap-2 bg-gray-600 p-4 rounded-md">
					<div className="flex gap-0 border-b">
						<div className="flex-1 font-bold border-r p-2">Haneul Pubkeys</div>
				...
				<section>
					<Button
						type="button"
						onClick={() => {
							append({ pubKey: 'Haneul Pubkey', weight: '', signature: 'Haneul Signature' });
						}}
					>
						New PubKey
					</Button>
...
/*
haneul keytool multi-sig-combine-partial-sig \
--pks \
ACaY7TW0MnPu+fr/Z2qH5YRybHsj80qfwfqiuduT4czi \
ABr818VXt+6PLPRoA7QnsHBfRpKJdWZPjt7ppiTl6Fkq \
ALDE3sq5JZOj3Hmo/UeUv14zi4TFQMFq/xCTaSH+swMS \
