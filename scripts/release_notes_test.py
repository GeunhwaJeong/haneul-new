...
diff --git a/crates/haneul-protocol-config/src/lib.rs b/crates/haneul-protocol-config/src/lib.rs
--- a/crates/haneul-protocol-config/src/lib.rs
+++ b/crates/haneul-protocol-config/src/lib.rs
@@ -25,7 +25,7 @@
...
"""
    ...
    def test_no_bump_when_file_not_changed(self, mock_check_output):
        ...
        mock_check_output.return_value = """
diff --git a/crates/haneul-core/src/lib.rs b/crates/haneul-core/src/lib.rs
--- a/crates/haneul-core/src/lib.rs
+++ b/crates/haneul-core/src/lib.rs
@@ -1,3 +1,4 @@
+// Some comment
"""
        from release_notes import pr_bumps_protocol_version
...
class TestDoGenerateProtocolVersionDisplay(unittest.TestCase):
    ...
    def test_includes_bump_pr_not_in_release_notes(self, mock_extract_pv, mock_git,
        ...
        self.assertIn("Haneul Protocol Version in this release: `110`", output)
