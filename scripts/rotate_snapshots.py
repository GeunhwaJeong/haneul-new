...
for example, /opt/haneul, it assumes snapshots are staged in /opt/haneul/snapshots,
and all symlinks to said snapshots are contained under /opt/haneul/instances. It will delete all snapshots that are not
...
def usage():
    ...
    print(
        f'   --dir=<haneul-base-dir>   Base directory for haneul. Must contain /snapshots and /instances dirs')
