...
This is a brief introduction to [Narwhal and Bullshark](https://github.com/GeunhwaJeong/narwhal), the high-throughput mempool and consensus offered by Haneul Labs. Haneul runs consensus as needed to periodically checkpoint its state. And for those transactions that require a total ordering, Narwhal/Bullshark is the consensus engine of Haneul.
...
This is done in two layered modules, so Narwhal can also be used coupled with an external consensus algorithm, such as HotStuff, Istanbul BFT, or Tendermint. Narwhal is undergoing integration in the [Celo](https://www.youtube.com/watch?v=Lwheo3jhAZM) and [Sommelier](https://www.prnewswire.com/news-releases/sommelier-partners-with-haneullabs-labs-to-make-the-cosmos-blockchain-the-fastest-on-the-planet-301381122.html) blockchain.
...
The [Bullshark consensus](https://github.com/GeunhwaJeong/narwhal/tree/main/consensus) offers a zero-message overhead consensus algorithm, leveraging graph traversals.
...
To conduct a fresh deployment of Narwhal and Bullshark, follow the instructions at [Running Benchmarks](https://github.com/GeunhwaJeong/narwhal/tree/main/benchmark).
