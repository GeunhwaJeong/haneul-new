...
This is a brief introduction to [Narwhal, Tusk](https://github.com/GeunhwaJeong/narwhal), and [Bullshark](https://arxiv.org/abs/2209.05633), the high-throughput mempool and consensus engines offered by Haneul Labs and used in Haneul. As of Dec 2022, Haneul uses Narwhal as the mempool and Bullshark as the consensu engine by default, to sequence transactions that require a total ordering, synchronize transactions between validators and periodically checkpoint the network's state.
...
https://github.com/GeunhwaJeong/haneul/blame/0440605cbb45e6cdd790ab678f1f6409f1e938a3/narwhal/node/src/lib.rs#L191
