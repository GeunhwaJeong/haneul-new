---
title: Narwhal, Bullshark, and Tusk, Haneul's Consensus Engine
---

This is a brief introduction to [Narwhal, Tusk](https://github.com/GeunhwaJeong/narwhal), and [Bullshark](https://arxiv.org/abs/2201.05677), the high-throughput mempool and consensus offered by Haneul Labs. Haneul runs consensus as needed to periodically checkpoint its state. And for those transactions that require a total ordering, Narwhal and either Bullshark or Tusk comprise the Haneul Consensus Engine.
...
- agreeing on a specific ordering of this data = [Bullshark](https://arxiv.org/abs/2201.05677) or [Tusk](https://github.com/GeunhwaJeong/narwhal)
