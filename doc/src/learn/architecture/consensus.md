...
The [consensus](https://github.com/GeunhwaJeong/haneul/blob/main/narwhal/consensus) component offers a zero-message overhead consensus algorithm, leveraging graph traversals.
