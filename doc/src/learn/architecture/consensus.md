...
The [Tusk consensus](https://github.com/GeunhwaJeong/narwhal/tree/main/consensus) offers a zero-message overhead consensus algorithm, leveraging graph traversals.
...
To conduct a fresh deployment of Narwhal and Tusk, follow the instructions at [Running Benchmarks](https://github.com/GeunhwaJeong/narwhal/tree/main/benchmark).
