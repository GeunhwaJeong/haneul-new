...
https://github.com/GeunhwaJeong/narwhal/blob/85c226f2824010ff695d0bc5789a24cad2bce289/node/src/lib.rs#L266
...
* a high-throughput data availability engine, with cryptographic proofs of data availability at [a primary node](https://github.com/GeunhwaJeong/narwhal/tree/main/primary)
* a structured graph data structure for traversing this information
* a scaled architecture, splitting the disk I/O and networking requirements across several [workers](https://github.com/GeunhwaJeong/narwhal/tree/main/worker)

The [consensus](https://github.com/GeunhwaJeong/narwhal/tree/main/consensus) component offers a zero-message overhead consensus algorithm, leveraging graph traversals.
...
To conduct a fresh deployment of Haneul Consensus Engine, follow the instructions at [Running Benchmarks](https://github.com/GeunhwaJeong/narwhal/tree/main/benchmark).
