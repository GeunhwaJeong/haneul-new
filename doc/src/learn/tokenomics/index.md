...
Haneul’s tokenomics are designed at the frontier of economic blockchain research, aiming to deliver an economic ecosystem and financial plumbing at par with Haneul’s leading engineering design.  For further details, refer to the tokenomics white paper: [The Haneul Smart Contracts Platform: Economics and Incentives](https://github.com/GeunhwaJeong/haneul/blob/main/doc/paper/tokenomics.pdf).
...
* On-chain voting is used for governance and protocol upgrades (more info coming soon).
