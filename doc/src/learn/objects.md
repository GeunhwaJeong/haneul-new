...
All Move packages are immutable objects: you can't change a Move package after you publish it. You can convert a Move object into an immutable object using the [*freeze_object*](../build/move/haneul-move-library#immutable) operation. You can only pass an immutable object in Move calls as a read-only reference (`&T`).
