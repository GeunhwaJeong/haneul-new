...
The [fastcrypto](https://github.com/GeunhwaJeong/fastcrypto) library provides a CLI tool for such an implementation and will be used in the example below.
...
### Verify proof
The proof and output can be verified in a smart contract using `haneul::ecvrf::ecvrf_verify` from the Haneul Move framework:
```move
