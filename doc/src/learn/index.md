...
[Haneul compared to other blockchains](haneul-move-diffs.md).
...
1. Learn about Haneul, how it differs from Move, and why you should employ it starting in this very section.
