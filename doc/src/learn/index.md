...
Check for the latest release of Haneul, including Release Notes, on the [Haneul Releases](https://github.com/GeunhwaJeong/haneul/releases) page.

### Doc updates

We list changes and updates to the documentation in the [Haneul documentation updates](../learn/haneul-doc-updates.md) topic.
