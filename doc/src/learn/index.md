...
* `haneul::id` is now `haneul::object` and `Info` is now `UID`. Use the [Object module](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/sources/object.move) that has [replaced the former ID.move](https://github.com/GeunhwaJeong/haneul/pull/3624).
