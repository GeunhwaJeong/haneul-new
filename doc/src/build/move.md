...
- (optional) have a mutable reference to an instance of the `TxContext` struct
  defined in the [TxContext module](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/sources/TxContext.move) as the last parameter
...
[dependencies]
Haneul = { local = "../../crates/haneul-framework" }
...
[TestScenario module](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/sources/TestScenario.move)
...
[ObjectOwner.move](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-core/src/unit_tests/data/object_owner/sources/ObjectOwner.move).
