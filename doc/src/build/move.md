...
blockchains with vastly different data and execution models. [Haneul](https://github.com/GeunhwaJeong/haneul/blob/main/README.md),
...
located in the
[haneul_programmability/framework/sources/Coin.move](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/framework/sources/Coin.move)
...
[haneul_programmability/framework/Move.toml](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/framework/Move.toml)
file.
...
[ID module](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/framework/sources/ID.move). The
...
`Coin<HANEUL>`, which represents a token used to pay for Haneul
computations (more generally known as _gas_) - in this case, the concrete type used to parameterize the
`Coin` struct is the `HANEUL` struct in the
[Coin module](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/framework/sources/Coin.move):
...
[Coin module](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/framework/sources/Coin.move), that is
the `value` function.
...
simplest entry functions is defined in the HANEUL
[module](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/framework/sources/HANEUL.move) to
...
- have parameters ordered as follows:
  ...
  defined in the [TxContext module](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/framework/sources/TxContext.move)
...
this package, first [install Haneul binaries](install.md).

Then clone the repository as described in
[Contributing to Haneul](../contribute/index.md#download-and-learn-haneul)
as this tutorial assumes you have a clone of Haneul's repository in your current directory.

Refer to the code example developed for this tutorial in the
[M1.move](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/tutorial/sources/M1.move) file.
...
to import the
[ID package](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/framework/sources/ID.move) from
...
# Haneul = { git = "https://github.com/GeunhwaJeong/haneul.git", subdir="haneul_programmability/framework", rev="44b5702712c15df365989a3b3f80038b7bf6c2ef"}

# Assuming the `haneul` repository is at the same level as the package parent directory
...
[Transfer module](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/framework/sources/Transfer.move):
...
[TestScenario module](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/framework/sources/TestScenario.move)
...
has to be _published_ to Haneul's [distributed ledger](../learn/how-haneul-works.md)
...
affects Move code development in Haneul - each module in a package can
...
[M1.move](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/tutorial/sources/M1.move).
...
#### Transfer to address
The [`Transfer`](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/framework/sources/Transfer.move) module provides all the APIs needed to manipuate the ownership of objects.
...
[ObjectOwner.move](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_core/src/unit_tests/data/object_owner/sources/ObjectOwner.move).
