...
* [How Haneul Move differs from Core Move](../../learn/haneul-move-diffs.md) - Highlights the differences between the core Move language and the Move we use in Haneul
* [Programming Objects Tutorial Series](../../build/programming-with-objects/index.md) - Tutorial series that walks through all the powerful ways to interact with objects in Haneul Move.
...
located in the
[coin.move](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/sources/coin.move)
...
[Move.toml](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/Move.toml)
file.
...
[object module](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/sources/object.move). The
...
[Coin module](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/sources/coin.move), that is
the `value` function.
...
- (optional) have a mutable reference to an instance of the `TxContext` struct
  defined in the [TxContext module](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/sources/tx_context.move) as the last parameter
...
[m1.move](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/examples/move_tutorial/sources/m1.move) file.
...
to import the
[Object package](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/sources/object.move) from
Haneul framework to gain access to the `Info` struct type defined
in this package.
...
[dependencies]
Haneul = { local = "../haneul/crates/haneul-framework" }

[addresses]
my_first_package = "0x0"
```

See the [Move.toml](https://github.com/GeunhwaJeong/haneul/blob/main/haneul_programmability/examples/move_tutorial/Move.toml)
...
`haneul::tx_context` and `haneul::transfer`. While this style of testing is
...
[Haneul CLI client documentation](cli-client.md) for a description of how
...
[m1.move](https://github.com/GeunhwaJeong/haneul/tree/main/haneul_programmability/examples/move_tutorial/sources/m1.move).
