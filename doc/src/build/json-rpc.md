...
Native transfer by `haneul_transferObject` is supported for coin
...
Follow the instructions to [sign the transaction](#2-sign-the-transaction-using-the-haneul-signtool).
...
purpose as the native coin transfer ([`haneul_transferObject`](#haneul_TransferObject)), and is mostly used for illustration
