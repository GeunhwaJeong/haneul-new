...
```shell
haneul client call --package 0x3 --module haneul_system --function request_set_gas_price --args 0x5 \"42\" --gas-budget <GAS-BUDGET-AMOUNT>
```
...
```shell
haneul client call --package 0x3 --module haneul_system --function report_validator --args 0x5 0x44840a79dd5cf1f5efeff1379f5eece04c72db13512a2e31e8750f5176285446 --gas-budget <GAS-BUDGET-AMOUNT>
```
