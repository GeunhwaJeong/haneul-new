...
* [Objects](../build/objects.md) - Haneul has programmable objects created and managed by Move packages (a.k.a. smart contracts). Move packages themselves
  are also objects. Thus, Haneul objects can be partitioned into two categories mutable data values and immutable packages.
* [Transactions](../build/transactions.md) - All updates to the Haneul ledger happen via a transaction. This section describes the transaction types
