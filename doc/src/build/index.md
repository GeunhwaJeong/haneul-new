...
1. [Connect](../build/wallet.md#rest-gateway) to the Haneul network Gateway service with the *Haneul Wallet*.
1. [Take](../build/programming-with-objects/index.md) the *Programming with Objects* codelab.
1. Build dApps:
   1. [Use](../build/rest-api.md) *Haneul REST Server and REST API* to interact with a local Haneul network.
