...
To configure the Haneul client:
```shell
$ haneul client
```
...
transfer an object from another account address, create an example NFT, or use the Haneul faucet to add coins to the address.
