...
| `new-address` | Generate new address and keypair with keypair scheme flag {ed25519 or secp256k1} with optional derivation path, default to m/44'/8282'/0'/0'/0' for ed25519 or m/54'/8282'/0'/0/0 for secp256k1. |
...
Haneul uses the active address if you do not specify one.
...
```shell
haneul client objects 0x913cf36f370613ed131868ac6f9da2420166062e
                 Object ID                  |  Version   |                    Digest                    |   Owner Type    |               Object Type
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
 0x66eaa38c8ea99673a92a076a00101ab9b3a06b55 |     0      | j8qLxVk/Bm9iMdhPf9b7HcIMQIAM+qCd8LfPAwKYrFo= |  AddressOwner   |      0x2::coin::Coin<0x2::haneul::HANEUL>
```
...
```shell
haneul client gas 0x562f07cf6369e8d22dbf226a5bfedc6300014837
```

## Create new account addresses

Haneul Client CLI includes 1 address by default. To add more, create new addresses for the client with the `new-address` command, or add existing accounts to the client.yaml.
...
```shell
haneul client objects 0x66af3898e7558b79e115ab61184a958497d1905a
```
...
```shell
haneul client transfer --to 0xf456ebef195e4a231488df56b762ac90695be2dd --object-id 0x66eaa38c8ea99673a92a076a00101ab9b3a06b55 --gas-budget 1000
```
...
```shell
haneul client objects 0x3cbf06e9997b3864e3baad6bc0f0ef8ec423cd75
```
...
```shell
haneul client objects 0x48ff0a932b12976caec91d521265b009ad5b2225
...
```shell
haneul client object 0x471c8e241d0473c34753461529b70f9c4ed3151b
```
...
```shell
haneul client publish $PATH_TO_PACKAGE/my_move_package --gas 0xc8add7b4073900ffb0a8b4fe7d70a7db454c2e19 --gas-budget 30000
```
...
**Note:** If your package includes unpublished depenedencies, you can add the `--with-unpublished-dependencies` flag to the `haneul client publish` command to include modules from those packages in the published build.
...
From now on, use the package object ID (`0xdbcee02bd4eb326122ced0a8540f15a057d82850`) in the Haneul client call
