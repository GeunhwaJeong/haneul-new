...
* Chained transactions in a Programmable Transaction block execute and fail atomically. This [example Defi transaction block](https://haneulexplorer.com/txblock/94u4E3hLbpbURU7Ja3NRSwk4Xvm22iq9GsTC5MrtLrnN?network=testnet&ref=blog.haneul.io) is a programmable transaction block with 12 operations - it performs five swaps across three distinct pools, mutating 20 existing objects and creating seven new ones in the process.
