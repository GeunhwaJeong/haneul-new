...
After you have the transaction block defined, you can directly execute it using the `signAndExecuteTransactionBlock` method on a HaneulClient.
...
```tsx
import { Inputs } from "@haneullabs/haneul.js/transactions";
