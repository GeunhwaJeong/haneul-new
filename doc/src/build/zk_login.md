...
zkLogin is a a Haneul native primitive and not a privilege of a particular wallet provider, and thus it can be integrated to any wallet provider, including mobile wallets.
