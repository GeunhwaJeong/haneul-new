...
1. Sign the transaction bytes with the ephemeral private key. This is the same as [traditional KeyPair signing](https://haneul-typescript-docs.vercel.app/typescript/cryptography/keypairs).
