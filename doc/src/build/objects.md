...
Haneul has programmable objects created and managed by [Move](move.md) packages (a.k.a. *smart contracts*). Move packages themselves are also objects. Thus, Haneul objects can be partitioned into two categories:
