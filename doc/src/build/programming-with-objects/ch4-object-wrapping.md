...
The full source code can be found in [TrustedSwap.move](../../../../haneul_programmability/examples/objects_tutorial/sources/TrustedSwap.move).

A more complex example of using direct wrapping can be found in [Escrow.move](../../../../haneul_programmability/examples/defi/sources/Escrow.move).
...
Full code can be found in [SimpleWarrior.move](../../../../haneul_programmability/examples/objects_tutorial/sources/SimpleWarrior.move).

You can also find a more complex example in [Hero.move](../../../../haneul_programmability/examples/games/hero/sources/Hero.move).
