...
```rust
public(script) fun request_swap(object: Object, fee: Coin<HANEUL>, service_address: address, ctx: &mut TxContext) {
...
The full source code can be found in [TrustedSwap.move](https://github.com/GeunhwaJeong/haneul/blob/main/haneul_programmability/examples/objects_tutorial/sources/TrustedSwap.move).
...
Full code can be found in [SimpleWarrior.move](https://github.com/GeunhwaJeong/haneul/blob/main/haneul_programmability/examples/objects_tutorial/sources/SimpleWarrior.move).
