...
All of the APIs for adding objects to persistent storage are defined in the [`transfer`](https://github.com/GeunhwaJeong/haneul/tree/main/crates/haneul-framework/packages/haneul-framework/sources/transfer.move) module. One key API is:
...
```shell
haneul client call --gas-budget <GAS-BUDGET-AMOUNT> --package $PACKAGE --module "color_object" --function "create" --args 0 255 0
```
