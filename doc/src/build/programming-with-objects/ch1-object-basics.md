...
Now let's try to call `create` in transactions and see what happens. To do this we need to start Haneul and the wallet. Follow the [Wallet Quick Start](../wallet.md) to start the Haneul network and set up the wallet.
