...
```
$ haneul client publish --path haneul_core/src/unit_tests/data/object_owner --gas-budget 5000
```
```
----- Publish Results ----
...
First of all, let's look at how to transfer a child object to an account address. The [Transfer](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-framework/sources/transfer.move) library provides the following API:
```rust
