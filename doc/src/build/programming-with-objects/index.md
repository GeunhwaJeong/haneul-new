...
Haneul is a blockchain centered around objects. Once you start programming non-trivial smart contracts on Haneul, you will start dealing with Haneul objects in the code. Haneul includes a very rich and comprehensive library and testing framework to allow you interact with objects in a safe and yet flexible way.

In this tutorial series, we will walk through all the powerful ways to interact with objects in Haneul Move. At the end, we will also walk through the designs of a few (close-to-)real world examples to demonstrate the tradeoffs of using different object types and ownership relationships.

Prerequisite Readings:
- [Learn about Haneul](../../learn/about-haneul.md)
- [Haneul Move](../move.md)
- [Haneul Objects](../objects.md)
