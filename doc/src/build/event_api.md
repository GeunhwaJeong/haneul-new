...
Haneul provides a few operators for combining filters:
...
```shell
>> {"jsonrpc":"2.0", "id": 1, "method": "haneul_subscribeEvent", "params": [{"All":[{"EventType":"MoveEvent"}, {"Package":"<PACKAGE-MODULE-ID>"}, {"Module":"nft"}]}]}
