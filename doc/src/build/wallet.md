...
the Haneul network authority's name, host and port information. It is used to establish connections
...
```shell
wallet --no-shell call --function transfer --module HANEUL --package 0x2 --args \"0x5044DC15D3C71D500116EB026E8B70D0A180F3AC\" \"0xF456EBEF195E4A231488DF56B762AC90695BE2DD\" --gas-budget 1000
```
