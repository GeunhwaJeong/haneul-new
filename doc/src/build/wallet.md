...
```shell
$ wallet switch --gateway https://gateway.devnet.haneul.io:443
```
...
haneul>-$ objects --address 0x913cf36f370613ed131868ac6f9da2420166062e
                 Object ID                  |  Version   |                                Digest
------------------------------------------------------------------------------------------------------------------------------
 0x0b8a4620426e526fa42995cf26eb610bfe6bf063 |     0      | o#6ea7e2d4bf47b3cc219fdc44bf15530244d3b3d1838d59586c0bb41d3db92221
```
  ...
  "contents": {
    "fields": {
      "balance": {
        ...
        "type": "0x2::balance::Balance<0x2::haneul::HANEUL>"
      },
      "id": {
        "fields": {
          "id": {
...
From now on, we can use the package object ID (`0x52fa2ff453cfecba06bb84b3b43147c586960e69`) in the Haneul wallet's call
