...
To initialize and start the network, you need to invoke the /haneul/genesis and /haneul/start endpoints as mentioned below.
...
The `genesis` command creates Haneul's initial state including four authorities and five user accounts
...
These are Haneul [objects](objects.md) used
...
The `start` command starts the Haneul network with the genesis configuration specified: 
...
representing five user accounts created during Haneul
[genesis](#post-haneulgenesis). Please note that actual numbers you will
...
Haneul genesis. Consequently, **do not copy and paste the actual values
