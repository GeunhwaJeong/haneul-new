...
To create these prototypes, we worked with game development studio Geniteam, who built the prototypes with the Unity SDK along with Haneul [APIs](https://app.swaggerhub.com/apis/HaneulLabs/haneul-api/0.1).

Geniteam developers that worked on this collaboration are not smart contract or Move developers. With this project, we started gathering data on what is the best way to design SDKs that make it easy to start building on Haneul.
...
The first prototype is [Haneul Monstar](https://haneul.io/haneul_monstar), a pet simulation game.
...
* Usability-focused APIs make building on Haneul easy.
