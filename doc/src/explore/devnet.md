...
```shell
$ wallet publish --path <your-haneul-repo>/haneul_programmability/examples/move_tutorial --gas-budget 30000
```
...
In order to create a sword and transfer it to another player, we use the following command to call the `sword_create` [function](https://github.com/GeunhwaJeong/haneul/blob/f4afb603801c90236772a1b2b56f2e216a9adf82/haneul_programmability/examples/move_tutorial/sources/M1.move#L44) in the `M1` [module](https://github.com/GeunhwaJeong/haneul/blob/f4afb603801c90236772a1b2b56f2e216a9adf82/haneul_programmability/examples/move_tutorial/sources/M1.move#L4) of the package we previously published.
