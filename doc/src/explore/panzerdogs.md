...
> "“Haneul provides exciting new options for Panzerdogs and blockchain gaming in general. Development on Haneul is fast and on point. The ownership programming model is very suited for decentralised gaming and offers security while also avoiding the need of bottlenecks like Proof-of-Work. Not only is its transaction speed impressive, but its ability to echo NFTs and its dynamic handling of on-chain assets can bring new value to users and the assets that they own. Imagine importing all your NFTs into a game, upgrading them into new, usable assets and enhance the gaming experience and the in-game economy. Not only do the NFTs become a part of the gaming experience, but the game also becomes a part of the NFT. Looking forward to seeing how Haneul will impact web3 gaming!”

## HaneulEcho

HaneulEcho is one of the first open source tools we are building to grow the Haneul ecosystem. Specifically, HaneulEcho lets owners of existing NFTs port them into Haneul and use them to explore new functionality (read more about HaneulEcho [here](https://medium.com/@media-haneullabs/d3a59606dfcb)).

An exciting feature of the Panzerdogs gameplay is that it lets users port-in their NFTs to be used as avatars within their game. Haneul is optimized to deliver high throughput, low latency, and low cost, making an ideal network for running in-game assets that need to move around often, cheaply, and easily. More importantly, Haneul’s design enables fully on-chain data storage, implying that in-game customizations and upgrades can be immediately reflected on Haneul. These characteristics make Haneul an ideal platform for running a game such as Panzerdogs, where the user’s NFTs and gameplay are deeply intertwined.

![PanzerdogsHaneulEcho](/static/haneulpanzerdogs1.png)
*Panzerdogs lets users HaneulEcho their existing NFTs*

## How does HaneulEcho work?

Beyond optimizing Haneul’s performance, one of our goals is to create the tooling that makes Haneul accessible and easy to use (read more about our Haneul Developer Kit [here](https://medium.com/@media-haneullabs/488ec3f3f1d2)). In that spirit, we’re in the process of creating a simple HaneulEcho white label solution to help users create Haneul-based NFTs.

The HaneulEcho white label begins by asking users to connect their existing address from other networks. This makes the cross-chain user interface as easy as possible from the user’s perspective.

![HaneulEcho white-labe](/static/haneulpanzerdogs2.png)
*The HaneulEcho white-label UI connects with existing wallets*

The user can then visualize their overall NFT portfolio and choose which to Echo into Haneul.
...
With HaneulEcho, users can easily bring in their NFTs to Haneul and unlock new functionality. Now users are ready to use their NFTs as avatars within Panzerdogs and explore the many rich synergies between on-chain ownership and gameplay.
