...
Publishing a coin in Haneul is similar to publishing a new type; however, it's a little more complicated as it requires using a [One Time Witness](../explore/move-examples/basics.md#one-time-witness).
