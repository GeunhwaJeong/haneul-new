...
[Haneul Explorer](https://explorer.haneul.io/) lets you view data about transactions and activity on the Haneul network. In addition to viewing activity on the network, you can use the Explorer to:
 ...
 * View validators and geographic locations of currently active full nodes.
 ...
 See the [Haneul Explorer README](https://github.com/GeunhwaJeong/haneul/tree/main/apps/explorer#readme) for instructions on how to run the Explorer locally.

## Choose a network

When you open Haneul Explorer, it displays the transactions for the Devnet network by default. You can also use the Explorer to view data for a local network running in your environment or a custom RPC endpoint URL. Use the drop-down menu at the top-right of the page to choose a different network.
...
When you open Haneul Explorer, the page displays network stats, transactions, and top validators on the network. The **Transactions** table lists the most recent transaction first.
 ...
 * **Type** - The type of transaction, one of Call, TransferHaneul, TransferObject, or Publish.
     ...
     * **TransferHaneul** - A transaction to transfer Haneul from one address to another.
