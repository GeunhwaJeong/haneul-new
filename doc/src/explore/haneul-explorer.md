 ...
 * **Type** - the type of transaction, one of Call, TransferHaneul, TransferObject, or Publish.
     ...
     * **TransferHaneul** - Indicates that the transaction transferred Haneul from one address to another.
 ...
 * **Gas** - Shows the amount of Haneul used to pay for the gas required to complete the transaction.
