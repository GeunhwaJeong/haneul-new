...
the Haneul network. Haneul wallet uses the network information to communicate
...
variable contains Haneul network authorities' name, host and port information.
...
```shell
./haneul genesis --config genesis.conf
```
