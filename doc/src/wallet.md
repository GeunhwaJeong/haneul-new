...
the Haneul network. The keystore file contains all the public-private key pair of the created accounts.
...
The `authorities` variable contains Haneul network authorities' name, host and port information.
It is used to establish connections to the Haneul network.
