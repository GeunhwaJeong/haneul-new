---
title: Profiling Haneul on Mac OS using XCode instruments.
---
...
* Build whatever Haneul component you want to run normally with `cargo build` - these docs assume `target/debug/haneul`.
