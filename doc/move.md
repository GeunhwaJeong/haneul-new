...
bootstrap Haneul operations, for example to create and manipulate gas
...
name, so that it can be identified by the Haneul platform. For the
...
included with Haneul genesis will do what they are intended to do
correctly.
...
will simply call into existing Haneul framework code.
