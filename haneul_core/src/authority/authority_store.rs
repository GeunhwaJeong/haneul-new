...
pub struct HaneulDataStore<const ALL_OBJ_VER: bool> {
...
impl<const ALL_OBJ_VER: bool> HaneulDataStore<ALL_OBJ_VER> {
    ...
    ) -> Result<(TxSequenceNumber, TransactionInfoResponse), HaneulError> {
    ...
    ) -> Result<Option<TxSequenceNumber>, HaneulError> {
...
impl<const ALL_OBJ_VER: bool> ModuleResolver for HaneulDataStore<ALL_OBJ_VER> {
