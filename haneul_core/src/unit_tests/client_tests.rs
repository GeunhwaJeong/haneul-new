...
use haneul_types::object::{Data, Object, GAS_VALUE_FOR_TESTING, OBJECT_START_VERSION};
...
async fn get_package_obj(
    client: &mut ClientState<LocalAuthorityClient>,
    objects: &[(ObjectRef, HaneulAddress)],
    gas_object_ref: &ObjectRef,
) -> Option<ObjectRead> {
...
async fn test_module_publish_and_call_good() {
    ...
    hero_path.push_str("/../haneul_programmability/examples/");
...
async fn test_module_publish_file_path() {
    ...
    hero_path.push_str("/../haneul_programmability/examples/Hero.move");
...
async fn test_module_publish_bad_path() {
    ...
    // Use a bad path
    hero_path.push_str("/../haneul_____programmability/examples/");
