...
use haneul_types::crypto::{get_key_pair_from_rng, KeyPair, Signature};
use haneul_types::gas_coin::GasCoin;
use haneul_types::messages::{
    CertifiedTransaction, SignatureAggregator, Transaction, TransactionData,
};
use haneul_types::object::{MoveObject, Object, Owner};
use haneul_types::serialize::serialize_cert;
...
fn test_keypair() -> (HaneulAddress, KeyPair) {
