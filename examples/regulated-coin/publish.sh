...
ADMIN_ADDRESS=$(haneul client active-address)

echo "- Publisher Address is: ${ADMIN_ADDRESS}"

publish_res=$(haneul client publish --json ${MOVE_PACKAGE_PATH})
