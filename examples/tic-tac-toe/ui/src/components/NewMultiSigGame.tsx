...
export function NewMultiSigGame(): ReactElement {
	...
	return (
		<>
			...
			/>
			<ComputedField
				value={opponent ? opponent.toHaneulAddress() : undefined}
			...
			<Em>
				...
				<Text as="div">
					...
					Although addresses on Haneul are derived from public keys, the derivation cannot be reversed,
...
/**
 * If `key` is a valid base64 encoded Haneul public key, return it as a
