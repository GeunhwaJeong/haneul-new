...
use haneul_indexer_alt_framework::types::collection_types::VecMap;
use haneul_indexer_alt_framework::types::dynamic_field::Field;
use haneul_indexer_alt_framework::types::id::UID;
...
pub fn extract_content_from_metadata(
    tag: &StructTag,
    object: &Object,
) -> anyhow::Result<Option<(BlogPostMetadata, HaneulAddress)>> {
    ...
    let publisher = HaneulAddress::from_str(publisher)
