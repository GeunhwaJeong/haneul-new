...
This is an extention of the [Custom Indexer guide](https://docs.haneul.io/guides/developer/advanced/custom-indexer) to show how to index Walrus blobs and their associated `Metadata` dynamic fields.
