...
As of writing, the SequentialConfig is defined [here](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-indexer-alt-framework/src/pipeline/sequential/mod.rs#L68) consisting of a committer config and a checkpoint lag. The default values set `checkpoint_lag` to 0, and the committer config as follows:
```
...
The ingestion config is defined [here](https://github.com/GeunhwaJeong/haneul/blob/main/crates/haneul-indexer-alt-framework/src/ingestion/mod.rs#L59) with defaults configured to:
```
