-- This table maps a blob to its associated Haneul Blob object and the latest dynamic field metadata
...
CREATE TABLE IF NOT EXISTS blog_post (
    ...
    -- ID of the Blob object on Haneul, used during reads to fetch the actual blob content. If this
