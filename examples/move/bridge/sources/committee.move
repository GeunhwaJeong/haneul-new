...
module bridge::committee {
    ...
    struct CommitteeMember has drop, store {
        /// The Haneul Address of the validator
    ...
    public(friend) fun create(_ctx: &TxContext): BridgeCommittee {
        ...
        vec_map::insert(&mut members, bridge_pubkey_bytes, CommitteeMember {
            // TODO: why do we need haneul_address?
            haneul_address: address::from_u256(1),
            bridge_pubkey_bytes,
            voting_power: 2500,
        ...
        vec_map::insert(&mut members, bridge_pubkey_bytes, CommitteeMember {
            haneul_address: address::from_u256(2),
            bridge_pubkey_bytes,
            voting_power: 2500,
        ...
        vec_map::insert(&mut members, bridge_pubkey_bytes, CommitteeMember {
            haneul_address: address::from_u256(3),
            bridge_pubkey_bytes,
            voting_power: 2500,
        ...
        vec_map::insert(&mut members, bridge_pubkey_bytes, CommitteeMember {
            haneul_address: address::from_u256(4),
            bridge_pubkey_bytes,
            voting_power: 2500,
    ...
    public fun verify_signatures(
        ...
        let message_bytes = HANEUL_MESSAGE_PREFIX;
