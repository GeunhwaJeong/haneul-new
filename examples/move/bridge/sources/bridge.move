...
module bridge::bridge {
    ...
    const EInvariantHaneulInitializedTokenTransferShouldNotBeClaimed: u64 = 13;
    ...
    // Record bridge message approvals in Haneul, called by the bridge client
    ...
    public fun approve_bridge_message(
        ...
        // retrieve pending message if source chain is Haneul, the initial message must exist on chain.
