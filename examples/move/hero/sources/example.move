...
use haneul::{balance::{Self, Balance}, coin::{Self, Coin}, event, haneul::HANEUL};
...
/// you pay for it.
public fun new_sword(game: &mut Game, payment: Coin<HANEUL>, ctx: &mut TxContext): Sword {
...
public fun take_payment(admin: &Admin, game: &mut Game, ctx: &mut TxContext): Coin<HANEUL> {
