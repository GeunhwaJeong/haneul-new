...
module shared_no_tto::shared_cash_register {
    ...
    public fun process_payment(register: &mut CashRegister, payment_id: u64, ctx: &TxContext): Coin<HANEUL> {
    ...
    public fun pay(register: &mut CashRegister, payment_id: u64, coin: Coin<HANEUL>, ctx: &mut TxContext) {
