...
impl<'a> ObjectRuntime<'a> {
    ...
    pub fn record_settlement_haneul_conservation(&mut self, input_haneul: u64, output_haneul: u64) {
        self.state.settlement_input_haneul += input_haneul;
        self.state.settlement_output_haneul += output_haneul;
    }
