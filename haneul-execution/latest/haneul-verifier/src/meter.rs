...
struct HaneulVerifierMeterBounds {
    name: String,
    ticks: u128,
    max_ticks: Option<u128>,
}

impl HaneulVerifierMeterBounds {
...
pub struct HaneulVerifierMeter {
    transaction_bounds: HaneulVerifierMeterBounds,
    package_bounds: HaneulVerifierMeterBounds,
    module_bounds: HaneulVerifierMeterBounds,
    function_bounds: HaneulVerifierMeterBounds,
}

impl HaneulVerifierMeter {
    ...
    fn get_bounds_mut(&mut self, scope: Scope) -> &mut HaneulVerifierMeterBounds {
        match scope {
    ...
    fn get_bounds(&self, scope: Scope) -> &HaneulVerifierMeterBounds {
        match scope {
...
impl Meter for HaneulVerifierMeter {
