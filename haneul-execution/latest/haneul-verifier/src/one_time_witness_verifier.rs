...
pub fn verify_module(
    ...
    // In Haneul's framework code there is an exception to the one-time witness type rule - we have a
    // HANEUL type in the haneul module but it is instantiated outside of the module initializer (in fact,
