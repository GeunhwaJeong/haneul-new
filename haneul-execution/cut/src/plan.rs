...
mod tests {
    ...
    fn test_no_workspace() {
        ...
        expect!["No [workspace] found at $PATH/haneul-execution/cut/Cargo.toml/Cargo.toml"]
    ...
    fn test_cut_plan_discover() {
        ...
        let plan = CutPlan::discover(Args {
            ...
            packages: vec![
                ...
                "haneul-adapter-latest".to_string(),
                "haneul-execution-cut".to_string(),
                "haneul-verifier-latest".to_string(),
            ],
        })
        .unwrap();
            ...
            CutPlan {
                ...
                packages: {
                    ...
                    "haneul-adapter-latest": CutPackage {
                        ...
                        dst_path: "$PATH/haneul-execution/exec-cut/haneul-adapter",
                        ws_state: Member,
                    },
                    "haneul-execution-cut": CutPackage {
                        dst_name: "haneul-execution-cut-feature",
                        src_path: "$PATH/haneul-execution/cut",
                        dst_path: "$PATH/haneul-execution/cut-cut",
                        ws_state: Member,
                    },
                    "haneul-verifier-latest": CutPackage {
        ...
        expect![[r#"
            ...
            new [workspace] members:
             - to:   haneul-adapter-feature
                     haneul-execution/exec-cut/haneul-adapter
               from: haneul-adapter-latest
                     haneul-execution/latest/haneul-adapter
             - to:   haneul-execution-cut-feature
                     haneul-execution/cut-cut
               from: haneul-execution-cut
                     haneul-execution/cut
             - to:   haneul-verifier-feature
                     haneul-execution/exec-cut/haneul-verifier
               from: haneul-verifier-latest
                     haneul-execution/latest/haneul-verifier
            ...
            CutPlan {
                ...
                packages: {
                    ...
                    "haneul-adapter-latest": CutPackage {
                        dst_name: "haneul-adapter-feature",
                        src_path: "$PATH/haneul-execution/latest/haneul-adapter",
                        dst_path: "$PATH/haneul-execution/feature/haneul-adapter",
                        ws_state: Member,
                    },
                    "haneul-execution-cut": CutPackage {
                        dst_name: "haneul-execution-cut-feature",
                        src_path: "$PATH/haneul-execution/cut",
                        dst_path: "$PATH/haneul-execution/feature/cut",
                        ws_state: Member,
                    },
                    "haneul-verifier-latest": CutPackage {
                        dst_name: "haneul-verifier-feature",
