...
// Event function
pub const HANEUL_EVENT_EMIT_EVENT: FunctionIdent =
    (HANEUL_FRAMEWORK_ADDRESS, EVENT_MODULE, ident_str!("emit"));
pub const HANEUL_EVENT_EMIT_AUTHENTICATED: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
    EVENT_MODULE,
    ident_str!("emit_authenticated"),
);
pub const HANEUL_EVENT_NUM_EVENTS: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
    EVENT_MODULE,
    ident_str!("num_events"),
);
pub const HANEUL_EVENT_EVENTS_BY_TYPE: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
    EVENT_MODULE,
...
pub const HANEUL_TRANSFER_PUBLIC_TRANSFER: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
    TRANSFER_MODULE,
    ident_str!("public_transfer"),
);
pub const HANEUL_TRANSFER_PUBLIC_FREEZE_OBJECT: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
    TRANSFER_MODULE,
    ident_str!("public_freeze_object"),
);
pub const HANEUL_TRANSFER_PUBLIC_SHARE_OBJECT: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
    TRANSFER_MODULE,
    ident_str!("public_share_object"),
);
pub const HANEUL_TRANSFER_PUBLIC_RECEIVE: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
    TRANSFER_MODULE,
    ident_str!("public_receive"),
);
pub const HANEUL_TRANSFER_RECEIVING_OBJECT_ID: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
    TRANSFER_MODULE,
    ident_str!("receiving_object_id"),
);
pub const HANEUL_TRANSFER_PUBLIC_PARTY_TRANSFER: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
    TRANSFER_MODULE,
...
pub const HANEUL_TRANSFER_TRANSFER: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
    TRANSFER_MODULE,
    ident_str!("transfer"),
);
pub const HANEUL_TRANSFER_FREEZE_OBJECT: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
    TRANSFER_MODULE,
    ident_str!("freeze_object"),
);
pub const HANEUL_TRANSFER_SHARE_OBJECT: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
    TRANSFER_MODULE,
    ident_str!("share_object"),
);
pub const HANEUL_TRANSFER_RECEIVE: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
    TRANSFER_MODULE,
    ident_str!("receive"),
);
pub const HANEUL_TRANSFER_PARTY_TRANSFER: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
    TRANSFER_MODULE,
...
pub const HANEUL_COIN_REGISTRY_NEW_CURRENCY: FunctionIdent = (
    HANEUL_FRAMEWORK_ADDRESS,
...
pub const EXHAUSTIVE_MODULES: &[(AccountAddress, &IdentStr)] = &[
    (HANEUL_FRAMEWORK_ADDRESS, EVENT_MODULE),
    (HANEUL_FRAMEWORK_ADDRESS, TRANSFER_MODULE),
];
...
pub const FUNCTIONS_TO_CHECK: &[(FunctionIdent, &[/* is internal */ bool])] = &[
    ...
    // event functions
    (HANEUL_EVENT_EMIT_EVENT, &[true]),
    (HANEUL_EVENT_EMIT_AUTHENTICATED, &[true]),
    (HANEUL_EVENT_NUM_EVENTS, &[]),
    (HANEUL_EVENT_EVENTS_BY_TYPE, &[false]),
    // public transfer functions
    (HANEUL_TRANSFER_PUBLIC_TRANSFER, &[false]),
    (HANEUL_TRANSFER_PUBLIC_FREEZE_OBJECT, &[false]),
    (HANEUL_TRANSFER_PUBLIC_SHARE_OBJECT, &[false]),
    (HANEUL_TRANSFER_PUBLIC_RECEIVE, &[false]),
    (HANEUL_TRANSFER_RECEIVING_OBJECT_ID, &[false]),
    (HANEUL_TRANSFER_PUBLIC_PARTY_TRANSFER, &[false]),
    // private transfer functions
    (HANEUL_TRANSFER_TRANSFER, &[true]),
    (HANEUL_TRANSFER_FREEZE_OBJECT, &[true]),
    (HANEUL_TRANSFER_SHARE_OBJECT, &[true]),
    (HANEUL_TRANSFER_RECEIVE, &[true]),
    (HANEUL_TRANSFER_PARTY_TRANSFER, &[true]),
    // coin registry functions
    (HANEUL_COIN_REGISTRY_NEW_CURRENCY, &[true]),
];
...
/// Several functions in the Haneul Framework have `internal` type parameters, whose arguments must be
...
/// To avoid, issues, all `su::transfer` and `haneul::event` functions must be configured in `INTERNAL_FUNCTIONS`.
...
pub fn callee_package_name(callee_addr: &AccountAddress) -> Cow<'static, str> {
    match *callee_addr {
        HANEUL_FRAMEWORK_ADDRESS => Cow::Borrowed("haneul"),
...
pub fn help_message(
    ...
    if *callee_addr == HANEUL_FRAMEWORK_ADDRESS && callee_module == TRANSFER_MODULE {
        format!(
            " If the type has the 'store' ability, use the public variant instead: 'haneul::transfer::public_{}'.",
            callee_function
        )
    } else {
        String::new()
