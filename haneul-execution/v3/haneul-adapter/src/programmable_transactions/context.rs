...
mod checked {
    ...
    pub fn finish(
        ...
        settlement_input_haneul: u64,
        settlement_output_haneul: u64,
        ...
        let accumulator_events = accumulator_events
            ...
            .map(|accum_event| {
                ...
                let write = AccumulatorWriteV1 {
                    address,
                    operation: accum_event.action.into_haneul_accumulator_action(),
                    value,
                };
        ...
        Ok(match call_arg {
            ...
            CallArg::FundsWithdrawal(FundsWithdrawalArg {
                ...
                let limit = match reservation {
                    haneul_types::transaction::Reservation::MaxAmountU64(u) => U256::from(u),
                };
    ...
    fn convert_vm_error<S: MoveResolver<Err = HaneulError>>(
        error: VMError,
        vm: &MoveVM,
        state_view: &S,
    ...
    /// Special case errors for type arguments to Move functions
    fn convert_type_argument_error<S: MoveResolver<Err = HaneulError>>(
        idx: usize,
        error: VMError,
        vm: &MoveVM,
        state_view: &S,
