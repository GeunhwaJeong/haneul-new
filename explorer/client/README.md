...
The Haneul Explorer frontend will use the DevNet Gateway server by default: https://gateway.devnet.haneul.io:443
...
See [Experiment with Haneul DevNet](https://docs.haneul.io/explore/devnet) for use.
