...
Note that the command `yarn test` is the exception. Here the HaneulExplorer will instead use the static JSON dataset. The tests have been written to specifically check the UI and not the API connection.
