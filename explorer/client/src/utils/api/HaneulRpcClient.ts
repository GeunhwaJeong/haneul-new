...
export interface HaneulObject<T = ContentsDefault> {
    contents: T;
...
const rpcUrl = tryGetRpcSetting() ?? 'https://demo-rpc.haneul.io';
export const DefaultRpcClient = new HaneulRpcClient(rpcUrl);
