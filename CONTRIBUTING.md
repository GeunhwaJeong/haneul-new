...
For detailed guidance on how to contribute to the Rust code in the Haneul repository refer to [Coding Guidelines](https://developers.libra.org/docs/coding-guidelines).
...
1. Fork `haneul` repository and create your branch from `main`.
