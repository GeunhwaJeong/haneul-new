...
- `haneul:signTransaction` - Used to prompt the user to sign a transaction, and return the serialized transaction and transaction signature back to the dapp. This method does not submit the transaction for execution.
