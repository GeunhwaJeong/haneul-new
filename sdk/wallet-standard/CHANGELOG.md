...
- 956ec28eb: Change `signMessage` to return message bytes. Add support for haneul:signMessage in the
  wallet standard
...
- 0a7b42a6d: This changes almost all occurences of "delegate", "delegation" (and various
  ...
  convention.
- c718deef4: wallet-standard: changes haneul:signAndExecuteTransaction and haneul:signTransaction features
...
- dbe73d5a4: Add an optional `contentOptions` field to `HaneulSignAndExecuteTransactionOptions` to
...
- 473005d8f: Add protocol_version to CheckpointSummary and HaneulSystemObject. Consolidate end-of-epoch
