...
(async () => {
	...
	// Read only call
	console.log(await mmClient.checkManagerBalance('MANAGER_1', 'HANEUL'));
	console.log(await mmClient.getLevel2Range('HANEUL_DBUSDC', 0.1, 100, true));

	// // Balance manager contract call
	// mmClient.balanceManager.depositIntoManager('MANAGER_1', 'HANEUL', 10)(tx);
