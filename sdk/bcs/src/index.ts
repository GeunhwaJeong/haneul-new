...
export class BCS {
	 ...
	 * @example
	 * ```
	 * let bcs = new BCS(getHaneulMoveConfig());
	 ...
	 * @example
	 * bcs.registerAddressType('address', HANEUL_ADDRESS_LENGTH);
	 ...
	 * @example
	 * let { typeName, typeParams } = parseTypeName('Option<Coin<HANEUL>>');
	 * // typeName: Option
	 * // typeParams: [ 'Coin<HANEUL>' ]
	 *
...
export function getHaneulMoveConfig(): BcsConfig {
	return {
		genericSeparators: ['<', '>'],
		vectorType: 'vector',
		addressLength: HANEUL_ADDRESS_LENGTH,
