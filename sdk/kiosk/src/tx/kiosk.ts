...
import { HaneulAddress, TransactionArgument, TransactionBlock } from '@haneullabs/haneul.js';
...
/**
 * Call the `kiosk::purchase<T>(Kiosk, ID, Coin<HANEUL>)` function and receive an Item and
...
/**
 * Call the `kiosk::withdraw(Kiosk, KioskOwnerCap, Option<u64>)` function and receive a Coin<HANEUL>.
