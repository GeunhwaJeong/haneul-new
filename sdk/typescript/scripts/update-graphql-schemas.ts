...
const result = execSync(`git branch --remote --list "origin/releases/haneul-graphql-rpc-v*"`)
	.toString()
	.trim()
	.split('\n')
	.map((ref) => {
...
await addSchemaVersion(
	'latest',
	'https://raw.githubusercontent.com/HaneulLabs/haneul/refs/heads/mainnet/crates/haneul-graphql-rpc/schema.graphql',
);
