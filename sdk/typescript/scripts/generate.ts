...
const options: {
	...
	types: {
		...
		Data: { alias: 'HaneulParsedData' },
		Event: { alias: 'HaneulEvent' },
		EventFilter: { alias: 'HaneulEventFilter' },
		EventID: { alias: 'EventId' },
		GasData: { alias: 'HaneulGasData' },
		MoveFunctionArgType: { alias: 'HaneulMoveFunctionArgType' },
		ObjectChange: { alias: 'HaneulObjectChange' },
		ObjectData: { alias: 'HaneulObjectData' },
		ObjectDataOptions: { alias: 'HaneulObjectDataOptions' },
		ObjectRef: { alias: 'HaneulObjectRef' },
		ObjectResponseQuery: { alias: 'HaneulObjectResponseQuery' },
		Owner: { alias: 'ObjectOwner' },
		PaginatedHaneulObjectResponse: { alias: 'PaginatedObjectsResponse' },
		...
		TransactionBlockResponseOptions: { alias: 'HaneulTransactionBlockResponseOptions' },
		TransactionBlockResponseQuery: { alias: 'HaneulTransactionBlockResponseQuery' },
...
export function normalizeMethodName(name: string): string {
	if (name.startsWith('haneul_')) {
		return normalizeMethodName(name.slice(4));
	}

	if (name.startsWith('haneulx_')) {
