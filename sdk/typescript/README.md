...
Note that the `latest` tag for the [published SDK](https://www.npmjs.com/package/@haneullabs/haneul.js)
...
[current release of the SDK](https://www.npmjs.com/package/@haneullabs/haneul.js) at
