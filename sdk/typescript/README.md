...
Follow the [JSON RPC doc](https://github.com/GeunhwaJeong/haneul/blob/main/doc/src/build/json-rpc.md) to start a local network and local RPC server
...
const provider = new JsonRpcProvider('https://gateway.devnet.haneul.io:9000/');
...
const signer = new RawSigner(
  keypair,
  new JsonRpcProvider('https://gateway.devnet.haneul.io:9000/')
);
const txn = await signer.transferCoin({
  signer: keypair.getPublicKey().toHaneulAddress(),
