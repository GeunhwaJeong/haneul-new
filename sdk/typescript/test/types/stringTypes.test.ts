...
import { isValidTransactionDigest, isValidHaneulAddress } from '../../src/index';
...
describe('String type guards', () => {
  ...
  describe('isValidHaneulAddress() / isValidObjectID()', () => {

    it('rejects non-hex strings', () => {
      expectAll([
        'MDpQc 1IIzkie1dJdj nfm85XmRCJmk KHVUU05Abg==',
        'X09wJFxwQDdTU1tzMy5NJXdSTnknPCh9J0tNUCdmIw  ',
      ], isValidHaneulAddress, false);
    });
