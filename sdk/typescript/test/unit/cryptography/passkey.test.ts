...
describe('passkey signer E2E testing', () => {
	...
	it('should verify a transaction from rust implementation', async () => {
		// generated test vector from `test_passkey_authenticator` in crates/haneul-types/src/unit_tests/passkey_authenticator_test.rs
		let sig = fromBase64(
	...
	it('should verify a transaction from a real passkey output', async () => {
		// generated test vector from a real iphone passkey output from broswer app: https://github.com/joyqvq/haneul-webauthn-poc
		let sig = fromBase64(
