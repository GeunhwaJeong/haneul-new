...
describe('Keypair', () => {
	...
	it('`toHaneulAddress()` should return a valid haneul address', async () => {
		expect(k1.toHaneulAddress()).toEqual(pk1.toHaneulAddress());
		expect(k1.toHaneulAddress()).toEqual(
			'0xafedf3bc60bd296aa6830d7c48ca44e0f7a32478ae4bd7b9a6ac1dc81ff7b29b',
		);

		expect(k2.toHaneulAddress()).toEqual(pk2.toHaneulAddress());
		expect(k2.toHaneulAddress()).toEqual(
			'0x7e4f9a35bf3b5383802d990956d6f3c93e6184ebbbcf0820c124ab3a59ef77ac',
		);

		expect(k3.toHaneulAddress()).toEqual(pk3.toHaneulAddress());
