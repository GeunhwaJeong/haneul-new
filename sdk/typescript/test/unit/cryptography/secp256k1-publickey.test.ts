...
import { toBase64, toHex } from '@haneullabs/bcs';
...
// ../haneul/target/debug/haneul client new-address secp256k1
// ../haneul/target/debug/haneul keytool list
const TEST_CASES = [
	{
		rawPublicKey: 'AwTC3jVFRxXc3RJIFgoQcv486QdqwYa8vBp4bgSq0gsI',
		haneulPublicKey: 'AQMEwt41RUcV3N0SSBYKEHL+POkHasGGvLwaeG4EqtILCA==',
		haneulAddress: '0xcdce00b4326fb908fdac83c35bcfbda323bfcc0618b47c66ccafbdced850efaa',
	},
	{
		rawPublicKey: 'A1F2CtldIGolO92Pm9yuxWXs5E07aX+6ZEHAnSuKOhii',
		haneulPublicKey: 'AQNRdgrZXSBqJTvdj5vcrsVl7ORNO2l/umRBwJ0rijoYog==',
		haneulAddress: '0xb588e58ed8967b6a6f9dbce76386283d374cf7389fb164189551257e32b023b2',
	},
	{
		rawPublicKey: 'Ak5rsa5Od4T6YFN/V3VIhZ/azMMYPkUilKQwc+RiaId+',
		haneulPublicKey: 'AQJOa7GuTneE+mBTf1d1SIWf2szDGD5FIpSkMHPkYmiHfg==',
		haneulAddress: '0x694dd74af1e82b968822a82fb5e315f6d20e8697d5d03c0b15e0178c1a1fcfa0',
	},
	{
		rawPublicKey: 'A4XbJ3fLvV/8ONsnLHAW1nORKsoCYsHaXv9FK1beMtvY',
		haneulPublicKey: 'AQOF2yd3y71f/DjbJyxwFtZzkSrKAmLB2l7/RStW3jLb2A==',
		haneulAddress: '0x78acc6ca0003457737d755ade25a6f3a144e5e44ed6f8e6af4982c5cc75e55e7',
	},
];
...
describe('Secp256k1PublicKey', () => {
	...
	TEST_CASES.forEach(({ rawPublicKey, haneulPublicKey, haneulAddress }) => {
		it(`toHaneulAddress from base64 public key ${haneulAddress}`, () => {
			const key = new Secp256k1PublicKey(rawPublicKey);
			expect(key.toHaneulAddress()).toEqual(haneulAddress);
		});

		it(`toHaneulPublicKey from base64 public key ${haneulAddress}`, () => {
			const key = new Secp256k1PublicKey(rawPublicKey);
			expect(key.toHaneulPublicKey()).toEqual(haneulPublicKey);
		});
	});
});
