...
import { normalizeHaneulAddress } from '../../../src/utils/haneul-types.js';
...
describe('Publickey', () => {
	...
	it('`toHaneulAddress()` should return correct haneul address associated with multisig publickey', async () => {
		const multiSigPublicKey = MultiSigPublicKey.fromPublicKeys({
			threshold: 3,
			publicKeys: [
				{ publicKey: pk1, weight: 1 },
