...
import { decodeHaneulPrivateKey } from '../../src/cryptography';
...
describe('MultiSig with zklogin signature', () => {
	it('Execute tx with multisig with 1 sig and 1 zkLogin sig combined', async () => {
		// default ephemeral keypair, address_seed and zklogin inputs defined: https://github.com/GeunhwaJeong/haneul/blob/071a2955f7dbb83ee01c35d3a4257926a50a35f5/crates/haneul-types/src/unit_tests/zklogin_test_vectors.json
		...
		let parsed = decodeHaneulPrivateKey(
		...
		let multisigAddr = multiSigPublicKey.toHaneulAddress();
