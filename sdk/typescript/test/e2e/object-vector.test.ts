...
import { Coin, getCreatedObjects, getExecutionStatusType, HANEUL_FRAMEWORK_ADDRESS } from '../../src';
...
describe('Test Move call with a vector of objects as input', () => {
	...
	beforeEach(async () => {
		toolbox = await setup();
		const packagePath =
			__dirname + '/../../../../crates/haneul-core/src/unit_tests/data/entry_point_vector';
	...
	it('Test regular arg mixed with object vector arg', async () => {
		...
		const coin = coins[3].data as HaneulObjectData;
