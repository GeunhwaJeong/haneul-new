...
describe('Transaction Builders', () => {
  ...
  it('SplitCoin + TransferObjects', async () => {
    ...
    const coin_0 = coins[0].details as HaneulObjectData;
  ...
  it('MergeCoins', async () => {
    const coins = await toolbox.getGasObjectsOwnedByAddress();
    const coin_0 = coins[0].details as HaneulObjectData;
    const coin_1 = coins[1].details as HaneulObjectData;
    const tx = new Transaction();
  ...
  it('MoveCall Shared Object', async () => {
    const coins = await toolbox.getGasObjectsOwnedByAddress();
    const coin_2 = coins[2].details as HaneulObjectData;
  ...
  it('TransferObject', async () => {
    const coins = await toolbox.getGasObjectsOwnedByAddress();
    const tx = new Transaction();
    const coin_0 = coins[2].details as HaneulObjectData;
