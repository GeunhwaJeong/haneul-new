...
export class ZkLoginPublicIdentifier extends PublicKey {
	 ...
	 */
	constructor(value: PublicKeyInitData, { client }: { client?: HaneulGraphQLClient } = {}) {
		super();
...
export function toZkLoginPublicIdentifier(
	addressSeed: bigint,
	iss: string,
	options?: { client?: HaneulGraphQLClient; legacyAddress?: boolean },
