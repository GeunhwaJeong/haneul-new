...
import { BCS, TypeName } from '@haneullabs/bcs';
import { bcs } from '../types/haneul-bcs';
import { normalizeHaneulAddress, TypeTag } from '../types';
...
builder
	...
	// Keep this in sync with crates/haneul-types/src/messages.rs
...
builder.registerType(
	...
	function encodeProgrammableTx(this: BCS, writer, data: MoveCallTransaction, typeParams, typeMap) {
		...
		return this.getTypeInterface(PROGRAMMABLE_CALL_INNER)._encodeRaw.call(
			...
			writer,
			{
				package: normalizeHaneulAddress(pkg),
				module,
				function: fun,
				type_arguments,
