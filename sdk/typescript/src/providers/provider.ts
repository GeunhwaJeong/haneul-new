...
export abstract class Provider {
   ...
   */
  abstract requestHaneulFromFaucet(
   ...
   * @param coinType optional fully qualified type names for the coin (e.g., 0x168da5bf1f48dafc111b0a488fa454aca95e0b5e::usdc::USDC), default to 0x2::haneul::HANEUL if not specified.
   ...
   */
  abstract getAllBalances(input: { owner: HaneulAddress }): Promise<CoinBalance[]>;
   ...
   * @param coinType fully qualified type names for the coin (e.g., 0x168da5bf1f48dafc111b0a488fa454aca95e0b5e::usdc::USDC), default to 0x2::haneul::HANEUL if not specified.
   */
   ...
   */
  abstract getLatestHaneulSystemState(): Promise<HaneulSystemStateSummary>;
