...
export class Ed25519Keypair extends Keypair {
	 ...
	 * the raw secret key.
	 *
	 * The haneul.keystore key is a list of Base64 encoded `flag || privkey`. To import
	 * a key from haneul.keystore to typescript, decode from base64 and remove the first
	 * flag byte after checking it is indeed the Ed25519 scheme flag 0x00 (See more
	 * on flag for signature scheme: https://github.com/GeunhwaJeong/haneul/blob/818406c5abdf7de1b80915a0519071eec3a5b1c7/crates/haneul-types/src/crypto.rs#L1650):
	 * ```
