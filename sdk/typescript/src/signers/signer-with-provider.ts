...
// This is currently hardcoded with [IntentScope::TransactionData = 0, Version::V0 = 0, AppId::Haneul = 0]
...
export abstract class SignerWithProvider implements Signer {
  ...
  async requestHaneulFromFaucet(
    ...
    return this.provider.requestHaneulFromFaucet(
   ...
   * in the Haneul System State object
  ...
  async transferHaneul(
    ...
    return this.signAndExecuteTransaction(
      { kind: 'transferHaneul', data: transaction },
      requestType
    );
  }
  ...
  async payHaneul(
    ...
    return this.signAndExecuteTransaction(
      { kind: 'payHaneul', data: transaction },
      requestType
    );
  }
  ...
  async payAllHaneul(
    ...
    return this.signAndExecuteTransaction(
      { kind: 'payAllHaneul', data: transaction },
      requestType
    );
  }
