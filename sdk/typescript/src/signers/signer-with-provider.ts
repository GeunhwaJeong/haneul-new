...
export abstract class SignerWithProvider implements Signer {
  ...
  async signAndExecuteTransaction(
    ...
    switch (transaction.kind) {
      ...
      case 'transferHaneul':
        return this.transferHaneul(transaction.data, requestType);
      case 'transferObject':
      ...
      case 'payHaneul':
        return this.payHaneul(transaction.data, requestType);
      case 'payAllHaneul':
        return this.payAllHaneul(transaction.data, requestType);
      case 'publish':
