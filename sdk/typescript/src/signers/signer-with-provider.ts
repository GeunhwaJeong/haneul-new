...
export abstract class SignerWithProvider implements Signer {
	...
	abstract connect(client: HaneulClient): SignerWithProvider;

	///////////////////
	// Sub-classes MAY override these

	constructor(client: HaneulClient) {
	...
	async devInspectTransactionBlock(
		input: Omit<Parameters<HaneulClient['devInspectTransactionBlock']>[0], 'sender'>,
