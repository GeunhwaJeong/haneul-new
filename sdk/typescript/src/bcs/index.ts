 ...
 * An object argument.
 */
export type ObjectArg = { ImmOrOwned: HaneulObjectRefType } | { Shared: SharedObjectRef };
...
const HaneulObjectRef = bcs.struct('HaneulObjectRef', {
	objectId: Address,
	version: bcs.u64(),
	digest: ObjectDigest,
});
...
export { haneulBcs as bcs, bcsRegistry };
