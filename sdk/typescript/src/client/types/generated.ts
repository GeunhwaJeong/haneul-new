...
export type Authenticator =
	/** The contained HaneulAddress exclusively has all permissions: read, write, delete, transfer */
	{
		SingleOwner: string;
	};
...
export interface HaneulAuthenticatorStateExpire {
	min_epoch: string;
}
...
export interface HaneulChangeEpoch {
...
export type HaneulEndOfEpochTransactionKind =
...
export interface HaneulMoveNormalizedEnum {
	abilities: HaneulMoveAbilitySet;
	typeParameters: HaneulMoveStructTypeParameter[];
	variants: {
		[key: string]: HaneulMoveNormalizedField[];
	};
}
...
export interface HaneulMoveNormalizedModule {
	address: string;
	enums?: {
		[key: string]: HaneulMoveNormalizedEnum;
	};
	exposedFunctions: {
...
export type HaneulTransactionBlockKind =
	...
	| {
			...
			transactions: HaneulEndOfEpochTransactionKind[];
	  }
	| {
			commit_timestamp_ms: string;
