...
import type { EnumInputShape, EnumOutputShape } from '@haneullabs/bcs';
...
export const HaneulAddress = transform(string(), (value) => normalizeHaneulAddress(value), [
	custom(isValidHaneulAddress),
]);
...
// https://github.com/GeunhwaJeong/haneul/blob/cea8742e810142a8145fd83c4c142d61e561004a/crates/haneul-graphql-rpc/schema/current_progress_schema.graphql#L1614-L1627
...
// https://github.com/GeunhwaJeong/haneul/blob/cea8742e810142a8145fd83c4c142d61e561004a/crates/haneul-graphql-rpc/schema/current_progress_schema.graphql#L1609-L1612
