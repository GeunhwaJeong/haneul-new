...
export function isObjectExistsInfo(obj: any, _argumentName?: string): obj is ObjectExistsInfo {
    return (
        ...
        isHaneulObject(obj.object) as boolean
    )
}
