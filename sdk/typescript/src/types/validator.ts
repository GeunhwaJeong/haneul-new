...
export const DelegationStakingPoolFields = object({
  delegation_token_supply: HaneulSupplyFields,
...
export const HaneulSystemState = object({
  info: object({ id: string() }),
  epoch: number(),
  // TODO(cleanup): remove optional after TestNet Wave 2(0.22.0)
  protocol_version: optional(number()),
  validators: ValidatorSet,
  treasury_cap: HaneulSupplyFields,
...
/* ---------------- Types for the HaneulSystemState Move object ---------------- */
...
export const MoveDelegationStakingPoolFields = object({
  ...
  haneul_balance: string(),
  validator_address: string(),
});

export type MoveHaneulSystemObjectFields = Infer<typeof MoveHaneulSystemObjectFields>;
export type MoveHaneulSystemObject = Infer<typeof MoveHaneulSystemObject>;
...
export const MoveHaneulSystemObjectFields = object({
...
export const MoveHaneulSystemObject = object({
  dataType: literal('moveObject'),
  type: string(),
  has_public_transfer: boolean(),
  fields: MoveHaneulSystemObjectFields,
});
