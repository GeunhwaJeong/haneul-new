 ...
 */
import { TransactionDigest, HaneulAddress, ObjectOwner, HaneulObjectRef, HaneulObjectInfo, ObjectContentFields, MovePackageContent, HaneulData, HaneulMoveObject, HaneulMovePackage, HaneulMoveFunctionArgTypesResponse, HaneulMoveFunctionArgType, HaneulMoveFunctionArgTypes, HaneulMoveNormalizedModules, HaneulMoveNormalizedModule, HaneulMoveModuleId, HaneulMoveNormalizedStruct, HaneulMoveStructTypeParameter, HaneulMoveNormalizedField, HaneulMoveNormalizedFunction, HaneulMoveVisibility, HaneulMoveTypeParameterIndex, HaneulMoveAbilitySet, HaneulMoveNormalizedType, HaneulMoveNormalizedTypeParameterType, HaneulMoveNormalizedStructType, HaneulObject, ObjectStatus, ObjectType, GetOwnedObjectsResponse, GetObjectDataResponse, ObjectDigest, ObjectId, SequenceNumber, Order, MoveEvent, PublishEvent, CoinBalanceChangeEvent, TransferObjectEvent, MutateObjectEvent, DeleteObjectEvent, NewObjectEvent, HaneulEvent, MoveEventField, EventQuery, EventId, PaginatedEvents, EventType, BalanceChangeType, HaneulEventFilter, HaneulEventEnvelope, HaneulEvents, SubscriptionId, SubscriptionEvent, TransferObject, HaneulTransferHaneul, HaneulChangeEpoch, Pay, PayHaneul, PayAllHaneul, ExecuteTransactionRequestType, TransactionKindName, HaneulTransactionKind, HaneulTransactionData, EpochId, GenericAuthoritySignature, AuthorityQuorumSignInfo, CertifiedTransaction, GasCostSummary, ExecutionStatusType, ExecutionStatus, OwnedObjectRef, DevInspectResults, DevInspectResultsType, DevInspectResultTupleType, ExecutionResultType, MutableReferenceOutputType, ReturnValueType, TransactionEffects, HaneulTransactionResponse, HaneulTransactionAuthSignersResponse, HaneulCertifiedTransactionEffects, HaneulExecuteTransactionResponse, GatewayTxSeqNumber, GetTxnDigestsResponse, PaginatedTransactionDigests, TransactionQuery, MoveCall, HaneulJsonValue, EmptySignInfo, AuthorityName, AuthoritySignature, TransactionBytes, HaneulParsedMergeCoinResponse, HaneulParsedSplitCoinResponse, HaneulParsedPublishResponse, HaneulPackage, HaneulParsedTransactionResponse, CoinMetadata, DelegationData, DelegationHaneulObject, TransferObjectTx, TransferHaneulTx, PayTx, PayHaneulTx, PayAllHaneulTx, PublishTx, SharedObjectRef, ObjectArg, CallArg, StructTag, TypeTag, MoveCallTx, Transaction, TransactionKind, TransactionData, RpcApiVersion, FaucetCoinInfo, FaucetResponse } from "./index";
...
export function isObjectOwner(obj: any, _argumentName?: string): obj is ObjectOwner {
    return (
        ((obj !== null &&
            ...
            isHaneulMoveTypeParameterIndex(obj.Shared.initial_shared_version) as boolean ||
            obj === "Immutable")
    )
}
...
export function isEventQuery(obj: any, _argumentName?: string): obj is EventQuery {
    return (
        (obj === "All" ||
            ...
            isHaneulMoveTypeParameterIndex(obj.TimeRange.start_time) as boolean &&
            isHaneulMoveTypeParameterIndex(obj.TimeRange.end_time) as boolean)
    )
}
...
export function isEventId(obj: any, _argumentName?: string): obj is EventId {
    return (
        (obj !== null &&
            typeof obj === "object" ||
            typeof obj === "function") &&
        isHaneulMoveTypeParameterIndex(obj.txSeq) as boolean &&
        isHaneulMoveTypeParameterIndex(obj.eventSeq) as boolean
    )
}
...
export function isPaginatedEvents(obj: any, _argumentName?: string): obj is PaginatedEvents {
    return (
        (obj !== null &&
            typeof obj === "object" ||
            typeof obj === "function") &&
        isHaneulEvents(obj.data) as boolean &&
        (obj.nextCursor === null ||
...
export function isHaneulEvents(obj: any, _argumentName?: string): obj is HaneulEvents {
    return (
        Array.isArray(obj) &&
        obj.every((e: any) =>
            isHaneulEventEnvelope(e) as boolean
        )
    )
}
...
export function isPayHaneul(obj: any, _argumentName?: string): obj is PayHaneul {
    return (
        (obj !== null &&
            typeof obj === "object" ||
            typeof obj === "function") &&
...
export function isPayAllHaneul(obj: any, _argumentName?: string): obj is PayAllHaneul {
    return (
        (obj !== null &&
            typeof obj === "object" ||
            typeof obj === "function") &&
    ...
    return (
        ((obj !== null &&
            ...
            (obj !== null &&
                typeof obj === "object" ||
                typeof obj === "function") &&
            isPayHaneul(obj.PayHaneul) as boolean ||
            (obj !== null &&
                typeof obj === "object" ||
                typeof obj === "function") &&
            isPayAllHaneul(obj.PayAllHaneul) as boolean)
    )
}
...
export function isDevInspectResults(obj: any, _argumentName?: string): obj is DevInspectResults {
    return (
        (obj !== null &&
            typeof obj === "object" ||
            typeof obj === "function") &&
        isTransactionEffects(obj.effects) as boolean &&
        isDevInspectResultsType(obj.results) as boolean
    )
}

export function isDevInspectResultsType(obj: any, _argumentName?: string): obj is DevInspectResultsType {
    return (
        ((obj !== null &&
            typeof obj === "object" ||
            typeof obj === "function") &&
            Array.isArray(obj.Ok) &&
            obj.Ok.every((e: any) =>
                isDevInspectResultTupleType(e) as boolean
            ) ||
            (obj !== null &&
                typeof obj === "object" ||
                typeof obj === "function") &&
            isTransactionDigest(obj.Err) as boolean)
    )
}

export function isDevInspectResultTupleType(obj: any, _argumentName?: string): obj is DevInspectResultTupleType {
    return (
        Array.isArray(obj) &&
        isHaneulMoveTypeParameterIndex(obj[0]) as boolean &&
        isExecutionResultType(obj[1]) as boolean
    )
}

export function isExecutionResultType(obj: any, _argumentName?: string): obj is ExecutionResultType {
    return (
        (obj !== null &&
            typeof obj === "object" ||
            typeof obj === "function") &&
        (typeof obj.mutableReferenceOutputs === "undefined" ||
            Array.isArray(obj.mutableReferenceOutputs) &&
            obj.mutableReferenceOutputs.every((e: any) =>
                isMutableReferenceOutputType(e) as boolean
            )) &&
        (typeof obj.returnValues === "undefined" ||
            Array.isArray(obj.returnValues) &&
            obj.returnValues.every((e: any) =>
                isReturnValueType(e) as boolean
            ))
    )
}

export function isMutableReferenceOutputType(obj: any, _argumentName?: string): obj is MutableReferenceOutputType {
    return (
        Array.isArray(obj) &&
        isHaneulMoveTypeParameterIndex(obj[0]) as boolean &&
        Array.isArray(obj[1]) &&
...
export function isReturnValueType(obj: any, _argumentName?: string): obj is ReturnValueType {
    return (
        Array.isArray(obj) &&
        Array.isArray(obj[0]) &&
        obj[0].every((e: any) =>
...
export function isHaneulTransactionAuthSignersResponse(obj: any, _argumentName?: string): obj is HaneulTransactionAuthSignersResponse {
    return (
        (obj !== null &&
            typeof obj === "object" ||
            typeof obj === "function") &&
...
export function isCoinMetadata(obj: any, _argumentName?: string): obj is CoinMetadata {
    return (
        (obj !== null &&
            typeof obj === "object" ||
            typeof obj === "function") &&
        isHaneulMoveTypeParameterIndex(obj.decimals) as boolean &&
        isTransactionDigest(obj.name) as boolean &&
...
export function isPayHaneulTx(obj: any, _argumentName?: string): obj is PayHaneulTx {
    return (
        (obj !== null &&
            typeof obj === "object" ||
            typeof obj === "function") &&
        (obj.PayHaneul !== null &&
            typeof obj.PayHaneul === "object" ||
            typeof obj.PayHaneul === "function") &&
        Array.isArray(obj.PayHaneul.coins) &&
        obj.PayHaneul.coins.every((e: any) =>
            isHaneulObjectRef(e) as boolean
        ) &&
        Array.isArray(obj.PayHaneul.recipients) &&
        obj.PayHaneul.recipients.every((e: any) =>
            isTransactionDigest(e) as boolean
        ) &&
        Array.isArray(obj.PayHaneul.amounts) &&
        obj.PayHaneul.amounts.every((e: any) =>
            isHaneulMoveTypeParameterIndex(e) as boolean
        )
    )
}

export function isPayAllHaneulTx(obj: any, _argumentName?: string): obj is PayAllHaneulTx {
    return (
        (obj !== null &&
            typeof obj === "object" ||
            typeof obj === "function") &&
        (obj.PayAllHaneul !== null &&
            typeof obj.PayAllHaneul === "object" ||
            typeof obj.PayAllHaneul === "function") &&
        Array.isArray(obj.PayAllHaneul.coins) &&
        obj.PayAllHaneul.coins.every((e: any) =>
            isHaneulObjectRef(e) as boolean
        ) &&
        isTransactionDigest(obj.PayAllHaneul.recipient) as boolean
    )
}
...
export function isSharedObjectRef(obj: any, _argumentName?: string): obj is SharedObjectRef {
    return (
        (obj !== null &&
            ...
            typeof obj === "function") &&
        isTransactionDigest(obj.objectId) as boolean &&
        isHaneulMoveTypeParameterIndex(obj.initialSharedVersion) as boolean
    )
}
...
export function isCallArg(obj: any, _argumentName?: string): obj is CallArg {
    return (
        ((obj !== null &&
            ...
            isHaneulMoveTypeParameterIndex(obj.ObjVec.length) as boolean)
    )
}
...
export function isTransaction(obj: any, _argumentName?: string): obj is Transaction {
    return (
        (isTransferObjectTx(obj) as boolean ||
            ...
            isPayHaneulTx(obj) as boolean ||
            isPayAllHaneulTx(obj) as boolean ||
