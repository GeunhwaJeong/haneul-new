...
export function isCoinDenominationInfoResponse(obj: any, _argumentName?: string): obj is CoinDenominationInfoResponse {
    return (
        ...
        isHaneulMoveTypeParameterIndex(obj.decimalNumber) as boolean
    )
}
