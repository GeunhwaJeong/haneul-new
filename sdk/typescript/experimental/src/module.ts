...
import { HaneulObjectRef, CallArg, TypeTag, MoveCallTx } from "./types";
 ...
 *
 * @example
 * class DevNetNFT extends haneul.MoveModule {
 *   constructor(public pkg: HaneulObjectRef) { super(pkg, 'devnet_nft'); }
 *
 *   // Move function is:
...
export class MoveModule {
  constructor(public pkg: HaneulObjectRef, public name: string) {}
