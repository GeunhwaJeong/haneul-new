...
This is a lightweight SDK (1kB minified bundle size), providing utility classes and functions for applications to interact with on-chain `.haneul` names registered from [Haneul Name Service (haneulns.io)](https://haneulns.io).

## Getting started

The SDK is published to [npm registry](https://www.npmjs.com/package/@haneullabs/haneulns-toolkit). To use it in your project:
