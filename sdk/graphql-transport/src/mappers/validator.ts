...
import type { HaneulValidatorSummary } from '@haneullabs/haneul/client';
...
export function mapGraphQlValidatorToRpcValidator(
	...
	return {
		...
		pendingTotalHaneulWithdraw: validator.pendingTotalHaneulWithdraw,
		...
		stakingPoolHaneulBalance: validator.stakingPoolHaneulBalance,
		haneulAddress: validator.address.address,
