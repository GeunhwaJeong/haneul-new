...
export const PaginateMoveModuleListsDocument = new TypedDocumentString(`
    query paginateMoveModuleLists($packageId: HaneulAddress!, $module: String!, $hasMoreFriends: Boolean!, $hasMoreStructs: Boolean!, $hasMoreFunctions: Boolean!, $hasMoreEnums: Boolean!, $afterFriends: String, $afterStructs: String, $afterFunctions: String, $afterEnums: String) {
  object(address: $packageId) {
    asMovePackage {
      module(name: $module) {
