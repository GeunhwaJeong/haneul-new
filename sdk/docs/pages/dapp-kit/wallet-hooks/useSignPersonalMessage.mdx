...
The `useSignPersonalMessage` hook can be used to prompt the user to sign a message with their wallet

```ts
import { ConnectButton, useCurrentAccount, useSignPersonalMessage } from '@haneullabs/dapp-kit';
