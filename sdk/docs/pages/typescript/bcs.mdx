...
The `@haneullabs/haneul/bcs` package extends `@haneullabs/bcs` with Haneul specific scheme definitions.

To learn more about using BCS see the [BCS documentation](/bcs).

the `bcs` export of `@haneullabs/haneul/bcs` contains all the same exports as `bcs` from `@haneullabs/bcs` plus
