...
The `CoinWithBalance` intent makes it easy to get a coin with a specific balance. For HANEUL, this has
...
This approach works well for HANEUL, but can't be used for other coin types. The CoinWithBalance intent
