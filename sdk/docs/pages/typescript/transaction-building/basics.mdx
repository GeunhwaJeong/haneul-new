...
This example starts by constructing a transaction to send HANEUL. To construct transactions, import the
...
[the HaneulClient docs for more details](/typescript/haneul-client#arguments)). These options will cause
