...
| --------------- | ------------------ | ----------------------------------- |
| Ed25519         | `Ed25519Keypair`   | `@haneullabs/haneul.js/keypairs/ed25519`   |
| ECDSA Secp256k1 | `Secp256k1Keypair` | `@haneullabs/haneul.js/keypairs/secp256k1` |
| ECDSA Secp256r1 | `Secp256r1Keypair` | `@haneullabs/haneul.js/keypairs/secp256r1` |

For information on these schemes, see the
[Haneul Wallet Specifications](https://docs.haneul.io/testnet/learn/cryptography/haneul-wallet-specs) topic.

To use, import the key pair class your project uses from the `@haneullabs/haneul.js/keypairs` folder. For
example, to use the Ed25519 scheme, import the `Ed25519Keypair` class from
`@haneullabs/haneul.js/keypairs/ed25519`.
...
if (publicKey.toHaneulAddress() !== keypair.getPublicKey().toHaneulAddress()) {
...
```typescript
import { Ed25519Keypair } from '@haneullabs/haneul.js/keypairs/ed25519';
import { fromHex } from '@haneullabs/haneul.js/utils';
