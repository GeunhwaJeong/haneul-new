...
<Callout type="info">
	Note: `@haneullabs/zklogin` package contains more utilities to help with computing address etc.
</Callout>

To parse a serialized zkLogin signature

```typescript
import { parseZkLoginSignature } '@haneullabs/haneul.js/zklogin';
...
```typescript
import { getZkLoginSignature } '@haneullabs/haneul.js/zklogin';
...
```typescript
import { computeZkLoginAddressFromSeed } '@haneullabs/haneul.js/zklogin';
