...
const placeAndListToKiosk = async () => {
	...
	kioskTx.shareAndTransferCap('0xSomeHaneulAddress').finalize();
...
```typescript
import { queryTransferPolicy, purchaseAndResolvePolicies, place, testnetEnvironment } from '@haneullabs/kiosk';
