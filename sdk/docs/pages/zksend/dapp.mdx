...
is provided through the [Wallet Standard](https://docs.haneul.io/standards/wallet-standard), and should
...
[open an issue](https://github.com/GeunhwaJeong/haneul/issues/new/choose).
...
```ts
import { useCurrentWallet } from '@haneullabs/dapp-kit';
