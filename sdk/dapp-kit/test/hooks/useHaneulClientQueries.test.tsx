...
import { useHaneulClientQueries } from '../../src/hooks/useHaneulClientQueries.js';
...
describe('useHaneulClientQueries', () => {
	...
	test('should fetch data', async () => {
		const getAllBalances = vi.spyOn(haneulClient, 'getAllBalances');
