...
describe('useDisconnectWallet', () => {
	...
	test('that disconnecting works successfully', async () => {
		...
		expect(window.localStorage.getItem('haneul-dapp-kit:wallet-connection-info')).toBeTruthy();
		...
		expect(window.localStorage.getItem('haneul-dapp-kit:wallet-connection-info')).toBeFalsy();
