...
import { useHaneulClientInfiniteQuery } from '../../src/hooks/useHaneulClientInfiniteQuery.js';
import { createWalletProviderContextWrapper } from '../test-utils.js';

describe('useHaneulClientInfiniteQuery', () => {
	it('should fetch data', async () => {
		...
		const { result } = renderHook(
			() =>
				useHaneulClientInfiniteQuery('queryTransactionBlocks', {
					filter: {
						FromAddress: '0x123',
					},
				}),
