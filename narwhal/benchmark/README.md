...
The AWS instances are orchestrated with [Fabric](http://www.fabfile.org) from the file [fabfile.py](https://github.com/GeunhwaJeong/narwhal/blob/main/benchmark/fabfile.py) (located in [narwhal/benchmarks](https://github.com/GeunhwaJeong/narwhal/blob/main/benchmark)); you can list all possible commands as follows:
```
