...
### Experimental step
The content of our [settings.json](https://github.com/GeunhwaJeong/haneul/blob/main/narwhal/benchmark/settings.json) file looks as follows:
```json
{
    "key": {
        "name": "aws",
    ...
    "repo": {
        "name": "narwhal",
        "url": "https://github.com/GeunhwaJeong/narwhal",
        "branch": "master"
    },
    "instances": {
        "type": "m5d.8xlarge",
...
```
We set the following `node_params` in our [fabfile](https://github.com/GeunhwaJeong/haneul/blob/main/narwhal/benchmark/fabfile.py):
```python
node_params = {
