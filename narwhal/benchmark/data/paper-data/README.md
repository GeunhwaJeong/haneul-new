...
### Experimental step
The content of our [settings.json](https://github.com/GeunhwaJeong/narwhal/blob/main/benchmark/settings.json) file looks as follows:
```json
{
    "key": {
        "name": "aws",
...
```
We set the following `node_params` in our [fabfile](https://github.com/GeunhwaJeong/narwhal/blob/main/benchmark/fabfile.py):
```python
node_params = {
