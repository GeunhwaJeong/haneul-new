...
use haneul_types::{
    crypto::{
        get_key_pair_from_rng, AuthorityKeyPair, AuthorityPublicKey, NetworkPublicKey, HaneulKeyPair,
    },
    multiaddr::Multiaddr,
};
...
async fn main() -> Result<(), eyre::Report> {
    ...
    match &app.command {
        ...
        Commands::GenerateNetworkKeys { filename } => {
            ...
            write_keypair_to_file(&HaneulKeyPair::Ed25519(network_keypair), filename).unwrap();
        }
