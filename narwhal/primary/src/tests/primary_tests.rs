...
async fn get_network_peers_from_admin_server() {
    ...
    let (tx_new_certificates, rx_new_certificates) = haneullabs_metrics::metered_channel::channel(
        CHANNEL_CAPACITY,
    ...
    let (tx_new_certificates_2, rx_new_certificates_2) = haneullabs_metrics::metered_channel::channel(
        CHANNEL_CAPACITY,
        &prometheus::IntGauge::new(
            PrimaryChannelMetrics::NAME_NEW_CERTS,
            PrimaryChannelMetrics::DESC_NEW_CERTS,
