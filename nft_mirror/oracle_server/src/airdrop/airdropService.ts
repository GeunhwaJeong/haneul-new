 ...
 *
 * @example {
 *   "wallet_message": "{\"domain\":{\"chainId\":1,\"name\":\"HaneulDrop\",\"version\":\"1\"},\"message\":{\"source_chain\":\"ethereum\",\"source_contract_address\":\"0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D\",\"source_token_id\":\"0x00000000000000000000000000000000000000000000000000000000000022e9\",\"source_owner_address\":\"0x09dbc4a902199bbe7f7ec29b3714731786f2e878\",\"destination_haneul_address\":\"0xa5e6dbcf33730ace6ec8b400ff4788c1f150ff7e\"},\"primaryType\":\"ClaimRequest\",\"types\":{\"EIP712Domain\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"version\",\"type\":\"string\"},{\"name\":\"chainId\",\"type\":\"uint256\"}],\"ClaimRequest\":[{\"name\":\"source_chain\",\"type\":\"string\"},{\"name\":\"source_contract_address\",\"type\":\"string\"},{\"name\":\"source_token_id\",\"type\":\"string\"},{\"name\":\"source_owner_address\",\"type\":\"string\"},{\"name\":\"destination_haneul_address\",\"type\":\"string\"}]}}",
 *   "signature": "abc"
 * }
 */
...
export class AirdropService {
    public async claim(
        ...
        const connection = new Connection(
            process.env.HANEUL_GATEWAY_ENDPOINT as string
        );
...
function isAirdropClaimInfo(arg: any): arg is AirdropClaimInfo {
    return (
        ...
        arg.destination_haneul_address
    );
}
