...
export class Connection {
    ...
    public async bulkFetchObjects(
        ...
        // TODO<https://github.com/GeunhwaJeong/haneul/issues/803>: support get objects by types in Gateway
        const objectIds = await this.getObjectIds(address);
        // TODO<https://github.com/GeunhwaJeong/haneul/issues/828> Gateway needs to support
