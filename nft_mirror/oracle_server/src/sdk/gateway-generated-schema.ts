...
export interface components {
    schemas: {
        ...
        CallRequest: {
            ...
            args: components['schemas']['HaneulJsonValue'][];
        ...
        /** @description JSON representation of an object in the Haneul network. */
        Object: {
