...
```
haneul client call --package 0x2 --module haneul_system --function rotate_operation_cap --args 0x5 --gas-budget 10000
```
...
```
haneul client call --package 0x2 --module haneul_system --function request_set_gas_price --args 0x5 {cap_object_id} {new_gas_price} --gas-budget 10000
```
...
```
haneul client call --package 0x2 --module haneul_system --function report_validator/undo_report_validator --args 0x5 {cap_object_id} {reportee_address} --gas-budget 10000
```
...
```
haneul client call --package 0x2 --module haneul_system --function request_add_validator_candidate --args 0x5 {protocol_pubkey_bytes {network_pubkey_bytes} {worker_pubkey_bytes} {proof_of_possession} {name} {description} {image_url} {project_url} {net_address}
