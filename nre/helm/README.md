...
# GraphQL
### Containers
**graphql** - container running haneul-graphql rpc endpoint. Requires a Database updated by the indexer-writer.
...
# Indexer-Reader
### Containers
**indexer-reader** - haneul-indexer-reader jsonrpc endpoint. This offers backwards compatibility with current haneul-node json rpc. This deployment is only needed as we transition to the graphql service. This is not needed if you do not want to support the jsonrpc.
...
# Indexer-Writer
### Containers
**haneul-indexer-writer** - Indexer writer syncs and indexes haneul checkpoint data into a Postgres database. Checkpoint data can be pulled from a fullnode or a cloud provider hosted bucket. More info and available buckets can be found in haneul [doc site](https://docs.haneul.io/guides/developer/advanced/custom-indexer#remote-reader).
