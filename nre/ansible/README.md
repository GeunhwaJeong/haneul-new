# Configure a Linux system as a Haneul Node using Ansible

This is a self contained Ansible role for configuring a Linux system as a Haneul Node.
...
3. Update the `haneul_release` var in the [Ansible Inventory](./inventory.yaml)
...
`ansible-playbook -i inventory.yaml haneul-node.yaml -e host=$inventory_name`
