...
const addressValidation = Yup.string()
    ...
    .test('is-haneul-address', '${value} is not a valid Haneul address', (value) =>
        isValidHaneulAddress(value)
    )
...
const validationSchema = Yup.object({
    ...
    amount: Yup.number()
        ...
        .test(
            'gas-balance-check',
            'Insufficient HANEUL balance to cover gas fee',
            (amount, ctx) => {
        ...
        .test(
            'num-gas-coins-check',
            'Need at least 2 HANEUL coins to transfer a HANEUL coin',
            (amount, ctx) => {
...
// TODO: show out of sync when haneul objects locally might be outdated
// TODO: clean/refactor
