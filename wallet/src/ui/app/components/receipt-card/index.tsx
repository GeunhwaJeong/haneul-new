...
function ReceiptCard({ tranferType, txDigest }: TxResponseProps) {
    const TxIcon = txDigest.isSender ? HaneulIcons.ArrowLeft : HaneulIcons.Buy;
    ...
    const transfersTxt = {
        ...
        coin: {
            header: 'HANEUL Transfer Completed!',
            copy: 'Staking HANEUL provides HANEUL holders with rewards to market price gains.',
        },
    };
    // TODO add copy for other trafer type like transfer haneul, swap, etc.
        ...
        <>
            <div className={st.failedIcon}>
                <div className={st.iconBg}>
                    <Icon icon={HaneulIcons.Close} className={cl(st.close)} />
                </div>
            </div>
