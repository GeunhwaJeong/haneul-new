...
import type { Ed25519KeypairData, Secp256k1KeypairData } from '@haneullabs/haneul.js';
 ...
 * @param mnemonics a 12-word seed phrase
 * @param path path string (`m/44'/8282'/0'/0'/0'`)
 * @returns public key and private key
 */
 ...
 * @param mnemonics a 12-word seed phrase
 * @param path path string (`m/54'/8282'/1'/0/0`)
 * @returns public key and private key
 */
