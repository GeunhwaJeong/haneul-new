...
A Chrome (v88+) extension wallet for [Haneul](https://haneul.io).
...
Currently the Wallet depends on an unreleased version of `haneul.js`, the TypeScript SDK for Haneul. Therefore, you need to build the SDK first:
