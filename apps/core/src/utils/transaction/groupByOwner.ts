...
import { ObjectChangesByOwner, HaneulObjectChangeWithDisplay } from './getObjectChangeSummary';
import { getOwnerType } from './getOwnerType';

const getOwner = (change: HaneulObjectChangeWithDisplay) => {
...
export const groupByOwner = (changes: HaneulObjectChangeWithDisplay[]) =>
