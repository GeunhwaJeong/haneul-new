...
import { KIOSK_OWNER_CAP, Network, PERSONAL_KIOSK_RULE_ADDRESS } from '@haneullabs/kiosk';
import { HaneulObjectData, HaneulObjectResponse } from '@haneullabs/haneul/client';
...
export function isKioskOwnerToken(
	network: Network,
	object?: HaneulObjectResponse | HaneulObjectData | null,
) {
