...
export const PASSWORD = 'haneullabs';
...
export async function createWallet(page: Page, extensionUrl: string) {
	...
	await page.getByLabel('Create Account Password').fill('haneullabs');
	await page.getByLabel('Confirm Account Password').fill('haneullabs');
