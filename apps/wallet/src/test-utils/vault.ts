...
import { mnemonicToSeedHex } from '@haneullabs/haneul.js/cryptography';
...
export const testEd25519AddressLegacy = testEd25519Legacy.getPublicKey().toHaneulAddress();
...
export const testEd25519Address = testEd25519.getPublicKey().toHaneulAddress();
...
export const testSecp256k1Address = testSecp256k1.getPublicKey().toHaneulAddress();
