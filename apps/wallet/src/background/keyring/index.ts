...
import { Base64DataBuffer, Ed25519Keypair } from '@haneullabs/haneul.js';
...
export class Keyring {
    ...
    #locked = true;
    #mainDerivedAccount: HaneulAddress | null = null;
    #accountsMap: Map<HaneulAddress, Account> = new Map();
    ...
    public async changeActiveAccount(address: HaneulAddress) {
     ...
     * @param address The haneul address to export the keypair
     ...
     */
    public async exportAccountKeypair(address: HaneulAddress, password: string) {
        if (this.isLocked) {
            return null;
        }
    ...
    private storeActiveAccount(address: HaneulAddress) {
