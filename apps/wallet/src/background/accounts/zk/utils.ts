...
import { type ZkSignatureInputs, generateNonce, generateRandomness } from '@haneullabs/zklogin';
...
const saltRegistryUrl = 'http://salt.api-devnet.haneul-labs.com';
...
const zkProofsServerUrl = 'http://prover-devnet.haneul-labs.com:8080';
