...
const saltRegistryUrl = 'https://salt.api.haneul-labs.com';
...
const zkLoginProofsServerUrlDev = 'https://prover-dev.haneul-labs.com/v1';
const zkLoginProofsServerUrlProd = 'https://prover.haneul-labs.com/v1';
