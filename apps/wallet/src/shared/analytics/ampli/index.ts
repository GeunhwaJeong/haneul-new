 ...
 *
 * [View Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest)
 *
 * [Full Setup Instructions](https://data.amplitude.com/haneullabs/Haneul%20Wallet/implementation/web)
 */
...
export interface IdentifyProperties {
	...
	/**
	 * The Haneul Network that the user is currently interacting with.
	 */
...
export interface ClickedStakeHaneulProperties {
	/**
	 * Whether or not the user is already staking some HANEUL.
	 */
...
export interface ClickedUnstakeHaneulProperties {
	/**
	 * The amount of HANEUL staked.
	 *
	 * | Rule | Value |
	 * |---|---|
	 * | Type | number |
...
export interface StakedHaneulProperties {
	/**
	 * The amount of HANEUL staked.
	 *
	 * | Rule | Value |
...
export interface StakedHaneulFailedProperties {
	/**
	 * A message associated with an error event.
	 */
	errorMessage: string;
...
export interface UnstakedHaneulProperties {
	/**
	 * The address of the selected validator.
	 */
	validatorAddress: string;
...
export class ClickedStakeHaneul implements BaseEvent {
	event_type = 'clicked stake HANEUL';

	constructor(public event_properties: ClickedStakeHaneulProperties) {
		this.event_properties = event_properties;
	}
}
...
export class ClickedUnstakeHaneul implements BaseEvent {
	event_type = 'clicked unstake HANEUL';

	constructor(public event_properties: ClickedUnstakeHaneulProperties) {
		this.event_properties = event_properties;
	}
}
...
export class StakedHaneul implements BaseEvent {
	event_type = 'staked HANEUL';

	constructor(public event_properties: StakedHaneulProperties) {
		this.event_properties = event_properties;
	}
}

export class StakedHaneulFailed implements BaseEvent {
	event_type = 'staked HANEUL (failed)';

	constructor(public event_properties: StakedHaneulFailedProperties) {
		this.event_properties = event_properties;
	}
}
...
export class UnstakedHaneul implements BaseEvent {
	event_type = 'unstaked HANEUL';

	constructor(public event_properties: UnstakedHaneulProperties) {
		this.event_properties = event_properties;
	}
}
...
export class Ampli {
  ...
  */
   ...
   * added accounts
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/added%20accounts)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/bypassed%20scam%20warning)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20bullshark%20quests%20cta)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20collectible%20card)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20create%20new%20account)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20create%20new%20wallet)
   *
   ...
   * clicked get started
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20get%20started)
   *
   ...
   * clicked hide asset
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20hide%20asset)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20import%20existing%20wallet)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20import%20passphrase)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20import%20private%20key)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20social%20sign%20in%20button)
   *
  ...
  /**
   * clicked stake HANEUL
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20stake%20HANEUL)
   *
   * When users click to stake HANEUL in the wallet.
   *
   * Owner: Jon Shek
   *
   ...
   */
  clickedStakeHaneul(
    properties: ClickedStakeHaneulProperties,
    options?: EventOptions,
  ) {
    return this.track(new ClickedStakeHaneul(properties), options);
  }

  /**
   * clicked swap coin
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20swap%20coin)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20token%20claims%20banner)
   *
   * Event has no description in tracking plan.
   *
  ...
  /**
   * clicked unstake HANEUL
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20unstake%20HANEUL)
   *
   * When users click to unstake HANEUL.
   *
   * Owner: Jon Shek
   *
   ...
   * @param options Amplitude event options.
   */
  clickedUnstakeHaneul(
    properties: ClickedUnstakeHaneulProperties,
    options?: EventOptions,
  ) {
    return this.track(new ClickedUnstakeHaneul(properties), options);
  }

  /**
   * clicked usdc promo banner
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/clicked%20usdc%20promo%20banner)
   *
   * Event has no description in tracking plan.
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/connected%20hardware%20wallet)
   *
   ...
   * created new wallet
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/created%20new%20wallet)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/disconnected%20application)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/imported%20existing%20account)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/interacted%20with%20malicious%20domain)
   *
   ...
   * opened application
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/opened%20application)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/opened%20connect%20ledger%20flow)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/opened%20wallet%20extension)
   *
   ...
   * pinned coin
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/pinned%20coin)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/received%20onramp%20providers%20data)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/Received%20onramp%20providers%20data%20(failed))
   *
   * Event to track when data from onramp providers is received
   *
   * @param properties The event's properties (e.g. countryCode)
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/responded%20to%20connection%20request)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/responded%20to%20transaction%20request)
   *
   ...
   * selected coin
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/selected%20coin)
   *
   ...
   * selected validator
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/selected%20validator)
   *
   ...
   * sent coin failed
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/sent%20coin%20failed)
   *
   ...
   * sent coins
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/sent%20coins)
   *
   ...
   * sent collectible
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/sent%20collectible)
   *
   * Owner: William Robertson
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/sent%20collectible%20(failed))
   *
   * Event has no description in tracking plan.
   *
   * @param properties The event's properties (e.g. errorMessage)
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/signed%20transaction%20block%20failed)
   *
   ...
   * staked HANEUL
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/staked%20HANEUL)
   *
   * When users successfully stake HANEUL with a validator.
   *
   * Owner: Jon Shek
   *
   * @param properties The event's properties (e.g. stakedAmount)
   ...
   */
  stakedHaneul(
    properties: StakedHaneulProperties,
    options?: EventOptions,
  ) {
    return this.track(new StakedHaneul(properties), options);
  }

  /**
   * staked HANEUL (failed)
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/staked%20HANEUL%20(failed))
   *
   * Event fired when a user attempt to native stake HANEUL results in a failure.
   *
   * @param properties The event's properties (e.g. errorMessage)
   * @param options Amplitude event options.
   */
  stakedHaneulFailed(
    properties: StakedHaneulFailedProperties,
    options?: EventOptions,
  ) {
    return this.track(new StakedHaneulFailed(properties), options);
  }

  /**
   * swapped coin
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/swapped%20coin)
   *
   ...
   * swapped coin (failed)
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/swapped%20coin%20(failed))
   *
   * Event has no description in tracking plan.
   *
   * @param properties The event's properties (e.g. errorMessage)
   ...
   * switched account
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/switched%20account)
   *
   ...
   * switched network
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/switched%20network)
   *
   ...
   * unpinned coin
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/unpinned%20coin)
   *
   ...
   * unstaked HANEUL
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/unstaked%20HANEUL)
   *
   * When users successfully un-stake HANEUL.
   *
   * Owner: Jon Shek
   *
   * @param properties The event's properties (e.g. validatorAddress)
   ...
   */
  unstakedHaneul(
    properties: UnstakedHaneulProperties,
    options?: EventOptions,
  ) {
    return this.track(new UnstakedHaneul(properties), options);
  }

  /**
   * viewed ledger tutorial
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/viewed%20ledger%20tutorial)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Wallet/events/main/latest/visited%20fiat%20on-ramp)
   *
