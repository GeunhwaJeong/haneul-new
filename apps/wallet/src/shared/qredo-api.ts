...
export class QredoAPI {
    ...
    #accessTokenRenewInProgress: ReturnType<AccessTokenRenewalFunction> | null =
        null;
    ...
    public createAccessToken({
        ...
        return this.#request(`${this.baseURL}connect/haneul/token`, {
            method: 'post',
            body: params,
        });
    }
    ...
    public getWallets({
        ...
        return this.#request(
            `${this.baseURL}connect/haneul/wallets${toSearchQueryString(
                searchParams
            )}`
        );
    }
    ...
    public createTransaction(
        ...
        return this.#request(`${this.baseURL}connect/haneul/transactions`, {
            method: 'post',
    ...
    public getTransaction(
        ...
        return this.#request(
            `${this.baseURL}connect/haneul/transactions/${transactionID}`
        );
    }
    ...
    public getTransactions(
        ...
        return this.#request(
            `${this.baseURL}connect/haneul/transactions${toSearchQueryString(
