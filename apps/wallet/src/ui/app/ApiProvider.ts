...
import { SentryRpcClient } from '@haneullabs/core';
...
export const API_ENV_TO_INFO: Record<API_ENV, EnvInfo> = {
    ...
    [API_ENV.devNet]: { name: 'Haneul Devnet', env: API_ENV.devNet },
    [API_ENV.customRPC]: { name: 'Custom RPC URL', env: API_ENV.customRPC },
    [API_ENV.testNet]: { name: 'Haneul Testnet', env: API_ENV.testNet },
    [API_ENV.mainnet]: { name: 'Haneul Mainnet', env: API_ENV.mainnet },
};
...
export default class ApiProvider {
    ...
    private _signerByAddress: Map<HaneulAddress, SignerWithProvider> = new Map();
