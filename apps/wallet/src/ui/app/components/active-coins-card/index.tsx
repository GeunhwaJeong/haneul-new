                        ...
                        <div className="flex flex-col justify-between items-center mt-2">
                            {coins?.map(({ coinType, totalBalance }) => (
                                <Link
                                    ...
                                    key={coinType}
                                    className="py-3.75 px-1.5 no-underline flex gap-2 items-center w-full hover:bg-haneul/10 group border-t border-solid border-transparent border-t-gray-45"
                                >
                                    <CoinItem
                                        coinType={coinType}
