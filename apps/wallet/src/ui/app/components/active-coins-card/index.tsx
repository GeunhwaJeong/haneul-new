...
function ActiveCoinsCard({
    ...
    const IconName = activeCoin?.coinIconName || HaneulIcons.HaneulLogoIcon;
    ...
    const SelectedCoinCard = activeCoin ? (
        <div className={st.selectCoin}>
            <Link
                ...
                className={st.coin}
            >
                <div className={cl(st.haneulIcon, defaultIconClass)}>
                    <Icon icon={IconName} />
                </div>
                ...
                <div className={st.chevron}>
                    <Icon icon={HaneulIcons.HaneulChevronRight} />
                </div>
            </Link>
