...
import { useHaneulLedgerClient } from '_src/ui/app/components/ledger/HaneulLedgerClientProvider';
				...
				<div className="flex flex-col items-center">
					...
					<div className="break-words text-center mt-4.5">
						<Text variant="pBodySmall" color="steel-darker" weight="normal">
							Connect your ledger to your computer, unlock it, and launch the Haneul app. Click
							Continue when done.
						</Text>
