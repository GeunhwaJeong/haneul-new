...
// When something goes wrong in the Haneul application itself, a TransportStatusError is
...
export function isLedgerTransportStatusError(
    error: unknown
): error is LedgerTransportStatusError {
