...
import { ArrowUpRight12, Clipboard24, Domain24, LockLocked24, More24 } from '@haneullabs/icons';
import SvgAccount24 from '@haneullabs/icons/src/Account24';
		...
		<MenuLayout title="Wallet Settings">
			...
			<div className="px-2.5 flex flex-col items-center justify-center no-underline gap-3.75 mt-3.75">
				...
				<Text variant="bodySmall" weight="medium" color="steel">
					On Haneul Wallet version v{version}
				</Text>
			</div>
		</MenuLayout>
	);
