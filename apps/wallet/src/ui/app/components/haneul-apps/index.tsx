...
import { HANEUL_FRAMEWORK_ADDRESS } from '@haneullabs/haneul.js';
...
import { DEFAULT_MINT_NFT_GAS_BUDGET } from '_redux/slices/haneul-objects/Coin';
        ...
        mutationFn: () => {
            ...
            return signer.signAndExecuteTransaction({
                ...
                data: {
                    ...
                    arguments: [
                        'Example NFT',
                        'An NFT created by Haneul Wallet',
                        DEFAULT_NFT_IMAGE,
                    ],
