...
import { type DAppEntry, HaneulApp } from './HaneulApp';
		...
		<Loading loading={loading}>
			...
			<div className="my-4">
				<Text variant="pBodySmall" color="gray-80" weight="normal">
					Apps you have connected to through the Haneul Wallet in this browser.
				</Text>
			</div>

			<div className="grid gap-3.75 grid-cols-2">
				{connectedApps.length ? (
					connectedApps.map((app) => <HaneulApp key={app.permissionID} {...app} displayType="card" />)
				) : (
					<>
