...
export type AccountItemProps = {
    ...
    onAccountSelected: (address: HaneulAddress) => void;
};
...
export function AccountListItem({
    ...
    return (
        <div
            className="flex p-2.5 items-start gap-2.5 rounded-md hover:bg-haneul/10 cursor-pointer focus-visible:ring-1 group transition-colors"
            onClick={() => {
