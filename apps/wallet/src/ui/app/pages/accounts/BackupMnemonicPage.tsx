...
import { ArrowLeft16, Check12 } from '@haneullabs/icons';
						...
						<div className="flex flex-col flex-nowrap flex-grow mb-5">
							...
							{isOnboardingFlow ? (
								<div className="w-full text-left flex mt-5 mb-">
									<label className="flex items-center justify-center h-5 mb-0 mr-5 text-haneul-dark gap-1.25 relative cursor-pointer">
										<input
											type="checkbox"
											name="agree"
											id="agree"
