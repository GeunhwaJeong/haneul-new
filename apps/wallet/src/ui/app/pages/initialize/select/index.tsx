...
import { Add16, Download16 } from '@haneullabs/icons';
	...
	return (
		<>
			<Heading variant="heading1" color="gray-90" as="h2" weight="bold">
				New to Haneul Wallet?
			</Heading>
			<div className="flex flex-col flex-nowrap gap-7.5 mt-7">
				{selections.map((aSelection) => (
					<div
						className={
							'bg-haneul-lightest flex flex-col flex-nowrap items-center gap-3 text-center rounded-15 py-10 px-7.5 max-w-popup-width shadow-wallet-content'
						}
						key={aSelection.url}
					>
