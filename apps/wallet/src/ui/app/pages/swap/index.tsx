...
import { useBalanceInUSD, useCoinMetadata, useZodForm } from '@haneullabs/core';
...
export function SwapPage() {
	...
	const isHaneul = fromCoinType
		? normalizeStructTag(fromCoinType) === normalizeStructTag(HANEUL_TYPE_ARG)
		: false;
	...
	const showGasFeeBanner = !swapTransactionPending && swapData && isHaneul && isMaxBalance;
							...
							<div className="flex flex-col gap-4">
								<div
									className={clsx(
										...
										{ 'bg-haneul-primaryBlue2023/10': isFormValid },
									)}
								>
									<AssetData
										coinType={toCoinType || ''}
