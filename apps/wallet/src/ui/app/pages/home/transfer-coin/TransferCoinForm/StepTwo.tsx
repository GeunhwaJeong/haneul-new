...
function StepTwo({
    ...
    const totalHaneulAmount = new BigNumber(gasCostEstimation || 0)
    ...
    const [formattedTotalHaneul] = useFormatCoin(totalHaneulAmount, GAS_TYPE_ARG);
                ...
                <div className={st.responseCard}>
                    ...
                    <div className={st.details}>
                        {[
                            ...
                            ['Total Amount', formattedTotalHaneul, GAS_SYMBOL],
