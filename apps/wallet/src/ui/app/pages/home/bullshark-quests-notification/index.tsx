				...
				<div className="flex flex-col font-frankfurter w-full h-full items-center p-4 text-white text-center">
					<div className="flex flex-col py-6 px-7 border-4 border-black border-solid w-full rounded-md h-full items-center overflow-auto">
						<div className="flex flex-col items-center">
							...
							<div className="bg-[url('https://quests.haneul-labs.com/_next/static/media/logo.81b4eb8f.svg')] h-40 w-40 bg-cover" />
							<InterstitialHeading text="5 Million HANEUL prize pool!" />
							<div className="flex flex-col items-center gap-2 mt-2">
								<InterstitialBanner lines={['2.5M HANEUL', 'Top 10,000 players!']} />
								<InterstitialBanner lines={['2.5M HANEUL', 'all eligible players!']} />
							</div>
						</div>
						...
						<div className="flex flex-col items-center gap-4 [-webkit-text-stroke:1px_black] w-full mt-5">
							...
							>
								<X32 className="text-haneul-dark h-8 w-8" />
							</button>
						</div>
					</div>
				</div>
