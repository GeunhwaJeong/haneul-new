...
const BACKEND_HOST =
	process.env.NODE_ENV === 'production' ? 'https://apps-backend.haneul.io' : 'http://localhost:3003';
...
const ONRAMP_PROVIDER: OnrampProvider[] = [
	{
		...
		getUrl: async (address) => {
			...
			const url = `https://haneulwallet.banxa.com/?${params}`;
			return url;
		},
	},
	{
