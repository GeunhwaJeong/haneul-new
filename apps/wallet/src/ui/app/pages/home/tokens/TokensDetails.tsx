...
import { useAppsBackend, useFormatCoin, useResolveHaneulNSName } from '@haneullabs/core';
...
import SvgHaneulTokensStack from './TokensStackIcon';
...
export function TokenRow({
	...
	return (
		<Tag
			className={clsx(
				'flex py-3 pl-1.5 pr-2 rounded hover:bg-haneul/10 items-center border-solid border-t-transparent border-x-transparent bg-transparent',
