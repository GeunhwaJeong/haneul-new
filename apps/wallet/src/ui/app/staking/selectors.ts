...
import { Delegation, getObjectFields } from '@haneullabs/haneul.js';
...
import type { DelegationHaneulObject, HaneulMoveObject } from '@haneullabs/haneul.js';
...
export function getValidatorSelector(validatorAddress?: string) {
    ...
    return createSelector(haneulSystemObjectSelector, (systemObj) => {
        ...
        const validator: HaneulMoveObject | undefined = [
            ...
            (aValidator) => aValidator.fields.haneul_address === validatorAddress
        );
        return validator;
    });
}
