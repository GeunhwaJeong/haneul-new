...
import { DEFAULT_GAS_BUDGET_FOR_STAKE } from '_redux/slices/haneul-objects/Coin';
...
function StakeForm({
    ...
    const [gasBudgetEstimation] = useFormatCoin(gasBudgetInMist, HANEUL_TYPE_ARG);

    const totalAvailableBalance =
        coinBalance -
        BigInt(coinType === HANEUL_TYPE_ARG ? gasBudgetInMist || 0 : 0);
