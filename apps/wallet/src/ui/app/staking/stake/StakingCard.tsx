...
function StakingCard() {
    ...
    //TODO: this is a hack to get the total amount of gas coins
    // for unstake add gas
    //NOTE: I think we should remove this. Validation expects just the total amount of HANEUL
    ...
    const allHaneulCoinsSelector = useMemo(
        () => createCoinsForTypeSelector(HANEUL_TYPE_ARG),
        []
    );
    const allHaneulCoins = useAppSelector(allHaneulCoinsSelector);
            ...
            try {
                ...
                Promise.all([
                    queryClient.invalidateQueries({
                        queryKey: ['object', normalizeHaneulAddress(STATE_OBJECT)],
                    }),
                    queryClient.invalidateQueries({
                        queryKey: ['validator'],
                    }),
