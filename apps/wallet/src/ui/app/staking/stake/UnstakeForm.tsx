...
export function UnStakeForm({
	...
	const [totalHaneul] = useFormatCoin(BigInt(stakingReward || 0) + coinBalance, HANEUL_TYPE_ARG);
	const [tokenBalance] = useFormatCoin(coinBalance, coinType);

	const transaction = useMemo(() => createUnstakeTransaction(stakedHaneulId), [stakedHaneulId]);
