...
import { isHaneulObject, isHaneulMoveObject, HANEUL_TYPE_ARG } from '@haneullabs/haneul.js';
...
export function ValidateDetailFormCard({
    ...
    const validatorByAddress = useMemo(() => {
        ...
        return (
            validatorsData.validators.fields.active_validators.find(
                (av) =>
                    av.fields.metadata.fields.haneul_address === validatorAddress
            ) || null
        );
    ...
    const validatorData = useMemo(() => {
        ...
        const { name: rawName, haneul_address } =
        ...
        return {
            ...
            apy: APY > 0 ? APY : 'N/A',
            logo: null,
            address: haneul_address,
            totalStaked: pending_delegations.reduce(
                (acc, fields) =>
                    (acc += BigInt(fields.fields.haneul_amount || 0n)),
                0n
            ),
