...
const cardStyle = cva(
    ...
    ],
    {
        variants: {
            variant: {
                warmUp: 'bg-white border border-gray-45 text-steel-dark hover:bg-haneul/10 hover:border-haneul/30',
                earning:
                    'bg-white border border-gray-45 text-steel-dark hover:bg-haneul/10 hover:border-haneul/30',
                coolDown:
...
export function StakeCard({
    ...
    const [principalStaked, symbol] = useFormatCoin(principal, HANEUL_TYPE_ARG);
