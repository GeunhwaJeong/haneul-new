...
import { GAS_TYPE_ARG } from '../../redux/slices/haneul-objects/Coin';
...
export function DelegationCard({
    ...
    return (
        <Link
            ...
            className="flex no-underline flex-col py-3 px-3.75 box-border h-36 w-full rounded-2xl border hover:bg-haneul/10 group border-solid border-gray-45 hover:border-haneul/10 bg-transparent"
        >
