...
export function ValidatorListItem({
    ...
    const validatorAddress = validator.fields.metadata.fields.haneul_address;
    const apy = useMemo(
    ...
    return (
        <AnimatePresence>
            ...
            >
                <div
                    className={cl(
                        selected && 'bg-haneul/10',
                        'flex justify-between w-full hover:bg-haneul/10 py-3.5 px-2 rounded-lg group items-center gap-1'
                    )}
                    role="button"
                >
