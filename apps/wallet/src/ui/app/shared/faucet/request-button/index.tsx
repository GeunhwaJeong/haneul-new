...
function FaucetRequestButton({
    ...
    const networkName = API_ENV_TO_INFO[network].name.replace(/haneul\s*/gi, '');
    ...
    return mutation.enabled ? (
        ...
        >
            <Icon icon={HaneulIcons.Download} className={cl(st.icon, st[mode])} />
            Request {networkName} HANEUL Tokens
        </Button>
    ) : null;
}
