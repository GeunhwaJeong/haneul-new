        ...
        return (
            <ButtonOrLink
                ...
                className={clsx(
                    ...
                    disabled
                        ? 'bg-gray-40'
                        : 'bg-haneul/10 hover:shadow-drop hover:border-haneul/10'
                )}
            >
                {loading && (
                ...
                {!loading && (
                    ...
                    >
                        {before && (
                            <Decorator disabled={disabled}>{before}</Decorator>
                        )}
                        <div className="flex flex-col">
                            {top && (
                                <Decorator disabled={disabled}>{top}</Decorator>
                            )}
                            <div
                                className={clsx(
