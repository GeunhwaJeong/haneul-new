    ...
    ],
    {
        variants: {
            ...
            dark: {
                ...
                false: 'border-haneul-light text-hero-dark active:bg-gray-45 active:text-steel-darker active:border-gray-45 disabled:bg-white hover:bg-haneul-light focus:bg-haneul-light',
            },
        },
        defaultVariants: {
            dark: false,
