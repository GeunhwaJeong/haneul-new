...
import { roundFloat, useGetRollingAverageApys } from '@haneullabs/core';
...
type DelegatedAPYProps = {
    stakedValidators: HaneulAddress[];
};
            ...
            {averageNetworkAPY > 0 ? (
                <>
                    ...
                    <div className="text-steel items-baseline text-body flex">
                        <IconTooltip
                            tip="The average APY of all validators you are currently staking your HANEUL on."
                            placement="top"
                        />
                    </div>
                </>
