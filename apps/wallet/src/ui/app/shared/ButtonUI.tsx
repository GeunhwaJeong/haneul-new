	...
	],
	{
		variants: {
			variant: {
				...
				hidden: [
					'bg-gray-45 bg-opacity-25 text-gray-60 hover:text-haneul-dark hover:bg-gray-35 hover:bg-opacity-75 border-none h-full w-full backdrop-blur-md',
				],
			},
			size: {
...
const iconStyles = cva('flex', {
	variants: {
		...
		variant: {
			primary: ['text-haneul-light group-active:text-steel/70 group-disabled:text-steel/50'],
			secondary: [
				'text-steel',
