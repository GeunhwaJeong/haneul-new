...
const tabStyles = cva(
    [
        'border-b border-transparent ui-selected:border-haneul-grey-65 font-semibold text-haneul-grey-70 pb-2 -mb-px',
...
export function TabList({
    ...
    return (
        <HeadlessTab.List
            className={clsx(
                'flex gap-6 border-haneul-grey-45 border-solid border-0',
                fullWidth && 'flex-1',
