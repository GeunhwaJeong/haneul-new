...
const cellStyle = cva(['text-haneul-grey-75 h-[30px] px-[4px]'], {
    variants: {
        variant: {
            th: 'text-left font-semibold uppercase text-subtitle',
            td: 'group-hover:text-haneul-grey-90 group-hover:bg-haneul-grey-40 text-body group-hover:first:rounded-l-[4px] group-hover:last:rounded-r-[4px]',
        },
    },
    defaultVariants: {
        variant: 'td',
