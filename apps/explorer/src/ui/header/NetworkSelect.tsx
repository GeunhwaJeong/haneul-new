    ...
    return (
        <div
            ...
            className={clsx(
                ...
                'flex items-start gap-4 px-2 py-3 text-body font-semibold rounded-md hover:text-haneul-grey-90 ui-active:text-haneul-grey-90 hover:bg-haneul-grey-40 ui-active:bg-haneul-grey-40',
        ...
        >
            <CheckIcon
                className={clsx('flex-shrink-0', {
                    ...
                    'text-haneul-grey-60': state === NetworkState.PENDING,
                    'text-haneul-grey-45': state === NetworkState.UNSELECTED,
                })}
            />
        ...
        >
            <input
                ...
                className={clsx(
                    ...
                    formState.errors.url
                        ...
                        : 'border-haneul-grey-65 text-haneul-grey-90'
                )}
            />
            ...
            <div className="absolute inset-y-0 right-0 flex flex-col justify-center px-3">
                <button
                    ...
                    type="submit"
                    className="text-white uppercase text-captionSmall font-semibold rounded-full px-2 py-1 bg-haneul-grey-90 flex items-center justify-center border-0 transition disabled:bg-haneul-grey-45 disabled:text-haneul-grey-65"
                >
                    Save
                </button>
            </div>
