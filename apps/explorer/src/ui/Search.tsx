    ...
    return (
        ...
        >
            <Combobox.Input
                ...
                className="w-full rounded-md border border-transparent bg-search-fill/60 pl-2 text-body leading-9 text-white/20 outline-none placeholder:text-xs placeholder:text-white/40 hover:bg-search-fill hover:placeholder:text-white/60 focus:border-haneul focus:bg-search-fill focus:text-white focus:placeholder:text-white/60"
                onChange={onChange}
