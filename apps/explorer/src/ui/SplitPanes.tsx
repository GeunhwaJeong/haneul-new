...
import { ChevronLeft16, ChevronUp16 } from '@haneullabs/icons';
    ...
    return (
        ...
        >
            <div
                ...
                className={clsx(
                    'relative bg-gray-45 group-hover:bg-haneul data-[is-dragging=true]:bg-hero',
                ...
                {collapsibleButton && (
                    <button
                        ...
                        className={clsx([
                            ...
                            'hover:bg-haneul hover:text-white group-hover:block',
