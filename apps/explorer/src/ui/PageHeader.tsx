...
const TYPE_TO_ICON: Record<PageHeaderType, typeof CallIcon> = {
    ...
    Pay: PayIcon,
    // TODO: replace with HANEUL specific icon if needed
    PayHaneul: PayIcon,
    PayAllHaneul: PayIcon,
    Publish: PublishIcon,
...
export function PageHeader({ title, subtitle, type, status }: PageHeaderProps) {
    ...
    return (
        <div data-testid="pageheader">
            <div className="text-haneul-grey-85 flex items-center gap-2 mb-3">
            ...
            <div className="flex flex-col lg:flex-row gap-2">
                <div className="flex items-start gap-2 min-w-0">
                    ...
                    <button
                        ...
                        className="bg-transparent border-none cursor-pointer p-0 m-0 text-haneul-steel flex justify-center items-center -mt-0.5"
                    >
            ...
            {subtitle && (
                <div className="text-haneul-grey-75 mt-2 break-words">
                    <Heading variant="heading4" weight="semibold">
                        {subtitle}
                    </Heading>
                </div>
