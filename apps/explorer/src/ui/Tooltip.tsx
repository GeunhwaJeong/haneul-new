            ...
            <FloatingPortal>
                <AnimatePresence>
                    {open ? (
                        ...
                        >
                            <div className="bg-haneul-grey-100 p-2 flex flex-col flex-nowrap gap-px rounded-md">
                                {tip}
                            </div>
                            <div
                                ref={arrowRef}
                                className="absolute z-[-1] bg-haneul-grey-100 transform rotate-45 h-[12px] w-[12px]"
                                style={arrowStyle}
                            />
                        </motion.div>
                    ) : null}
