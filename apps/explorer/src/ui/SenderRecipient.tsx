    ...
    return (
        <div className="flex flex-col justify-start text-haneul-grey-100 gap-4">
            ...
            <div className="flex flex-col gap-[15px] justify-center relative">
                {singleTransferCoin && (
                    <div className="absolute border-dashed border border-haneul-steel overflow-y-hidden h-[calc(57%)] w-4 border-r-transparent border-t-transparent mt-1 ml-1.5 rounded-l" />
                )}
