...
export function SenderRecipient({
    ...
    return (
        <div className="flex flex-col justify-start text-haneul-grey-100 gap-4">
            ...
            <div className="flex flex-col gap-[15px] justify-center relative">
                {singleTransferCoin && (
                    <div className="absolute border-2 border-haneul-steel overflow-y-hidden h-[calc(55%)] w-4 border-r-transparent border-t-transparent mt-1 ml-1.5 rounded-l border-dotted" />
                )}
