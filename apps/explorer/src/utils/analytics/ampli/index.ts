 ...
 *
 * [View Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Explorer/events/main/latest)
 *
 * [Full Setup Instructions](https://data.amplitude.com/haneullabs/Haneul%20Explorer/implementation/web)
 */
...
export interface IdentifyProperties {
	...
	/**
	 * The domain (e.g., haneulexplorer.com) of a given page.
	 */
	pageDomain: string;
	/**
	...
	pagePath: string;
	/**
	 * The full URL (e.g., haneulexplorer.com/validators) of a given page.
	 */
	pageUrl: string;
}
...
export class OpenedHaneulExplorer implements BaseEvent {
	event_type = 'opened haneul explorer';
}
...
export class Ampli {
  ...
  */
   ...
   * activated tooltip
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Explorer/events/main/latest/activated%20tooltip)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Explorer/events/main/latest/clicked%20current%20epoch%20card)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Explorer/events/main/latest/clicked%20search%20result)
   *
   ...
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Explorer/events/main/latest/clicked%20validator%20row)
   *
   ...
   * completed search
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Explorer/events/main/latest/completed%20search)
   *
  ...
  /**
   * opened haneul explorer
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Explorer/events/main/latest/opened%20haneul%20explorer)
   *
   * When users first open Haneul Explorer.
   *
   * Owner: William Robertson
   *
   * @param options Amplitude event options.
   */
  openedHaneulExplorer(
    options?: EventOptions,
  ) {
    return this.track(new OpenedHaneulExplorer(), options);
  }

  /**
   * redirect to external explorer
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Explorer/events/main/latest/redirect%20to%20external%20explorer)
   *
   * Metric to track which external explorers are being used, currently have haneulscan and haneulvision
   *
   ...
   * switched network
   *
   * [View in Tracking Plan](https://data.amplitude.com/haneullabs/Haneul%20Explorer/events/main/latest/switched%20network)
   *
