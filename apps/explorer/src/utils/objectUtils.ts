...
import { getObjectType, type ObjectOwner, type HaneulObjectResponse } from '@haneullabs/haneul.js';
...
export function parseObjectType(data: HaneulObjectResponse): string {
