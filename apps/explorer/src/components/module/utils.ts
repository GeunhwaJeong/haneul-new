...
/**
 * Converts a HaneulMoveNormalizedType to string
 ...
 * T is provided on function level with the type_parameters field of HaneulMoveNormalizedFunction that defines the abilities.
...
export function normalizedFunctionParameterTypeToString(
    param: HaneulMoveNormalizedType,
