...
import { normalizeHaneulAddress, type HaneulMoveNormalizedType } from '@haneullabs/haneul.js';
import cl from 'clsx';
...
function unwrapTypeReference(type: HaneulMoveNormalizedType): null | TypeReference {
										...
										if (
											...
											return (
												<LinkWithQuery
													...
													to={href}
													target={
														normalizeHaneulAddress(reference.address) === normalizeHaneulAddress(id!)
															? undefined
															: '_blank'
													}
												/>
