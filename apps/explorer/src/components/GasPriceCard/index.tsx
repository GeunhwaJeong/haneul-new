...
import { useGetReferenceGasPrice, useRpcClient } from '@haneullabs/core';
...
function useHistoricalGasPrices() {
	...
	return useQuery<EpochGasInfo[]>({
		...
		queryFn: async () => {
			...
			// once this is done https://haneullabs.atlassian.net/browse/PI-6
...
// TODO: Delete this prop once we roll out the HANEUL token card
