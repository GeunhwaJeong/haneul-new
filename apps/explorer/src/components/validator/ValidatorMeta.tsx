				...
				<div className="mt-1.5 flex flex-col">
					...
					{projectUrl && (
						<a
							...
							className="mt-2.5 inline-flex items-center gap-1.5 text-body font-medium text-haneul-dark no-underline"
						>
							{projectUrl.replace(/\/$/, '')}
				...
				<DescriptionList>
					...
					<DescriptionItem title="Address" align="start">
						<div className="flex items-start gap-1">
							<AddressLink address={validatorData.haneulAddress} noTruncate />
							<CopyToClipboard size="md" color="steel" copyText={validatorData.haneulAddress} />
						</div>
					</DescriptionItem>
