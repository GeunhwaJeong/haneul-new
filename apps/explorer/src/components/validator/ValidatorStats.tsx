...
export function ValidatorStats({
    ...
    const delegatedStake = +validatorData.delegation_staking_pool.haneul_balance;
            ...
            <Card spacing="lg">
                <div className="flex basis-full flex-col gap-8 md:basis-1/3">
                    ...
                    <div className="flex flex-col gap-8 lg:flex-row">
                        ...
                        <Stats
                            label="Total HANEUL Staked"
                            tooltip="The total HANEUL staked on the network by validators and delegators to validate the network and earn rewards."
                    ...
                    <div className="flex flex-col gap-8 lg:flex-row">
                        ...
                        <Stats
                            ...
                            tooltip="The total HANEUL staked by delegators."
                        ...
                        <Stats
                            label="Self Staked"
                            tooltip="The total HANEUL staked by this validator."
            ...
            <Card spacing="lg">
                <div className="flex basis-full flex-col items-stretch gap-8 md:basis-80">
                    ...
                    <div className="flex flex-col gap-8">
                        <Stats
                            label="Last Epoch HANEUL Rewards"
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="flex flex-col gap-8 lg:flex-row">
                            <Stats
                                ...
                                tooltip="A score generated by validators to evaluate each other’s performance throughout Haneul’s regular operations."
                                unavailable
                            />
                            <Stats
