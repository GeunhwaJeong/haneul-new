...
import { useAppsBackend, useElementDimensions } from '@haneullabs/core';
...
const haneulVisionTestnetUrl = 'https://testnet.haneulvision.xyz/';
const haneulScanTestnetUrl = 'https://haneulscan.xyz/testnet/home';

function TestnetOutageBanner() {
	return (
		<div className="flex flex-wrap gap-4">
			Haneul Explorer&apos;s Testnet backend is undergoing maintenance. The following explorers may
			provide more accurate data at this time:
			<div className="flex gap-4 max-md:py-3">
				<Link href={haneulVisionTestnetUrl} after={<ArrowUpRight12 className="h-3 w-3 text-steel" />}>
					<Text variant="bodySmall/medium" color="hero-darkest">
						HaneulVision
					</Text>
				</Link>
				<Link href={haneulScanTestnetUrl} after={<ArrowUpRight12 className="h-3 w-3 text-steel" />}>
					<Text variant="bodySmall/medium" color="hero-darkest">
						HaneulScan
					</Text>
				</Link>
