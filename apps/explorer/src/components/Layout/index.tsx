...
import { type Network, NetworkConfigs, createHaneulClient } from '~/utils/api/DefaultRpcClient';
import { KioskClientProvider } from '@haneullabs/core/src/components/KioskClientProvider';
...
export function Layout() {
	...
	useCookieConsentBanner(persistableStorage, {
		cookie_name: 'haneul_explorer_cookie_consent',
		onBeforeLoad: async () => {
