...
type TransactionBlocksForObject = {
	address: string;
...
type TransactionBlocksForObjectActionType = {
	type: PAGE_ACTIONS;
...
const reducer = (state: PageStateByFilterMap, action: TransactionBlocksForObjectActionType) => {
	switch (action.type) {
...
function TransactionBlocksForObject({
	address,
...
export default TransactionBlocksForObject;
