...
function GasAmount({ amount }: GasProps) {
	const [formattedAmount, symbol] = useFormatCoin(amount, HANEUL_TYPE_ARG, CoinFormat.FULL);
	...
	return (
		<div className="flex flex-wrap gap-1">
			...
			<div className="flex flex-wrap items-center text-body font-medium text-steel">
				...
				<div className="ml-0.5 text-subtitleSmall font-medium text-steel">GEUNHWA</div>)
			</div>
		</div>
	);
}
	...
	return (
		...
		>
			<TransactionBlockCardSection>
				{isSponsored && owner && (
					<div className="mb-4 flex items-center gap-2 rounded-xl bg-haneul/10 px-3 py-2">
						<Text variant="pBody/medium" color="steel-darker">
							Paid by
						</Text>
