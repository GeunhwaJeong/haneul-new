...
function GasAmount({ amount }: { amount: bigint | number }) {
    ...
    return (
        <div className="flex items-center gap-1 h-full">
            <div className="text-haneul-grey-90 flex items-baseline gap-0.5">
                <Text variant="body">{formattedAmount}</Text>
                <Text variant="subtitleSmall">{symbol}</Text>
            </div>
            <Text variant="bodySmall">
                <div className="text-haneul-grey-65 flex items-center">
                    (
                    <div className="flex items-baseline gap-0.5">
                        <div>{amount.toLocaleString()}</div>
                        <Text variant="subtitleSmall">GEUNHWA</Text>
                    </div>
                    )
                </div>
            </Text>
