...
import type { TransactionKindName, HaneulTransactionKind } from '@haneullabs/haneul.js';
...
function getSignatureFromAddress(
    ...
    return signatures.find(
        (signature) => `0x${signature.pubKey.toHaneulAddress()}` === haneulAddress
    );
}
            ...
            <Text variant="bodySmall/medium">
                <div className="flex items-center text-steel">
                    ...
                    <div className="flex items-baseline gap-0.5">
                        ...
                        <Text variant="subtitleSmall/medium">GEUNHWA</Text>
                    </div>
                    )
                </div>
            </Text>
                                ...
                                <ItemView
                                    data={{
                                        ...
                                        content: [
                                            ...
                                            {
                                                label: 'PubKey',
                                                value: `0x${accountSignature.pubKey.toHaneulAddress()}`,
                                                monotypeClass: true,
                                            },
                                            {
                                                label: 'Signature',
                                ...
                                <ItemView
                                    data={{
                                        ...
                                        content: [
                                            ...
                                            {
                                                label: 'PubKey',
                                                value: `0x${sponsorSignature.pubKey.toHaneulAddress()}`,
                                                monotypeClass: true,
                                            },
                                            {
                                                label: 'Signature',
