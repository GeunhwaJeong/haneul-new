...
const validators: TestValidatorInfo[] = [
    {
        ...
        haneulAddress: '0x693447224cf96c7b1f8de90d15198ceea22439e5',
    },
    {
        name: 'Blockdaemon',
        stake: BigInt(8_220_000),
        haneulAddress: '0x4497a41750e240f7a3352215c78b1e8ce9d605c1',
    },
    {
        name: 'Kraken',
        stake: BigInt(4_650_000),
        haneulAddress: '0xdb3d8f18e40e7fdcb4a3179e029044595e33cf76',
    },
    {
        name: 'Coinbase',
        stake: BigInt(4_550_000),
        haneulAddress: '0xf2f70c204eed5c33a9bb3eb4c0e3048edbbc3ac3',
    },
    {
        name: 'a16z',
        stake: BigInt(2_860_000),
        haneulAddress: '0xf446d537680e4601f8fdc922ab897cc78f3706d7',
    },
    {
        name: 'Figment',
        stake: BigInt(2_840_000),
        haneulAddress: '0x1c83e3c2fe69dd15f60633cf072c3840adef504b',
    },
    {
        name: 'Another One',
        stake: BigInt(2_730_000),
        haneulAddress: '0x62afdd1fb17dbeb5325a0f3f6d073ba05bf1b958',
    },
    {
        name: 'Someone Else',
        stake: BigInt(2_730_000),
        haneulAddress: '0xdd0b64b253fe55b71f9784afee2dfa2e8bbd1ab7',
    },
    {
        name: '4Pool',
        stake: BigInt(2_730_000),
        haneulAddress: '0xd4394c1577ca125630f652428d071a7b7dd047ad',
    },
    {
        name: '3Pool',
        stake: BigInt(2_730_000),
        haneulAddress: '0xb0ecf49920c6a46104e94d810a9e81db17a6e866',
    },
];
...
export const mockState: ValidatorState = {
    ...
    parameters: {
        type: '0x2::haneul_system::SystemParameters',
        fields: {
        ...
        fields: {
            ...
            metadata: {
                ...
                fields: {
                    ...
                    next_epoch_stake: 0,
                    pubkey_bytes: '',
                    haneul_address: partial.haneulAddress,
                },
            },
            ...
            pending_stake: {
                type: '0x1::option::Option<0x2::balance::Balance<0x2::haneul::HANEUL>>',
                fields: {},
            },
