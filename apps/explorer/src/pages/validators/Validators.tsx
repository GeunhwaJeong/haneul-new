        ...
        data: [...validators]
            ...
            .map((validator) => {
                ...
                return {
                    ...
                    apy:
                        rollingAverageApys?.[validator.haneulAddress] ||
                        rollingAverageApys?.[validator.haneulAddress] === 0
                            ? rollingAverageApys?.[validator.haneulAddress]
                            : null,
        ...
        columns: [
            ...
            },
            {
                ...
                cell: (props: any) => {
                    ...
                    return atRisk !== null ? (
                        <Tooltip tip="Staked HANEUL is below the minimum HANEUL stake threshold to remain a validator.">
...
function ValidatorPageResult() {
    ...
    const totalStaked = useMemo(() => {
        ...
        return validators.reduce(
            (acc, cur) => acc + +cur.stakingPoolHaneulBalance,
            0
        );
    }, [data]);
