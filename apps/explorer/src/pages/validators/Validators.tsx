    ...
    return {
        data: validators.map((validator, index) => {
            ...
            const delegatedStake =
                +validator.fields.delegation_staking_pool.fields.haneul_balance;
            ...
            return {
                ...
                img: img,
                address: validator.fields.metadata.fields.haneul_address,
...
function ValidatorPageResult() {
    ...
    const totalStaked = useMemo(() => {
        ...
        return validators.reduce(
            (acc, cur) =>
                acc +
                +cur.fields.delegation_staking_pool.fields.haneul_balance +
