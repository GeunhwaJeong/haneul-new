...
import { useGetValidatorsEvents, useGetRollingAverageApys } from '@haneullabs/core';
            ...
            <div className="grid grid-flow-row gap-4 sm:gap-2 md:flex md:gap-6">
                ...
                <EpochStats label="Activity">
                    <Stats label="Gas Revenue" tooltip="Gas Revenue">
                        <HaneulAmount amount={gasCostSummary?.gasRevenue} />
                    </Stats>
                    <Stats label="Storage Revenue" tooltip="Storage Revenue">
                        <HaneulAmount amount={gasCostSummary?.storageRevenue} />
                    </Stats>
                    <Stats label="Stake Rewards" tooltip="Stake Rewards">
                        <HaneulAmount amount={gasCostSummary?.stakeRewards} />
                    </Stats>
                </EpochStats>
                <EpochStats label="Rewards">
                    ...
                    <Stats label="Total Rewards" tooltip="Total Rewards">
                        <HaneulAmount amount={totalRewards} />
                    </Stats>
                    ...
                    >
                        <HaneulAmount amount={storageFundEarnings} />
                    </Stats>
                </EpochStats>
                <Card spacing="lg">
                    <RingChart
