...
import { ArrowUpRight16, Info16 } from '@haneullabs/icons';
...
function OwnerCard({
	...
	const [storageRebateFormatted] = useFormatCoin(storageRebate, HANEUL_TYPE_ARG, CoinFormat.FULL);
