    ...
    A: AuthorityClient + Send + Sync + 'static + Clone,
{
    ...
    fn update_certificates(
        ...
        for new_cert in &certificates {
            ...
            // TODO: Refactor how we stor certs in client to avoid this logic https://github.com/GeunhwaJeong/fastnft/issues/82
    ...
    fn update_objects_from_order_info(
        ...
        // https://github.com/GeunhwaJeong/fastnft/issues/175
    ...
    /// https://github.com/GeunhwaJeong/fastnft/issues/174
    ...
    /// TODO: https://github.com/GeunhwaJeong/fastnft/issues/173
    async fn execute_call(
        ...
        // https://github.com/GeunhwaJeong/fastnft/issues/173
    ...
    fn transfer_object(
        ...
        Box::pin(self.transfer(
            (
                ...
                // TODO(https://github.com/GeunhwaJeong/fastnft/issues/123): Include actual object digest here
