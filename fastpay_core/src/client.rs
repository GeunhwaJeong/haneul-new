    ...
    A: AuthorityAPI + Send + Sync + 'static + Clone,
{
    ...
    async fn query(
        ...
        // BUG(https://github.com/GeunhwaJeong/fastnft/issues/290): This function assumes that requesting the parent cert of object seq+1 will give the cert of
        ...
        for client in self.authority_clients.iter_mut() {
            ...
            if let Ok(response) = result {
                ...
                if certificate.check(&self.committee).is_ok() {
                    // BUG (https://github.com/GeunhwaJeong/fastnft/issues/290): Orders do not have a sequence number any more, objects do.
                    /*
    ...
    A: AuthorityAPI + Send + Sync + 'static + Clone,
{
    ...
    // BUG(https://github.com/GeunhwaJeong/fastnft/issues/290): This logic for
    ...
    /// TODO: lock only objects that are mutable: https://github.com/GeunhwaJeong/fastnft/issues/305
    ...
    // https://github.com/GeunhwaJeong/fastnft/pull/336.
    async fn download_own_object_ids_from_random_authority(
        ...
        // TODO: implement sampling according to stake distribution and using secure RNG. https://github.com/GeunhwaJeong/fastnft/issues/128
            ...
            OrderKind::Transfer(transfer) => {
                ...
                let response = self
                    .get_object_info(ObjectInfoRequest {
                        ...
                        // TODO(https://github.com/GeunhwaJeong/fastnft/issues/290):
