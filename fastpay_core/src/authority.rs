...
impl AuthorityState {
    ...
    pub async fn handle_order(&self, order: Order) -> Result<ObjectInfoResponse, FastPayError> {
        ...
        for object_ref in input_objects {
            ...
            // TODO(https://github.com/GeunhwaJeong/fastnft/issues/123): This hack substitutes the real
    ...
    pub async fn handle_object_info_request(
        ...
        if let Some(seq) = request.request_sequence_number {
            // TODO(https://github.com/GeunhwaJeong/fastnft/issues/123): Here we need to develop a strategy
