...
impl AuthorityState {
    ...
    pub async fn handle_order(&self, order: Order) -> Result<AccountInfoResponse, FastPayError> {
        ...
        // TODO(https://github.com/GeunhwaJeong/fastnft/issues/45): check that c.gas_payment exists + that its value is > gas_budget
    ...
    pub async fn handle_confirmation_order(
        ...
        match order.kind {
            ...
            OrderKind::Call(c) => {
                ...
                // TODO(https://github.com/GeunhwaJeong/fastnft/issues/45): charge for gas
                ...
                match adapter::execute(
                    ...
                    Ok(()) => {
                        // TODO(https://github.com/GeunhwaJeong/fastnft/issues/63): AccountInfoResponse should return all object ID outputs.
                    ...
                    Err(_e) => {
                        // TODO(https://github.com/GeunhwaJeong/fastnft/issues/63): return this error to the client
